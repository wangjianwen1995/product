...
public class SdInfoVSD implements Serializable {
    ...
    @Column(name = "VSD_0_1_6")
    @JsonProperty("VSD-0-1-6")
    private String VSD_0_1_6; // 患者年龄是否大于等于18岁
    public String getVSD_0_1_6() {  return this.VSD_0_1_6;}
    @JsonProperty("VSD-0-1-6")
    public void setVSD_0_1_6(final String VSD_0_1_6) { this.VSD_0_1_6=VSD_0_1_6;}
    @Column(name = "IDCard")
    @JsonProperty("IDCard")
    ...
    public String getVSD_1_1_1() {  return this.VSD_1_1_1;}
    @JsonProperty("VSD-1-1-1")
    public void setVSD_1_1_1(final String VSD_1_1_1) { this.VSD_1_1_1=VSD_1_1_1;}
    @Column(name = "VSD_1_1_2")
    @JsonProperty("VSD-1-1-2")
    private String VSD_1_1_2; // 左室射血分数（LVEF）测量值
    public String getVSD_1_1_2() {  return this.VSD_1_1_2;}
    @JsonProperty("VSD-1-1-2")
    public void setVSD_1_1_2(final String VSD_1_1_2) { this.VSD_1_1_2=VSD_1_1_2;}
    @Column(name = "VSD_1_1_2_1")
    @JsonProperty("VSD-1-1-2-1")
    private String VSD_1_1_2_1; // LVEF评估结果的分层
    public String getVSD_1_1_2_1() {  return this.VSD_1_1_2_1;}
    @JsonProperty("VSD-1-1-2-1")
    public void setVSD_1_1_2_1(final String VSD_1_1_2_1) { this.VSD_1_1_2_1=VSD_1_1_2_1;}
    @Column(name = "VSD_1_1_3")
    @JsonProperty("VSD-1-1-3")
    private String VSD_1_1_3; // 室间隔缺损手术缺损分型
    public String getVSD_1_1_3() {  return this.VSD_1_1_3;}
    @JsonProperty("VSD-1-1-3")
    public void setVSD_1_1_3(final String VSD_1_1_3) { this.VSD_1_1_3=VSD_1_1_3;}
    @Column(name = "VSD_1_1_4")
    @JsonProperty("VSD-1-1-4")
    private String VSD_1_1_4; // VSD是否多发
    public String getVSD_1_1_4() {  return this.VSD_1_1_4;}
    @JsonProperty("VSD-1-1-4")
    public void setVSD_1_1_4(final String VSD_1_1_4) { this.VSD_1_1_4=VSD_1_1_4;}
    @Column(name = "VSD_1_2_1")
    @JsonProperty("VSD-1-2-1")
    private String VSD_1_2_1; // 是否实施手术前的心导管检查评估
    public String getVSD_1_2_1() {  return this.VSD_1_2_1;}
    @JsonProperty("VSD-1-2-1")
    public void setVSD_1_2_1(final String VSD_1_2_1) { this.VSD_1_2_1=VSD_1_2_1;}
    @Column(name = "VSD_1_2_2_1")
    @JsonProperty("VSD-1-2-2-1")
    private String VSD_1_2_2_1; // 肺循环血量
    public String getVSD_1_2_2_1() {  return this.VSD_1_2_2_1;}
    @JsonProperty("VSD-1-2-2-1")
    public void setVSD_1_2_2_1(final String VSD_1_2_2_1) { this.VSD_1_2_2_1=VSD_1_2_2_1;}
    @Column(name = "VSD_1_2_2_2")
    @JsonProperty("VSD-1-2-2-2")
    private String VSD_1_2_2_2; // 体循环血量
    public String getVSD_1_2_2_2() {  return this.VSD_1_2_2_2;}
    @JsonProperty("VSD-1-2-2-2")
    public void setVSD_1_2_2_2(final String VSD_1_2_2_2) { this.VSD_1_2_2_2=VSD_1_2_2_2;}
    @Column(name = "VSD_1_2_2")
    @JsonProperty("VSD-1-2-2")
    private String VSD_1_2_2; // 肺循环血量/体循环血量比值(QP/QS)
    public String getVSD_1_2_2() {  return this.VSD_1_2_2;}
    @JsonProperty("VSD-1-2-2")
    public void setVSD_1_2_2(final String VSD_1_2_2) { this.VSD_1_2_2=VSD_1_2_2;}
    @Column(name = "VSD_2_1_1")
    @JsonProperty("VSD-2-1-1")
    private String VSD_2_1_1; // 室间隔缺损手术缺损手术适应证
    public String getVSD_2_1_1() {  return this.VSD_2_1_1;}
    @JsonProperty("VSD-2-1-1")
    public void setVSD_2_1_1(final String VSD_2_1_1) { this.VSD_2_1_1=VSD_2_1_1;}
    @Column(name = "VSD_2_1_1_1")
    @JsonProperty("VSD-2-1-1-1")
    private String VSD_2_1_1_1; // 其他室间隔缺损手术适应证
    public String getVSD_2_1_1_1() {  return this.VSD_2_1_1_1;}
    @JsonProperty("VSD-2-1-1-1")
    public void setVSD_2_1_1_1(final String VSD_2_1_1_1) { this.VSD_2_1_1_1=VSD_2_1_1_1;}
    @Column(name = "VSD_2_1_2")
    @JsonProperty("VSD-2-1-2")
    private String VSD_2_1_2; // 手术方法的选择
    public String getVSD_2_1_2() {  return this.VSD_2_1_2;}
    @JsonProperty("VSD-2-1-2")
    public void setVSD_2_1_2(final String VSD_2_1_2) { this.VSD_2_1_2=VSD_2_1_2;}
    @Column(name = "VSD_2_1_2_1")
    @JsonProperty("VSD-2-1-2-1")
    private String VSD_2_1_2_1; // 其他手术方法
    public String getVSD_2_1_2_1() {  return this.VSD_2_1_2_1;}
    @JsonProperty("VSD-2-1-2-1")
    public void setVSD_2_1_2_1(final String VSD_2_1_2_1) { this.VSD_2_1_2_1=VSD_2_1_2_1;}
    @Column(name = "VSD_3_1_1")
    @JsonProperty("VSD-3-1-1")
    private String VSD_3_1_1; // 是否使用体外循环
    public String getVSD_3_1_1() {  return this.VSD_3_1_1;}
    @JsonProperty("VSD-3-1-1")
    public void setVSD_3_1_1(final String VSD_3_1_1) { this.VSD_3_1_1=VSD_3_1_1;}
    @Column(name = "VSD_3_1_2")
    @JsonProperty("VSD-3-1-2")
    private String VSD_3_1_2; // 起始日期时间
    public String getVSD_3_1_2() {  return this.VSD_3_1_2;}
    @JsonProperty("VSD-3-1-2")
    public void setVSD_3_1_2(final String VSD_3_1_2) { this.VSD_3_1_2=VSD_3_1_2;}
    @Column(name = "VSD_3_1_3")
    @JsonProperty("VSD-3-1-3")
    private String VSD_3_1_3; // 终止日期时间
    public String getVSD_3_1_3() {  return this.VSD_3_1_3;}
    @JsonProperty("VSD-3-1-3")
    public void setVSD_3_1_3(final String VSD_3_1_3) { this.VSD_3_1_3=VSD_3_1_3;}
    @Column(name = "VSD_3_2_1_1")
    @JsonProperty("VSD-3-2-1-1")
    private String VSD_3_2_1_1; // 术中是否再次阻断主动脉
    public String getVSD_3_2_1_1() {  return this.VSD_3_2_1_1;}
    @JsonProperty("VSD-3-2-1-1")
    public void setVSD_3_2_1_1(final String VSD_3_2_1_1) { this.VSD_3_2_1_1=VSD_3_2_1_1;}
    @Column(name = "VSD_3_2_1")
    @JsonProperty("VSD-3-2-1")
    private String VSD_3_2_1; // 术中使用经食道超声
    public String getVSD_3_2_1() {  return this.VSD_3_2_1;}
    @JsonProperty("VSD-3-2-1")
    public void setVSD_3_2_1(final String VSD_3_2_1) { this.VSD_3_2_1=VSD_3_2_1;}
    @Column(name = "VSD_3_2_1_2")
    @JsonProperty("VSD-3-2-1-2")
    private String VSD_3_2_1_2; // 是否存在残余分流
    public String getVSD_3_2_1_2() {  return this.VSD_3_2_1_2;}
    @JsonProperty("VSD-3-2-1-2")
    public void setVSD_3_2_1_2(final String VSD_3_2_1_2) { this.VSD_3_2_1_2=VSD_3_2_1_2;}
    @Column(name = "VSD_3_3_1")
    @JsonProperty("VSD-3-3-1")
    private String VSD_3_3_1; // 是否围术期使用血制品
    public String getVSD_3_3_1() {  return this.VSD_3_3_1;}
    @JsonProperty("VSD-3-3-1")
    public void setVSD_3_3_1(final String VSD_3_3_1) { this.VSD_3_3_1=VSD_3_3_1;}
    @Column(name = "VSD_3_3_2")
    @JsonProperty("VSD-3-3-2")
    private String VSD_3_3_2; // 其中:全血量(ml)
    public String getVSD_3_3_2() {  return this.VSD_3_3_2;}
    @JsonProperty("VSD-3-3-2")
    public void setVSD_3_3_2(final String VSD_3_3_2) { this.VSD_3_3_2=VSD_3_3_2;}
    @Column(name = "VSD_3_3_3")
    @JsonProperty("VSD-3-3-3")
    private String VSD_3_3_3; // 其中:红细胞量(ml)
    public String getVSD_3_3_3() {  return this.VSD_3_3_3;}
    @JsonProperty("VSD-3-3-3")
    public void setVSD_3_3_3(final String VSD_3_3_3) { this.VSD_3_3_3=VSD_3_3_3;}
    @Column(name = "VSD_3_3_4")
    @JsonProperty("VSD-3-3-4")
    private String VSD_3_3_4; // 其中:血浆量(ml)
    public String getVSD_3_3_4() {  return this.VSD_3_3_4;}
    @JsonProperty("VSD-3-3-4")
    public void setVSD_3_3_4(final String VSD_3_3_4) { this.VSD_3_3_4=VSD_3_3_4;}
    @Column(name = "VSD_3_3_5")
    @JsonProperty("VSD-3-3-5")
    private String VSD_3_3_5; // 其中:血小板量(ml)
    public String getVSD_3_3_5() {  return this.VSD_3_3_5;}
    @JsonProperty("VSD-3-3-5")
    public void setVSD_3_3_5(final String VSD_3_3_5) { this.VSD_3_3_5=VSD_3_3_5;}
    @Column(name = "VSD_3_3_6")
    @JsonProperty("VSD-3-3-6")
    private String VSD_3_3_6; // 临床用血总量(ml)
    public String getVSD_3_3_6() {  return this.VSD_3_3_6;}
    @JsonProperty("VSD-3-3-6")
    public void setVSD_3_3_6(final String VSD_3_3_6) { this.VSD_3_3_6=VSD_3_3_6;}
    @Column(name = "VSD_3_4_1")
    @JsonProperty("VSD-3-4-1")
    private String VSD_3_4_1; // 是否实施术后机械通气
    public String getVSD_3_4_1() {  return this.VSD_3_4_1;}
    @JsonProperty("VSD-3-4-1")
    public void setVSD_3_4_1(final String VSD_3_4_1) { this.VSD_3_4_1=VSD_3_4_1;}
    @Column(name = "VSD_3_4_2")
    @JsonProperty("VSD-3-4-2")
    private String VSD_3_4_2; // 起始日期时间
    public String getVSD_3_4_2() {  return this.VSD_3_4_2;}
    @JsonProperty("VSD-3-4-2")
    public void setVSD_3_4_2(final String VSD_3_4_2) { this.VSD_3_4_2=VSD_3_4_2;}
    @Column(name = "VSD_3_4_3")
    @JsonProperty("VSD-3-4-3")
    private String VSD_3_4_3; // 终止日期时间
    public String getVSD_3_4_3() {  return this.VSD_3_4_3;}
    @JsonProperty("VSD-3-4-3")
    public void setVSD_3_4_3(final String VSD_3_4_3) { this.VSD_3_4_3=VSD_3_4_3;}
    ...
    public String getVSD_5_1_1() {  return this.VSD_5_1_1;}
    @JsonProperty("VSD-5-1-1")
    public void setVSD_5_1_1(final String VSD_5_1_1) { this.VSD_5_1_1=VSD_5_1_1;}
    @Column(name = "VSD_5_1_2")
    @JsonProperty("VSD-5-1-2")
    private String VSD_5_1_2; // 术后活动性出血或血肿主要情况
    public String getVSD_5_1_2() {  return this.VSD_5_1_2;}
    @JsonProperty("VSD-5-1-2")
    public void setVSD_5_1_2(final String VSD_5_1_2) { this.VSD_5_1_2=VSD_5_1_2;}
    @Column(name = "VSD_5_1_3")
    @JsonProperty("VSD-5-1-3")
    private String VSD_5_1_3; // 是否再手术
    public String getVSD_5_1_3() {  return this.VSD_5_1_3;}
    @JsonProperty("VSD-5-1-3")
    public void setVSD_5_1_3(final String VSD_5_1_3) { this.VSD_5_1_3=VSD_5_1_3;}
    @Column(name = "VSD_5_1_4")
    @JsonProperty("VSD-5-1-4")
    private String VSD_5_1_4; // 再手术起始日期时间
    public String getVSD_5_1_4() {  return this.VSD_5_1_4;}
    @JsonProperty("VSD-5-1-4")
    public void setVSD_5_1_4(final String VSD_5_1_4) { this.VSD_5_1_4=VSD_5_1_4;}
    @Column(name = "CM_2_1")
    @JsonProperty("CM-2-1")
    ...
    public String getVSD_7_1_1_1() {  return this.VSD_7_1_1_1;}
    @JsonProperty("VSD-7-1-1-1")
    public void setVSD_7_1_1_1(final String VSD_7_1_1_1) { this.VSD_7_1_1_1=VSD_7_1_1_1;}
    @Column(name = "VSD_7_1_1")
    @JsonProperty("VSD-7-1-1")
    private String VSD_7_1_1; // 手术前健康教育项目的选择
    public String getVSD_7_1_1() {  return this.VSD_7_1_1;}
    @JsonProperty("VSD-7-1-1")
    public void setVSD_7_1_1(final String VSD_7_1_1) { this.VSD_7_1_1=VSD_7_1_1;}
    @Column(name = "VSD_7_2_1")
    @JsonProperty("VSD-7-2-1")
    private String VSD_7_2_1; // 出院时,告知患者高危因素本人评估结果
    public String getVSD_7_2_1() {  return this.VSD_7_2_1;}
    @JsonProperty("VSD-7-2-1")
    public void setVSD_7_2_1(final String VSD_7_2_1) { this.VSD_7_2_1=VSD_7_2_1;}
    @Column(name = "VSD_7_2_2")
    @JsonProperty("VSD-7-2-2")
    private String VSD_7_2_2; // 常见高危因素的选择
    public String getVSD_7_2_2() {  return this.VSD_7_2_2;}
    @JsonProperty("VSD-7-2-2")
    public void setVSD_7_2_2(final String VSD_7_2_2) { this.VSD_7_2_2=VSD_7_2_2;}
    @Column(name = "VSD_7_2_2_1")
    @JsonProperty("VSD-7-2-2-1")
    private String VSD_7_2_2_1; // 其他常见高危因素
    public String getVSD_7_2_2_1() {  return this.VSD_7_2_2_1;}
    @JsonProperty("VSD-7-2-2-1")
    public void setVSD_7_2_2_1(final String VSD_7_2_2_1) { this.VSD_7_2_2_1=VSD_7_2_2_1;}
    @Column(name = "VSD_7_3_1_1")
    @JsonProperty("VSD-7-3-1-1")
    private String VSD_7_3_1_1; // 是否履行出院教育与告知责任，且有记录
    public String getVSD_7_3_1_1() {  return this.VSD_7_3_1_1;}
    @JsonProperty("VSD-7-3-1-1")
    public void setVSD_7_3_1_1(final String VSD_7_3_1_1) { this.VSD_7_3_1_1=VSD_7_3_1_1;}
    @Column(name = "VSD_7_3_1")
    @JsonProperty("VSD-7-3-1")
    private String VSD_7_3_1; // 交与患者/患儿家长“出院小结”的副本告知患者/患儿家长出院时风险因素
    public String getVSD_7_3_1() {  return this.VSD_7_3_1;}
    @JsonProperty("VSD-7-3-1")
    public void setVSD_7_3_1(final String VSD_7_3_1) { this.VSD_7_3_1=VSD_7_3_1;}
    @Column(name = "VSD_7_3_2")
    @JsonProperty("VSD-7-3-2")
    private String VSD_7_3_2; // 出院带药:  坚持抗凝治疗
    public String getVSD_7_3_2() {  return this.VSD_7_3_2;}
    @JsonProperty("VSD-7-3-2")
    public void setVSD_7_3_2(final String VSD_7_3_2) { this.VSD_7_3_2=VSD_7_3_2;}
    @Column(name = "VSD_7_3_3")
    @JsonProperty("VSD-7-3-3")
    private String VSD_7_3_3; // 告知发生紧急情况时求援救治途径
    public String getVSD_7_3_3() {  return this.VSD_7_3_3;}
    @JsonProperty("VSD-7-3-3")
    public void setVSD_7_3_3(final String VSD_7_3_3) { this.VSD_7_3_3=VSD_7_3_3;}
    @Column(name = "VSD_7_3_4")
    @JsonProperty("VSD-7-3-4")
    private String VSD_7_3_4; // 出院时教育与随访
    public String getVSD_7_3_4() {  return this.VSD_7_3_4;}
    @JsonProperty("VSD-7-3-4")
    public void setVSD_7_3_4(final String VSD_7_3_4) { this.VSD_7_3_4=VSD_7_3_4;}
    @Column(name = "VSD_7_3_5")
    @JsonProperty("VSD-7-3-5")
    private String VSD_7_3_5; // 告知何为风险因素与紧急情况
    public String getVSD_7_3_5() {  return this.VSD_7_3_5;}
    @JsonProperty("VSD-7-3-5")
    public void setVSD_7_3_5(final String VSD_7_3_5) { this.VSD_7_3_5=VSD_7_3_5;}
    @Column(name = "CM_3_1")
    @JsonProperty("CM-3-1")
