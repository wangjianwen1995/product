...
/*主要诊断 ICD-10 编码：C01，C02，且伴主要手术ICD-9-CM-3 编码：25.1 至 25.4，40.4 的手术出院患者。
*/
@ApiModel(value = "38信息")
@Entity
@Table(name = "sd_info_TSCC")
public class SdInfoTSCC implements Serializable {
    ...
    @Column(name = "TSCC_1_1_1")
    @JsonProperty("TSCC-1-1-1")
    private String TSCC_1_1_1; // 收集术前检查项目
    public String getTSCC_1_1_1() {  return this.TSCC_1_1_1;}
    @JsonProperty("TSCC-1-1-1")
    public void setTSCC_1_1_1(final String TSCC_1_1_1) { this.TSCC_1_1_1=TSCC_1_1_1;}
    @Column(name = "TSCC_1_2_1")
    @JsonProperty("TSCC-1-2-1")
    private String TSCC_1_2_1; // 治疗前是否有病理组织形态学/细胞学诊断报告
    public String getTSCC_1_2_1() {  return this.TSCC_1_2_1;}
    @JsonProperty("TSCC-1-2-1")
    public void setTSCC_1_2_1(final String TSCC_1_2_1) { this.TSCC_1_2_1=TSCC_1_2_1;}
    @Column(name = "TSCC_1_2_2")
    @JsonProperty("TSCC-1-2-2")
    private String TSCC_1_2_2; // 采集组织或细胞学标本来源途径
    public String getTSCC_1_2_2() {  return this.TSCC_1_2_2;}
    @JsonProperty("TSCC-1-2-2")
    public void setTSCC_1_2_2(final String TSCC_1_2_2) { this.TSCC_1_2_2=TSCC_1_2_2;}
    @Column(name = "TSCC_1_2_2_1")
    @JsonProperty("TSCC-1-2-2-1")
    private String TSCC_1_2_2_1; // 其他采集组织或细胞学标本来源途径
    public String getTSCC_1_2_2_1() {  return this.TSCC_1_2_2_1;}
    @JsonProperty("TSCC-1-2-2-1")
    public void setTSCC_1_2_2_1(final String TSCC_1_2_2_1) { this.TSCC_1_2_2_1=TSCC_1_2_2_1;}
    @Column(name = "TSCC_1_2_3")
    @JsonProperty("TSCC-1-2-3")
    private String TSCC_1_2_3; // 病理组织形态学/细胞学诊断结果
    public String getTSCC_1_2_3() {  return this.TSCC_1_2_3;}
    @JsonProperty("TSCC-1-2-3")
    public void setTSCC_1_2_3(final String TSCC_1_2_3) { this.TSCC_1_2_3=TSCC_1_2_3;}
    @Column(name = "TSCC_1_2_4")
    @JsonProperty("TSCC-1-2-4")
    private String TSCC_1_2_4; // 病理组织形态学/细胞学诊断报告单TSCCNM 临床分期结论距本次治疗前的时限
    public String getTSCC_1_2_4() {  return this.TSCC_1_2_4;}
    @JsonProperty("TSCC-1-2-4")
    public void setTSCC_1_2_4(final String TSCC_1_2_4) { this.TSCC_1_2_4=TSCC_1_2_4;}
    @Column(name = "TSCC_1_3_1")
    @JsonProperty("TSCC-1-3-1")
    private String TSCC_1_3_1; // 是否存在全身其他系统疾病
    public String getTSCC_1_3_1() {  return this.TSCC_1_3_1;}
    @JsonProperty("TSCC-1-3-1")
    public void setTSCC_1_3_1(final String TSCC_1_3_1) { this.TSCC_1_3_1=TSCC_1_3_1;}
    @Column(name = "TSCC_1_3_2")
    @JsonProperty("TSCC-1-3-2")
    private String TSCC_1_3_2; // 全身系统性疾病情况
    public String getTSCC_1_3_2() {  return this.TSCC_1_3_2;}
    @JsonProperty("TSCC-1-3-2")
    public void setTSCC_1_3_2(final String TSCC_1_3_2) { this.TSCC_1_3_2=TSCC_1_3_2;}
    @Column(name = "TSCC_1_4_1")
    @JsonProperty("TSCC-1-4-1")
    private String TSCC_1_4_1; // 是否是治疗前接受过2个或以上治疗科室会诊的患者
    public String getTSCC_1_4_1() {  return this.TSCC_1_4_1;}
    @JsonProperty("TSCC-1-4-1")
    public void setTSCC_1_4_1(final String TSCC_1_4_1) { this.TSCC_1_4_1=TSCC_1_4_1;}
    @Column(name = "TSCC_2_1_1")
    @JsonProperty("TSCC-2-1-1")
    private String TSCC_2_1_1; // 治疗前是否完成临床 TNM分期
    public String getTSCC_2_1_1() {  return this.TSCC_2_1_1;}
    @JsonProperty("TSCC-2-1-1")
    public void setTSCC_2_1_1(final String TSCC_2_1_1) { this.TSCC_2_1_1=TSCC_2_1_1;}
    @Column(name = "TSCC_2_1_2")
    @JsonProperty("TSCC-2-1-2")
    private String TSCC_2_1_2; // 原发肿瘤（T）分期
    public String getTSCC_2_1_2() {  return this.TSCC_2_1_2;}
    @JsonProperty("TSCC-2-1-2")
    public void setTSCC_2_1_2(final String TSCC_2_1_2) { this.TSCC_2_1_2=TSCC_2_1_2;}
    @Column(name = "TSCC_2_1_3")
    @JsonProperty("TSCC-2-1-3")
    private String TSCC_2_1_3; // 区域淋巴结（N）分期 
    public String getTSCC_2_1_3() {  return this.TSCC_2_1_3;}
    @JsonProperty("TSCC-2-1-3")
    public void setTSCC_2_1_3(final String TSCC_2_1_3) { this.TSCC_2_1_3=TSCC_2_1_3;}
    @Column(name = "TSCC_2_1_3_r")
    @JsonProperty("TSCC-2-1-3-r")
    private String TSCC_2_1_3_r; // 
    public String getTSCC_2_1_3_r() {  return this.TSCC_2_1_3_r;}
    @JsonProperty("TSCC-2-1-3-r")
    public void setTSCC_2_1_3_r(final String TSCC_2_1_3_r) { this.TSCC_2_1_3_r=TSCC_2_1_3_r;}
    @Column(name = "TSCC_2_1_4")
    @JsonProperty("TSCC-2-1-4")
    private String TSCC_2_1_4; // 远处转移（M）分期
    public String getTSCC_2_1_4() {  return this.TSCC_2_1_4;}
    @JsonProperty("TSCC-2-1-4")
    public void setTSCC_2_1_4(final String TSCC_2_1_4) { this.TSCC_2_1_4=TSCC_2_1_4;}
    @Column(name = "TSCC_2_1_4_r")
    @JsonProperty("TSCC-2-1-4-r")
    private String TSCC_2_1_4_r; // 
    public String getTSCC_2_1_4_r() {  return this.TSCC_2_1_4_r;}
    @JsonProperty("TSCC-2-1-4-r")
    public void setTSCC_2_1_4_r(final String TSCC_2_1_4_r) { this.TSCC_2_1_4_r=TSCC_2_1_4_r;}
    @Column(name = "TSCC_2_1_5")
    @JsonProperty("TSCC-2-1-5")
    private String TSCC_2_1_5; // 舌鳞状细胞癌治疗前 cTNM 分期结论
    public String getTSCC_2_1_5() {  return this.TSCC_2_1_5;}
    @JsonProperty("TSCC-2-1-5")
    public void setTSCC_2_1_5(final String TSCC_2_1_5) { this.TSCC_2_1_5=TSCC_2_1_5;}
    @Column(name = "TSCC_2_2_1")
    @JsonProperty("TSCC-2-2-1")
    private String TSCC_2_2_1; // 治疗前是否完成舌鳞状细胞癌CT/CBCT分期
    public String getTSCC_2_2_1() {  return this.TSCC_2_2_1;}
    @JsonProperty("TSCC-2-2-1")
    public void setTSCC_2_2_1(final String TSCC_2_2_1) { this.TSCC_2_2_1=TSCC_2_2_1;}
    @Column(name = "TSCC_2_2_2")
    @JsonProperty("TSCC-2-2-2")
    private String TSCC_2_2_2; // cTNM分期病理学定义
    public String getTSCC_2_2_2() {  return this.TSCC_2_2_2;}
    @JsonProperty("TSCC-2-2-2")
    public void setTSCC_2_2_2(final String TSCC_2_2_2) { this.TSCC_2_2_2=TSCC_2_2_2;}
    @Column(name = "TSCC_3_1_1")
    @JsonProperty("TSCC-3-1-1")
    private String TSCC_3_1_1; // 实施的舌鳞状细胞癌原发灶手术方案的选择
    public String getTSCC_3_1_1() {  return this.TSCC_3_1_1;}
    @JsonProperty("TSCC-3-1-1")
    public void setTSCC_3_1_1(final String TSCC_3_1_1) { this.TSCC_3_1_1=TSCC_3_1_1;}
    @Column(name = "TSCC_3_1_2")
    @JsonProperty("TSCC-3-1-2")
    private String TSCC_3_1_2; // 是否进行手术切除下颌骨
    public String getTSCC_3_1_2() {  return this.TSCC_3_1_2;}
    @JsonProperty("TSCC-3-1-2")
    public void setTSCC_3_1_2(final String TSCC_3_1_2) { this.TSCC_3_1_2=TSCC_3_1_2;}
    @Column(name = "TSCC_3_1_3")
    @JsonProperty("TSCC-3-1-3")
    private String TSCC_3_1_3; // 实施的下颌骨切除方式的手术方案的选择
    public String getTSCC_3_1_3() {  return this.TSCC_3_1_3;}
    @JsonProperty("TSCC-3-1-3")
    public void setTSCC_3_1_3(final String TSCC_3_1_3) { this.TSCC_3_1_3=TSCC_3_1_3;}
    @Column(name = "TSCC_3_1_4")
    @JsonProperty("TSCC-3-1-4")
    private String TSCC_3_1_4; // 是否进行手术颈淋巴组织清扫
    public String getTSCC_3_1_4() {  return this.TSCC_3_1_4;}
    @JsonProperty("TSCC-3-1-4")
    public void setTSCC_3_1_4(final String TSCC_3_1_4) { this.TSCC_3_1_4=TSCC_3_1_4;}
    @Column(name = "TSCC_3_1_5_1")
    @JsonProperty("TSCC-3-1-5-1")
    private String TSCC_3_1_5_1; // 颈淋巴组织清扫合理性
    public String getTSCC_3_1_5_1() {  return this.TSCC_3_1_5_1;}
    @JsonProperty("TSCC-3-1-5-1")
    public void setTSCC_3_1_5_1(final String TSCC_3_1_5_1) { this.TSCC_3_1_5_1=TSCC_3_1_5_1;}
    @Column(name = "TSCC_3_1_6")
    @JsonProperty("TSCC-3-1-6")
    private String TSCC_3_1_6; // 实施的颈淋巴清扫的手术方案的选择
    public String getTSCC_3_1_6() {  return this.TSCC_3_1_6;}
    @JsonProperty("TSCC-3-1-6")
    public void setTSCC_3_1_6(final String TSCC_3_1_6) { this.TSCC_3_1_6=TSCC_3_1_6;}
    @Column(name = "TSCC_3_1_7")
    @JsonProperty("TSCC-3-1-7")
    private String TSCC_3_1_7; // 实施的颈淋巴清扫时颈部结构的保留
    public String getTSCC_3_1_7() {  return this.TSCC_3_1_7;}
    @JsonProperty("TSCC-3-1-7")
    public void setTSCC_3_1_7(final String TSCC_3_1_7) { this.TSCC_3_1_7=TSCC_3_1_7;}
    @Column(name = "TSCC_3_1_8")
    @JsonProperty("TSCC-3-1-8")
    private String TSCC_3_1_8; // 实施颈淋巴清扫的时间
    public String getTSCC_3_1_8() {  return this.TSCC_3_1_8;}
    @JsonProperty("TSCC-3-1-8")
    public void setTSCC_3_1_8(final String TSCC_3_1_8) { this.TSCC_3_1_8=TSCC_3_1_8;}
    @Column(name = "TSCC_3_1_9")
    @JsonProperty("TSCC-3-1-9")
    private String TSCC_3_1_9; // 术中舌重建的方式的选择
    public String getTSCC_3_1_9() {  return this.TSCC_3_1_9;}
    @JsonProperty("TSCC-3-1-9")
    public void setTSCC_3_1_9(final String TSCC_3_1_9) { this.TSCC_3_1_9=TSCC_3_1_9;}
    @Column(name = "TSCC_3_1_10")
    @JsonProperty("TSCC-3-1-10")
    private String TSCC_3_1_10; // 是否进行颌骨重建
    public String getTSCC_3_1_10() {  return this.TSCC_3_1_10;}
    @JsonProperty("TSCC-3-1-10")
    public void setTSCC_3_1_10(final String TSCC_3_1_10) { this.TSCC_3_1_10=TSCC_3_1_10;}
    @Column(name = "TSCC_3_1_11")
    @JsonProperty("TSCC-3-1-11")
    private String TSCC_3_1_11; // 术中颌骨重建的方式的选择
    public String getTSCC_3_1_11() {  return this.TSCC_3_1_11;}
    @JsonProperty("TSCC-3-1-11")
    public void setTSCC_3_1_11(final String TSCC_3_1_11) { this.TSCC_3_1_11=TSCC_3_1_11;}
    @Column(name = "TSCC_3_2_1")
    @JsonProperty("TSCC-3-2-1")
    private String TSCC_3_2_1; // 舌鳞状细胞癌手术中达到安全切缘是否有证实措施
    public String getTSCC_3_2_1() {  return this.TSCC_3_2_1;}
    @JsonProperty("TSCC-3-2-1")
    public void setTSCC_3_2_1(final String TSCC_3_2_1) { this.TSCC_3_2_1=TSCC_3_2_1;}
    @Column(name = "TSCC_3_2_2")
    @JsonProperty("TSCC-3-2-2")
    private String TSCC_3_2_2; // 记入手术记录中安全切缘证实措施的选择
    public String getTSCC_3_2_2() {  return this.TSCC_3_2_2;}
    @JsonProperty("TSCC-3-2-2")
    public void setTSCC_3_2_2(final String TSCC_3_2_2) { this.TSCC_3_2_2=TSCC_3_2_2;}
    @Column(name = "TSCC_4_1_1")
    @JsonProperty("TSCC-4-1-1")
    private String TSCC_4_1_1; // 是否有术后病理学诊断
    public String getTSCC_4_1_1() {  return this.TSCC_4_1_1;}
    @JsonProperty("TSCC-4-1-1")
    public void setTSCC_4_1_1(final String TSCC_4_1_1) { this.TSCC_4_1_1=TSCC_4_1_1;}
    @Column(name = "TSCC_4_2_1")
    @JsonProperty("TSCC-4-2-1")
    private String TSCC_4_2_1; // 合格的病理报告包括以下主要内容
    public String getTSCC_4_2_1() {  return this.TSCC_4_2_1;}
    @JsonProperty("TSCC-4-2-1")
    public void setTSCC_4_2_1(final String TSCC_4_2_1) { this.TSCC_4_2_1=TSCC_4_2_1;}
    @Column(name = "TSCC_4_2_1_1")
    @JsonProperty("TSCC-4-2-1-1")
    private String TSCC_4_2_1_1; // 其他合格的病理报告主要内容
    public String getTSCC_4_2_1_1() {  return this.TSCC_4_2_1_1;}
    @JsonProperty("TSCC-4-2-1-1")
    public void setTSCC_4_2_1_1(final String TSCC_4_2_1_1) { this.TSCC_4_2_1_1=TSCC_4_2_1_1;}
    @Column(name = "TSCC_4_3_1")
    @JsonProperty("TSCC-4-3-1")
    private String TSCC_4_3_1; // 是否有舌鳞状细胞癌病理TSCC TNM分期
    public String getTSCC_4_3_1() {  return this.TSCC_4_3_1;}
    @JsonProperty("TSCC-4-3-1")
    public void setTSCC_4_3_1(final String TSCC_4_3_1) { this.TSCC_4_3_1=TSCC_4_3_1;}
    @Column(name = "TSCC_4_3_2")
    @JsonProperty("TSCC-4-3-2")
    private String TSCC_4_3_2; // 原发肿瘤（T）分期
    public String getTSCC_4_3_2() {  return this.TSCC_4_3_2;}
    @JsonProperty("TSCC-4-3-2")
    public void setTSCC_4_3_2(final String TSCC_4_3_2) { this.TSCC_4_3_2=TSCC_4_3_2;}
    @Column(name = "TSCC_4_3_3")
    @JsonProperty("TSCC-4-3-3")
    private String TSCC_4_3_3; // 区域淋巴结（N）分期
    public String getTSCC_4_3_3() {  return this.TSCC_4_3_3;}
    @JsonProperty("TSCC-4-3-3")
    public void setTSCC_4_3_3(final String TSCC_4_3_3) { this.TSCC_4_3_3=TSCC_4_3_3;}
    @Column(name = "TSCC_4_3_3_r")
    @JsonProperty("TSCC-4-3-3-r")
    private String TSCC_4_3_3_r; // 
    public String getTSCC_4_3_3_r() {  return this.TSCC_4_3_3_r;}
    @JsonProperty("TSCC-4-3-3-r")
    public void setTSCC_4_3_3_r(final String TSCC_4_3_3_r) { this.TSCC_4_3_3_r=TSCC_4_3_3_r;}
    @Column(name = "TSCC_4_3_4")
    @JsonProperty("TSCC-4-3-4")
    private String TSCC_4_3_4; // 远处转移（M）分期
    public String getTSCC_4_3_4() {  return this.TSCC_4_3_4;}
    @JsonProperty("TSCC-4-3-4")
    public void setTSCC_4_3_4(final String TSCC_4_3_4) { this.TSCC_4_3_4=TSCC_4_3_4;}
    @Column(name = "TSCC_4_3_4_r")
    @JsonProperty("TSCC-4-3-4-r")
    private String TSCC_4_3_4_r; // 
    public String getTSCC_4_3_4_r() {  return this.TSCC_4_3_4_r;}
    @JsonProperty("TSCC-4-3-4-r")
    public void setTSCC_4_3_4_r(final String TSCC_4_3_4_r) { this.TSCC_4_3_4_r=TSCC_4_3_4_r;}
    @Column(name = "TSCC_4_3_5")
    @JsonProperty("TSCC-4-3-5")
    private String TSCC_4_3_5; // TSCC TNM分期结论
    public String getTSCC_4_3_5() {  return this.TSCC_4_3_5;}
    @JsonProperty("TSCC-4-3-5")
    public void setTSCC_4_3_5(final String TSCC_4_3_5) { this.TSCC_4_3_5=TSCC_4_3_5;}
    @Column(name = "TSCC_4_4_1")
    @JsonProperty("TSCC-4-4-1")
    private String TSCC_4_4_1; // 是否有组织学分级
    public String getTSCC_4_4_1() {  return this.TSCC_4_4_1;}
    @JsonProperty("TSCC-4-4-1")
    public void setTSCC_4_4_1(final String TSCC_4_4_1) { this.TSCC_4_4_1=TSCC_4_4_1;}
    @Column(name = "TSCC_4_4_2")
    @JsonProperty("TSCC-4-4-2")
    private String TSCC_4_4_2; // 组织学分级
    public String getTSCC_4_4_2() {  return this.TSCC_4_4_2;}
    @JsonProperty("TSCC-4-4-2")
    public void setTSCC_4_4_2(final String TSCC_4_4_2) { this.TSCC_4_4_2=TSCC_4_4_2;}
    ...
    @Column(name = "TSCC_6_1_3")
    @JsonProperty("TSCC-6-1-3")
    private String TSCC_6_1_3; // TSCC手术特指的并发症
    public String getTSCC_6_1_3() {  return this.TSCC_6_1_3;}
    @JsonProperty("TSCC-6-1-3")
    public void setTSCC_6_1_3(final String TSCC_6_1_3) { this.TSCC_6_1_3=TSCC_6_1_3;}
    ...
    @Column(name = "TSCC_6_2_1")
    @JsonProperty("TSCC-6-2-1")
    private String TSCC_6_2_1; // 游离移植组织并发症的验证方法
    public String getTSCC_6_2_1() {  return this.TSCC_6_2_1;}
    @JsonProperty("TSCC-6-2-1")
    public void setTSCC_6_2_1(final String TSCC_6_2_1) { this.TSCC_6_2_1=TSCC_6_2_1;}
    @Column(name = "TSCC_6_2_1_1")
    @JsonProperty("TSCC-6-2-1-1")
    private String TSCC_6_2_1_1; // 其他游离移植组织并发症的验证方法
    public String getTSCC_6_2_1_1() {  return this.TSCC_6_2_1_1;}
    @JsonProperty("TSCC-6-2-1-1")
    public void setTSCC_6_2_1_1(final String TSCC_6_2_1_1) { this.TSCC_6_2_1_1=TSCC_6_2_1_1;}
    @Column(name = "TSCC_6_3_1")
    @JsonProperty("TSCC-6-3-1")
    private String TSCC_6_3_1; // 是否是非计划二次手术
    public String getTSCC_6_3_1() {  return this.TSCC_6_3_1;}
    @JsonProperty("TSCC-6-3-1")
    public void setTSCC_6_3_1(final String TSCC_6_3_1) { this.TSCC_6_3_1=TSCC_6_3_1;}
    @Column(name = "TSCC_6_3_2")
    @JsonProperty("TSCC-6-3-2")
    private String TSCC_6_3_2; // 非计划二次手术主要原因的选择
    public String getTSCC_6_3_2() {  return this.TSCC_6_3_2;}
    @JsonProperty("TSCC-6-3-2")
    public void setTSCC_6_3_2(final String TSCC_6_3_2) { this.TSCC_6_3_2=TSCC_6_3_2;}
    @Column(name = "TSCC_6_3_2_1")
    @JsonProperty("TSCC-6-3-2-1")
    private String TSCC_6_3_2_1; // 非计划二次手术其他主要原因
    public String getTSCC_6_3_2_1() {  return this.TSCC_6_3_2_1;}
    @JsonProperty("TSCC-6-3-2-1")
    public void setTSCC_6_3_2_1(final String TSCC_6_3_2_1) { this.TSCC_6_3_2_1=TSCC_6_3_2_1;}
    @Column(name = "TSCC_6_3_3")
    @JsonProperty("TSCC-6-3-3")
    private String TSCC_6_3_3; // 二次手术开始（切皮）日期时间 
    public String getTSCC_6_3_3() {  return this.TSCC_6_3_3;}
    @JsonProperty("TSCC-6-3-3")
    public void setTSCC_6_3_3(final String TSCC_6_3_3) { this.TSCC_6_3_3=TSCC_6_3_3;}
    @Column(name = "TSCC_6_3_4")
    @JsonProperty("TSCC-6-3-4")
    private String TSCC_6_3_4; // 二次手术结束（缝皮结束）日期时间
    public String getTSCC_6_3_4() {  return this.TSCC_6_3_4;}
    @JsonProperty("TSCC-6-3-4")
    public void setTSCC_6_3_4(final String TSCC_6_3_4) { this.TSCC_6_3_4=TSCC_6_3_4;}
    @Column(name = "CM_3_1")
    @JsonProperty("CM-3-1")
    ...
    @Column(name = "TSCC_8_1_1")
    @JsonProperty("TSCC-8-1-1")
    private String TSCC_8_1_1; // 术后是否进行吞咽功能评估
    public String getTSCC_8_1_1() {  return this.TSCC_8_1_1;}
    @JsonProperty("TSCC-8-1-1")
    public void setTSCC_8_1_1(final String TSCC_8_1_1) { this.TSCC_8_1_1=TSCC_8_1_1;}
    @Column(name = "TSCC_8_1_2")
    @JsonProperty("TSCC-8-1-2")
    private String TSCC_8_1_2; // 术后是否进行吞咽功能训练
    public String getTSCC_8_1_2() {  return this.TSCC_8_1_2;}
    @JsonProperty("TSCC-8-1-2")
    public void setTSCC_8_1_2(final String TSCC_8_1_2) { this.TSCC_8_1_2=TSCC_8_1_2;}
    @Column(name = "TSCC_8_2_1")
    @JsonProperty("TSCC-8-2-1")
    private String TSCC_8_2_1; // 术后是否进行语音评估
    public String getTSCC_8_2_1() {  return this.TSCC_8_2_1;}
    @JsonProperty("TSCC-8-2-1")
    public void setTSCC_8_2_1(final String TSCC_8_2_1) { this.TSCC_8_2_1=TSCC_8_2_1;}
    @Column(name = "TSCC_8_2_2")
    @JsonProperty("TSCC-8-2-2")
    private String TSCC_8_2_2; // 术后是否进行语音指导
    public String getTSCC_8_2_2() {  return this.TSCC_8_2_2;}
    @JsonProperty("TSCC-8-2-2")
    public void setTSCC_8_2_2(final String TSCC_8_2_2) { this.TSCC_8_2_2=TSCC_8_2_2;}
    @Column(name = "TSCC_8_3_1")
    @JsonProperty("TSCC-8-3-1")
    private String TSCC_8_3_1; // 术后是否进行心理评估
    public String getTSCC_8_3_1() {  return this.TSCC_8_3_1;}
    @JsonProperty("TSCC-8-3-1")
    public void setTSCC_8_3_1(final String TSCC_8_3_1) { this.TSCC_8_3_1=TSCC_8_3_1;}
    @Column(name = "TSCC_8_3_2")
    @JsonProperty("TSCC-8-3-2")
    private String TSCC_8_3_2; // 术后是否进行心理指导
    public String getTSCC_8_3_2() {  return this.TSCC_8_3_2;}
    @JsonProperty("TSCC-8-3-2")
    public void setTSCC_8_3_2(final String TSCC_8_3_2) { this.TSCC_8_3_2=TSCC_8_3_2;}
    @Column(name = "CM_7_1_1")
    @JsonProperty("CM-7-1-1")
    private String CM_7_1_1; // 为患者提供术前健康教育
    ...
    private String CM_7_1_2; // 为患者提供术后健康教育
