...
/*主要诊断 ICD-10 编码：I60.0 至 I60.9，且伴主要手术ICD-9-CM 编码：01.3，02.2，02.3，38.3，38.4，38.6，39.5的手术出院患者。
*/
@ApiModel(value = "15信息")
@Entity
@Table(name = "sd_info_aSAH")
public class SdInfoaSAH implements Serializable {
    ...
    @Column(name = "aSAH_0_1_9_3")
    @JsonProperty("aSAH-0-1-9-3")
    private String aSAH_0_1_9_3; // 其他主要手术操作栏中提取ICD-9-CM-3四位亚目编码与名称
    public String getaSAH_0_1_9_3() {  return this.aSAH_0_1_9_3;}
    @JsonProperty("aSAH-0-1-9-3")
    public void setaSAH_0_1_9_3(final String aSAH_0_1_9_3) { this.aSAH_0_1_9_3=aSAH_0_1_9_3;}
    ...
    @Column(name = "aSAH_0_1_10_1")
    @JsonProperty("aSAH-0-1-10-1")
    private String aSAH_0_1_10_1; // 其他主要手术操作栏中提取ICD-9-CM-3六位临床扩展编码与名称
    public String getaSAH_0_1_10_1() {  return this.aSAH_0_1_10_1;}
    @JsonProperty("aSAH-0-1-10-1")
    public void setaSAH_0_1_10_1(final String aSAH_0_1_10_1) { this.aSAH_0_1_10_1=aSAH_0_1_10_1;}
    ...
    @Column(name = "aSAH_1_1_1_1")
    @JsonProperty("aSAH-1-1-1-1")
    private String aSAH_1_1_1_1; // 急诊医师接诊日期是否确定
    public String getaSAH_1_1_1_1() {  return this.aSAH_1_1_1_1;}
    @JsonProperty("aSAH-1-1-1-1")
    public void setaSAH_1_1_1_1(final String aSAH_1_1_1_1) { this.aSAH_1_1_1_1=aSAH_1_1_1_1;}
    @Column(name = "aSAH_1_1_1")
    @JsonProperty("aSAH-1-1-1")
    private String aSAH_1_1_1; // 本院急诊医师接诊日期时间
    public String getaSAH_1_1_1() {  return this.aSAH_1_1_1;}
    @JsonProperty("aSAH-1-1-1")
    public void setaSAH_1_1_1(final String aSAH_1_1_1) { this.aSAH_1_1_1=aSAH_1_1_1;}
    @Column(name = "aSAH_1_2_1_1")
    @JsonProperty("aSAH-1-2-1-1")
    private String aSAH_1_2_1_1; // 患者基础信息是否确定
    public String getaSAH_1_2_1_1() {  return this.aSAH_1_2_1_1;}
    @JsonProperty("aSAH-1-2-1-1")
    public void setaSAH_1_2_1_1(final String aSAH_1_2_1_1) { this.aSAH_1_2_1_1=aSAH_1_2_1_1;}
    @Column(name = "aSAH_1_2_1")
    @JsonProperty("aSAH-1-2-1")
    private String aSAH_1_2_1; // 身高(cm)
    public String getaSAH_1_2_1() {  return this.aSAH_1_2_1;}
    @JsonProperty("aSAH-1-2-1")
    public void setaSAH_1_2_1(final String aSAH_1_2_1) { this.aSAH_1_2_1=aSAH_1_2_1;}
    @Column(name = "aSAH_1_2_2")
    @JsonProperty("aSAH-1-2-2")
    private String aSAH_1_2_2; // 体重(kg)
    public String getaSAH_1_2_2() {  return this.aSAH_1_2_2;}
    @JsonProperty("aSAH-1-2-2")
    public void setaSAH_1_2_2(final String aSAH_1_2_2) { this.aSAH_1_2_2=aSAH_1_2_2;}
    @Column(name = "aSAH_1_2_3")
    @JsonProperty("aSAH-1-2-3")
    private String aSAH_1_2_3; // 呼吸(次/分)
    public String getaSAH_1_2_3() {  return this.aSAH_1_2_3;}
    @JsonProperty("aSAH-1-2-3")
    public void setaSAH_1_2_3(final String aSAH_1_2_3) { this.aSAH_1_2_3=aSAH_1_2_3;}
    @Column(name = "aSAH_1_2_4")
    @JsonProperty("aSAH-1-2-4")
    private String aSAH_1_2_4; // 脉搏(次/分)
    public String getaSAH_1_2_4() {  return this.aSAH_1_2_4;}
    @JsonProperty("aSAH-1-2-4")
    public void setaSAH_1_2_4(final String aSAH_1_2_4) { this.aSAH_1_2_4=aSAH_1_2_4;}
    @Column(name = "aSAH_1_2_5")
    @JsonProperty("aSAH-1-2-5")
    private String aSAH_1_2_5; // 收缩压(mmHg)
    public String getaSAH_1_2_5() {  return this.aSAH_1_2_5;}
    @JsonProperty("aSAH-1-2-5")
    public void setaSAH_1_2_5(final String aSAH_1_2_5) { this.aSAH_1_2_5=aSAH_1_2_5;}
    @Column(name = "aSAH_1_2_6")
    @JsonProperty("aSAH-1-2-6")
    private String aSAH_1_2_6; // 舒张压(mmHg)
    public String getaSAH_1_2_6() {  return this.aSAH_1_2_6;}
    @JsonProperty("aSAH-1-2-6")
    public void setaSAH_1_2_6(final String aSAH_1_2_6) { this.aSAH_1_2_6=aSAH_1_2_6;}
    @Column(name = "aSAH_1_3_1")
    @JsonProperty("aSAH-1-3-1")
    private String aSAH_1_3_1; // 是否实施首次头部影像学检查
    public String getaSAH_1_3_1() {  return this.aSAH_1_3_1;}
    @JsonProperty("aSAH-1-3-1")
    public void setaSAH_1_3_1(final String aSAH_1_3_1) { this.aSAH_1_3_1=aSAH_1_3_1;}
    @Column(name = "aSAH_1_3_2")
    @JsonProperty("aSAH-1-3-2")
    private String aSAH_1_3_2; // 急诊首次头部影像学检查项目
    public String getaSAH_1_3_2() {  return this.aSAH_1_3_2;}
    @JsonProperty("aSAH-1-3-2")
    public void setaSAH_1_3_2(final String aSAH_1_3_2) { this.aSAH_1_3_2=aSAH_1_3_2;}
    @Column(name = "aSAH_1_3_3")
    @JsonProperty("aSAH-1-3-3")
    private String aSAH_1_3_3; // CT检查回报日期时间
    public String getaSAH_1_3_3() {  return this.aSAH_1_3_3;}
    @JsonProperty("aSAH-1-3-3")
    public void setaSAH_1_3_3(final String aSAH_1_3_3) { this.aSAH_1_3_3=aSAH_1_3_3;}
    @Column(name = "aSAH_2_1_1")
    @JsonProperty("aSAH-2-1-1")
    private String aSAH_2_1_1; // 是否实施入院Hunt-Hess分级评估
    public String getaSAH_2_1_1() {  return this.aSAH_2_1_1;}
    @JsonProperty("aSAH-2-1-1")
    public void setaSAH_2_1_1(final String aSAH_2_1_1) { this.aSAH_2_1_1=aSAH_2_1_1;}
    @Column(name = "aSAH_2_1_4")
    @JsonProperty("aSAH-2-1-4")
    private String aSAH_2_1_4; // 既往是否有严重的全身疾患
    public String getaSAH_2_1_4() {  return this.aSAH_2_1_4;}
    @JsonProperty("aSAH-2-1-4")
    public void setaSAH_2_1_4(final String aSAH_2_1_4) { this.aSAH_2_1_4=aSAH_2_1_4;}
    @Column(name = "aSAH_2_1_4_1")
    @JsonProperty("aSAH-2-1-4-1")
    private String aSAH_2_1_4_1; // 既往严重的全身疾患其他
    public String getaSAH_2_1_4_1() {  return this.aSAH_2_1_4_1;}
    @JsonProperty("aSAH-2-1-4-1")
    public void setaSAH_2_1_4_1(final String aSAH_2_1_4_1) { this.aSAH_2_1_4_1=aSAH_2_1_4_1;}
    @Column(name = "aSAH_2_1_2")
    @JsonProperty("aSAH-2-1-2")
    private String aSAH_2_1_2; // 入院后首次Hunt-Hess分级评估
    public String getaSAH_2_1_2() {  return this.aSAH_2_1_2;}
    @JsonProperty("aSAH-2-1-2")
    public void setaSAH_2_1_2(final String aSAH_2_1_2) { this.aSAH_2_1_2=aSAH_2_1_2;}
    @Column(name = "aSAH_2_1_3")
    @JsonProperty("aSAH-2-1-3")
    private String aSAH_2_1_3; // 完成评估日期时间
    public String getaSAH_2_1_3() {  return this.aSAH_2_1_3;}
    @JsonProperty("aSAH-2-1-3")
    public void setaSAH_2_1_3(final String aSAH_2_1_3) { this.aSAH_2_1_3=aSAH_2_1_3;}
    @Column(name = "aSAH_3_1_1_2")
    @JsonProperty("aSAH-3-1-1-2")
    private String aSAH_3_1_1_2; // 术前检查项目的选择
    public String getaSAH_3_1_1_2() {  return this.aSAH_3_1_1_2;}
    @JsonProperty("aSAH-3-1-1-2")
    public void setaSAH_3_1_1_2(final String aSAH_3_1_1_2) { this.aSAH_3_1_1_2=aSAH_3_1_1_2;}
    @Column(name = "aSAH_3_1_1_1")
    @JsonProperty("aSAH-3-1-1-1")
    private String aSAH_3_1_1_1; // 其它术前检查项目
    public String getaSAH_3_1_1_1() {  return this.aSAH_3_1_1_1;}
    @JsonProperty("aSAH-3-1-1-1")
    public void setaSAH_3_1_1_1(final String aSAH_3_1_1_1) { this.aSAH_3_1_1_1=aSAH_3_1_1_1;}
    @Column(name = "aSAH_3_1_2")
    @JsonProperty("aSAH-3-1-2")
    private String aSAH_3_1_2; // 完成最后一次的时间
    public String getaSAH_3_1_2() {  return this.aSAH_3_1_2;}
    @JsonProperty("aSAH-3-1-2")
    public void setaSAH_3_1_2(final String aSAH_3_1_2) { this.aSAH_3_1_2=aSAH_3_1_2;}
    @Column(name = "aSAH_4_2_1")
    @JsonProperty("aSAH-4-2-1")
    private String aSAH_4_2_1; // 是否入院后实施首次CT血管成像（CTA）
    public String getaSAH_4_2_1() {  return this.aSAH_4_2_1;}
    @JsonProperty("aSAH-4-2-1")
    public void setaSAH_4_2_1(final String aSAH_4_2_1) { this.aSAH_4_2_1=aSAH_4_2_1;}
    @Column(name = "aSAH_4_2_2")
    @JsonProperty("aSAH-4-2-2")
    private String aSAH_4_2_2; // 完成首次CT血管成像（CTA）报告日期时间
    public String getaSAH_4_2_2() {  return this.aSAH_4_2_2;}
    @JsonProperty("aSAH-4-2-2")
    public void setaSAH_4_2_2(final String aSAH_4_2_2) { this.aSAH_4_2_2=aSAH_4_2_2;}
    @Column(name = "aSAH_4_3_1")
    @JsonProperty("aSAH-4-3-1")
    private String aSAH_4_3_1; // 是否入院后实施首次全脑血管造影术(DSA)
    public String getaSAH_4_3_1() {  return this.aSAH_4_3_1;}
    @JsonProperty("aSAH-4-3-1")
    public void setaSAH_4_3_1(final String aSAH_4_3_1) { this.aSAH_4_3_1=aSAH_4_3_1;}
    @Column(name = "aSAH_4_3_2")
    @JsonProperty("aSAH-4-3-2")
    private String aSAH_4_3_2; // 完成首次血管检查（DSA）报告日期时间
    public String getaSAH_4_3_2() {  return this.aSAH_4_3_2;}
    @JsonProperty("aSAH-4-3-2")
    public void setaSAH_4_3_2(final String aSAH_4_3_2) { this.aSAH_4_3_2=aSAH_4_3_2;}
    @Column(name = "aSAH_5_2_1")
    @JsonProperty("aSAH-5-2-1")
    private String aSAH_5_2_1; // 入院后治疗模式的选择
    public String getaSAH_5_2_1() {  return this.aSAH_5_2_1;}
    @JsonProperty("aSAH-5-2-1")
    public void setaSAH_5_2_1(final String aSAH_5_2_1) { this.aSAH_5_2_1=aSAH_5_2_1;}
    @Column(name = "aSAH_5_2_1_1")
    @JsonProperty("aSAH-5-2-1-1")
    private String aSAH_5_2_1_1; // 入院后其他治疗模式
    public String getaSAH_5_2_1_1() {  return this.aSAH_5_2_1_1;}
    @JsonProperty("aSAH-5-2-1-1")
    public void setaSAH_5_2_1_1(final String aSAH_5_2_1_1) { this.aSAH_5_2_1_1=aSAH_5_2_1_1;}
    @Column(name = "aSAH_5_1_1")
    @JsonProperty("aSAH-5-1-1")
    private String aSAH_5_1_1; // 是否术前再次Hunt-Hess分级评估
    public String getaSAH_5_1_1() {  return this.aSAH_5_1_1;}
    @JsonProperty("aSAH-5-1-1")
    public void setaSAH_5_1_1(final String aSAH_5_1_1) { this.aSAH_5_1_1=aSAH_5_1_1;}
    @Column(name = "aSAH_5_1_2")
    @JsonProperty("aSAH-5-1-2")
    private String aSAH_5_1_2; // 术前再次Hunt-Hess再分级
    public String getaSAH_5_1_2() {  return this.aSAH_5_1_2;}
    @JsonProperty("aSAH-5-1-2")
    public void setaSAH_5_1_2(final String aSAH_5_1_2) { this.aSAH_5_1_2=aSAH_5_1_2;}
    @Column(name = "aSAH_5_1_3")
    @JsonProperty("aSAH-5-1-3")
    private String aSAH_5_1_3; // 完成评估日期时间
    public String getaSAH_5_1_3() {  return this.aSAH_5_1_3;}
    @JsonProperty("aSAH-5-1-3")
    public void setaSAH_5_1_3(final String aSAH_5_1_3) { this.aSAH_5_1_3=aSAH_5_1_3;}
    @Column(name = "aSAH_6_1_1")
    @JsonProperty("aSAH-6-1-1")
    private String aSAH_6_1_1; // 手术指征
    public String getaSAH_6_1_1() {  return this.aSAH_6_1_1;}
    @JsonProperty("aSAH-6-1-1")
    public void setaSAH_6_1_1(final String aSAH_6_1_1) { this.aSAH_6_1_1=aSAH_6_1_1;}
    @Column(name = "aSAH_6_1_1_1")
    @JsonProperty("aSAH-6-1-1-1")
    private String aSAH_6_1_1_1; // 其他手术指征
    public String getaSAH_6_1_1_1() {  return this.aSAH_6_1_1_1;}
    @JsonProperty("aSAH-6-1-1-1")
    public void setaSAH_6_1_1_1(final String aSAH_6_1_1_1) { this.aSAH_6_1_1_1=aSAH_6_1_1_1;}
    @Column(name = "aSAH_6_2_1")
    @JsonProperty("aSAH-6-2-1")
    private String aSAH_6_2_1; // 责任动脉瘤所在的部位
    public String getaSAH_6_2_1() {  return this.aSAH_6_2_1;}
    @JsonProperty("aSAH-6-2-1")
    public void setaSAH_6_2_1(final String aSAH_6_2_1) { this.aSAH_6_2_1=aSAH_6_2_1;}
    @Column(name = "aSAH_6_2_1_1")
    @JsonProperty("aSAH-6-2-1-1")
    private String aSAH_6_2_1_1; // 责任动脉瘤所在的其他部位
    public String getaSAH_6_2_1_1() {  return this.aSAH_6_2_1_1;}
    @JsonProperty("aSAH-6-2-1-1")
    public void setaSAH_6_2_1_1(final String aSAH_6_2_1_1) { this.aSAH_6_2_1_1=aSAH_6_2_1_1;}
    @Column(name = "aSAH_6_2_2")
    @JsonProperty("aSAH-6-2-2")
    private String aSAH_6_2_2; // 多发责任动脉瘤所在部位
    public String getaSAH_6_2_2() {  return this.aSAH_6_2_2;}
    @JsonProperty("aSAH-6-2-2")
    public void setaSAH_6_2_2(final String aSAH_6_2_2) { this.aSAH_6_2_2=aSAH_6_2_2;}
    @Column(name = "aSAH_6_2_2_1")
    @JsonProperty("aSAH-6-2-2-1")
    private String aSAH_6_2_2_1; // 多发责任动脉瘤所在其他部位
    public String getaSAH_6_2_2_1() {  return this.aSAH_6_2_2_1;}
    @JsonProperty("aSAH-6-2-2-1")
    public void setaSAH_6_2_2_1(final String aSAH_6_2_2_1) { this.aSAH_6_2_2_1=aSAH_6_2_2_1;}
    @Column(name = "aSAH_6_2_3")
    @JsonProperty("aSAH-6-2-3")
    private String aSAH_6_2_3; // 责任动脉瘤的大小
    public String getaSAH_6_2_3() {  return this.aSAH_6_2_3;}
    @JsonProperty("aSAH-6-2-3")
    public void setaSAH_6_2_3(final String aSAH_6_2_3) { this.aSAH_6_2_3=aSAH_6_2_3;}
    @Column(name = "aSAH_6_2_4")
    @JsonProperty("aSAH-6-2-4")
    private String aSAH_6_2_4; // 手术名称与ICD-9-CM-3亚目编码
    public String getaSAH_6_2_4() {  return this.aSAH_6_2_4;}
    @JsonProperty("aSAH-6-2-4")
    public void setaSAH_6_2_4(final String aSAH_6_2_4) { this.aSAH_6_2_4=aSAH_6_2_4;}
    @Column(name = "aSAH_6_1_2_1")
    @JsonProperty("aSAH-6-1-2-1")
    private String aSAH_6_1_2_1; // 其它手术名称
    public String getaSAH_6_1_2_1() {  return this.aSAH_6_1_2_1;}
    @JsonProperty("aSAH-6-1-2-1")
    public void setaSAH_6_1_2_1(final String aSAH_6_1_2_1) { this.aSAH_6_1_2_1=aSAH_6_1_2_1;}
    @Column(name = "aSAH_7_1_1")
    @JsonProperty("aSAH-7-1-1")
    private String aSAH_7_1_1; // 是否实施开颅手术术中安全监测措施
    public String getaSAH_7_1_1() {  return this.aSAH_7_1_1;}
    @JsonProperty("aSAH-7-1-1")
    public void setaSAH_7_1_1(final String aSAH_7_1_1) { this.aSAH_7_1_1=aSAH_7_1_1;}
    @Column(name = "aSAH_7_1_2")
    @JsonProperty("aSAH-7-1-2")
    private String aSAH_7_1_2; // 安全监测措施选择
    public String getaSAH_7_1_2() {  return this.aSAH_7_1_2;}
    @JsonProperty("aSAH-7-1-2")
    public void setaSAH_7_1_2(final String aSAH_7_1_2) { this.aSAH_7_1_2=aSAH_7_1_2;}
    @Column(name = "aSAH_7_1_2_1")
    @JsonProperty("aSAH-7-1-2-1")
    private String aSAH_7_1_2_1; // 其它安全监测措施
    public String getaSAH_7_1_2_1() {  return this.aSAH_7_1_2_1;}
    @JsonProperty("aSAH-7-1-2-1")
    public void setaSAH_7_1_2_1(final String aSAH_7_1_2_1) { this.aSAH_7_1_2_1=aSAH_7_1_2_1;}
    ...
    @Column(name = "aSAH_9_1_1")
    @JsonProperty("aSAH-9-1-1")
    private String aSAH_9_1_1; // 是否为特殊类型的急性aSAH患者
    public String getaSAH_9_1_1() {  return this.aSAH_9_1_1;}
    @JsonProperty("aSAH-9-1-1")
    public void setaSAH_9_1_1(final String aSAH_9_1_1) { this.aSAH_9_1_1=aSAH_9_1_1;}
    @Column(name = "aSAH_9_1_2")
    @JsonProperty("aSAH-9-1-2")
    private String aSAH_9_1_2; // 患者类型的选择
    public String getaSAH_9_1_2() {  return this.aSAH_9_1_2;}
    @JsonProperty("aSAH-9-1-2")
    public void setaSAH_9_1_2(final String aSAH_9_1_2) { this.aSAH_9_1_2=aSAH_9_1_2;}
    @Column(name = "aSAH_9_2_1")
    @JsonProperty("aSAH-9-2-1")
    private String aSAH_9_2_1; // 开颅术后是否预防使用抗癫痫药物
    public String getaSAH_9_2_1() {  return this.aSAH_9_2_1;}
    @JsonProperty("aSAH-9-2-1")
    public void setaSAH_9_2_1(final String aSAH_9_2_1) { this.aSAH_9_2_1=aSAH_9_2_1;}
    @Column(name = "aSAH_9_2_2")
    @JsonProperty("aSAH-9-2-2")
    private String aSAH_9_2_2; // 抗癫痫药物选择
    public String getaSAH_9_2_2() {  return this.aSAH_9_2_2;}
    @JsonProperty("aSAH-9-2-2")
    public void setaSAH_9_2_2(final String aSAH_9_2_2) { this.aSAH_9_2_2=aSAH_9_2_2;}
    @Column(name = "aSAH_9_2_2_1")
    @JsonProperty("aSAH-9-2-2-1")
    private String aSAH_9_2_2_1; // 其它抗癫痫药物
    public String getaSAH_9_2_2_1() {  return this.aSAH_9_2_2_1;}
    @JsonProperty("aSAH-9-2-2-1")
    public void setaSAH_9_2_2_1(final String aSAH_9_2_2_1) { this.aSAH_9_2_2_1=aSAH_9_2_2_1;}
    @Column(name = "CM_2_1")
    @JsonProperty("CM-2-1")
    ...
    @Column(name = "aSAH_10_2_2")
    @JsonProperty("aSAH-10-2-2")
    private String aSAH_10_2_2; // aSAH术后特指并发症
    public String getaSAH_10_2_2() {  return this.aSAH_10_2_2;}
    @JsonProperty("aSAH-10-2-2")
    public void setaSAH_10_2_2(final String aSAH_10_2_2) { this.aSAH_10_2_2=aSAH_10_2_2;}
    @Column(name = "aSAH_10_2_2_1")
    @JsonProperty("aSAH-10-2-2-1")
    private String aSAH_10_2_2_1; // 其它aSAH术后特指并发症
    public String getaSAH_10_2_2_1() {  return this.aSAH_10_2_2_1;}
    @JsonProperty("aSAH-10-2-2-1")
    public void setaSAH_10_2_2_1(final String aSAH_10_2_2_1) { this.aSAH_10_2_2_1=aSAH_10_2_2_1;}
    @Column(name = "CM_2_4")
    @JsonProperty("CM-2-4")
    ...
    @Column(name = "aSAH_10_4_1")
    @JsonProperty("aSAH-10-4-1")
    private String aSAH_10_4_1; // 是否手术后再手术
    public String getaSAH_10_4_1() {  return this.aSAH_10_4_1;}
    @JsonProperty("aSAH-10-4-1")
    public void setaSAH_10_4_1(final String aSAH_10_4_1) { this.aSAH_10_4_1=aSAH_10_4_1;}
    @Column(name = "aSAH_10_4_2")
    @JsonProperty("aSAH-10-4-2")
    private String aSAH_10_4_2; // 手术后再手术原因
    public String getaSAH_10_4_2() {  return this.aSAH_10_4_2;}
    @JsonProperty("aSAH-10-4-2")
    public void setaSAH_10_4_2(final String aSAH_10_4_2) { this.aSAH_10_4_2=aSAH_10_4_2;}
    @Column(name = "aSAH_10_4_2_1")
    @JsonProperty("aSAH-10-4-2-1")
    private String aSAH_10_4_2_1; // 其它手术后再手术原因
    public String getaSAH_10_4_2_1() {  return this.aSAH_10_4_2_1;}
    @JsonProperty("aSAH-10-4-2-1")
    public void setaSAH_10_4_2_1(final String aSAH_10_4_2_1) { this.aSAH_10_4_2_1=aSAH_10_4_2_1;}
    @Column(name = "aSAH_11_1_1")
    @JsonProperty("aSAH-11-1-1")
    private String aSAH_11_1_1; // 手术中出血量(ml)
    public String getaSAH_11_1_1() {  return this.aSAH_11_1_1;}
    @JsonProperty("aSAH-11-1-1")
    public void setaSAH_11_1_1(final String aSAH_11_1_1) { this.aSAH_11_1_1=aSAH_11_1_1;}
    @Column(name = "aSAH_11_1_2")
    @JsonProperty("aSAH-11-1-2")
    private String aSAH_11_1_2; // 手术中输血量(ml)
    public String getaSAH_11_1_2() {  return this.aSAH_11_1_2;}
    @JsonProperty("aSAH-11-1-2")
    public void setaSAH_11_1_2(final String aSAH_11_1_2) { this.aSAH_11_1_2=aSAH_11_1_2;}
    @Column(name = "aSAH_11_1_3")
    @JsonProperty("aSAH-11-1-3")
    private String aSAH_11_1_3; // 手术后出血量(ml)
    public String getaSAH_11_1_3() {  return this.aSAH_11_1_3;}
    @JsonProperty("aSAH-11-1-3")
    public void setaSAH_11_1_3(final String aSAH_11_1_3) { this.aSAH_11_1_3=aSAH_11_1_3;}
    @Column(name = "aSAH_11_1_4")
    @JsonProperty("aSAH-11-1-4")
    private String aSAH_11_1_4; // 手术后输血量(ml)
    public String getaSAH_11_1_4() {  return this.aSAH_11_1_4;}
    @JsonProperty("aSAH-11-1-4")
    public void setaSAH_11_1_4(final String aSAH_11_1_4) { this.aSAH_11_1_4=aSAH_11_1_4;}
    @Column(name = "aSAH_11_2_1")
    @JsonProperty("aSAH-11-2-1")
    private String aSAH_11_2_1; // 全血(ml)
    public String getaSAH_11_2_1() {  return this.aSAH_11_2_1;}
    @JsonProperty("aSAH-11-2-1")
    public void setaSAH_11_2_1(final String aSAH_11_2_1) { this.aSAH_11_2_1=aSAH_11_2_1;}
    @Column(name = "aSAH_11_2_2")
    @JsonProperty("aSAH-11-2-2")
    private String aSAH_11_2_2; // 成份血(ml)
    public String getaSAH_11_2_2() {  return this.aSAH_11_2_2;}
    @JsonProperty("aSAH-11-2-2")
    public void setaSAH_11_2_2(final String aSAH_11_2_2) { this.aSAH_11_2_2=aSAH_11_2_2;}
    @Column(name = "aSAH_11_2_3")
    @JsonProperty("aSAH-11-2-3")
    private String aSAH_11_2_3; // 血浆(ml)
    public String getaSAH_11_2_3() {  return this.aSAH_11_2_3;}
    @JsonProperty("aSAH-11-2-3")
    public void setaSAH_11_2_3(final String aSAH_11_2_3) { this.aSAH_11_2_3=aSAH_11_2_3;}
    @Column(name = "aSAH_12_1_1")
    @JsonProperty("aSAH-12-1-1")
    private String aSAH_12_1_1; // 是否为术前Hunt-Hess分级 1-2级的患者
    public String getaSAH_12_1_1() {  return this.aSAH_12_1_1;}
    @JsonProperty("aSAH-12-1-1")
    public void setaSAH_12_1_1(final String aSAH_12_1_1) { this.aSAH_12_1_1=aSAH_12_1_1;}
    @Column(name = "aSAH_12_1_2")
    @JsonProperty("aSAH-12-1-2")
    private String aSAH_12_1_2; // 出院前是否实施mRS评分
    public String getaSAH_12_1_2() {  return this.aSAH_12_1_2;}
    @JsonProperty("aSAH-12-1-2")
    public void setaSAH_12_1_2(final String aSAH_12_1_2) { this.aSAH_12_1_2=aSAH_12_1_2;}
    @Column(name = "aSAH_12_1_4")
    @JsonProperty("aSAH-12-1-4")
    private String aSAH_12_1_4; // 出院前mRS评估
    public String getaSAH_12_1_4() {  return this.aSAH_12_1_4;}
    @JsonProperty("aSAH-12-1-4")
    public void setaSAH_12_1_4(final String aSAH_12_1_4) { this.aSAH_12_1_4=aSAH_12_1_4;}
    @Column(name = "aSAH_12_1_3")
    @JsonProperty("aSAH-12-1-3")
    private String aSAH_12_1_3; // 出院前mRS评分值
    public String getaSAH_12_1_3() {  return this.aSAH_12_1_3;}
    @JsonProperty("aSAH-12-1-3")
    public void setaSAH_12_1_3(final String aSAH_12_1_3) { this.aSAH_12_1_3=aSAH_12_1_3;}
    @Column(name = "aSAH_13_1_1")
    @JsonProperty("aSAH-13-1-1")
    private String aSAH_13_1_1; // 是否有重点护理评估和健康教育
    public String getaSAH_13_1_1() {  return this.aSAH_13_1_1;}
    @JsonProperty("aSAH-13-1-1")
    public void setaSAH_13_1_1(final String aSAH_13_1_1) { this.aSAH_13_1_1=aSAH_13_1_1;}
    @Column(name = "aSAH_13_1_2_1")
    @JsonProperty("aSAH-13-1-2-1")
    private String aSAH_13_1_2_1; // 行走评估结果
    public String getaSAH_13_1_2_1() {  return this.aSAH_13_1_2_1;}
    @JsonProperty("aSAH-13-1-2-1")
    public void setaSAH_13_1_2_1(final String aSAH_13_1_2_1) { this.aSAH_13_1_2_1=aSAH_13_1_2_1;}
    @Column(name = "aSAH_13_1_2_2")
    @JsonProperty("aSAH-13-1-2-2")
    private String aSAH_13_1_2_2; // 呼吸评估结果
    public String getaSAH_13_1_2_2() {  return this.aSAH_13_1_2_2;}
    @JsonProperty("aSAH-13-1-2-2")
    public void setaSAH_13_1_2_2(final String aSAH_13_1_2_2) { this.aSAH_13_1_2_2=aSAH_13_1_2_2;}
    @Column(name = "aSAH_13_1_2_3")
    @JsonProperty("aSAH-13-1-2-3")
    private String aSAH_13_1_2_3; // 饮食评估结果
    public String getaSAH_13_1_2_3() {  return this.aSAH_13_1_2_3;}
    @JsonProperty("aSAH-13-1-2-3")
    public void setaSAH_13_1_2_3(final String aSAH_13_1_2_3) { this.aSAH_13_1_2_3=aSAH_13_1_2_3;}
    @Column(name = "aSAH_13_1_2_4")
    @JsonProperty("aSAH-13-1-2-4")
    private String aSAH_13_1_2_4; // 吞咽评估结果
    public String getaSAH_13_1_2_4() {  return this.aSAH_13_1_2_4;}
    @JsonProperty("aSAH-13-1-2-4")
    public void setaSAH_13_1_2_4(final String aSAH_13_1_2_4) { this.aSAH_13_1_2_4=aSAH_13_1_2_4;}
    @Column(name = "aSAH_13_1_2_5_3")
    @JsonProperty("aSAH-13-1-2-5-3")
    private String aSAH_13_1_2_5_3; // 压疮评估（Braden评分值）分值是否确定
    public String getaSAH_13_1_2_5_3() {  return this.aSAH_13_1_2_5_3;}
    @JsonProperty("aSAH-13-1-2-5-3")
    public void setaSAH_13_1_2_5_3(final String aSAH_13_1_2_5_3) { this.aSAH_13_1_2_5_3=aSAH_13_1_2_5_3;}
    @Column(name = "aSAH_13_1_2_5")
    @JsonProperty("aSAH-13-1-2-5")
    private String aSAH_13_1_2_5; // 压疮评估（Braden评分值）分值
    public String getaSAH_13_1_2_5() {  return this.aSAH_13_1_2_5;}
    @JsonProperty("aSAH-13-1-2-5")
    public void setaSAH_13_1_2_5(final String aSAH_13_1_2_5) { this.aSAH_13_1_2_5=aSAH_13_1_2_5;}
    @Column(name = "aSAH_13_1_2_5_1")
    @JsonProperty("aSAH-13-1-2-5-1")
    private String aSAH_13_1_2_5_1; // 压疮评估结果选择
    public String getaSAH_13_1_2_5_1() {  return this.aSAH_13_1_2_5_1;}
    @JsonProperty("aSAH-13-1-2-5-1")
    public void setaSAH_13_1_2_5_1(final String aSAH_13_1_2_5_1) { this.aSAH_13_1_2_5_1=aSAH_13_1_2_5_1;}
    @Column(name = "aSAH_13_1_2_5_2")
    @JsonProperty("aSAH-13-1-2-5-2")
    private String aSAH_13_1_2_5_2; // 预防压疮告知
    public String getaSAH_13_1_2_5_2() {  return this.aSAH_13_1_2_5_2;}
    @JsonProperty("aSAH-13-1-2-5-2")
    public void setaSAH_13_1_2_5_2(final String aSAH_13_1_2_5_2) { this.aSAH_13_1_2_5_2=aSAH_13_1_2_5_2;}
    @Column(name = "aSAH_13_1_3_1")
    @JsonProperty("aSAH-13-1-3-1")
    private String aSAH_13_1_3_1; // 实施入院护理有记录
    public String getaSAH_13_1_3_1() {  return this.aSAH_13_1_3_1;}
    @JsonProperty("aSAH-13-1-3-1")
    public void setaSAH_13_1_3_1(final String aSAH_13_1_3_1) { this.aSAH_13_1_3_1=aSAH_13_1_3_1;}
    @Column(name = "aSAH_13_1_3_2")
    @JsonProperty("aSAH-13-1-3-2")
    private String aSAH_13_1_3_2; // 实施术前健康教育有记录
    public String getaSAH_13_1_3_2() {  return this.aSAH_13_1_3_2;}
    @JsonProperty("aSAH-13-1-3-2")
    public void setaSAH_13_1_3_2(final String aSAH_13_1_3_2) { this.aSAH_13_1_3_2=aSAH_13_1_3_2;}
    @Column(name = "aSAH_13_1_3_3")
    @JsonProperty("aSAH-13-1-3-3")
    private String aSAH_13_1_3_3; // 实施术前护理有记录
    public String getaSAH_13_1_3_3() {  return this.aSAH_13_1_3_3;}
    @JsonProperty("aSAH-13-1-3-3")
    public void setaSAH_13_1_3_3(final String aSAH_13_1_3_3) { this.aSAH_13_1_3_3=aSAH_13_1_3_3;}
    @Column(name = "aSAH_13_1_3_4")
    @JsonProperty("aSAH-13-1-3-4")
    private String aSAH_13_1_3_4; // 实施术后健康教育有记录
    public String getaSAH_13_1_3_4() {  return this.aSAH_13_1_3_4;}
    @JsonProperty("aSAH-13-1-3-4")
    public void setaSAH_13_1_3_4(final String aSAH_13_1_3_4) { this.aSAH_13_1_3_4=aSAH_13_1_3_4;}
    @Column(name = "aSAH_13_1_3_5")
    @JsonProperty("aSAH-13-1-3-5")
    private String aSAH_13_1_3_5; // 实施术后护理有记录
    public String getaSAH_13_1_3_5() {  return this.aSAH_13_1_3_5;}
    @JsonProperty("aSAH-13-1-3-5")
    public void setaSAH_13_1_3_5(final String aSAH_13_1_3_5) { this.aSAH_13_1_3_5=aSAH_13_1_3_5;}
    @Column(name = "aSAH_13_2_1")
    @JsonProperty("aSAH-13-2-1")
    private String aSAH_13_2_1; // 是否履行出院教育与告知责任
    public String getaSAH_13_2_1() {  return this.aSAH_13_2_1;}
    @JsonProperty("aSAH-13-2-1")
    public void setaSAH_13_2_1(final String aSAH_13_2_1) { this.aSAH_13_2_1=aSAH_13_2_1;}
    @Column(name = "aSAH_13_2_2_1")
    @JsonProperty("aSAH-13-2-2-1")
    private String aSAH_13_2_2_1; // 交与患者“出院小结”的副本，并告知患者出院时风险因素
    public String getaSAH_13_2_2_1() {  return this.aSAH_13_2_2_1;}
    @JsonProperty("aSAH-13-2-2-1")
    public void setaSAH_13_2_2_1(final String aSAH_13_2_2_1) { this.aSAH_13_2_2_1=aSAH_13_2_2_1;}
    @Column(name = "aSAH_13_2_2_2")
    @JsonProperty("aSAH-13-2-2-2")
    private String aSAH_13_2_2_2; // 出院带药
    public String getaSAH_13_2_2_2() {  return this.aSAH_13_2_2_2;}
    @JsonProperty("aSAH-13-2-2-2")
    public void setaSAH_13_2_2_2(final String aSAH_13_2_2_2) { this.aSAH_13_2_2_2=aSAH_13_2_2_2;}
    @Column(name = "aSAH_13_2_2_3")
    @JsonProperty("aSAH-13-2-2-3")
    private String aSAH_13_2_2_3; // 告知发生紧急情况时求援救治途径
    public String getaSAH_13_2_2_3() {  return this.aSAH_13_2_2_3;}
    @JsonProperty("aSAH-13-2-2-3")
    public void setaSAH_13_2_2_3(final String aSAH_13_2_2_3) { this.aSAH_13_2_2_3=aSAH_13_2_2_3;}
    @Column(name = "aSAH_13_2_2_4")
    @JsonProperty("aSAH-13-2-2-4")
    private String aSAH_13_2_2_4; // 出院时教育与随访
    public String getaSAH_13_2_2_4() {  return this.aSAH_13_2_2_4;}
    @JsonProperty("aSAH-13-2-2-4")
    public void setaSAH_13_2_2_4(final String aSAH_13_2_2_4) { this.aSAH_13_2_2_4=aSAH_13_2_2_4;}
    @Column(name = "aSAH_13_2_2_5")
    @JsonProperty("aSAH-13-2-2-5")
    private String aSAH_13_2_2_5; // 告知何为风险因素与紧急情况
    public String getaSAH_13_2_2_5() {  return this.aSAH_13_2_2_5;}
    @JsonProperty("aSAH-13-2-2-5")
    public void setaSAH_13_2_2_5(final String aSAH_13_2_2_5) { this.aSAH_13_2_2_5=aSAH_13_2_2_5;}
    @Column(name = "CM_4_1")
    @JsonProperty("CM-4-1")
