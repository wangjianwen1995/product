...
public class SdInfoTC implements Serializable {
    ...
    public String getTC_0_1_4_1() {  return this.TC_0_1_4_1;}
    @JsonProperty("TC-0-1-4-1")
    public void setTC_0_1_4_1(final String TC_0_1_4_1) { this.TC_0_1_4_1=TC_0_1_4_1;}
    ...
    public String getTC_0_1_4_2() {  return this.TC_0_1_4_2;}
    @JsonProperty("TC-0-1-4-2")
    public void setTC_0_1_4_2(final String TC_0_1_4_2) { this.TC_0_1_4_2=TC_0_1_4_2;}
    ...
    public String getTC_1_1_1() {  return this.TC_1_1_1;}
    @JsonProperty("TC-1-1-1")
    public void setTC_1_1_1(final String TC_1_1_1) { this.TC_1_1_1=TC_1_1_1;}
    @Column(name = "TC_1_1_2")
    @JsonProperty("TC-1-1-2")
    private String TC_1_1_2; // 主要有那些临床表现及体征
    public String getTC_1_1_2() {  return this.TC_1_1_2;}
    @JsonProperty("TC-1-1-2")
    public void setTC_1_1_2(final String TC_1_1_2) { this.TC_1_1_2=TC_1_1_2;}
    @Column(name = "TC_1_1_2_1")
    @JsonProperty("TC-1-1-2-1")
    private String TC_1_1_2_1; // 其他主要有那些临床表现及体征
    public String getTC_1_1_2_1() {  return this.TC_1_1_2_1;}
    @JsonProperty("TC-1-1-2-1")
    public void setTC_1_1_2_1(final String TC_1_1_2_1) { this.TC_1_1_2_1=TC_1_1_2_1;}
    @Column(name = "TC_1_1_3")
    @JsonProperty("TC-1-1-3")
    private String TC_1_1_3; // 主要辅助检查
    public String getTC_1_1_3() {  return this.TC_1_1_3;}
    @JsonProperty("TC-1-1-3")
    public void setTC_1_1_3(final String TC_1_1_3) { this.TC_1_1_3=TC_1_1_3;}
    @Column(name = "TC_1_1_4")
    @JsonProperty("TC-1-1-4")
    private String TC_1_1_4; // 次要辅助检查
    public String getTC_1_1_4() {  return this.TC_1_1_4;}
    @JsonProperty("TC-1-1-4")
    public void setTC_1_1_4(final String TC_1_1_4) { this.TC_1_1_4=TC_1_1_4;}
    @Column(name = "TC_1_1_4_1")
    @JsonProperty("TC-1-1-4-1")
    private String TC_1_1_4_1; // 其他次要辅助检查
    public String getTC_1_1_4_1() {  return this.TC_1_1_4_1;}
    @JsonProperty("TC-1-1-4-1")
    public void setTC_1_1_4_1(final String TC_1_1_4_1) { this.TC_1_1_4_1=TC_1_1_4_1;}
    @Column(name = "TC_1_2_5_r")
    @JsonProperty("TC-1-2-5-r")
    private String TC_1_2_5_r; // 
    public String getTC_1_2_5_r() {  return this.TC_1_2_5_r;}
    @JsonProperty("TC-1-2-5-r")
    public void setTC_1_2_5_r(final String TC_1_2_5_r) { this.TC_1_2_5_r=TC_1_2_5_r;}
    @Column(name = "TC_1_2_6_r")
    @JsonProperty("TC-1-2-6-r")
    private String TC_1_2_6_r; // 
    public String getTC_1_2_6_r() {  return this.TC_1_2_6_r;}
    @JsonProperty("TC-1-2-6-r")
    public void setTC_1_2_6_r(final String TC_1_2_6_r) { this.TC_1_2_6_r=TC_1_2_6_r;}
    @Column(name = "TC_1_2_7_r")
    @JsonProperty("TC-1-2-7-r")
    private String TC_1_2_7_r; // 
    public String getTC_1_2_7_r() {  return this.TC_1_2_7_r;}
    @JsonProperty("TC-1-2-7-r")
    public void setTC_1_2_7_r(final String TC_1_2_7_r) { this.TC_1_2_7_r=TC_1_2_7_r;}
    @Column(name = "TC_1_2_1")
    @JsonProperty("TC-1-2-1")
    private String TC_1_2_1; // 患者年龄
    public String getTC_1_2_1() {  return this.TC_1_2_1;}
    @JsonProperty("TC-1-2-1")
    public void setTC_1_2_1(final String TC_1_2_1) { this.TC_1_2_1=TC_1_2_1;}
    @Column(name = "TC_1_2_2")
    @JsonProperty("TC-1-2-2")
    private String TC_1_2_2; // T  原肿瘤
    public String getTC_1_2_2() {  return this.TC_1_2_2;}
    @JsonProperty("TC-1-2-2")
    public void setTC_1_2_2(final String TC_1_2_2) { this.TC_1_2_2=TC_1_2_2;}
    @Column(name = "TC_1_2_3")
    @JsonProperty("TC-1-2-3")
    private String TC_1_2_3; // N 淋巴结转移
    public String getTC_1_2_3() {  return this.TC_1_2_3;}
    @JsonProperty("TC-1-2-3")
    public void setTC_1_2_3(final String TC_1_2_3) { this.TC_1_2_3=TC_1_2_3;}
    @Column(name = "TC_1_2_4")
    @JsonProperty("TC-1-2-4")
    private String TC_1_2_4; //  M 远处转移
    public String getTC_1_2_4() {  return this.TC_1_2_4;}
    @JsonProperty("TC-1-2-4")
    public void setTC_1_2_4(final String TC_1_2_4) { this.TC_1_2_4=TC_1_2_4;}
    @Column(name = "TC_1_2_5")
    @JsonProperty("TC-1-2-5")
    private String TC_1_2_5; // 术前细胞学检查
    public String getTC_1_2_5() {  return this.TC_1_2_5;}
    @JsonProperty("TC-1-2-5")
    public void setTC_1_2_5(final String TC_1_2_5) { this.TC_1_2_5=TC_1_2_5;}
    @Column(name = "TC_1_3_1")
    @JsonProperty("TC-1-3-1")
    private String TC_1_3_1; // cTNM 临床分期结果选择
    public String getTC_1_3_1() {  return this.TC_1_3_1;}
    @JsonProperty("TC-1-3-1")
    public void setTC_1_3_1(final String TC_1_3_1) { this.TC_1_3_1=TC_1_3_1;}
    @Column(name = "TC_1_3_2")
    @JsonProperty("TC-1-3-2")
    private String TC_1_3_2; // 乳头状癌及滤泡癌 患者年龄<55岁
    public String getTC_1_3_2() {  return this.TC_1_3_2;}
    @JsonProperty("TC-1-3-2")
    public void setTC_1_3_2(final String TC_1_3_2) { this.TC_1_3_2=TC_1_3_2;}
    @Column(name = "TC_1_3_3")
    @JsonProperty("TC-1-3-3")
    private String TC_1_3_3; // 乳头状癌及滤泡癌患者年龄≥55岁
    public String getTC_1_3_3() {  return this.TC_1_3_3;}
    @JsonProperty("TC-1-3-3")
    public void setTC_1_3_3(final String TC_1_3_3) { this.TC_1_3_3=TC_1_3_3;}
    @Column(name = "TC_1_3_4")
    @JsonProperty("TC-1-3-4")
    private String TC_1_3_4; // 未分化癌 （所用未分化均为Ⅳ期）
    public String getTC_1_3_4() {  return this.TC_1_3_4;}
    @JsonProperty("TC-1-3-4")
    public void setTC_1_3_4(final String TC_1_3_4) { this.TC_1_3_4=TC_1_3_4;}
    @Column(name = "TC_1_3_5")
    @JsonProperty("TC-1-3-5")
    private String TC_1_3_5; // 髓样癌
    public String getTC_1_3_5() {  return this.TC_1_3_5;}
    @JsonProperty("TC-1-3-5")
    public void setTC_1_3_5(final String TC_1_3_5) { this.TC_1_3_5=TC_1_3_5;}
    @Column(name = "TC_1_4_1")
    @JsonProperty("TC-1-4-1")
    private String TC_1_4_1; // 治疗前是否接受过（MDT）多学科协作诊疗(2个或以上治疗科室会诊)
    public String getTC_1_4_1() {  return this.TC_1_4_1;}
    @JsonProperty("TC-1-4-1")
    public void setTC_1_4_1(final String TC_1_4_1) { this.TC_1_4_1=TC_1_4_1;}
    @Column(name = "TC_2_1_1")
    @JsonProperty("TC-2-1-1")
    private String TC_2_1_1; // 术前评估有无淋巴结转移
    public String getTC_2_1_1() {  return this.TC_2_1_1;}
    @JsonProperty("TC-2-1-1")
    public void setTC_2_1_1(final String TC_2_1_1) { this.TC_2_1_1=TC_2_1_1;}
    @Column(name = "TC_2_1_2")
    @JsonProperty("TC-2-1-2")
    private String TC_2_1_2; // 淋巴结转移征象
    public String getTC_2_1_2() {  return this.TC_2_1_2;}
    @JsonProperty("TC-2-1-2")
    public void setTC_2_1_2(final String TC_2_1_2) { this.TC_2_1_2=TC_2_1_2;}
    @Column(name = "TC_2_1_2_1")
    @JsonProperty("TC-2-1-2-1")
    private String TC_2_1_2_1; // 其他淋巴结转移征象
    public String getTC_2_1_2_1() {  return this.TC_2_1_2_1;}
    @JsonProperty("TC-2-1-2-1")
    public void setTC_2_1_2_1(final String TC_2_1_2_1) { this.TC_2_1_2_1=TC_2_1_2_1;}
    @Column(name = "TC_2_2_1")
    @JsonProperty("TC-2-2-1")
    private String TC_2_2_1; // 是否甲状腺癌手术治疗
    public String getTC_2_2_1() {  return this.TC_2_2_1;}
    @JsonProperty("TC-2-2-1")
    public void setTC_2_2_1(final String TC_2_2_1) { this.TC_2_2_1=TC_2_2_1;}
    @Column(name = "TC_2_3_1")
    @JsonProperty("TC-2-3-1")
    private String TC_2_3_1; // 甲状腺癌再次手术
    public String getTC_2_3_1() {  return this.TC_2_3_1;}
    @JsonProperty("TC-2-3-1")
    public void setTC_2_3_1(final String TC_2_3_1) { this.TC_2_3_1=TC_2_3_1;}
    @Column(name = "TC_2_3_2")
    @JsonProperty("TC-2-3-2")
    private String TC_2_3_2; // 甲状腺癌再次手术主要原因
    public String getTC_2_3_2() {  return this.TC_2_3_2;}
    @JsonProperty("TC-2-3-2")
    public void setTC_2_3_2(final String TC_2_3_2) { this.TC_2_3_2=TC_2_3_2;}
    @Column(name = "TC_2_3_2_1")
    @JsonProperty("TC-2-3-2-1")
    private String TC_2_3_2_1; // 其它甲状腺癌再次手术主要原因
    public String getTC_2_3_2_1() {  return this.TC_2_3_2_1;}
    @JsonProperty("TC-2-3-2-1")
    public void setTC_2_3_2_1(final String TC_2_3_2_1) { this.TC_2_3_2_1=TC_2_3_2_1;}
    @Column(name = "TC_2_4_1")
    @JsonProperty("TC-2-4-1")
    private String TC_2_4_1; // 甲状腺癌手术治疗方式
    public String getTC_2_4_1() {  return this.TC_2_4_1;}
    @JsonProperty("TC-2-4-1")
    public void setTC_2_4_1(final String TC_2_4_1) { this.TC_2_4_1=TC_2_4_1;}
    @Column(name = "TC_2_4_1_1")
    @JsonProperty("TC-2-4-1-1")
    private String TC_2_4_1_1; // 其他甲状腺癌手术治疗方式
    public String getTC_2_4_1_1() {  return this.TC_2_4_1_1;}
    @JsonProperty("TC-2-4-1-1")
    public void setTC_2_4_1_1(final String TC_2_4_1_1) { this.TC_2_4_1_1=TC_2_4_1_1;}
    @Column(name = "TC_2_4_3")
    @JsonProperty("TC-2-4-3")
    private String TC_2_4_3; // 甲状腺全切除手术适应证的选择
    public String getTC_2_4_3() {  return this.TC_2_4_3;}
    @JsonProperty("TC-2-4-3")
    public void setTC_2_4_3(final String TC_2_4_3) { this.TC_2_4_3=TC_2_4_3;}
    @Column(name = "TC_2_4_3_1")
    @JsonProperty("TC-2-4-3-1")
    private String TC_2_4_3_1; // 其他甲状腺全切除手术适应证
    public String getTC_2_4_3_1() {  return this.TC_2_4_3_1;}
    @JsonProperty("TC-2-4-3-1")
    public void setTC_2_4_3_1(final String TC_2_4_3_1) { this.TC_2_4_3_1=TC_2_4_3_1;}
    @Column(name = "TC_2_4_2")
    @JsonProperty("TC-2-4-2")
    private String TC_2_4_2; // 甲状腺腺叶切除适应证的选择
    public String getTC_2_4_2() {  return this.TC_2_4_2;}
    @JsonProperty("TC-2-4-2")
    public void setTC_2_4_2(final String TC_2_4_2) { this.TC_2_4_2=TC_2_4_2;}
    @Column(name = "TC_2_4_2_1")
    @JsonProperty("TC-2-4-2-1")
    private String TC_2_4_2_1; // 其他甲状腺腺叶切除适应证
    public String getTC_2_4_2_1() {  return this.TC_2_4_2_1;}
    @JsonProperty("TC-2-4-2-1")
    public void setTC_2_4_2_1(final String TC_2_4_2_1) { this.TC_2_4_2_1=TC_2_4_2_1;}
    @Column(name = "TC_2_4_4")
    @JsonProperty("TC-2-4-4")
    private String TC_2_4_4; // 甲状腺全切除+淋巴结清扫手术适应证的选择
    public String getTC_2_4_4() {  return this.TC_2_4_4;}
    @JsonProperty("TC-2-4-4")
    public void setTC_2_4_4(final String TC_2_4_4) { this.TC_2_4_4=TC_2_4_4;}
    @Column(name = "TC_2_4_4_1")
    @JsonProperty("TC-2-4-4-1")
    private String TC_2_4_4_1; // 其他甲状腺全切除+淋巴结清扫手术适应证
    public String getTC_2_4_4_1() {  return this.TC_2_4_4_1;}
    @JsonProperty("TC-2-4-4-1")
    public void setTC_2_4_4_1(final String TC_2_4_4_1) { this.TC_2_4_4_1=TC_2_4_4_1;}
    @Column(name = "TC_2_5_1")
    @JsonProperty("TC-2-5-1")
    private String TC_2_5_1; // 是否进行术中快速病理
    public String getTC_2_5_1() {  return this.TC_2_5_1;}
    @JsonProperty("TC-2-5-1")
    public void setTC_2_5_1(final String TC_2_5_1) { this.TC_2_5_1=TC_2_5_1;}
    @Column(name = "TC_2_5_2")
    @JsonProperty("TC-2-5-2")
    private String TC_2_5_2; // 术中冰冻病理学检查证实有颈侧区淋巴结转移
    public String getTC_2_5_2() {  return this.TC_2_5_2;}
    @JsonProperty("TC-2-5-2")
    public void setTC_2_5_2(final String TC_2_5_2) { this.TC_2_5_2=TC_2_5_2;}
    @Column(name = "TC_2_5_3")
    @JsonProperty("TC-2-5-3")
    private String TC_2_5_3; // 清扫淋巴结手术部位
    public String getTC_2_5_3() {  return this.TC_2_5_3;}
    @JsonProperty("TC-2-5-3")
    public void setTC_2_5_3(final String TC_2_5_3) { this.TC_2_5_3=TC_2_5_3;}
    @Column(name = "TC_2_5_4")
    @JsonProperty("TC-2-5-4")
    private String TC_2_5_4; // 淋巴结清扫范围
    public String getTC_2_5_4() {  return this.TC_2_5_4;}
    @JsonProperty("TC-2-5-4")
    public void setTC_2_5_4(final String TC_2_5_4) { this.TC_2_5_4=TC_2_5_4;}
    @Column(name = "TC_2_5_4_1")
    @JsonProperty("TC-2-5-4-1")
    private String TC_2_5_4_1; // 其他淋巴结清扫范围
    public String getTC_2_5_4_1() {  return this.TC_2_5_4_1;}
    @JsonProperty("TC-2-5-4-1")
    public void setTC_2_5_4_1(final String TC_2_5_4_1) { this.TC_2_5_4_1=TC_2_5_4_1;}
    @Column(name = "CM_2_1")
    @JsonProperty("CM-2-1")
    ...
    public String getTC_3_2_2() {  return this.TC_3_2_2;}
    @JsonProperty("TC-3-2-2")
    public void setTC_3_2_2(final String TC_3_2_2) { this.TC_3_2_2=TC_3_2_2;}
    @Column(name = "TC_3_2_2_1")
    @JsonProperty("TC-3-2-2-1")
    private String TC_3_2_2_1; // 其他甲状腺手术后特指并发症
    public String getTC_3_2_2_1() {  return this.TC_3_2_2_1;}
    @JsonProperty("TC-3-2-2-1")
    public void setTC_3_2_2_1(final String TC_3_2_2_1) { this.TC_3_2_2_1=TC_3_2_2_1;}
    @Column(name = "CM_2_4")
    @JsonProperty("CM-2-4")
    ...
    public String getTC_3_2_1() {  return this.TC_3_2_1;}
    @JsonProperty("TC-3-2-1")
    public void setTC_3_2_1(final String TC_3_2_1) { this.TC_3_2_1=TC_3_2_1;}
    @Column(name = "TC_3_2_3")
    @JsonProperty("TC-3-2-3")
    private String TC_3_2_3; // 非计划二次手术可能的原因
    public String getTC_3_2_3() {  return this.TC_3_2_3;}
    @JsonProperty("TC-3-2-3")
    public void setTC_3_2_3(final String TC_3_2_3) { this.TC_3_2_3=TC_3_2_3;}
    @Column(name = "TC_3_2_3_1")
    @JsonProperty("TC-3-2-3-1")
    private String TC_3_2_3_1; // 非计划二次手术其他原因
    public String getTC_3_2_3_1() {  return this.TC_3_2_3_1;}
    @JsonProperty("TC-3-2-3-1")
    public void setTC_3_2_3_1(final String TC_3_2_3_1) { this.TC_3_2_3_1=TC_3_2_3_1;}
    @Column(name = "TC_3_2_4")
    @JsonProperty("TC-3-2-4")
    private String TC_3_2_4; // 手术开始（切皮）日期时间 
    public String getTC_3_2_4() {  return this.TC_3_2_4;}
    @JsonProperty("TC-3-2-4")
    public void setTC_3_2_4(final String TC_3_2_4) { this.TC_3_2_4=TC_3_2_4;}
    @Column(name = "TC_3_2_5")
    @JsonProperty("TC-3-2-5")
    private String TC_3_2_5; // 手术结束（缝皮结束）日期时间
    public String getTC_3_2_5() {  return this.TC_3_2_5;}
    @JsonProperty("TC-3-2-5")
    public void setTC_3_2_5(final String TC_3_2_5) { this.TC_3_2_5=TC_3_2_5;}
    ...
    public String getTC_5_1_1() {  return this.TC_5_1_1;}
    @JsonProperty("TC-5-1-1")
    public void setTC_5_1_1(final String TC_5_1_1) { this.TC_5_1_1=TC_5_1_1;}
    @Column(name = "TC_5_1_2_0")
    @JsonProperty("TC-5-1-2-0")
    private String TC_5_1_2_0; // 病理诊断结论
    public String getTC_5_1_2_0() {  return this.TC_5_1_2_0;}
    @JsonProperty("TC-5-1-2-0")
    public void setTC_5_1_2_0(final String TC_5_1_2_0) { this.TC_5_1_2_0=TC_5_1_2_0;}
    @Column(name = "TC_5_1_2")
    @JsonProperty("TC-5-1-2")
    private String TC_5_1_2; // 乳头状甲状腺癌
    public String getTC_5_1_2() {  return this.TC_5_1_2;}
    @JsonProperty("TC-5-1-2")
    public void setTC_5_1_2(final String TC_5_1_2) { this.TC_5_1_2=TC_5_1_2;}
    @Column(name = "TC_5_1_3")
    @JsonProperty("TC-5-1-3")
    private String TC_5_1_3; // 滤泡性甲状腺癌
    public String getTC_5_1_3() {  return this.TC_5_1_3;}
    @JsonProperty("TC-5-1-3")
    public void setTC_5_1_3(final String TC_5_1_3) { this.TC_5_1_3=TC_5_1_3;}
    @Column(name = "TC_5_1_4")
    @JsonProperty("TC-5-1-4")
    private String TC_5_1_4; // 乳头状甲状腺癌
    public String getTC_5_1_4() {  return this.TC_5_1_4;}
    @JsonProperty("TC-5-1-4")
    public void setTC_5_1_4(final String TC_5_1_4) { this.TC_5_1_4=TC_5_1_4;}
    @Column(name = "TC_5_1_5")
    @JsonProperty("TC-5-1-5")
    private String TC_5_1_5; // 乳头状甲状腺癌
    public String getTC_5_1_5() {  return this.TC_5_1_5;}
    @JsonProperty("TC-5-1-5")
    public void setTC_5_1_5(final String TC_5_1_5) { this.TC_5_1_5=TC_5_1_5;}
    @Column(name = "TC_5_1_6")
    @JsonProperty("TC-5-1-6")
    private String TC_5_1_6; // 滤泡性甲状腺癌
    public String getTC_5_1_6() {  return this.TC_5_1_6;}
    @JsonProperty("TC-5-1-6")
    public void setTC_5_1_6(final String TC_5_1_6) { this.TC_5_1_6=TC_5_1_6;}
    @Column(name = "TC_5_1_7")
    @JsonProperty("TC-5-1-7")
    private String TC_5_1_7; // 是否进行促甲状腺素(TSH)检测
    public String getTC_5_1_7() {  return this.TC_5_1_7;}
    @JsonProperty("TC-5-1-7")
    public void setTC_5_1_7(final String TC_5_1_7) { this.TC_5_1_7=TC_5_1_7;}
    @Column(name = "TC_5_1_8")
    @JsonProperty("TC-5-1-8")
    private String TC_5_1_8; // 促甲状腺素(TSH)检测结果(mIU/ L )
    public String getTC_5_1_8() {  return this.TC_5_1_8;}
    @JsonProperty("TC-5-1-8")
    public void setTC_5_1_8(final String TC_5_1_8) { this.TC_5_1_8=TC_5_1_8;}
    @Column(name = "TC_5_2_1")
    @JsonProperty("TC-5-2-1")
    private String TC_5_2_1; // 术后内分泌抑制治疗适应证的选择
    public String getTC_5_2_1() {  return this.TC_5_2_1;}
    @JsonProperty("TC-5-2-1")
    public void setTC_5_2_1(final String TC_5_2_1) { this.TC_5_2_1=TC_5_2_1;}
    @Column(name = "TC_5_2_1_1")
    @JsonProperty("TC-5-2-1-1")
    private String TC_5_2_1_1; // 其他术后内分泌抑制治疗适应证
    public String getTC_5_2_1_1() {  return this.TC_5_2_1_1;}
    @JsonProperty("TC-5-2-1-1")
    public void setTC_5_2_1_1(final String TC_5_2_1_1) { this.TC_5_2_1_1=TC_5_2_1_1;}
    @Column(name = "TC_5_2_2")
    @JsonProperty("TC-5-2-2")
    private String TC_5_2_2; // 是否进行内分泌抑制治疗
    public String getTC_5_2_2() {  return this.TC_5_2_2;}
    @JsonProperty("TC-5-2-2")
    public void setTC_5_2_2(final String TC_5_2_2) { this.TC_5_2_2=TC_5_2_2;}
    @Column(name = "TC_5_2_3")
    @JsonProperty("TC-5-2-3")
    private String TC_5_2_3; // 促甲状腺素(TSH)抑制剂的选择
    public String getTC_5_2_3() {  return this.TC_5_2_3;}
    @JsonProperty("TC-5-2-3")
    public void setTC_5_2_3(final String TC_5_2_3) { this.TC_5_2_3=TC_5_2_3;}
    @Column(name = "TC_5_2_3_1")
    @JsonProperty("TC-5-2-3-1")
    private String TC_5_2_3_1; // 其他促甲状腺素(TSH)抑制剂
    public String getTC_5_2_3_1() {  return this.TC_5_2_3_1;}
    @JsonProperty("TC-5-2-3-1")
    public void setTC_5_2_3_1(final String TC_5_2_3_1) { this.TC_5_2_3_1=TC_5_2_3_1;}
    @Column(name = "TC_5_2_4")
    @JsonProperty("TC-5-2-4")
    private String TC_5_2_4; // 治疗并发症的选择
    public String getTC_5_2_4() {  return this.TC_5_2_4;}
    @JsonProperty("TC-5-2-4")
    public void setTC_5_2_4(final String TC_5_2_4) { this.TC_5_2_4=TC_5_2_4;}
    @Column(name = "TC_5_2_4_1")
    @JsonProperty("TC-5-2-4-1")
    private String TC_5_2_4_1; // 其他治疗并发症
    public String getTC_5_2_4_1() {  return this.TC_5_2_4_1;}
    @JsonProperty("TC-5-2-4-1")
    public void setTC_5_2_4_1(final String TC_5_2_4_1) { this.TC_5_2_4_1=TC_5_2_4_1;}
    @Column(name = "TC_5_2_5")
    @JsonProperty("TC-5-2-5")
    private String TC_5_2_5; // 术后核素治疗适应证的选择
    public String getTC_5_2_5() {  return this.TC_5_2_5;}
    @JsonProperty("TC-5-2-5")
    public void setTC_5_2_5(final String TC_5_2_5) { this.TC_5_2_5=TC_5_2_5;}
    @Column(name = "TC_5_2_5_1")
    @JsonProperty("TC-5-2-5-1")
    private String TC_5_2_5_1; // 其他术后核素治疗适应证
    public String getTC_5_2_5_1() {  return this.TC_5_2_5_1;}
    @JsonProperty("TC-5-2-5-1")
    public void setTC_5_2_5_1(final String TC_5_2_5_1) { this.TC_5_2_5_1=TC_5_2_5_1;}
    @Column(name = "TC_5_2_6")
    @JsonProperty("TC-5-2-6")
    private String TC_5_2_6; // 是否进行术后核素治疗
    public String getTC_5_2_6() {  return this.TC_5_2_6;}
    @JsonProperty("TC-5-2-6")
    public void setTC_5_2_6(final String TC_5_2_6) { this.TC_5_2_6=TC_5_2_6;}
    @Column(name = "TC_6_1")
    @JsonProperty("TC-6-1")
    private String TC_6_1; // 是否输血
    public String getTC_6_1() {  return this.TC_6_1;}
    @JsonProperty("TC-6-1")
    public void setTC_6_1(final String TC_6_1) { this.TC_6_1=TC_6_1;}
    @Column(name = "TC_6_1_1")
    @JsonProperty("TC-6-1-1")
    private String TC_6_1_1; // 出血量(ml)
    public String getTC_6_1_1() {  return this.TC_6_1_1;}
    @JsonProperty("TC-6-1-1")
    public void setTC_6_1_1(final String TC_6_1_1) { this.TC_6_1_1=TC_6_1_1;}
    @Column(name = "TC_6_1_2")
    @JsonProperty("TC-6-1-2")
    private String TC_6_1_2; // 输血量(ml)
    public String getTC_6_1_2() {  return this.TC_6_1_2;}
    @JsonProperty("TC-6-1-2")
    public void setTC_6_1_2(final String TC_6_1_2) { this.TC_6_1_2=TC_6_1_2;}
    @Column(name = "TC_6_2_1")
    @JsonProperty("TC-6-2-1")
    private String TC_6_2_1; // 出血量(ml)
    public String getTC_6_2_1() {  return this.TC_6_2_1;}
    @JsonProperty("TC-6-2-1")
    public void setTC_6_2_1(final String TC_6_2_1) { this.TC_6_2_1=TC_6_2_1;}
    @Column(name = "TC_6_2_2")
    @JsonProperty("TC-6-2-2")
    private String TC_6_2_2; // 输血量(ml)
    public String getTC_6_2_2() {  return this.TC_6_2_2;}
    @JsonProperty("TC-6-2-2")
    public void setTC_6_2_2(final String TC_6_2_2) { this.TC_6_2_2=TC_6_2_2;}
    ...
    public String getTC_7_2_1() {  return this.TC_7_2_1;}
    @JsonProperty("TC-7-2-1")
    public void setTC_7_2_1(final String TC_7_2_1) { this.TC_7_2_1=TC_7_2_1;}
    @Column(name = "TC_7_2_2")
    @JsonProperty("TC-7-2-2")
    private String TC_7_2_2; // 告知甲状腺癌复发风险评估结果
    public String getTC_7_2_2() {  return this.TC_7_2_2;}
    @JsonProperty("TC-7-2-2")
    public void setTC_7_2_2(final String TC_7_2_2) { this.TC_7_2_2=TC_7_2_2;}
