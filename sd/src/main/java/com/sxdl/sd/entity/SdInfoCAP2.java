...
public class SdInfoCAP2 implements Serializable {
    ...
    public String getCap_0_1_4_1() {  return this.Cap_0_1_4_1;}
    @JsonProperty("Cap-0-1-4-1")
    public void setCap_0_1_4_1(final String Cap_0_1_4_1) { this.Cap_0_1_4_1=Cap_0_1_4_1;}
    ...
    public String getCap_0_1_5_1() {  return this.Cap_0_1_5_1;}
    @JsonProperty("Cap-0-1-5-1")
    public void setCap_0_1_5_1(final String Cap_0_1_5_1) { this.Cap_0_1_5_1=Cap_0_1_5_1;}
    ...
    @Column(name = "Cap_0_2_1_3")
    @JsonProperty("Cap-0-2-1-3")
    private String Cap_0_2_1_3; // 年龄(月)
    public String getCap_0_2_1_3() {  return this.Cap_0_2_1_3;}
    @JsonProperty("Cap-0-2-1-3")
    public void setCap_0_2_1_3(final String Cap_0_2_1_3) { this.Cap_0_2_1_3=Cap_0_2_1_3;}
    @Column(name = "Cap_0_2_1_2")
    @JsonProperty("Cap-0-2-1-2")
    private String Cap_0_2_1_2; // 年龄分组
    public String getCap_0_2_1_2() {  return this.Cap_0_2_1_2;}
    @JsonProperty("Cap-0-2-1-2")
    public void setCap_0_2_1_2(final String Cap_0_2_1_2) { this.Cap_0_2_1_2=Cap_0_2_1_2;}
    ...
    public String getCap_1_1_0() {  return this.Cap_1_1_0;}
    @JsonProperty("Cap-1-1-0")
    public void setCap_1_1_0(final String Cap_1_1_0) { this.Cap_1_1_0=Cap_1_1_0;}
    @Column(name = "Cap_1_1_1")
    @JsonProperty("Cap-1-1-1")
    private String Cap_1_1_1; // 重症肺炎的高危因素
    public String getCap_1_1_1() {  return this.Cap_1_1_1;}
    @JsonProperty("Cap-1-1-1")
    public void setCap_1_1_1(final String Cap_1_1_1) { this.Cap_1_1_1=Cap_1_1_1;}
    @Column(name = "Cap_1_1_1_1")
    @JsonProperty("Cap-1-1-1-1")
    private String Cap_1_1_1_1; // 其他高危因素
    public String getCap_1_1_1_1() {  return this.Cap_1_1_1_1;}
    @JsonProperty("Cap-1-1-1-1")
    public void setCap_1_1_1_1(final String Cap_1_1_1_1) { this.Cap_1_1_1_1=Cap_1_1_1_1;}
    @Column(name = "Cap_1_1_2")
    @JsonProperty("Cap-1-1-2")
    private String Cap_1_1_2; // 符合重症肺炎
    public String getCap_1_1_2() {  return this.Cap_1_1_2;}
    @JsonProperty("Cap-1-1-2")
    public void setCap_1_1_2(final String Cap_1_1_2) { this.Cap_1_1_2=Cap_1_1_2;}
    @Column(name = "Cap_1_2_1")
    @JsonProperty("Cap-1-2-1")
    private String Cap_1_2_1; // 是否为重症住院及住ICU/RCU患儿
    public String getCap_1_2_1() {  return this.Cap_1_2_1;}
    @JsonProperty("Cap-1-2-1")
    public void setCap_1_2_1(final String Cap_1_2_1) { this.Cap_1_2_1=Cap_1_2_1;}
    @Column(name = "Cap_1_2_2")
    @JsonProperty("Cap-1-2-2")
    private String Cap_1_2_2; // 重度肺炎表现
    public String getCap_1_2_2() {  return this.Cap_1_2_2;}
    @JsonProperty("Cap-1-2-2")
    public void setCap_1_2_2(final String Cap_1_2_2) { this.Cap_1_2_2=Cap_1_2_2;}
    @Column(name = "Cap_1_2_3")
    @JsonProperty("Cap-1-2-3")
    private String Cap_1_2_3; // 符合重症住院及住ICU/RCU标准
    public String getCap_1_2_3() {  return this.Cap_1_2_3;}
    @JsonProperty("Cap-1-2-3")
    public void setCap_1_2_3(final String Cap_1_2_3) { this.Cap_1_2_3=Cap_1_2_3;}
    @Column(name = "Cap_1_3_1")
    @JsonProperty("Cap-1-3-1")
    private String Cap_1_3_1; // 是否接种肺炎链球菌疫苗和（或）流感疫苗的
    public String getCap_1_3_1() {  return this.Cap_1_3_1;}
    @JsonProperty("Cap-1-3-1")
    public void setCap_1_3_1(final String Cap_1_3_1) { this.Cap_1_3_1=Cap_1_3_1;}
    @Column(name = "Cap_1_1_3")
    @JsonProperty("Cap-1-1-3")
    private String Cap_1_1_3; // 符合以下情况之一,需住院
    public String getCap_1_1_3() {  return this.Cap_1_1_3;}
    @JsonProperty("Cap-1-1-3")
    public void setCap_1_1_3(final String Cap_1_1_3) { this.Cap_1_1_3=Cap_1_1_3;}
    @Column(name = "Cap_2_1")
    @JsonProperty("Cap-2-1")
    private String Cap_2_1; // 实施首次氧合评估（首次）
    public String getCap_2_1() {  return this.Cap_2_1;}
    @JsonProperty("Cap-2-1")
    public void setCap_2_1(final String Cap_2_1) { this.Cap_2_1=Cap_2_1;}
    @Column(name = "Cap_2_2")
    @JsonProperty("Cap-2-2")
    private String Cap_2_2; // 实施首次氧合评估时段
    public String getCap_2_2() {  return this.Cap_2_2;}
    @JsonProperty("Cap-2-2")
    public void setCap_2_2(final String Cap_2_2) { this.Cap_2_2=Cap_2_2;}
    @Column(name = "Cap_2_3")
    @JsonProperty("Cap-2-3")
    private String Cap_2_3; // 实施首次氧合评估时是否吸氧（FiO₂）
    public String getCap_2_3() {  return this.Cap_2_3;}
    @JsonProperty("Cap-2-3")
    public void setCap_2_3(final String Cap_2_3) { this.Cap_2_3=Cap_2_3;}
    @Column(name = "Cap_2_4")
    @JsonProperty("Cap-2-4")
    private String Cap_2_4; // 动脉血气分析/指氧仪检查
    public String getCap_2_4() {  return this.Cap_2_4;}
    @JsonProperty("Cap-2-4")
    public void setCap_2_4(final String Cap_2_4) { this.Cap_2_4=Cap_2_4;}
    @Column(name = "Cap_2_4_3")
    @JsonProperty("Cap-2-4-3")
    private String Cap_2_4_3; // 动脉血气分析值(mmHg)
    public String getCap_2_4_3() {  return this.Cap_2_4_3;}
    @JsonProperty("Cap-2-4-3")
    public void setCap_2_4_3(final String Cap_2_4_3) { this.Cap_2_4_3=Cap_2_4_3;}
    @Column(name = "Cap_2_4_5")
    @JsonProperty("Cap-2-4-5")
    private String Cap_2_4_5; // 动脉血气分析值是否在正常范围
    public String getCap_2_4_5() {  return this.Cap_2_4_5;}
    @JsonProperty("Cap-2-4-5")
    public void setCap_2_4_5(final String Cap_2_4_5) { this.Cap_2_4_5=Cap_2_4_5;}
    @Column(name = "Cap_2_4_4")
    @JsonProperty("Cap-2-4-4")
    private String Cap_2_4_4; // 指氧仪检查值(%)
    public String getCap_2_4_4() {  return this.Cap_2_4_4;}
    @JsonProperty("Cap-2-4-4")
    public void setCap_2_4_4(final String Cap_2_4_4) { this.Cap_2_4_4=Cap_2_4_4;}
    @Column(name = "Cap_2_4_6")
    @JsonProperty("Cap-2-4-6")
    private String Cap_2_4_6; // 指氧仪检查值是否在正常范围
    public String getCap_2_4_6() {  return this.Cap_2_4_6;}
    @JsonProperty("Cap-2-4-6")
    public void setCap_2_4_6(final String Cap_2_4_6) { this.Cap_2_4_6=Cap_2_4_6;}
    @Column(name = "Cap_3_1_1")
    @JsonProperty("Cap-3-1-1")
    private String Cap_3_1_1; // 患儿是否采集标本
    public String getCap_3_1_1() {  return this.Cap_3_1_1;}
    @JsonProperty("Cap-3-1-1")
    public void setCap_3_1_1(final String Cap_3_1_1) { this.Cap_3_1_1=Cap_3_1_1;}
    @Column(name = "Cap_3_2_1")
    @JsonProperty("Cap-3-2-1")
    private String Cap_3_2_1; // 是否入院之前已经接受抗菌药物治疗
    public String getCap_3_2_1() {  return this.Cap_3_2_1;}
    @JsonProperty("Cap-3-2-1")
    public void setCap_3_2_1(final String Cap_3_2_1) { this.Cap_3_2_1=Cap_3_2_1;}
    @Column(name = "Cap_3_2_2")
    @JsonProperty("Cap-3-2-2")
    private String Cap_3_2_2; // 实施首次采集标本时段
    public String getCap_3_2_2() {  return this.Cap_3_2_2;}
    @JsonProperty("Cap-3-2-2")
    public void setCap_3_2_2(final String Cap_3_2_2) { this.Cap_3_2_2=Cap_3_2_2;}
    @Column(name = "Cap_3_2_3")
    @JsonProperty("Cap-3-2-3")
    private String Cap_3_2_3; // 首次采集标本种类
    public String getCap_3_2_3() {  return this.Cap_3_2_3;}
    @JsonProperty("Cap-3-2-3")
    public void setCap_3_2_3(final String Cap_3_2_3) { this.Cap_3_2_3=Cap_3_2_3;}
    @Column(name = "Cap_3_2_4")
    @JsonProperty("Cap-3-2-4")
    private String Cap_3_2_4; // 采集标本日期时间
    public String getCap_3_2_4() {  return this.Cap_3_2_4;}
    @JsonProperty("Cap-3-2-4")
    public void setCap_3_2_4(final String Cap_3_2_4) { this.Cap_3_2_4=Cap_3_2_4;}
    @Column(name = "Cap_3_3_1")
    @JsonProperty("Cap-3-3-1")
    private String Cap_3_3_1; // 细菌学检查项目的选择
    public String getCap_3_3_1() {  return this.Cap_3_3_1;}
    @JsonProperty("Cap-3-3-1")
    public void setCap_3_3_1(final String Cap_3_3_1) { this.Cap_3_3_1=Cap_3_3_1;}
    @Column(name = "Cap_3_3_1_1")
    @JsonProperty("Cap-3-3-1-1")
    private String Cap_3_3_1_1; // 其他细菌学检查项目
    public String getCap_3_3_1_1() {  return this.Cap_3_3_1_1;}
    @JsonProperty("Cap-3-3-1-1")
    public void setCap_3_3_1_1(final String Cap_3_3_1_1) { this.Cap_3_3_1_1=Cap_3_3_1_1;}
    @Column(name = "Cap_3_3_2")
    @JsonProperty("Cap-3-3-2")
    private String Cap_3_3_2; // 病毒学检查项目的选择 
    public String getCap_3_3_2() {  return this.Cap_3_3_2;}
    @JsonProperty("Cap-3-3-2")
    public void setCap_3_3_2(final String Cap_3_3_2) { this.Cap_3_3_2=Cap_3_3_2;}
    @Column(name = "Cap_3_3_2_1")
    @JsonProperty("Cap-3-3-2-1")
    private String Cap_3_3_2_1; // 其他病毒学检查项目
    public String getCap_3_3_2_1() {  return this.Cap_3_3_2_1;}
    @JsonProperty("Cap-3-3-2-1")
    public void setCap_3_3_2_1(final String Cap_3_3_2_1) { this.Cap_3_3_2_1=Cap_3_3_2_1;}
    @Column(name = "Cap_3_3_3")
    @JsonProperty("Cap-3-3-3")
    private String Cap_3_3_3; // 肺炎支原体检查项目的选择
    public String getCap_3_3_3() {  return this.Cap_3_3_3;}
    @JsonProperty("Cap-3-3-3")
    public void setCap_3_3_3(final String Cap_3_3_3) { this.Cap_3_3_3=Cap_3_3_3;}
    @Column(name = "Cap_3_3_3_1")
    @JsonProperty("Cap-3-3-3-1")
    private String Cap_3_3_3_1; // 其他肺炎支原体检查项目
    public String getCap_3_3_3_1() {  return this.Cap_3_3_3_1;}
    @JsonProperty("Cap-3-3-3-1")
    public void setCap_3_3_3_1(final String Cap_3_3_3_1) { this.Cap_3_3_3_1=Cap_3_3_3_1;}
    @Column(name = "Cap_3_4_4")
    @JsonProperty("Cap-3-4-4")
    private String Cap_3_4_4; // 是否进行实验室检查
    public String getCap_3_4_4() {  return this.Cap_3_4_4;}
    @JsonProperty("Cap-3-4-4")
    public void setCap_3_4_4(final String Cap_3_4_4) { this.Cap_3_4_4=Cap_3_4_4;}
    @Column(name = "Cap_3_4_2")
    @JsonProperty("Cap-3-4-2")
    private String Cap_3_4_2; // 临床实验室检查项目的选择 
    public String getCap_3_4_2() {  return this.Cap_3_4_2;}
    @JsonProperty("Cap-3-4-2")
    public void setCap_3_4_2(final String Cap_3_4_2) { this.Cap_3_4_2=Cap_3_4_2;}
    @Column(name = "Cap_3_4_2_1")
    @JsonProperty("Cap-3-4-2-1")
    private String Cap_3_4_2_1; // 其他临床实验室检查项目
    public String getCap_3_4_2_1() {  return this.Cap_3_4_2_1;}
    @JsonProperty("Cap-3-4-2-1")
    public void setCap_3_4_2_1(final String Cap_3_4_2_1) { this.Cap_3_4_2_1=Cap_3_4_2_1;}
    @Column(name = "Cap_3_5_1")
    @JsonProperty("Cap-3-5-1")
    private String Cap_3_5_1; // 病原学检测结果
    public String getCap_3_5_1() {  return this.Cap_3_5_1;}
    @JsonProperty("Cap-3-5-1")
    public void setCap_3_5_1(final String Cap_3_5_1) { this.Cap_3_5_1=Cap_3_5_1;}
    @Column(name = "Cap_3_5_1_1")
    @JsonProperty("Cap-3-5-1-1")
    private String Cap_3_5_1_1; // 其他病原学检测结果
    public String getCap_3_5_1_1() {  return this.Cap_3_5_1_1;}
    @JsonProperty("Cap-3-5-1-1")
    public void setCap_3_5_1_1(final String Cap_3_5_1_1) { this.Cap_3_5_1_1=Cap_3_5_1_1;}
    @Column(name = "Cap_3_5_2")
    @JsonProperty("Cap-3-5-2")
    private String Cap_3_5_2; // 获得病原学诊断报告结果的日期时间
    public String getCap_3_5_2() {  return this.Cap_3_5_2;}
    @JsonProperty("Cap-3-5-2")
    public void setCap_3_5_2(final String Cap_3_5_2) { this.Cap_3_5_2=Cap_3_5_2;}
    @Column(name = "Cap_4_0")
    @JsonProperty("Cap-4-0")
    private String Cap_4_0; // 患儿有无接受抗菌药物治疗
    public String getCap_4_0() {  return this.Cap_4_0;}
    @JsonProperty("Cap-4-0")
    public void setCap_4_0(final String Cap_4_0) { this.Cap_4_0=Cap_4_0;}
    @Column(name = "Cap_4_1_4")
    @JsonProperty("Cap-4-1-4")
    private String Cap_4_1_4; // 使用首剂抗菌药物治疗途径
    public String getCap_4_1_4() {  return this.Cap_4_1_4;}
    @JsonProperty("Cap-4-1-4")
    public void setCap_4_1_4(final String Cap_4_1_4) { this.Cap_4_1_4=Cap_4_1_4;}
    @Column(name = "Cap_4_1_2")
    @JsonProperty("Cap-4-1-2")
    private String Cap_4_1_2; // 患儿入院后接受首剂抗菌药物治疗（注射剂输入/注射）时间
    public String getCap_4_1_2() {  return this.Cap_4_1_2;}
    @JsonProperty("Cap-4-1-2")
    public void setCap_4_1_2(final String Cap_4_1_2) { this.Cap_4_1_2=Cap_4_1_2;}
    @Column(name = "Cap_4_1_1_r")
    @JsonProperty("Cap-4-1-1-r")
    private String Cap_4_1_1_r; // 自动赋值规则(h)
    public String getCap_4_1_1_r() {  return this.Cap_4_1_1_r;}
    @JsonProperty("Cap-4-1-1-r")
    public void setCap_4_1_1_r(final String Cap_4_1_1_r) { this.Cap_4_1_1_r=Cap_4_1_1_r;}
    @Column(name = "Cap_4_1_3")
    @JsonProperty("Cap-4-1-3")
    private String Cap_4_1_3; // 接受入院后首剂抗菌药物使用时机 DTN
    public String getCap_4_1_3() {  return this.Cap_4_1_3;}
    @JsonProperty("Cap-4-1-3")
    public void setCap_4_1_3(final String Cap_4_1_3) { this.Cap_4_1_3=Cap_4_1_3;}
    @Column(name = "Cap_4_1_5")
    @JsonProperty("Cap-4-1-5")
    private String Cap_4_1_5; // 抗菌药物注射剂输入/注射治疗终止日期与时间
    public String getCap_4_1_5() {  return this.Cap_4_1_5;}
    @JsonProperty("Cap-4-1-5")
    public void setCap_4_1_5(final String Cap_4_1_5) { this.Cap_4_1_5=Cap_4_1_5;}
    @Column(name = "Cap_4_2_1")
    @JsonProperty("Cap-4-2-1")
    private String Cap_4_2_1; // 是否抗菌药物注射剂改口服
    public String getCap_4_2_1() {  return this.Cap_4_2_1;}
    @JsonProperty("Cap-4-2-1")
    public void setCap_4_2_1(final String Cap_4_2_1) { this.Cap_4_2_1=Cap_4_2_1;}
    @Column(name = "Cap_4_2_2")
    @JsonProperty("Cap-4-2-2")
    private String Cap_4_2_2; // 抗菌药物注射剂改口服日期与时间
    public String getCap_4_2_2() {  return this.Cap_4_2_2;}
    @JsonProperty("Cap-4-2-2")
    public void setCap_4_2_2(final String Cap_4_2_2) { this.Cap_4_2_2=Cap_4_2_2;}
    @Column(name = "Cap_5_1_1")
    @JsonProperty("Cap-5-1-1")
    private String Cap_5_1_1; // 拟诊需抗感染治疗肺炎缘由
    public String getCap_5_1_1() {  return this.Cap_5_1_1;}
    @JsonProperty("Cap-5-1-1")
    public void setCap_5_1_1(final String Cap_5_1_1) { this.Cap_5_1_1=Cap_5_1_1;}
    @Column(name = "Cap_5_1_1_1")
    @JsonProperty("Cap-5-1-1-1")
    private String Cap_5_1_1_1; // 其他类型肺炎
    public String getCap_5_1_1_1() {  return this.Cap_5_1_1_1;}
    @JsonProperty("Cap-5-1-1-1")
    public void setCap_5_1_1_1(final String Cap_5_1_1_1) { this.Cap_5_1_1_1=Cap_5_1_1_1;}
    @Column(name = "Cap_5_1_2")
    @JsonProperty("Cap-5-1-2")
    private String Cap_5_1_2; // 是否需进行抗感染治疗
    public String getCap_5_1_2() {  return this.Cap_5_1_2;}
    @JsonProperty("Cap-5-1-2")
    public void setCap_5_1_2(final String Cap_5_1_2) { this.Cap_5_1_2=Cap_5_1_2;}
    @Column(name = "Cap_5_2_1")
    @JsonProperty("Cap-5-2-1")
    private String Cap_5_2_1; // 抗感染治疗药物选择
    public String getCap_5_2_1() {  return this.Cap_5_2_1;}
    @JsonProperty("Cap-5-2-1")
    public void setCap_5_2_1(final String Cap_5_2_1) { this.Cap_5_2_1=Cap_5_2_1;}
    @Column(name = "Cap_5_2_2")
    @JsonProperty("Cap-5-2-2")
    private String Cap_5_2_2; // 青霉素类抗感染药物
    public String getCap_5_2_2() {  return this.Cap_5_2_2;}
    @JsonProperty("Cap-5-2-2")
    public void setCap_5_2_2(final String Cap_5_2_2) { this.Cap_5_2_2=Cap_5_2_2;}
    @Column(name = "Cap_5_2_2_1")
    @JsonProperty("Cap-5-2-2-1")
    private String Cap_5_2_2_1; // 其它青霉素抗菌药
    public String getCap_5_2_2_1() {  return this.Cap_5_2_2_1;}
    @JsonProperty("Cap-5-2-2-1")
    public void setCap_5_2_2_1(final String Cap_5_2_2_1) { this.Cap_5_2_2_1=Cap_5_2_2_1;}
    @Column(name = "Cap_5_2_3")
    @JsonProperty("Cap-5-2-3")
    private String Cap_5_2_3; // 头孢菌素类抗感染药物
    public String getCap_5_2_3() {  return this.Cap_5_2_3;}
    @JsonProperty("Cap-5-2-3")
    public void setCap_5_2_3(final String Cap_5_2_3) { this.Cap_5_2_3=Cap_5_2_3;}
    @Column(name = "Cap_5_2_3_1")
    @JsonProperty("Cap-5-2-3-1")
    private String Cap_5_2_3_1; // 其它头孢菌素抗菌药
    public String getCap_5_2_3_1() {  return this.Cap_5_2_3_1;}
    @JsonProperty("Cap-5-2-3-1")
    public void setCap_5_2_3_1(final String Cap_5_2_3_1) { this.Cap_5_2_3_1=Cap_5_2_3_1;}
    @Column(name = "Cap_5_2_4")
    @JsonProperty("Cap-5-2-4")
    private String Cap_5_2_4; // 大环内酯类抗感染药物
    public String getCap_5_2_4() {  return this.Cap_5_2_4;}
    @JsonProperty("Cap-5-2-4")
    public void setCap_5_2_4(final String Cap_5_2_4) { this.Cap_5_2_4=Cap_5_2_4;}
    @Column(name = "Cap_5_2_4_1")
    @JsonProperty("Cap-5-2-4-1")
    private String Cap_5_2_4_1; // 其它大环内酯抗菌药
    public String getCap_5_2_4_1() {  return this.Cap_5_2_4_1;}
    @JsonProperty("Cap-5-2-4-1")
    public void setCap_5_2_4_1(final String Cap_5_2_4_1) { this.Cap_5_2_4_1=Cap_5_2_4_1;}
    @Column(name = "Cap_5_2_6")
    @JsonProperty("Cap-5-2-6")
    private String Cap_5_2_6; // 神经氨酸抑制剂
    public String getCap_5_2_6() {  return this.Cap_5_2_6;}
    @JsonProperty("Cap-5-2-6")
    public void setCap_5_2_6(final String Cap_5_2_6) { this.Cap_5_2_6=Cap_5_2_6;}
    @Column(name = "Cap_5_2_6_1")
    @JsonProperty("Cap-5-2-6-1")
    private String Cap_5_2_6_1; // 神经氨酸抑制剂
    public String getCap_5_2_6_1() {  return this.Cap_5_2_6_1;}
    @JsonProperty("Cap-5-2-6-1")
    public void setCap_5_2_6_1(final String Cap_5_2_6_1) { this.Cap_5_2_6_1=Cap_5_2_6_1;}
    @Column(name = "Cap_5_2_6_2")
    @JsonProperty("Cap-5-2-6-2")
    private String Cap_5_2_6_2; // 首剂抗病毒药物治疗日期与时间
    public String getCap_5_2_6_2() {  return this.Cap_5_2_6_2;}
    @JsonProperty("Cap-5-2-6-2")
    public void setCap_5_2_6_2(final String Cap_5_2_6_2) { this.Cap_5_2_6_2=Cap_5_2_6_2;}
    @Column(name = "Cap_5_2_5")
    @JsonProperty("Cap-5-2-5")
    private String Cap_5_2_5; // 其他类抗感染药物
    public String getCap_5_2_5() {  return this.Cap_5_2_5;}
    @JsonProperty("Cap-5-2-5")
    public void setCap_5_2_5(final String Cap_5_2_5) { this.Cap_5_2_5=Cap_5_2_5;}
    @Column(name = "Cap_5_2_5_1")
    @JsonProperty("Cap-5-2-5-1")
    private String Cap_5_2_5_1; // 其他类抗菌药
    public String getCap_5_2_5_1() {  return this.Cap_5_2_5_1;}
    @JsonProperty("Cap-5-2-5-1")
    public void setCap_5_2_5_1(final String Cap_5_2_5_1) { this.Cap_5_2_5_1=Cap_5_2_5_1;}
    @Column(name = "Cap_6_1_1")
    @JsonProperty("Cap-6-1-1")
    private String Cap_6_1_1; // 初始治疗48～72小时后是否进行评价
    public String getCap_6_1_1() {  return this.Cap_6_1_1;}
    @JsonProperty("Cap-6-1-1")
    public void setCap_6_1_1(final String Cap_6_1_1) { this.Cap_6_1_1=Cap_6_1_1;}
    @Column(name = "Cap_6_1_2")
    @JsonProperty("Cap-6-1-2")
    private String Cap_6_1_2; // 评价结论
    public String getCap_6_1_2() {  return this.Cap_6_1_2;}
    @JsonProperty("Cap-6-1-2")
    public void setCap_6_1_2(final String Cap_6_1_2) { this.Cap_6_1_2=Cap_6_1_2;}
    @Column(name = "Cap_6_1_3")
    @JsonProperty("Cap-6-1-3")
    private String Cap_6_1_3; // 初始治疗48~72小时后评价有效者下一步治疗方案
    public String getCap_6_1_3() {  return this.Cap_6_1_3;}
    @JsonProperty("Cap-6-1-3")
    public void setCap_6_1_3(final String Cap_6_1_3) { this.Cap_6_1_3=Cap_6_1_3;}
    @Column(name = "Cap_6_1_4")
    @JsonProperty("Cap-6-1-4")
    private String Cap_6_1_4; // 是否进行重复病原学检查
    public String getCap_6_1_4() {  return this.Cap_6_1_4;}
    @JsonProperty("Cap-6-1-4")
    public void setCap_6_1_4(final String Cap_6_1_4) { this.Cap_6_1_4=Cap_6_1_4;}
    @Column(name = "Cap_6_1_5")
    @JsonProperty("Cap-6-1-5")
    private String Cap_6_1_5; // 初始治疗48~72小时后无效常见原因
    public String getCap_6_1_5() {  return this.Cap_6_1_5;}
    @JsonProperty("Cap-6-1-5")
    public void setCap_6_1_5(final String Cap_6_1_5) { this.Cap_6_1_5=Cap_6_1_5;}
    @Column(name = "Cap_6_1_5_1")
    @JsonProperty("Cap-6-1-5-1")
    private String Cap_6_1_5_1; // 其它原因
    public String getCap_6_1_5_1() {  return this.Cap_6_1_5_1;}
    @JsonProperty("Cap-6-1-5-1")
    public void setCap_6_1_5_1(final String Cap_6_1_5_1) { this.Cap_6_1_5_1=Cap_6_1_5_1;}
    @Column(name = "Cap_6_1_6")
    @JsonProperty("Cap-6-1-6")
    private String Cap_6_1_6; // 病原学检查项目选择
    public String getCap_6_1_6() {  return this.Cap_6_1_6;}
    @JsonProperty("Cap-6-1-6")
    public void setCap_6_1_6(final String Cap_6_1_6) { this.Cap_6_1_6=Cap_6_1_6;}
    @Column(name = "Cap_6_1_6_1")
    @JsonProperty("Cap-6-1-6-1")
    private String Cap_6_1_6_1; // 其它检查
    public String getCap_6_1_6_1() {  return this.Cap_6_1_6_1;}
    @JsonProperty("Cap-6-1-6-1")
    public void setCap_6_1_6_1(final String Cap_6_1_6_1) { this.Cap_6_1_6_1=Cap_6_1_6_1;}
    @Column(name = "Cap_6_1_7")
    @JsonProperty("Cap-6-1-7")
    private String Cap_6_1_7; // 重复病原学诊断结果选择
    public String getCap_6_1_7() {  return this.Cap_6_1_7;}
    @JsonProperty("Cap-6-1-7")
    public void setCap_6_1_7(final String Cap_6_1_7) { this.Cap_6_1_7=Cap_6_1_7;}
    @Column(name = "Cap_6_1_7_1")
    @JsonProperty("Cap-6-1-7-1")
    private String Cap_6_1_7_1; // 其它重复病原学诊断结果
    public String getCap_6_1_7_1() {  return this.Cap_6_1_7_1;}
    @JsonProperty("Cap-6-1-7-1")
    public void setCap_6_1_7_1(final String Cap_6_1_7_1) { this.Cap_6_1_7_1=Cap_6_1_7_1;}
    @Column(name = "Cap_6_1_8")
    @JsonProperty("Cap-6-1-8")
    private String Cap_6_1_8; // 获得病原学诊断报告结果的日期时间
    public String getCap_6_1_8() {  return this.Cap_6_1_8;}
    @JsonProperty("Cap-6-1-8")
    public void setCap_6_1_8(final String Cap_6_1_8) { this.Cap_6_1_8=Cap_6_1_8;}
    @Column(name = "Cap_6_2_1")
    @JsonProperty("Cap-6-2-1")
    private String Cap_6_2_1; // 病原针对性治疗情况
    public String getCap_6_2_1() {  return this.Cap_6_2_1;}
    @JsonProperty("Cap-6-2-1")
    public void setCap_6_2_1(final String Cap_6_2_1) { this.Cap_6_2_1=Cap_6_2_1;}
    @Column(name = "Cap_6_2_2")
    @JsonProperty("Cap-6-2-2")
    private String Cap_6_2_2; // 抗感染治疗药物选择
    public String getCap_6_2_2() {  return this.Cap_6_2_2;}
    @JsonProperty("Cap-6-2-2")
    public void setCap_6_2_2(final String Cap_6_2_2) { this.Cap_6_2_2=Cap_6_2_2;}
    @Column(name = "Cap_6_2_3")
    @JsonProperty("Cap-6-2-3")
    private String Cap_6_2_3; // 青霉素类抗感染药物
    public String getCap_6_2_3() {  return this.Cap_6_2_3;}
    @JsonProperty("Cap-6-2-3")
    public void setCap_6_2_3(final String Cap_6_2_3) { this.Cap_6_2_3=Cap_6_2_3;}
    @Column(name = "Cap_6_2_3_1")
    @JsonProperty("Cap-6-2-3-1")
    private String Cap_6_2_3_1; // 其它青霉素抗菌药
    public String getCap_6_2_3_1() {  return this.Cap_6_2_3_1;}
    @JsonProperty("Cap-6-2-3-1")
    public void setCap_6_2_3_1(final String Cap_6_2_3_1) { this.Cap_6_2_3_1=Cap_6_2_3_1;}
    @Column(name = "Cap_6_2_4")
    @JsonProperty("Cap-6-2-4")
    private String Cap_6_2_4; // 头孢菌素类抗感染药物
    public String getCap_6_2_4() {  return this.Cap_6_2_4;}
    @JsonProperty("Cap-6-2-4")
    public void setCap_6_2_4(final String Cap_6_2_4) { this.Cap_6_2_4=Cap_6_2_4;}
    @Column(name = "Cap_6_2_4_1")
    @JsonProperty("Cap-6-2-4-1")
    private String Cap_6_2_4_1; // 其它头孢菌素抗菌药
    public String getCap_6_2_4_1() {  return this.Cap_6_2_4_1;}
    @JsonProperty("Cap-6-2-4-1")
    public void setCap_6_2_4_1(final String Cap_6_2_4_1) { this.Cap_6_2_4_1=Cap_6_2_4_1;}
    @Column(name = "Cap_6_2_5")
    @JsonProperty("Cap-6-2-5")
    private String Cap_6_2_5; // 大环内酯类抗感染药物
    public String getCap_6_2_5() {  return this.Cap_6_2_5;}
    @JsonProperty("Cap-6-2-5")
    public void setCap_6_2_5(final String Cap_6_2_5) { this.Cap_6_2_5=Cap_6_2_5;}
    @Column(name = "Cap_6_2_5_1")
    @JsonProperty("Cap-6-2-5-1")
    private String Cap_6_2_5_1; // 其它大环内酯抗菌药
    public String getCap_6_2_5_1() {  return this.Cap_6_2_5_1;}
    @JsonProperty("Cap-6-2-5-1")
    public void setCap_6_2_5_1(final String Cap_6_2_5_1) { this.Cap_6_2_5_1=Cap_6_2_5_1;}
    @Column(name = "Cap_6_2_6")
    @JsonProperty("Cap-6-2-6")
    private String Cap_6_2_6; // 其他类抗感染药物
    public String getCap_6_2_6() {  return this.Cap_6_2_6;}
    @JsonProperty("Cap-6-2-6")
    public void setCap_6_2_6(final String Cap_6_2_6) { this.Cap_6_2_6=Cap_6_2_6;}
    @Column(name = "Cap_6_2_6_1")
    @JsonProperty("Cap-6-2-6-1")
    private String Cap_6_2_6_1; // 其他类抗菌药
    public String getCap_6_2_6_1() {  return this.Cap_6_2_6_1;}
    @JsonProperty("Cap-6-2-6-1")
    public void setCap_6_2_6_1(final String Cap_6_2_6_1) { this.Cap_6_2_6_1=Cap_6_2_6_1;}
    @Column(name = "Cap_6_2_7")
    @JsonProperty("Cap-6-2-7")
    private String Cap_6_2_7; // 神经氨酸抑制剂
    public String getCap_6_2_7() {  return this.Cap_6_2_7;}
    @JsonProperty("Cap-6-2-7")
    public void setCap_6_2_7(final String Cap_6_2_7) { this.Cap_6_2_7=Cap_6_2_7;}
    @Column(name = "Cap_6_2_7_1")
    @JsonProperty("Cap-6-2-7-1")
    private String Cap_6_2_7_1; // 神经氨酸抑制剂
    public String getCap_6_2_7_1() {  return this.Cap_6_2_7_1;}
    @JsonProperty("Cap-6-2-7-1")
    public void setCap_6_2_7_1(final String Cap_6_2_7_1) { this.Cap_6_2_7_1=Cap_6_2_7_1;}
    @Column(name = "Cap_7_1_1")
    @JsonProperty("Cap-7-1-1")
    private String Cap_7_1_1; // 是否使用氧疗与呼吸支持治疗
    public String getCap_7_1_1() {  return this.Cap_7_1_1;}
    @JsonProperty("Cap-7-1-1")
    public void setCap_7_1_1(final String Cap_7_1_1) { this.Cap_7_1_1=Cap_7_1_1;}
    @Column(name = "Cap_7_2_1")
    @JsonProperty("Cap-7-2-1")
    private String Cap_7_2_1; // 是否使用氧疗
    public String getCap_7_2_1() {  return this.Cap_7_2_1;}
    @JsonProperty("Cap-7-2-1")
    public void setCap_7_2_1(final String Cap_7_2_1) { this.Cap_7_2_1=Cap_7_2_1;}
    @Column(name = "Cap_7_2_2")
    @JsonProperty("Cap-7-2-2")
    private String Cap_7_2_2; // 氧疗指征
    public String getCap_7_2_2() {  return this.Cap_7_2_2;}
    @JsonProperty("Cap-7-2-2")
    public void setCap_7_2_2(final String Cap_7_2_2) { this.Cap_7_2_2=Cap_7_2_2;}
    @Column(name = "Cap_7_2_5")
    @JsonProperty("Cap-7-2-5")
    private String Cap_7_2_5; // 给予氧疗医嘱
    public String getCap_7_2_5() {  return this.Cap_7_2_5;}
    @JsonProperty("Cap-7-2-5")
    public void setCap_7_2_5(final String Cap_7_2_5) { this.Cap_7_2_5=Cap_7_2_5;}
    @Column(name = "Cap_7_2_5_1")
    @JsonProperty("Cap-7-2-5-1")
    private String Cap_7_2_5_1; // 其他富氧治疗
    public String getCap_7_2_5_1() {  return this.Cap_7_2_5_1;}
    @JsonProperty("Cap-7-2-5-1")
    public void setCap_7_2_5_1(final String Cap_7_2_5_1) { this.Cap_7_2_5_1=Cap_7_2_5_1;}
    @Column(name = "Cap_7_2_6")
    @JsonProperty("Cap-7-2-6")
    private String Cap_7_2_6; // 氧疗起始日期与时间
    public String getCap_7_2_6() {  return this.Cap_7_2_6;}
    @JsonProperty("Cap-7-2-6")
    public void setCap_7_2_6(final String Cap_7_2_6) { this.Cap_7_2_6=Cap_7_2_6;}
    @Column(name = "Cap_7_2_7")
    @JsonProperty("Cap-7-2-7")
    private String Cap_7_2_7; // 氧疗终止日期与时间
    public String getCap_7_2_7() {  return this.Cap_7_2_7;}
    @JsonProperty("Cap-7-2-7")
    public void setCap_7_2_7(final String Cap_7_2_7) { this.Cap_7_2_7=Cap_7_2_7;}
    @Column(name = "Cap_7_2_8")
    @JsonProperty("Cap-7-2-8")
    private String Cap_7_2_8; // 使用氧疗治疗天数
    public String getCap_7_2_8() {  return this.Cap_7_2_8;}
    @JsonProperty("Cap-7-2-8")
    public void setCap_7_2_8(final String Cap_7_2_8) { this.Cap_7_2_8=Cap_7_2_8;}
    @Column(name = "Cap_7_3_1")
    @JsonProperty("Cap-7-3-1")
    private String Cap_7_3_1; // 是否使用无创通气
    public String getCap_7_3_1() {  return this.Cap_7_3_1;}
    @JsonProperty("Cap-7-3-1")
    public void setCap_7_3_1(final String Cap_7_3_1) { this.Cap_7_3_1=Cap_7_3_1;}
    @Column(name = "Cap_7_3_2")
    @JsonProperty("Cap-7-3-2")
    private String Cap_7_3_2; // 无创通气指征
    public String getCap_7_3_2() {  return this.Cap_7_3_2;}
    @JsonProperty("Cap-7-3-2")
    public void setCap_7_3_2(final String Cap_7_3_2) { this.Cap_7_3_2=Cap_7_3_2;}
    @Column(name = "Cap_7_3_3")
    @JsonProperty("Cap-7-3-3")
    private String Cap_7_3_3; // 无创通气治疗起始日期与时间
    public String getCap_7_3_3() {  return this.Cap_7_3_3;}
    @JsonProperty("Cap-7-3-3")
    public void setCap_7_3_3(final String Cap_7_3_3) { this.Cap_7_3_3=Cap_7_3_3;}
    @Column(name = "Cap_7_3_4")
    @JsonProperty("Cap-7-3-4")
    private String Cap_7_3_4; // 无创通气治疗终止日期与时间
    public String getCap_7_3_4() {  return this.Cap_7_3_4;}
    @JsonProperty("Cap-7-3-4")
    public void setCap_7_3_4(final String Cap_7_3_4) { this.Cap_7_3_4=Cap_7_3_4;}
    @Column(name = "Cap_7_3_5")
    @JsonProperty("Cap-7-3-5")
    private String Cap_7_3_5; // 使用无创通气治疗小时数
    public String getCap_7_3_5() {  return this.Cap_7_3_5;}
    @JsonProperty("Cap-7-3-5")
    public void setCap_7_3_5(final String Cap_7_3_5) { this.Cap_7_3_5=Cap_7_3_5;}
    @Column(name = "Cap_7_4_1")
    @JsonProperty("Cap-7-4-1")
    private String Cap_7_4_1; // 是否使用有创机械通气
    public String getCap_7_4_1() {  return this.Cap_7_4_1;}
    @JsonProperty("Cap-7-4-1")
    public void setCap_7_4_1(final String Cap_7_4_1) { this.Cap_7_4_1=Cap_7_4_1;}
    @Column(name = "Cap_7_4_2")
    @JsonProperty("Cap-7-4-2")
    private String Cap_7_4_2; // 机械通气指征
    public String getCap_7_4_2() {  return this.Cap_7_4_2;}
    @JsonProperty("Cap-7-4-2")
    public void setCap_7_4_2(final String Cap_7_4_2) { this.Cap_7_4_2=Cap_7_4_2;}
    @Column(name = "Cap_7_4_3")
    @JsonProperty("Cap-7-4-3")
    private String Cap_7_4_3; // 有创机械通气治疗起始日期与时间
    public String getCap_7_4_3() {  return this.Cap_7_4_3;}
    @JsonProperty("Cap-7-4-3")
    public void setCap_7_4_3(final String Cap_7_4_3) { this.Cap_7_4_3=Cap_7_4_3;}
    @Column(name = "Cap_7_4_4")
    @JsonProperty("Cap-7-4-4")
    private String Cap_7_4_4; // 有创机械通气治疗终止日期与时间
    public String getCap_7_4_4() {  return this.Cap_7_4_4;}
    @JsonProperty("Cap-7-4-4")
    public void setCap_7_4_4(final String Cap_7_4_4) { this.Cap_7_4_4=Cap_7_4_4;}
    @Column(name = "Cap_7_4_5")
    @JsonProperty("Cap-7-4-5")
    private String Cap_7_4_5; // 使用有创机械通气治疗小时数
    public String getCap_7_4_5() {  return this.Cap_7_4_5;}
    @JsonProperty("Cap-7-4-5")
    public void setCap_7_4_5(final String Cap_7_4_5) { this.Cap_7_4_5=Cap_7_4_5;}
    @Column(name = "Cap_7_5_1")
    @JsonProperty("Cap-7-5-1")
    private String Cap_7_5_1; // 是否使用体外膜肺
    public String getCap_7_5_1() {  return this.Cap_7_5_1;}
    @JsonProperty("Cap-7-5-1")
    public void setCap_7_5_1(final String Cap_7_5_1) { this.Cap_7_5_1=Cap_7_5_1;}
    @Column(name = "Cap_7_5_2")
    @JsonProperty("Cap-7-5-2")
    private String Cap_7_5_2; // ECMO指征
    public String getCap_7_5_2() {  return this.Cap_7_5_2;}
    @JsonProperty("Cap-7-5-2")
    public void setCap_7_5_2(final String Cap_7_5_2) { this.Cap_7_5_2=Cap_7_5_2;}
    @Column(name = "Cap_7_5_3")
    @JsonProperty("Cap-7-5-3")
    private String Cap_7_5_3; // 体外膜肺治疗起始日期与时间
    public String getCap_7_5_3() {  return this.Cap_7_5_3;}
    @JsonProperty("Cap-7-5-3")
    public void setCap_7_5_3(final String Cap_7_5_3) { this.Cap_7_5_3=Cap_7_5_3;}
    @Column(name = "Cap_7_5_4")
    @JsonProperty("Cap-7-5-4")
    private String Cap_7_5_4; // 体外膜肺治疗终止日期与时间
    public String getCap_7_5_4() {  return this.Cap_7_5_4;}
    @JsonProperty("Cap-7-5-4")
    public void setCap_7_5_4(final String Cap_7_5_4) { this.Cap_7_5_4=Cap_7_5_4;}
    @Column(name = "Cap_7_5_5")
    @JsonProperty("Cap-7-5-5")
    private String Cap_7_5_5; // 使用体外膜肺治疗小时数
    public String getCap_7_5_5() {  return this.Cap_7_5_5;}
    @JsonProperty("Cap-7-5-5")
    public void setCap_7_5_5(final String Cap_7_5_5) { this.Cap_7_5_5=Cap_7_5_5;}
    ...
    public String getCap_9_1_1_1() {  return this.Cap_9_1_1_1;}
    @JsonProperty("Cap-9-1-1-1")
    public void setCap_9_1_1_1(final String Cap_9_1_1_1) { this.Cap_9_1_1_1=Cap_9_1_1_1;}
    @Column(name = "Cap_9_1_1_2")
    @JsonProperty("Cap-9-1-1-2")
    private String Cap_9_1_1_2; // 其他出院评估
    public String getCap_9_1_1_2() {  return this.Cap_9_1_1_2;}
    @JsonProperty("Cap-9-1-1-2")
    public void setCap_9_1_1_2(final String Cap_9_1_1_2) { this.Cap_9_1_1_2=Cap_9_1_1_2;}
    @Column(name = "Cap_9_2_1")
    @JsonProperty("Cap-9-2-1")
    private String Cap_9_2_1; // 出院前末次氧合评估
    public String getCap_9_2_1() {  return this.Cap_9_2_1;}
    @JsonProperty("Cap-9-2-1")
    public void setCap_9_2_1(final String Cap_9_2_1) { this.Cap_9_2_1=Cap_9_2_1;}
    @Column(name = "Cap_9_2_2")
    @JsonProperty("Cap-9-2-2")
    private String Cap_9_2_2; // 末次氧合评估项目
    public String getCap_9_2_2() {  return this.Cap_9_2_2;}
    @JsonProperty("Cap-9-2-2")
    public void setCap_9_2_2(final String Cap_9_2_2) { this.Cap_9_2_2=Cap_9_2_2;}
    @Column(name = "Cap_9_2_2_1")
    @JsonProperty("Cap-9-2-2-1")
    private String Cap_9_2_2_1; // 末次检测脉搏血氧饱和度测定值(%)
    public String getCap_9_2_2_1() {  return this.Cap_9_2_2_1;}
    @JsonProperty("Cap-9-2-2-1")
    public void setCap_9_2_2_1(final String Cap_9_2_2_1) { this.Cap_9_2_2_1=Cap_9_2_2_1;}
    @Column(name = "Cap_9_2_2_4")
    @JsonProperty("Cap-9-2-2-4")
    private String Cap_9_2_2_4; // 末次检测脉搏血氧饱和度测定值是否在正常范围
    public String getCap_9_2_2_4() {  return this.Cap_9_2_2_4;}
    @JsonProperty("Cap-9-2-2-4")
    public void setCap_9_2_2_4(final String Cap_9_2_2_4) { this.Cap_9_2_2_4=Cap_9_2_2_4;}
    @Column(name = "Cap_9_2_2_2")
    @JsonProperty("Cap-9-2-2-2")
    private String Cap_9_2_2_2; // 末次检测动脉血气分析测定值mmHg(mmHg)
    public String getCap_9_2_2_2() {  return this.Cap_9_2_2_2;}
    @JsonProperty("Cap-9-2-2-2")
    public void setCap_9_2_2_2(final String Cap_9_2_2_2) { this.Cap_9_2_2_2=Cap_9_2_2_2;}
    @Column(name = "Cap_9_2_2_3")
    @JsonProperty("Cap-9-2-2-3")
    private String Cap_9_2_2_3; // 末次检测动脉血气分析测定值是否在正常范围
    public String getCap_9_2_2_3() {  return this.Cap_9_2_2_3;}
    @JsonProperty("Cap-9-2-2-3")
    public void setCap_9_2_2_3(final String Cap_9_2_2_3) { this.Cap_9_2_2_3=Cap_9_2_2_3;}
    @Column(name = "CM_5_1")
    @JsonProperty("CM-5-1")
    ...
    public String getCap_11_1_1() {  return this.Cap_11_1_1;}
    @JsonProperty("Cap-11-1-1")
    public void setCap_11_1_1(final String Cap_11_1_1) { this.Cap_11_1_1=Cap_11_1_1;}
    @Column(name = "Cap_11_1_2")
    @JsonProperty("Cap-11-1-2")
    private String Cap_11_1_2; // 患儿接受末剂抗菌药物治疗注射剂输入/注射日期时间
    public String getCap_11_1_2() {  return this.Cap_11_1_2;}
    @JsonProperty("Cap-11-1-2")
    public void setCap_11_1_2(final String Cap_11_1_2) { this.Cap_11_1_2=Cap_11_1_2;}
    @Column(name = "Cap_11_1_3")
    @JsonProperty("Cap-11-1-3")
    private String Cap_11_1_3; // 注射剂输入/注射抗菌药物疗程（天数）
    public String getCap_11_1_3() {  return this.Cap_11_1_3;}
    @JsonProperty("Cap-11-1-3")
    public void setCap_11_1_3(final String Cap_11_1_3) { this.Cap_11_1_3=Cap_11_1_3;}
    @Column(name = "Cap_11_2_1")
    @JsonProperty("Cap-11-2-1")
    private String Cap_11_2_1; // 是否抗菌药物注射剂改口服
    public String getCap_11_2_1() {  return this.Cap_11_2_1;}
    @JsonProperty("Cap-11-2-1")
    public void setCap_11_2_1(final String Cap_11_2_1) { this.Cap_11_2_1=Cap_11_2_1;}
    @Column(name = "Cap_11_2_2")
    @JsonProperty("Cap-11-2-2")
    private String Cap_11_2_2; // 改用抗菌药物口服剂首剂日期与时间
    public String getCap_11_2_2() {  return this.Cap_11_2_2;}
    @JsonProperty("Cap-11-2-2")
    public void setCap_11_2_2(final String Cap_11_2_2) { this.Cap_11_2_2=Cap_11_2_2;}
    @Column(name = "Cap_11_2_3")
    @JsonProperty("Cap-11-2-3")
    private String Cap_11_2_3; // 末剂抗菌药物口服剂或出院日期与时间
    public String getCap_11_2_3() {  return this.Cap_11_2_3;}
    @JsonProperty("Cap-11-2-3")
    public void setCap_11_2_3(final String Cap_11_2_3) { this.Cap_11_2_3=Cap_11_2_3;}
    @Column(name = "Cap_11_2_4")
    @JsonProperty("Cap-11-2-4")
    private String Cap_11_2_4; // 口服剂抗菌药物疗程（天数）
    public String getCap_11_2_4() {  return this.Cap_11_2_4;}
    @JsonProperty("Cap-11-2-4")
    public void setCap_11_2_4(final String Cap_11_2_4) { this.Cap_11_2_4=Cap_11_2_4;}
    @Column(name = "CM_6_1")
    @JsonProperty("CM-6-1")
