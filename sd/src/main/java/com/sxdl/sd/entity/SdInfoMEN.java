...
public class SdInfoMEN implements Serializable {
    ...
    public String getMEN_1_1_1() {  return this.MEN_1_1_1;}
    @JsonProperty("MEN-1-1-1")
    public void setMEN_1_1_1(final String MEN_1_1_1) { this.MEN_1_1_1=MEN_1_1_1;}
    @Column(name = "MEN_1_1_2")
    @JsonProperty("MEN-1-1-2")
    private String MEN_1_1_2; // 基础影像学检查项目的选择
    public String getMEN_1_1_2() {  return this.MEN_1_1_2;}
    @JsonProperty("MEN-1-1-2")
    public void setMEN_1_1_2(final String MEN_1_1_2) { this.MEN_1_1_2=MEN_1_1_2;}
    @Column(name = "MEN_1_1_3")
    @JsonProperty("MEN-1-1-3")
    private String MEN_1_1_3; // 完成被选项影像学检查的日期时间
    public String getMEN_1_1_3() {  return this.MEN_1_1_3;}
    @JsonProperty("MEN-1-1-3")
    public void setMEN_1_1_3(final String MEN_1_1_3) { this.MEN_1_1_3=MEN_1_1_3;}
    @Column(name = "MEN_2_1_1")
    @JsonProperty("MEN-2-1-1")
    private String MEN_2_1_1; // 肿瘤大小
    public String getMEN_2_1_1() {  return this.MEN_2_1_1;}
    @JsonProperty("MEN-2-1-1")
    public void setMEN_2_1_1(final String MEN_2_1_1) { this.MEN_2_1_1=MEN_2_1_1;}
    @Column(name = "MEN_2_1_2")
    @JsonProperty("MEN-2-1-2")
    private String MEN_2_1_2; // 肿瘤部位
    public String getMEN_2_1_2() {  return this.MEN_2_1_2;}
    @JsonProperty("MEN-2-1-2")
    public void setMEN_2_1_2(final String MEN_2_1_2) { this.MEN_2_1_2=MEN_2_1_2;}
    @Column(name = "MEN_2_1_2_1")
    @JsonProperty("MEN-2-1-2-1")
    private String MEN_2_1_2_1; // 其他肿瘤部位
    public String getMEN_2_1_2_1() {  return this.MEN_2_1_2_1;}
    @JsonProperty("MEN-2-1-2-1")
    public void setMEN_2_1_2_1(final String MEN_2_1_2_1) { this.MEN_2_1_2_1=MEN_2_1_2_1;}
    @Column(name = "MEN_2_1_3")
    @JsonProperty("MEN-2-1-3")
    private String MEN_2_1_3; // 主要症状
    public String getMEN_2_1_3() {  return this.MEN_2_1_3;}
    @JsonProperty("MEN-2-1-3")
    public void setMEN_2_1_3(final String MEN_2_1_3) { this.MEN_2_1_3=MEN_2_1_3;}
    @Column(name = "MEN_2_1_4")
    @JsonProperty("MEN-2-1-4")
    private String MEN_2_1_4; // 癫痫类型
    public String getMEN_2_1_4() {  return this.MEN_2_1_4;}
    @JsonProperty("MEN-2-1-4")
    public void setMEN_2_1_4(final String MEN_2_1_4) { this.MEN_2_1_4=MEN_2_1_4;}
    @Column(name = "MEN_2_1_3_2")
    @JsonProperty("MEN-2-1-3-2")
    private String MEN_2_1_3_2; // 其他主要症状
    public String getMEN_2_1_3_2() {  return this.MEN_2_1_3_2;}
    @JsonProperty("MEN-2-1-3-2")
    public void setMEN_2_1_3_2(final String MEN_2_1_3_2) { this.MEN_2_1_3_2=MEN_2_1_3_2;}
    @Column(name = "MEN_2_1_5")
    @JsonProperty("MEN-2-1-5")
    private String MEN_2_1_5; // 是否术前告知患者或家属，手术必要性及潜在相关风险的知情同意
    public String getMEN_2_1_5() {  return this.MEN_2_1_5;}
    @JsonProperty("MEN-2-1-5")
    public void setMEN_2_1_5(final String MEN_2_1_5) { this.MEN_2_1_5=MEN_2_1_5;}
    @Column(name = "MEN_3_1_1")
    @JsonProperty("MEN-3-1-1")
    private String MEN_3_1_1; // 肿瘤切除手术适应证
    public String getMEN_3_1_1() {  return this.MEN_3_1_1;}
    @JsonProperty("MEN-3-1-1")
    public void setMEN_3_1_1(final String MEN_3_1_1) { this.MEN_3_1_1=MEN_3_1_1;}
    @Column(name = "MEN_3_1_2")
    @JsonProperty("MEN-3-1-2")
    private String MEN_3_1_2; // 是否有开颅手术的禁忌证
    public String getMEN_3_1_2() {  return this.MEN_3_1_2;}
    @JsonProperty("MEN-3-1-2")
    public void setMEN_3_1_2(final String MEN_3_1_2) { this.MEN_3_1_2=MEN_3_1_2;}
    @Column(name = "MEN_3_1_3")
    @JsonProperty("MEN-3-1-3")
    private String MEN_3_1_3; //  禁忌证选择
    public String getMEN_3_1_3() {  return this.MEN_3_1_3;}
    @JsonProperty("MEN-3-1-3")
    public void setMEN_3_1_3(final String MEN_3_1_3) { this.MEN_3_1_3=MEN_3_1_3;}
    @Column(name = "MEN_4_1_1")
    @JsonProperty("MEN-4-1-1")
    private String MEN_4_1_1; // 是否是要术中神经功能保护
    public String getMEN_4_1_1() {  return this.MEN_4_1_1;}
    @JsonProperty("MEN-4-1-1")
    public void setMEN_4_1_1(final String MEN_4_1_1) { this.MEN_4_1_1=MEN_4_1_1;}
    @Column(name = "MEN_4_1_2")
    @JsonProperty("MEN-4-1-2")
    private String MEN_4_1_2; // 哪种类型脑膜瘤需要术中使用的神经功能保护措施
    public String getMEN_4_1_2() {  return this.MEN_4_1_2;}
    @JsonProperty("MEN-4-1-2")
    public void setMEN_4_1_2(final String MEN_4_1_2) { this.MEN_4_1_2=MEN_4_1_2;}
    @Column(name = "MEN_4_1_2_1")
    @JsonProperty("MEN-4-1-2-1")
    private String MEN_4_1_2_1; // 其它类型
    public String getMEN_4_1_2_1() {  return this.MEN_4_1_2_1;}
    @JsonProperty("MEN-4-1-2-1")
    public void setMEN_4_1_2_1(final String MEN_4_1_2_1) { this.MEN_4_1_2_1=MEN_4_1_2_1;}
    @Column(name = "MEN_4_1_3")
    @JsonProperty("MEN-4-1-3")
    private String MEN_4_1_3; // 术中使用的神经功能保护措施
    public String getMEN_4_1_3() {  return this.MEN_4_1_3;}
    @JsonProperty("MEN-4-1-3")
    public void setMEN_4_1_3(final String MEN_4_1_3) { this.MEN_4_1_3=MEN_4_1_3;}
    @Column(name = "MEN_4_2_1")
    @JsonProperty("MEN-4-2-1")
    private String MEN_4_2_1; // 肿瘤切除率Simpson 分级
    public String getMEN_4_2_1() {  return this.MEN_4_2_1;}
    @JsonProperty("MEN-4-2-1")
    public void setMEN_4_2_1(final String MEN_4_2_1) { this.MEN_4_2_1=MEN_4_2_1;}
    @Column(name = "MEN_5_1_1")
    @JsonProperty("MEN-5-1-1")
    private String MEN_5_1_1; // 手术中出血量(ml)
    public String getMEN_5_1_1() {  return this.MEN_5_1_1;}
    @JsonProperty("MEN-5-1-1")
    public void setMEN_5_1_1(final String MEN_5_1_1) { this.MEN_5_1_1=MEN_5_1_1;}
    @Column(name = "MEN_5_1_2")
    @JsonProperty("MEN-5-1-2")
    private String MEN_5_1_2; // 手术中输血量(ml)
    public String getMEN_5_1_2() {  return this.MEN_5_1_2;}
    @JsonProperty("MEN-5-1-2")
    public void setMEN_5_1_2(final String MEN_5_1_2) { this.MEN_5_1_2=MEN_5_1_2;}
    @Column(name = "MEN_5_1_3")
    @JsonProperty("MEN-5-1-3")
    private String MEN_5_1_3; // 手术后出血量(ml)
    public String getMEN_5_1_3() {  return this.MEN_5_1_3;}
    @JsonProperty("MEN-5-1-3")
    public void setMEN_5_1_3(final String MEN_5_1_3) { this.MEN_5_1_3=MEN_5_1_3;}
    @Column(name = "MEN_5_1_4")
    @JsonProperty("MEN-5-1-4")
    private String MEN_5_1_4; // 手术后输血量(ml)
    public String getMEN_5_1_4() {  return this.MEN_5_1_4;}
    @JsonProperty("MEN-5-1-4")
    public void setMEN_5_1_4(final String MEN_5_1_4) { this.MEN_5_1_4=MEN_5_1_4;}
    @Column(name = "MEN_5_2_1")
    @JsonProperty("MEN-5-2-1")
    private String MEN_5_2_1; // 全血(ml)
    public String getMEN_5_2_1() {  return this.MEN_5_2_1;}
    @JsonProperty("MEN-5-2-1")
    public void setMEN_5_2_1(final String MEN_5_2_1) { this.MEN_5_2_1=MEN_5_2_1;}
    @Column(name = "MEN_5_2_2")
    @JsonProperty("MEN-5-2-2")
    private String MEN_5_2_2; // 成份血(ml)
    public String getMEN_5_2_2() {  return this.MEN_5_2_2;}
    @JsonProperty("MEN-5-2-2")
    public void setMEN_5_2_2(final String MEN_5_2_2) { this.MEN_5_2_2=MEN_5_2_2;}
    @Column(name = "MEN_5_2_3")
    @JsonProperty("MEN-5-2-3")
    private String MEN_5_2_3; // 血浆(ml)
    public String getMEN_5_2_3() {  return this.MEN_5_2_3;}
    @JsonProperty("MEN-5-2-3")
    public void setMEN_5_2_3(final String MEN_5_2_3) { this.MEN_5_2_3=MEN_5_2_3;}
    @Column(name = "MEN_6_1_1")
    @JsonProperty("MEN-6-1-1")
    private String MEN_6_1_1; // 是否进行复查头颅平扫CT
    public String getMEN_6_1_1() {  return this.MEN_6_1_1;}
    @JsonProperty("MEN-6-1-1")
    public void setMEN_6_1_1(final String MEN_6_1_1) { this.MEN_6_1_1=MEN_6_1_1;}
    @Column(name = "MEN_6_1_2")
    @JsonProperty("MEN-6-1-2")
    private String MEN_6_1_2; // 评估日期时间
    public String getMEN_6_1_2() {  return this.MEN_6_1_2;}
    @JsonProperty("MEN-6-1-2")
    public void setMEN_6_1_2(final String MEN_6_1_2) { this.MEN_6_1_2=MEN_6_1_2;}
    @Column(name = "MEN_6_1_3")
    @JsonProperty("MEN-6-1-3")
    private String MEN_6_1_3; // 评估结果
    public String getMEN_6_1_3() {  return this.MEN_6_1_3;}
    @JsonProperty("MEN-6-1-3")
    public void setMEN_6_1_3(final String MEN_6_1_3) { this.MEN_6_1_3=MEN_6_1_3;}
    @Column(name = "MEN_6_1_5")
    @JsonProperty("MEN-6-1-5")
    private String MEN_6_1_5; // 其他评估结果
    public String getMEN_6_1_5() {  return this.MEN_6_1_5;}
    @JsonProperty("MEN-6-1-5")
    public void setMEN_6_1_5(final String MEN_6_1_5) { this.MEN_6_1_5=MEN_6_1_5;}
    @Column(name = "MEN_6_1_4")
    @JsonProperty("MEN-6-1-4")
    private String MEN_6_1_4; // 是否需要二次手术
    public String getMEN_6_1_4() {  return this.MEN_6_1_4;}
    @JsonProperty("MEN-6-1-4")
    public void setMEN_6_1_4(final String MEN_6_1_4) { this.MEN_6_1_4=MEN_6_1_4;}
    ...
    public String getCM_2_5_1() {  return this.CM_2_5_1;}
    @JsonProperty("CM-2-5-1")
    public void setCM_2_5_1(final String CM_2_5_1) { this.CM_2_5_1=CM_2_5_1;}
    @Column(name = "CM_2_5_2")
    @JsonProperty("CM-2-5-2")
    private String CM_2_5_2; // 手术后再手术名称
    public String getCM_2_5_2() {  return this.CM_2_5_2;}
    @JsonProperty("CM-2-5-2")
    public void setCM_2_5_2(final String CM_2_5_2) { this.CM_2_5_2=CM_2_5_2;}
    @Column(name = "CM_2_5_3")
    @JsonProperty("CM-2-5-3")
    private String CM_2_5_3; // 再手术日期时间
    public String getCM_2_5_3() {  return this.CM_2_5_3;}
    @JsonProperty("CM-2-5-3")
    public void setCM_2_5_3(final String CM_2_5_3) { this.CM_2_5_3=CM_2_5_3;}
    @Column(name = "MEN_9_1_1")
    @JsonProperty("MEN-9-1-1")
    private String MEN_9_1_1; // 病理诊断包含的基本内容
    public String getMEN_9_1_1() {  return this.MEN_9_1_1;}
    @JsonProperty("MEN-9-1-1")
    public void setMEN_9_1_1(final String MEN_9_1_1) { this.MEN_9_1_1=MEN_9_1_1;}
    @Column(name = "MEN_9_1_2")
    @JsonProperty("MEN-9-1-2")
    private String MEN_9_1_2; // 病理诊断是否按照2016 CNS WHO肿瘤分类标准名称
    public String getMEN_9_1_2() {  return this.MEN_9_1_2;}
    @JsonProperty("MEN-9-1-2")
    public void setMEN_9_1_2(final String MEN_9_1_2) { this.MEN_9_1_2=MEN_9_1_2;}
    @Column(name = "MEN_9_1_3")
    @JsonProperty("MEN-9-1-3")
    private String MEN_9_1_3; // 脑膜瘤WHO分级
    public String getMEN_9_1_3() {  return this.MEN_9_1_3;}
    @JsonProperty("MEN-9-1-3")
    public void setMEN_9_1_3(final String MEN_9_1_3) { this.MEN_9_1_3=MEN_9_1_3;}
    @Column(name = "MEN_9_1_4")
    @JsonProperty("MEN-9-1-4")
    private String MEN_9_1_4; // 病理组织学类型
    public String getMEN_9_1_4() {  return this.MEN_9_1_4;}
    @JsonProperty("MEN-9-1-4")
    public void setMEN_9_1_4(final String MEN_9_1_4) { this.MEN_9_1_4=MEN_9_1_4;}
    @Column(name = "MEN_9_1_5")
    @JsonProperty("MEN-9-1-5")
    private String MEN_9_1_5; // 病理诊断报告日期时间
    public String getMEN_9_1_5() {  return this.MEN_9_1_5;}
    @JsonProperty("MEN-9-1-5")
    public void setMEN_9_1_5(final String MEN_9_1_5) { this.MEN_9_1_5=MEN_9_1_5;}
    @Column(name = "MEN_10_1_1_0")
    @JsonProperty("MEN-10-1-1-0")
    private String MEN_10_1_1_0; // 出院前是否存在功能残损
    public String getMEN_10_1_1_0() {  return this.MEN_10_1_1_0;}
    @JsonProperty("MEN-10-1-1-0")
    public void setMEN_10_1_1_0(final String MEN_10_1_1_0) { this.MEN_10_1_1_0=MEN_10_1_1_0;}
    @Column(name = "MEN_10_1_1")
    @JsonProperty("MEN-10-1-1")
    private String MEN_10_1_1; // 出院前存在功能残损
    public String getMEN_10_1_1() {  return this.MEN_10_1_1;}
    @JsonProperty("MEN-10-1-1")
    public void setMEN_10_1_1(final String MEN_10_1_1) { this.MEN_10_1_1=MEN_10_1_1;}
    @Column(name = "MEN_10_1_1_1")
    @JsonProperty("MEN-10-1-1-1")
    private String MEN_10_1_1_1; // 其他出院前存在功能残损
    public String getMEN_10_1_1_1() {  return this.MEN_10_1_1_1;}
    @JsonProperty("MEN-10-1-1-1")
    public void setMEN_10_1_1_1(final String MEN_10_1_1_1) { this.MEN_10_1_1_1=MEN_10_1_1_1;}
    @Column(name = "MEN_10_1_2")
    @JsonProperty("MEN-10-1-2")
    private String MEN_10_1_2; // 出院前是否完成KPS评分
    public String getMEN_10_1_2() {  return this.MEN_10_1_2;}
    @JsonProperty("MEN-10-1-2")
    public void setMEN_10_1_2(final String MEN_10_1_2) { this.MEN_10_1_2=MEN_10_1_2;}
    @Column(name = "MEN_10_1_2_3")
    @JsonProperty("MEN-10-1-2-3")
    private String MEN_10_1_2_3; // KPS评分功能状态
    public String getMEN_10_1_2_3() {  return this.MEN_10_1_2_3;}
    @JsonProperty("MEN-10-1-2-3")
    public void setMEN_10_1_2_3(final String MEN_10_1_2_3) { this.MEN_10_1_2_3=MEN_10_1_2_3;}
    @Column(name = "MEN_10_2_1")
    @JsonProperty("MEN-10-2-1")
    private String MEN_10_2_1; // 出院前是否完成MRI T1/T2加权平扫+增强扫描影像学评估
    public String getMEN_10_2_1() {  return this.MEN_10_2_1;}
    @JsonProperty("MEN-10-2-1")
    public void setMEN_10_2_1(final String MEN_10_2_1) { this.MEN_10_2_1=MEN_10_2_1;}
    @Column(name = "MEN_10_2_2")
    @JsonProperty("MEN-10-2-2")
    private String MEN_10_2_2; // 影像学评估日期时间
    public String getMEN_10_2_2() {  return this.MEN_10_2_2;}
    @JsonProperty("MEN-10-2-2")
    public void setMEN_10_2_2(final String MEN_10_2_2) { this.MEN_10_2_2=MEN_10_2_2;}
    @Column(name = "MEN_10_2_3")
    @JsonProperty("MEN-10-2-3")
    private String MEN_10_2_3; // 肿瘤全切率(%)
    public String getMEN_10_2_3() {  return this.MEN_10_2_3;}
    @JsonProperty("MEN-10-2-3")
    public void setMEN_10_2_3(final String MEN_10_2_3) { this.MEN_10_2_3=MEN_10_2_3;}
    @Column(name = "MEN_10_2_4")
    @JsonProperty("MEN-10-2-4")
    private String MEN_10_2_4; // 肿瘤全切率分类
    public String getMEN_10_2_4() {  return this.MEN_10_2_4;}
    @JsonProperty("MEN-10-2-4")
    public void setMEN_10_2_4(final String MEN_10_2_4) { this.MEN_10_2_4=MEN_10_2_4;}
    @Column(name = "MEN_11_1_1")
    @JsonProperty("MEN-11-1-1")
    private String MEN_11_1_1; // 入院时是否有重点护理评估
    public String getMEN_11_1_1() {  return this.MEN_11_1_1;}
    @JsonProperty("MEN-11-1-1")
    public void setMEN_11_1_1(final String MEN_11_1_1) { this.MEN_11_1_1=MEN_11_1_1;}
    @Column(name = "MEN_11_1_2_1")
    @JsonProperty("MEN-11-1-2-1")
    private String MEN_11_1_2_1; // 行走评估结果
    public String getMEN_11_1_2_1() {  return this.MEN_11_1_2_1;}
    @JsonProperty("MEN-11-1-2-1")
    public void setMEN_11_1_2_1(final String MEN_11_1_2_1) { this.MEN_11_1_2_1=MEN_11_1_2_1;}
    @Column(name = "MEN_11_1_2_2")
    @JsonProperty("MEN-11-1-2-2")
    private String MEN_11_1_2_2; // 呼吸评估结果
    public String getMEN_11_1_2_2() {  return this.MEN_11_1_2_2;}
    @JsonProperty("MEN-11-1-2-2")
    public void setMEN_11_1_2_2(final String MEN_11_1_2_2) { this.MEN_11_1_2_2=MEN_11_1_2_2;}
    @Column(name = "MEN_11_1_2_3")
    @JsonProperty("MEN-11-1-2-3")
    private String MEN_11_1_2_3; // 饮食评估结果
    public String getMEN_11_1_2_3() {  return this.MEN_11_1_2_3;}
    @JsonProperty("MEN-11-1-2-3")
    public void setMEN_11_1_2_3(final String MEN_11_1_2_3) { this.MEN_11_1_2_3=MEN_11_1_2_3;}
    @Column(name = "MEN_11_1_2_4")
    @JsonProperty("MEN-11-1-2-4")
    private String MEN_11_1_2_4; // 吞咽评估结果
    public String getMEN_11_1_2_4() {  return this.MEN_11_1_2_4;}
    @JsonProperty("MEN-11-1-2-4")
    public void setMEN_11_1_2_4(final String MEN_11_1_2_4) { this.MEN_11_1_2_4=MEN_11_1_2_4;}
    @Column(name = "MEN_11_1_2_6")
    @JsonProperty("MEN-11-1-2-6")
    private String MEN_11_1_2_6; // 压疮评估无法确定
    public String getMEN_11_1_2_6() {  return this.MEN_11_1_2_6;}
    @JsonProperty("MEN-11-1-2-6")
    public void setMEN_11_1_2_6(final String MEN_11_1_2_6) { this.MEN_11_1_2_6=MEN_11_1_2_6;}
    @Column(name = "MEN_11_1_2_5")
    @JsonProperty("MEN-11-1-2-5")
    private String MEN_11_1_2_5; // 压疮评估（Braden评分值）分值
    public String getMEN_11_1_2_5() {  return this.MEN_11_1_2_5;}
    @JsonProperty("MEN-11-1-2-5")
    public void setMEN_11_1_2_5(final String MEN_11_1_2_5) { this.MEN_11_1_2_5=MEN_11_1_2_5;}
    @Column(name = "MEN_11_1_2_5_1")
    @JsonProperty("MEN-11-1-2-5-1")
    private String MEN_11_1_2_5_1; // 压疮评估结果选择
    public String getMEN_11_1_2_5_1() {  return this.MEN_11_1_2_5_1;}
    @JsonProperty("MEN-11-1-2-5-1")
    public void setMEN_11_1_2_5_1(final String MEN_11_1_2_5_1) { this.MEN_11_1_2_5_1=MEN_11_1_2_5_1;}
    @Column(name = "MEN_11_1_2_5_2")
    @JsonProperty("MEN-11-1-2-5-2")
    private String MEN_11_1_2_5_2; // 预防压疮告知
    public String getMEN_11_1_2_5_2() {  return this.MEN_11_1_2_5_2;}
    @JsonProperty("MEN-11-1-2-5-2")
    public void setMEN_11_1_2_5_2(final String MEN_11_1_2_5_2) { this.MEN_11_1_2_5_2=MEN_11_1_2_5_2;}
    @Column(name = "MEN_11_1_2")
    @JsonProperty("MEN-11-1-2")
    private String MEN_11_1_2; // 是否进行术前健康教育，且有记录
    public String getMEN_11_1_2() {  return this.MEN_11_1_2;}
    @JsonProperty("MEN-11-1-2")
    public void setMEN_11_1_2(final String MEN_11_1_2) { this.MEN_11_1_2=MEN_11_1_2;}
    @Column(name = "MEN_11_1_3_2")
    @JsonProperty("MEN-11-1-3-2")
    private String MEN_11_1_3_2; // 实施术前健康教育有记录
    public String getMEN_11_1_3_2() {  return this.MEN_11_1_3_2;}
    @JsonProperty("MEN-11-1-3-2")
    public void setMEN_11_1_3_2(final String MEN_11_1_3_2) { this.MEN_11_1_3_2=MEN_11_1_3_2;}
    @Column(name = "MEN_11_1_3_2_1")
    @JsonProperty("MEN-11-1-3-2-1")
    private String MEN_11_1_3_2_1; // 其他术前健康教育记录
    public String getMEN_11_1_3_2_1() {  return this.MEN_11_1_3_2_1;}
    @JsonProperty("MEN-11-1-3-2-1")
    public void setMEN_11_1_3_2_1(final String MEN_11_1_3_2_1) { this.MEN_11_1_3_2_1=MEN_11_1_3_2_1;}
    @Column(name = "MEN_11_1_3_4")
    @JsonProperty("MEN-11-1-3-4")
    private String MEN_11_1_3_4; // 是否进行术后健康教育，且有记录
    public String getMEN_11_1_3_4() {  return this.MEN_11_1_3_4;}
    @JsonProperty("MEN-11-1-3-4")
    public void setMEN_11_1_3_4(final String MEN_11_1_3_4) { this.MEN_11_1_3_4=MEN_11_1_3_4;}
    @Column(name = "MEN_11_1_3_3")
    @JsonProperty("MEN-11-1-3-3")
    private String MEN_11_1_3_3; // 实施术后健康教育有记录
    public String getMEN_11_1_3_3() {  return this.MEN_11_1_3_3;}
    @JsonProperty("MEN-11-1-3-3")
    public void setMEN_11_1_3_3(final String MEN_11_1_3_3) { this.MEN_11_1_3_3=MEN_11_1_3_3;}
    @Column(name = "MEN_11_1_3_3_1")
    @JsonProperty("MEN-11-1-3-3-1")
    private String MEN_11_1_3_3_1; // 其他术后健康教育记录
    public String getMEN_11_1_3_3_1() {  return this.MEN_11_1_3_3_1;}
    @JsonProperty("MEN-11-1-3-3-1")
    public void setMEN_11_1_3_3_1(final String MEN_11_1_3_3_1) { this.MEN_11_1_3_3_1=MEN_11_1_3_3_1;}
    @Column(name = "MEN_11_2")
    @JsonProperty("MEN-11-2")
    private String MEN_11_2; // 是否履行出院教育与告知责任，且有记录
    public String getMEN_11_2() {  return this.MEN_11_2;}
    @JsonProperty("MEN-11-2")
    public void setMEN_11_2(final String MEN_11_2) { this.MEN_11_2=MEN_11_2;}
    @Column(name = "MEN_11_2_2_1")
    @JsonProperty("MEN-11-2-2-1")
    private String MEN_11_2_2_1; // 交与患者“出院小结”的副本，并告知患者出院时风险因素
    public String getMEN_11_2_2_1() {  return this.MEN_11_2_2_1;}
    @JsonProperty("MEN-11-2-2-1")
    public void setMEN_11_2_2_1(final String MEN_11_2_2_1) { this.MEN_11_2_2_1=MEN_11_2_2_1;}
    @Column(name = "MEN_11_2_2_2")
    @JsonProperty("MEN-11-2-2-2")
    private String MEN_11_2_2_2; // 出院带药
    public String getMEN_11_2_2_2() {  return this.MEN_11_2_2_2;}
    @JsonProperty("MEN-11-2-2-2")
    public void setMEN_11_2_2_2(final String MEN_11_2_2_2) { this.MEN_11_2_2_2=MEN_11_2_2_2;}
    @Column(name = "MEN_11_2_2_3")
    @JsonProperty("MEN-11-2-2-3")
    private String MEN_11_2_2_3; // 告知发生紧急情况时求援救治途径
    public String getMEN_11_2_2_3() {  return this.MEN_11_2_2_3;}
    @JsonProperty("MEN-11-2-2-3")
    public void setMEN_11_2_2_3(final String MEN_11_2_2_3) { this.MEN_11_2_2_3=MEN_11_2_2_3;}
    @Column(name = "MEN_11_2_2_4")
    @JsonProperty("MEN-11-2-2-4")
    private String MEN_11_2_2_4; // 出院时教育与随访
    public String getMEN_11_2_2_4() {  return this.MEN_11_2_2_4;}
    @JsonProperty("MEN-11-2-2-4")
    public void setMEN_11_2_2_4(final String MEN_11_2_2_4) { this.MEN_11_2_2_4=MEN_11_2_2_4;}
    @Column(name = "MEN_11_2_2_5")
    @JsonProperty("MEN-11-2-2-5")
    private String MEN_11_2_2_5; // 告知何为风险因素与紧急情况
    public String getMEN_11_2_2_5() {  return this.MEN_11_2_2_5;}
    @JsonProperty("MEN-11-2-2-5")
    public void setMEN_11_2_2_5(final String MEN_11_2_2_5) { this.MEN_11_2_2_5=MEN_11_2_2_5;}
    @Column(name = "CM_3_1")
    @JsonProperty("CM-3-1")
