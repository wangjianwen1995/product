...
public class SdInfoPT implements Serializable {
    ...
    public String getPT_1_1_1() {  return this.PT_1_1_1;}
    @JsonProperty("PT-1-1-1")
    public void setPT_1_1_1(final String PT_1_1_1) { this.PT_1_1_1=PT_1_1_1;}
    @Column(name = "PT_1_1_1_1")
    @JsonProperty("PT-1-1-1-1")
    private String PT_1_1_1_1; // 完成临床腮腺肿瘤分类前主要检查其他项目
    public String getPT_1_1_1_1() {  return this.PT_1_1_1_1;}
    @JsonProperty("PT-1-1-1-1")
    public void setPT_1_1_1_1(final String PT_1_1_1_1) { this.PT_1_1_1_1=PT_1_1_1_1;}
    @Column(name = "PT_1_2_1")
    @JsonProperty("PT-1-2-1")
    private String PT_1_2_1; // 治疗前判断良性，或者恶性肿瘤
    public String getPT_1_2_1() {  return this.PT_1_2_1;}
    @JsonProperty("PT-1-2-1")
    public void setPT_1_2_1(final String PT_1_2_1) { this.PT_1_2_1=PT_1_2_1;}
    @Column(name = "PT_1_2_2")
    @JsonProperty("PT-1-2-2")
    private String PT_1_2_2; // 良性原发肿瘤分类
    public String getPT_1_2_2() {  return this.PT_1_2_2;}
    @JsonProperty("PT-1-2-2")
    public void setPT_1_2_2(final String PT_1_2_2) { this.PT_1_2_2=PT_1_2_2;}
    @Column(name = "PT_1_2_3")
    @JsonProperty("PT-1-2-3")
    private String PT_1_2_3; // 恶性原发肿瘤（T）分期
    public String getPT_1_2_3() {  return this.PT_1_2_3;}
    @JsonProperty("PT-1-2-3")
    public void setPT_1_2_3(final String PT_1_2_3) { this.PT_1_2_3=PT_1_2_3;}
    @Column(name = "PT_1_2_4")
    @JsonProperty("PT-1-2-4")
    private String PT_1_2_4; // 区域淋巴结（N）分期 
    public String getPT_1_2_4() {  return this.PT_1_2_4;}
    @JsonProperty("PT-1-2-4")
    public void setPT_1_2_4(final String PT_1_2_4) { this.PT_1_2_4=PT_1_2_4;}
    @Column(name = "PT_1_2_4_r")
    @JsonProperty("PT-1-2-4-r")
    private String PT_1_2_4_r; // 
    public String getPT_1_2_4_r() {  return this.PT_1_2_4_r;}
    @JsonProperty("PT-1-2-4-r")
    public void setPT_1_2_4_r(final String PT_1_2_4_r) { this.PT_1_2_4_r=PT_1_2_4_r;}
    @Column(name = "PT_1_2_5")
    @JsonProperty("PT-1-2-5")
    private String PT_1_2_5; // 远处转移（M）分期
    public String getPT_1_2_5() {  return this.PT_1_2_5;}
    @JsonProperty("PT-1-2-5")
    public void setPT_1_2_5(final String PT_1_2_5) { this.PT_1_2_5=PT_1_2_5;}
    @Column(name = "PT_1_2_5_r")
    @JsonProperty("PT-1-2-5-r")
    private String PT_1_2_5_r; // 
    public String getPT_1_2_5_r() {  return this.PT_1_2_5_r;}
    @JsonProperty("PT-1-2-5-r")
    public void setPT_1_2_5_r(final String PT_1_2_5_r) { this.PT_1_2_5_r=PT_1_2_5_r;}
    @Column(name = "PT_1_2_6")
    @JsonProperty("PT-1-2-6")
    private String PT_1_2_6; // 治疗前 腮腺肿瘤分类结论
    public String getPT_1_2_6() {  return this.PT_1_2_6;}
    @JsonProperty("PT-1-2-6")
    public void setPT_1_2_6(final String PT_1_2_6) { this.PT_1_2_6=PT_1_2_6;}
    @Column(name = "PT_1_3_1")
    @JsonProperty("PT-1-3-1")
    private String PT_1_3_1; // 是否存在全身其他系统疾病
    public String getPT_1_3_1() {  return this.PT_1_3_1;}
    @JsonProperty("PT-1-3-1")
    public void setPT_1_3_1(final String PT_1_3_1) { this.PT_1_3_1=PT_1_3_1;}
    @Column(name = "PT_1_3_2")
    @JsonProperty("PT-1-3-2")
    private String PT_1_3_2; // 全身系统性疾病情况
    public String getPT_1_3_2() {  return this.PT_1_3_2;}
    @JsonProperty("PT-1-3-2")
    public void setPT_1_3_2(final String PT_1_3_2) { this.PT_1_3_2=PT_1_3_2;}
    @Column(name = "PT_1_4_1")
    @JsonProperty("PT-1-4-1")
    private String PT_1_4_1; // 是否是治疗前接受过2个或以上治疗科室会诊的患者
    public String getPT_1_4_1() {  return this.PT_1_4_1;}
    @JsonProperty("PT-1-4-1")
    public void setPT_1_4_1(final String PT_1_4_1) { this.PT_1_4_1=PT_1_4_1;}
    @Column(name = "PT_2_1_1")
    @JsonProperty("PT-2-1-1")
    private String PT_2_1_1; // 治疗前是否有病理组织形态学/细胞学诊断报告
    public String getPT_2_1_1() {  return this.PT_2_1_1;}
    @JsonProperty("PT-2-1-1")
    public void setPT_2_1_1(final String PT_2_1_1) { this.PT_2_1_1=PT_2_1_1;}
    @Column(name = "PT_2_1_2")
    @JsonProperty("PT-2-1-2")
    private String PT_2_1_2; // 采集组织或细胞学标本来源途径
    public String getPT_2_1_2() {  return this.PT_2_1_2;}
    @JsonProperty("PT-2-1-2")
    public void setPT_2_1_2(final String PT_2_1_2) { this.PT_2_1_2=PT_2_1_2;}
    @Column(name = "PT_2_1_2_1")
    @JsonProperty("PT-2-1-2-1")
    private String PT_2_1_2_1; // 采集组织或细胞学标本其他来源途径
    public String getPT_2_1_2_1() {  return this.PT_2_1_2_1;}
    @JsonProperty("PT-2-1-2-1")
    public void setPT_2_1_2_1(final String PT_2_1_2_1) { this.PT_2_1_2_1=PT_2_1_2_1;}
    @Column(name = "PT_2_1_3")
    @JsonProperty("PT-2-1-3")
    private String PT_2_1_3; // 病理组织形态学/细胞学诊断报告单临床分期结论距本次治疗前的时限
    public String getPT_2_1_3() {  return this.PT_2_1_3;}
    @JsonProperty("PT-2-1-3")
    public void setPT_2_1_3(final String PT_2_1_3) { this.PT_2_1_3=PT_2_1_3;}
    @Column(name = "PT_2_2_1")
    @JsonProperty("PT-2-2-1")
    private String PT_2_2_1; // 手术路径的选择
    public String getPT_2_2_1() {  return this.PT_2_2_1;}
    @JsonProperty("PT-2-2-1")
    public void setPT_2_2_1(final String PT_2_2_1) { this.PT_2_2_1=PT_2_2_1;}
    @Column(name = "PT_2_2_1_1")
    @JsonProperty("PT-2-2-1-1")
    private String PT_2_2_1_1; // 其他手术路径
    public String getPT_2_2_1_1() {  return this.PT_2_2_1_1;}
    @JsonProperty("PT-2-2-1-1")
    public void setPT_2_2_1_1(final String PT_2_2_1_1) { this.PT_2_2_1_1=PT_2_2_1_1;}
    @Column(name = "PT_2_2_2")
    @JsonProperty("PT-2-2-2")
    private String PT_2_2_2; // 术中探及腮腺肿瘤病变涉及的范围
    public String getPT_2_2_2() {  return this.PT_2_2_2;}
    @JsonProperty("PT-2-2-2")
    public void setPT_2_2_2(final String PT_2_2_2) { this.PT_2_2_2=PT_2_2_2;}
    @Column(name = "PT_2_2_3_1")
    @JsonProperty("PT-2-2-3-1")
    private String PT_2_2_3_1; // 根治性手术治疗符合原则规范
    public String getPT_2_2_3_1() {  return this.PT_2_2_3_1;}
    @JsonProperty("PT-2-2-3-1")
    public void setPT_2_2_3_1(final String PT_2_2_3_1) { this.PT_2_2_3_1=PT_2_2_3_1;}
    @Column(name = "PT_2_2_3_2")
    @JsonProperty("PT-2-2-3-2")
    private String PT_2_2_3_2; // 非根治性手术治疗符合原则规范
    public String getPT_2_2_3_2() {  return this.PT_2_2_3_2;}
    @JsonProperty("PT-2-2-3-2")
    public void setPT_2_2_3_2(final String PT_2_2_3_2) { this.PT_2_2_3_2=PT_2_2_3_2;}
    @Column(name = "PT_2_2_4")
    @JsonProperty("PT-2-2-4")
    private String PT_2_2_4; // 实施的腮腺肿瘤根治性术式的选择
    public String getPT_2_2_4() {  return this.PT_2_2_4;}
    @JsonProperty("PT-2-2-4")
    public void setPT_2_2_4(final String PT_2_2_4) { this.PT_2_2_4=PT_2_2_4;}
    @Column(name = "PT_2_2_5")
    @JsonProperty("PT-2-2-5")
    private String PT_2_2_5; // 面神经处理方式的选择
    public String getPT_2_2_5() {  return this.PT_2_2_5;}
    @JsonProperty("PT-2-2-5")
    public void setPT_2_2_5(final String PT_2_2_5) { this.PT_2_2_5=PT_2_2_5;}
    @Column(name = "PT_2_2_5_1")
    @JsonProperty("PT-2-2-5-1")
    private String PT_2_2_5_1; // 其他面神经处理方式
    public String getPT_2_2_5_1() {  return this.PT_2_2_5_1;}
    @JsonProperty("PT-2-2-5-1")
    public void setPT_2_2_5_1(final String PT_2_2_5_1) { this.PT_2_2_5_1=PT_2_2_5_1;}
    @Column(name = "PT_2_2_6")
    @JsonProperty("PT-2-2-6")
    private String PT_2_2_6; // 是否进行颈部淋巴组织清扫
    public String getPT_2_2_6() {  return this.PT_2_2_6;}
    @JsonProperty("PT-2-2-6")
    public void setPT_2_2_6(final String PT_2_2_6) { this.PT_2_2_6=PT_2_2_6;}
    @Column(name = "PT_2_2_7")
    @JsonProperty("PT-2-2-7")
    private String PT_2_2_7; // 颈部淋巴组织清扫的原因
    public String getPT_2_2_7() {  return this.PT_2_2_7;}
    @JsonProperty("PT-2-2-7")
    public void setPT_2_2_7(final String PT_2_2_7) { this.PT_2_2_7=PT_2_2_7;}
    @Column(name = "PT_2_2_7_1")
    @JsonProperty("PT-2-2-7-1")
    private String PT_2_2_7_1; // 颈部淋巴组织清扫的其他原因
    public String getPT_2_2_7_1() {  return this.PT_2_2_7_1;}
    @JsonProperty("PT-2-2-7-1")
    public void setPT_2_2_7_1(final String PT_2_2_7_1) { this.PT_2_2_7_1=PT_2_2_7_1;}
    @Column(name = "PT_2_3_1")
    @JsonProperty("PT-2-3-1")
    private String PT_2_3_1; // 是否进行手术面神经解剖
    public String getPT_2_3_1() {  return this.PT_2_3_1;}
    @JsonProperty("PT-2-3-1")
    public void setPT_2_3_1(final String PT_2_3_1) { this.PT_2_3_1=PT_2_3_1;}
    @Column(name = "PT_2_3_2")
    @JsonProperty("PT-2-3-2")
    private String PT_2_3_2; // 面神经解剖组别
    public String getPT_2_3_2() {  return this.PT_2_3_2;}
    @JsonProperty("PT-2-3-2")
    public void setPT_2_3_2(final String PT_2_3_2) { this.PT_2_3_2=PT_2_3_2;}
    @Column(name = "PT_2_3_3")
    @JsonProperty("PT-2-3-3")
    private String PT_2_3_3; // 面神经切断
    public String getPT_2_3_3() {  return this.PT_2_3_3;}
    @JsonProperty("PT-2-3-3")
    public void setPT_2_3_3(final String PT_2_3_3) { this.PT_2_3_3=PT_2_3_3;}
    @Column(name = "PT_2_3_4")
    @JsonProperty("PT-2-3-4")
    private String PT_2_3_4; // 面神经吻合
    public String getPT_2_3_4() {  return this.PT_2_3_4;}
    @JsonProperty("PT-2-3-4")
    public void setPT_2_3_4(final String PT_2_3_4) { this.PT_2_3_4=PT_2_3_4;}
    @Column(name = "PT_2_4_1")
    @JsonProperty("PT-2-4-1")
    private String PT_2_4_1; // 腮腺肿瘤手术中达到安全切缘是否有证实措施
    public String getPT_2_4_1() {  return this.PT_2_4_1;}
    @JsonProperty("PT-2-4-1")
    public void setPT_2_4_1(final String PT_2_4_1) { this.PT_2_4_1=PT_2_4_1;}
    @Column(name = "PT_2_4_2")
    @JsonProperty("PT-2-4-2")
    private String PT_2_4_2; // 记入手术记录中安全切缘证实措施的选择
    public String getPT_2_4_2() {  return this.PT_2_4_2;}
    @JsonProperty("PT-2-4-2")
    public void setPT_2_4_2(final String PT_2_4_2) { this.PT_2_4_2=PT_2_4_2;}
    @Column(name = "PT_2_4_3")
    @JsonProperty("PT-2-4-3")
    private String PT_2_4_3; // 术中是否送冰冻病理检查
    public String getPT_2_4_3() {  return this.PT_2_4_3;}
    @JsonProperty("PT-2-4-3")
    public void setPT_2_4_3(final String PT_2_4_3) { this.PT_2_4_3=PT_2_4_3;}
    @Column(name = "PT_2_5_1")
    @JsonProperty("PT-2-5-1")
    private String PT_2_5_1; // 副腮腺切除后是否够行导管吻合
    public String getPT_2_5_1() {  return this.PT_2_5_1;}
    @JsonProperty("PT-2-5-1")
    public void setPT_2_5_1(final String PT_2_5_1) { this.PT_2_5_1=PT_2_5_1;}
    @Column(name = "PT_2_5_2")
    @JsonProperty("PT-2-5-2")
    private String PT_2_5_2; // 是否使用各种引流
    public String getPT_2_5_2() {  return this.PT_2_5_2;}
    @JsonProperty("PT-2-5-2")
    public void setPT_2_5_2(final String PT_2_5_2) { this.PT_2_5_2=PT_2_5_2;}
    @Column(name = "PT_2_6_1")
    @JsonProperty("PT-2-6-1")
    private String PT_2_6_1; // 腮腺肿瘤手术中预防常见并发症的措施
    public String getPT_2_6_1() {  return this.PT_2_6_1;}
    @JsonProperty("PT-2-6-1")
    public void setPT_2_6_1(final String PT_2_6_1) { this.PT_2_6_1=PT_2_6_1;}
    @Column(name = "PT_2_6_2")
    @JsonProperty("PT-2-6-2")
    private String PT_2_6_2; // 记入手术记录中防常见并发症措施的选择
    public String getPT_2_6_2() {  return this.PT_2_6_2;}
    @JsonProperty("PT-2-6-2")
    public void setPT_2_6_2(final String PT_2_6_2) { this.PT_2_6_2=PT_2_6_2;}
    @Column(name = "PT_2_6_3")
    @JsonProperty("PT-2-6-3")
    private String PT_2_6_3; // 术中是否选择放疗粒子植入
    public String getPT_2_6_3() {  return this.PT_2_6_3;}
    @JsonProperty("PT-2-6-3")
    public void setPT_2_6_3(final String PT_2_6_3) { this.PT_2_6_3=PT_2_6_3;}
    @Column(name = "PT_2_6_4")
    @JsonProperty("PT-2-6-4")
    private String PT_2_6_4; // 术中是否选择后装放疗施源器植入
    public String getPT_2_6_4() {  return this.PT_2_6_4;}
    @JsonProperty("PT-2-6-4")
    public void setPT_2_6_4(final String PT_2_6_4) { this.PT_2_6_4=PT_2_6_4;}
    ...
    public String getPT_4_1_1() {  return this.PT_4_1_1;}
    @JsonProperty("PT-4-1-1")
    public void setPT_4_1_1(final String PT_4_1_1) { this.PT_4_1_1=PT_4_1_1;}
    @Column(name = "PT_4_2_1")
    @JsonProperty("PT-4-2-1")
    private String PT_4_2_1; // 术前是否进行面神经功能评估
    public String getPT_4_2_1() {  return this.PT_4_2_1;}
    @JsonProperty("PT-4-2-1")
    public void setPT_4_2_1(final String PT_4_2_1) { this.PT_4_2_1=PT_4_2_1;}
    @Column(name = "PT_4_2_2")
    @JsonProperty("PT-4-2-2")
    private String PT_4_2_2; // HBGS量表评估结果
    public String getPT_4_2_2() {  return this.PT_4_2_2;}
    @JsonProperty("PT-4-2-2")
    public void setPT_4_2_2(final String PT_4_2_2) { this.PT_4_2_2=PT_4_2_2;}
    @Column(name = "PT_4_2_3")
    @JsonProperty("PT-4-2-3")
    private String PT_4_2_3; // 肌电仪评估结果
    public String getPT_4_2_3() {  return this.PT_4_2_3;}
    @JsonProperty("PT-4-2-3")
    public void setPT_4_2_3(final String PT_4_2_3) { this.PT_4_2_3=PT_4_2_3;}
    @Column(name = "PT_4_2_4")
    @JsonProperty("PT-4-2-4")
    private String PT_4_2_4; // 面部三维动态定量评估结果
    public String getPT_4_2_4() {  return this.PT_4_2_4;}
    @JsonProperty("PT-4-2-4")
    public void setPT_4_2_4(final String PT_4_2_4) { this.PT_4_2_4=PT_4_2_4;}
    @Column(name = "PT_4_3_1")
    @JsonProperty("PT-4-3-1")
    private String PT_4_3_1; // 术后是否进行面神经功能评估
    public String getPT_4_3_1() {  return this.PT_4_3_1;}
    @JsonProperty("PT-4-3-1")
    public void setPT_4_3_1(final String PT_4_3_1) { this.PT_4_3_1=PT_4_3_1;}
    @Column(name = "PT_4_3_2")
    @JsonProperty("PT-4-3-2")
    private String PT_4_3_2; // HBGS量表评估结果
    public String getPT_4_3_2() {  return this.PT_4_3_2;}
    @JsonProperty("PT-4-3-2")
    public void setPT_4_3_2(final String PT_4_3_2) { this.PT_4_3_2=PT_4_3_2;}
    @Column(name = "PT_4_3_3")
    @JsonProperty("PT-4-3-3")
    private String PT_4_3_3; // 肌电仪评估结果
    public String getPT_4_3_3() {  return this.PT_4_3_3;}
    @JsonProperty("PT-4-3-3")
    public void setPT_4_3_3(final String PT_4_3_3) { this.PT_4_3_3=PT_4_3_3;}
    @Column(name = "PT_4_3_4")
    @JsonProperty("PT-4-3-4")
    private String PT_4_3_4; // 面部三维动态定量评估结果
    public String getPT_4_3_4() {  return this.PT_4_3_4;}
    @JsonProperty("PT-4-3-4")
    public void setPT_4_3_4(final String PT_4_3_4) { this.PT_4_3_4=PT_4_3_4;}
    @Column(name = "PT_5_1_1")
    @JsonProperty("PT-5-1-1")
    private String PT_5_1_1; // 是否有病理学诊断
    public String getPT_5_1_1() {  return this.PT_5_1_1;}
    @JsonProperty("PT-5-1-1")
    public void setPT_5_1_1(final String PT_5_1_1) { this.PT_5_1_1=PT_5_1_1;}
    @Column(name = "PT_5_2_1")
    @JsonProperty("PT-5-2-1")
    private String PT_5_2_1; // 采集组织或细胞学标本途经的选择
    public String getPT_5_2_1() {  return this.PT_5_2_1;}
    @JsonProperty("PT-5-2-1")
    public void setPT_5_2_1(final String PT_5_2_1) { this.PT_5_2_1=PT_5_2_1;}
    @Column(name = "PT_5_2_1_1")
    @JsonProperty("PT-5-2-1-1")
    private String PT_5_2_1_1; // 采集组织或细胞学标本其他途经
    public String getPT_5_2_1_1() {  return this.PT_5_2_1_1;}
    @JsonProperty("PT-5-2-1-1")
    public void setPT_5_2_1_1(final String PT_5_2_1_1) { this.PT_5_2_1_1=PT_5_2_1_1;}
    @Column(name = "PT_5_3_1")
    @JsonProperty("PT-5-3-1")
    private String PT_5_3_1; // 合格的病理报告包括以下主要内容
    public String getPT_5_3_1() {  return this.PT_5_3_1;}
    @JsonProperty("PT-5-3-1")
    public void setPT_5_3_1(final String PT_5_3_1) { this.PT_5_3_1=PT_5_3_1;}
    @Column(name = "PT_5_3_1_1")
    @JsonProperty("PT-5-3-1-1")
    private String PT_5_3_1_1; // 合格的病理报告其他内容
    public String getPT_5_3_1_1() {  return this.PT_5_3_1_1;}
    @JsonProperty("PT-5-3-1-1")
    public void setPT_5_3_1_1(final String PT_5_3_1_1) { this.PT_5_3_1_1=PT_5_3_1_1;}
    @Column(name = "PT_5_4_1")
    @JsonProperty("PT-5-4-1")
    private String PT_5_4_1; // 是否有腮腺恶性肿瘤病理pTNM分期
    public String getPT_5_4_1() {  return this.PT_5_4_1;}
    @JsonProperty("PT-5-4-1")
    public void setPT_5_4_1(final String PT_5_4_1) { this.PT_5_4_1=PT_5_4_1;}
    @Column(name = "PT_5_4_2")
    @JsonProperty("PT-5-4-2")
    private String PT_5_4_2; // pTNM 分期结论
    public String getPT_5_4_2() {  return this.PT_5_4_2;}
    @JsonProperty("PT-5-4-2")
    public void setPT_5_4_2(final String PT_5_4_2) { this.PT_5_4_2=PT_5_4_2;}
    @Column(name = "PT_5_5_1")
    @JsonProperty("PT-5-5-1")
    private String PT_5_5_1; // 是否有组织学分级
    public String getPT_5_5_1() {  return this.PT_5_5_1;}
    @JsonProperty("PT-5-5-1")
    public void setPT_5_5_1(final String PT_5_5_1) { this.PT_5_5_1=PT_5_5_1;}
    @Column(name = "PT_5_5_2")
    @JsonProperty("PT-5-5-2")
    private String PT_5_5_2; // 组织学分级
    public String getPT_5_5_2() {  return this.PT_5_5_2;}
    @JsonProperty("PT-5-5-2")
    public void setPT_5_5_2(final String PT_5_5_2) { this.PT_5_5_2=PT_5_5_2;}
    @Column(name = "CM_2_1")
    @JsonProperty("CM-2-1")
    ...
    public String getPT_6_1_2() {  return this.PT_6_1_2;}
    @JsonProperty("PT-6-1-2")
    public void setPT_6_1_2(final String PT_6_1_2) { this.PT_6_1_2=PT_6_1_2;}
    ...
    public String getPT_6_2_1() {  return this.PT_6_2_1;}
    @JsonProperty("PT-6-2-1")
    public void setPT_6_2_1(final String PT_6_2_1) { this.PT_6_2_1=PT_6_2_1;}
    @Column(name = "PT_6_2_2")
    @JsonProperty("PT-6-2-2")
    private String PT_6_2_2; // 非计划二次手术主要原因的选择
    public String getPT_6_2_2() {  return this.PT_6_2_2;}
    @JsonProperty("PT-6-2-2")
    public void setPT_6_2_2(final String PT_6_2_2) { this.PT_6_2_2=PT_6_2_2;}
    @Column(name = "PT_6_2_2_1")
    @JsonProperty("PT-6-2-2-1")
    private String PT_6_2_2_1; // 其他非计划二次手术主要原因
    public String getPT_6_2_2_1() {  return this.PT_6_2_2_1;}
    @JsonProperty("PT-6-2-2-1")
    public void setPT_6_2_2_1(final String PT_6_2_2_1) { this.PT_6_2_2_1=PT_6_2_2_1;}
    @Column(name = "PT_6_2_3_1")
    @JsonProperty("PT-6-2-3-1")
    private String PT_6_2_3_1; // 二次手术开始（切皮）日期时间 
    public String getPT_6_2_3_1() {  return this.PT_6_2_3_1;}
    @JsonProperty("PT-6-2-3-1")
    public void setPT_6_2_3_1(final String PT_6_2_3_1) { this.PT_6_2_3_1=PT_6_2_3_1;}
    @Column(name = "PT_6_2_3_2")
    @JsonProperty("PT-6-2-3-2")
    private String PT_6_2_3_2; // 二次手术结束（缝皮结束）日期时间
    public String getPT_6_2_3_2() {  return this.PT_6_2_3_2;}
    @JsonProperty("PT-6-2-3-2")
    public void setPT_6_2_3_2(final String PT_6_2_3_2) { this.PT_6_2_3_2=PT_6_2_3_2;}
    @Column(name = "CM_3_1")
    @JsonProperty("CM-3-1")
    ...
    public String getPT_8_1_1() {  return this.PT_8_1_1;}
    @JsonProperty("PT-8-1-1")
    public void setPT_8_1_1(final String PT_8_1_1) { this.PT_8_1_1=PT_8_1_1;}
    @Column(name = "PT_8_1_2")
    @JsonProperty("PT-8-1-2")
    private String PT_8_1_2; // 术后是否进行面神经功能恢复训练
    public String getPT_8_1_2() {  return this.PT_8_1_2;}
    @JsonProperty("PT-8-1-2")
    public void setPT_8_1_2(final String PT_8_1_2) { this.PT_8_1_2=PT_8_1_2;}
    @Column(name = "PT_8_2_1")
    @JsonProperty("PT-8-2-1")
    private String PT_8_2_1; // 术后是否进行语音评估
    public String getPT_8_2_1() {  return this.PT_8_2_1;}
    @JsonProperty("PT-8-2-1")
    public void setPT_8_2_1(final String PT_8_2_1) { this.PT_8_2_1=PT_8_2_1;}
    @Column(name = "PT_8_2_2")
    @JsonProperty("PT-8-2-2")
    private String PT_8_2_2; // 术后是否进行语音指导
    public String getPT_8_2_2() {  return this.PT_8_2_2;}
    @JsonProperty("PT-8-2-2")
    public void setPT_8_2_2(final String PT_8_2_2) { this.PT_8_2_2=PT_8_2_2;}
    @Column(name = "PT_8_3_1")
    @JsonProperty("PT-8-3-1")
    private String PT_8_3_1; // 术后是否进行心理评估
    public String getPT_8_3_1() {  return this.PT_8_3_1;}
    @JsonProperty("PT-8-3-1")
    public void setPT_8_3_1(final String PT_8_3_1) { this.PT_8_3_1=PT_8_3_1;}
    @Column(name = "PT_8_3_2")
    @JsonProperty("PT-8-3-2")
    private String PT_8_3_2; // 术后是否进行心理指导
    public String getPT_8_3_2() {  return this.PT_8_3_2;}
    @JsonProperty("PT-8-3-2")
    public void setPT_8_3_2(final String PT_8_3_2) { this.PT_8_3_2=PT_8_3_2;}
    @Column(name = "PT_8_4_1")
    @JsonProperty("PT-8-4-1")
    private String PT_8_4_1; // 术后是否进行面神经功能康复治疗
    public String getPT_8_4_1() {  return this.PT_8_4_1;}
    @JsonProperty("PT-8-4-1")
    public void setPT_8_4_1(final String PT_8_4_1) { this.PT_8_4_1=PT_8_4_1;}
    @Column(name = "PT_8_4_2")
    @JsonProperty("PT-8-4-2")
    private String PT_8_4_2; // 术后面神经功能康复治疗类型
    public String getPT_8_4_2() {  return this.PT_8_4_2;}
    @JsonProperty("PT-8-4-2")
    public void setPT_8_4_2(final String PT_8_4_2) { this.PT_8_4_2=PT_8_4_2;}
    @Column(name = "PT_8_4_2_1")
    @JsonProperty("PT-8-4-2-1")
    private String PT_8_4_2_1; // 术后其他面神经功能康复治疗类型
    public String getPT_8_4_2_1() {  return this.PT_8_4_2_1;}
    @JsonProperty("PT-8-4-2-1")
    public void setPT_8_4_2_1(final String PT_8_4_2_1) { this.PT_8_4_2_1=PT_8_4_2_1;}
    ...
    public String getPT_9_2_3() {  return this.PT_9_2_3;}
    @JsonProperty("PT-9-2-3")
    public void setPT_9_2_3(final String PT_9_2_3) { this.PT_9_2_3=PT_9_2_3;}
    @Column(name = "PT_9_2_4")
    @JsonProperty("PT-9-2-4")
    private String PT_9_2_4; // 出院后合理的进餐制度和正确的进餐方式预防合并症
    public String getPT_9_2_4() {  return this.PT_9_2_4;}
    @JsonProperty("PT-9-2-4")
    public void setPT_9_2_4(final String PT_9_2_4) { this.PT_9_2_4=PT_9_2_4;}
    @Column(name = "PT_9_2_5")
    @JsonProperty("PT-9-2-5")
    private String PT_9_2_5; // 告知腮腺肿瘤术后常见并发症的应对措施
    public String getPT_9_2_5() {  return this.PT_9_2_5;}
    @JsonProperty("PT-9-2-5")
    public void setPT_9_2_5(final String PT_9_2_5) { this.PT_9_2_5=PT_9_2_5;}
