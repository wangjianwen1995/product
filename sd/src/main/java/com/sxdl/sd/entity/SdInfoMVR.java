...
/*主要手术 ICD-9-CM-3 编码：35.02、35.12、35.23、35.24的手术出院患者。
*/
@ApiModel(value = "06信息")
@Entity
@Table(name = "sd_info_MVR")
public class SdInfoMVR implements Serializable {
    ...
    @Column(name = "MVR_1_1_1")
    @JsonProperty("MVR-1-1-1")
    private String MVR_1_1_1; // 是否实施手术前的超声心动图评估
    public String getMVR_1_1_1() {  return this.MVR_1_1_1;}
    @JsonProperty("MVR-1-1-1")
    public void setMVR_1_1_1(final String MVR_1_1_1) { this.MVR_1_1_1=MVR_1_1_1;}
    @Column(name = "MVR_1_1_2")
    @JsonProperty("MVR-1-1-2")
    private String MVR_1_1_2; // 左室射血分数（LVEF）测量值(%)
    public String getMVR_1_1_2() {  return this.MVR_1_1_2;}
    @JsonProperty("MVR-1-1-2")
    public void setMVR_1_1_2(final String MVR_1_1_2) { this.MVR_1_1_2=MVR_1_1_2;}
    @Column(name = "MVR_1_1_3")
    @JsonProperty("MVR-1-1-3")
    private String MVR_1_1_3; // 评估结果的分层
    public String getMVR_1_1_3() {  return this.MVR_1_1_3;}
    @JsonProperty("MVR-1-1-3")
    public void setMVR_1_1_3(final String MVR_1_1_3) { this.MVR_1_1_3=MVR_1_1_3;}
    @Column(name = "MVR_1_1_4")
    @JsonProperty("MVR-1-1-4")
    private String MVR_1_1_4; // 左心房前后径(mm)
    public String getMVR_1_1_4() {  return this.MVR_1_1_4;}
    @JsonProperty("MVR-1-1-4")
    public void setMVR_1_1_4(final String MVR_1_1_4) { this.MVR_1_1_4=MVR_1_1_4;}
    @Column(name = "MVR_1_1_5")
    @JsonProperty("MVR-1-1-5")
    private String MVR_1_1_5; // 反流量(ml)
    public String getMVR_1_1_5() {  return this.MVR_1_1_5;}
    @JsonProperty("MVR-1-1-5")
    public void setMVR_1_1_5(final String MVR_1_1_5) { this.MVR_1_1_5=MVR_1_1_5;}
    @Column(name = "MVR_1_1_6")
    @JsonProperty("MVR-1-1-6")
    private String MVR_1_1_6; // 反流量评估结果的分层
    public String getMVR_1_1_6() {  return this.MVR_1_1_6;}
    @JsonProperty("MVR-1-1-6")
    public void setMVR_1_1_6(final String MVR_1_1_6) { this.MVR_1_1_6=MVR_1_1_6;}
    @Column(name = "MVR_1_1_7")
    @JsonProperty("MVR-1-1-7")
    private String MVR_1_1_7; // 二尖瓣口面积(cm²)
    public String getMVR_1_1_7() {  return this.MVR_1_1_7;}
    @JsonProperty("MVR-1-1-7")
    public void setMVR_1_1_7(final String MVR_1_1_7) { this.MVR_1_1_7=MVR_1_1_7;}
    @Column(name = "MVR_1_1_9")
    @JsonProperty("MVR-1-1-9")
    private String MVR_1_1_9; // 是否左心耳血栓
    public String getMVR_1_1_9() {  return this.MVR_1_1_9;}
    @JsonProperty("MVR-1-1-9")
    public void setMVR_1_1_9(final String MVR_1_1_9) { this.MVR_1_1_9=MVR_1_1_9;}
    @Column(name = "MVR_1_2_1")
    @JsonProperty("MVR-1-2-1")
    private String MVR_1_2_1; // 是否有冠心病史，或冠心病危险因素
    public String getMVR_1_2_1() {  return this.MVR_1_2_1;}
    @JsonProperty("MVR-1-2-1")
    public void setMVR_1_2_1(final String MVR_1_2_1) { this.MVR_1_2_1=MVR_1_2_1;}
    @Column(name = "MVR_1_2_2")
    @JsonProperty("MVR-1-2-2")
    private String MVR_1_2_2; // 是否实施手术前的冠状动脉造影评估
    public String getMVR_1_2_2() {  return this.MVR_1_2_2;}
    @JsonProperty("MVR-1-2-2")
    public void setMVR_1_2_2(final String MVR_1_2_2) { this.MVR_1_2_2=MVR_1_2_2;}
    @Column(name = "MVR_1_2_3")
    @JsonProperty("MVR-1-2-3")
    private String MVR_1_2_3; // 冠状动脉病变数量
    public String getMVR_1_2_3() {  return this.MVR_1_2_3;}
    @JsonProperty("MVR-1-2-3")
    public void setMVR_1_2_3(final String MVR_1_2_3) { this.MVR_1_2_3=MVR_1_2_3;}
    @Column(name = "MVR_1_2_4")
    @JsonProperty("MVR-1-2-4")
    private String MVR_1_2_4; // 血管病变主要位置
    public String getMVR_1_2_4() {  return this.MVR_1_2_4;}
    @JsonProperty("MVR-1-2-4")
    public void setMVR_1_2_4(final String MVR_1_2_4) { this.MVR_1_2_4=MVR_1_2_4;}
    @Column(name = "MVR_1_3_1")
    @JsonProperty("MVR-1-3-1")
    private String MVR_1_3_1; // 是否使用SinoSCOREⅡ风险评估表进行手术前风险评估
    public String getMVR_1_3_1() {  return this.MVR_1_3_1;}
    @JsonProperty("MVR-1-3-1")
    public void setMVR_1_3_1(final String MVR_1_3_1) { this.MVR_1_3_1=MVR_1_3_1;}
    @Column(name = "MVR_1_3_2")
    @JsonProperty("MVR-1-3-2")
    private String MVR_1_3_2; // MVR手术风险评估（SinoSCOREⅡ）评估值
    public String getMVR_1_3_2() {  return this.MVR_1_3_2;}
    @JsonProperty("MVR-1-3-2")
    public void setMVR_1_3_2(final String MVR_1_3_2) { this.MVR_1_3_2=MVR_1_3_2;}
    @Column(name = "MVR_1_3_3")
    @JsonProperty("MVR-1-3-3")
    private String MVR_1_3_3; // 评估结果分层的选择
    public String getMVR_1_3_3() {  return this.MVR_1_3_3;}
    @JsonProperty("MVR-1-3-3")
    public void setMVR_1_3_3(final String MVR_1_3_3) { this.MVR_1_3_3=MVR_1_3_3;}
    @Column(name = "MVR_1_4_1")
    @JsonProperty("MVR-1-4-1")
    private String MVR_1_4_1; // 是否使用欧州心血管手术危险因素评分 EuroSCORE进行手术前评估
    public String getMVR_1_4_1() {  return this.MVR_1_4_1;}
    @JsonProperty("MVR-1-4-1")
    public void setMVR_1_4_1(final String MVR_1_4_1) { this.MVR_1_4_1=MVR_1_4_1;}
    @Column(name = "MVR_1_4_3")
    @JsonProperty("MVR-1-4-3")
    private String MVR_1_4_3; // 欧州心血管手术危险因素评分 EuroSCORE值
    public String getMVR_1_4_3() {  return this.MVR_1_4_3;}
    @JsonProperty("MVR-1-4-3")
    public void setMVR_1_4_3(final String MVR_1_4_3) { this.MVR_1_4_3=MVR_1_4_3;}
    @Column(name = "MVR_1_4_2")
    @JsonProperty("MVR-1-4-2")
    private String MVR_1_4_2; // 评估结果分层的选择
    public String getMVR_1_4_2() {  return this.MVR_1_4_2;}
    @JsonProperty("MVR-1-4-2")
    public void setMVR_1_4_2(final String MVR_1_4_2) { this.MVR_1_4_2=MVR_1_4_2;}
    @Column(name = "MVR_2_1_1")
    @JsonProperty("MVR-2-1-1")
    private String MVR_2_1_1; // 二尖瓣手术适应证
    public String getMVR_2_1_1() {  return this.MVR_2_1_1;}
    @JsonProperty("MVR-2-1-1")
    public void setMVR_2_1_1(final String MVR_2_1_1) { this.MVR_2_1_1=MVR_2_1_1;}
    @Column(name = "MVR_2_1_1_1")
    @JsonProperty("MVR-2-1-1-1")
    private String MVR_2_1_1_1; // 其他二尖瓣手术适应证
    public String getMVR_2_1_1_1() {  return this.MVR_2_1_1_1;}
    @JsonProperty("MVR-2-1-1-1")
    public void setMVR_2_1_1_1(final String MVR_2_1_1_1) { this.MVR_2_1_1_1=MVR_2_1_1_1;}
    @Column(name = "MVR_2_2_1")
    @JsonProperty("MVR-2-2-1")
    private String MVR_2_2_1; // 是否实施急诊二尖瓣手术
    public String getMVR_2_2_1() {  return this.MVR_2_2_1;}
    @JsonProperty("MVR-2-2-1")
    public void setMVR_2_2_1(final String MVR_2_2_1) { this.MVR_2_2_1=MVR_2_2_1;}
    @Column(name = "MVR_2_2_2")
    @JsonProperty("MVR-2-2-2")
    private String MVR_2_2_2; // 是否人工机械瓣膜急性功能障碍
    public String getMVR_2_2_2() {  return this.MVR_2_2_2;}
    @JsonProperty("MVR-2-2-2")
    public void setMVR_2_2_2(final String MVR_2_2_2) { this.MVR_2_2_2=MVR_2_2_2;}
    @Column(name = "MVR_2_3_1")
    @JsonProperty("MVR-2-3-1")
    private String MVR_2_3_1; // 是否同时合并其他手术
    public String getMVR_2_3_1() {  return this.MVR_2_3_1;}
    @JsonProperty("MVR-2-3-1")
    public void setMVR_2_3_1(final String MVR_2_3_1) { this.MVR_2_3_1=MVR_2_3_1;}
    @Column(name = "MVR_2_3_2")
    @JsonProperty("MVR-2-3-2")
    private String MVR_2_3_2; // 合并其他手术种类
    public String getMVR_2_3_2() {  return this.MVR_2_3_2;}
    @JsonProperty("MVR-2-3-2")
    public void setMVR_2_3_2(final String MVR_2_3_2) { this.MVR_2_3_2=MVR_2_3_2;}
    @Column(name = "MVR_2_4_1")
    @JsonProperty("MVR-2-4-1")
    private String MVR_2_4_1; // 手术切口的选择
    public String getMVR_2_4_1() {  return this.MVR_2_4_1;}
    @JsonProperty("MVR-2-4-1")
    public void setMVR_2_4_1(final String MVR_2_4_1) { this.MVR_2_4_1=MVR_2_4_1;}
    @Column(name = "MVR_2_4_1_1")
    @JsonProperty("MVR-2-4-1-1")
    private String MVR_2_4_1_1; // 其他手术切口
    public String getMVR_2_4_1_1() {  return this.MVR_2_4_1_1;}
    @JsonProperty("MVR-2-4-1-1")
    public void setMVR_2_4_1_1(final String MVR_2_4_1_1) { this.MVR_2_4_1_1=MVR_2_4_1_1;}
    @Column(name = "MVR_3_1_1")
    @JsonProperty("MVR-3-1-1")
    private String MVR_3_1_1; // 二尖瓣病变类型
    public String getMVR_3_1_1() {  return this.MVR_3_1_1;}
    @JsonProperty("MVR-3-1-1")
    public void setMVR_3_1_1(final String MVR_3_1_1) { this.MVR_3_1_1=MVR_3_1_1;}
    @Column(name = "MVR_3_1_2")
    @JsonProperty("MVR-3-1-2")
    private String MVR_3_1_2; // 二尖瓣手术种类
    public String getMVR_3_1_2() {  return this.MVR_3_1_2;}
    @JsonProperty("MVR-3-1-2")
    public void setMVR_3_1_2(final String MVR_3_1_2) { this.MVR_3_1_2=MVR_3_1_2;}
    @Column(name = "MVR_3_1_3")
    @JsonProperty("MVR-3-1-3")
    private String MVR_3_1_3; // 瓣膜种类
    public String getMVR_3_1_3() {  return this.MVR_3_1_3;}
    @JsonProperty("MVR-3-1-3")
    public void setMVR_3_1_3(final String MVR_3_1_3) { this.MVR_3_1_3=MVR_3_1_3;}
    @Column(name = "MVR_3_2_1")
    @JsonProperty("MVR-3-2-1")
    private String MVR_3_2_1; // 是否使用体外循环辅助的二尖瓣手术
    public String getMVR_3_2_1() {  return this.MVR_3_2_1;}
    @JsonProperty("MVR-3-2-1")
    public void setMVR_3_2_1(final String MVR_3_2_1) { this.MVR_3_2_1=MVR_3_2_1;}
    @Column(name = "MVR_3_2_2")
    @JsonProperty("MVR-3-2-2")
    private String MVR_3_2_2; // 体外循环起始日期时间
    public String getMVR_3_2_2() {  return this.MVR_3_2_2;}
    @JsonProperty("MVR-3-2-2")
    public void setMVR_3_2_2(final String MVR_3_2_2) { this.MVR_3_2_2=MVR_3_2_2;}
    @Column(name = "MVR_3_2_3")
    @JsonProperty("MVR-3-2-3")
    private String MVR_3_2_3; // 体外循环结朿日期时间
    public String getMVR_3_2_3() {  return this.MVR_3_2_3;}
    @JsonProperty("MVR-3-2-3")
    public void setMVR_3_2_3(final String MVR_3_2_3) { this.MVR_3_2_3=MVR_3_2_3;}
    @Column(name = "MVR_3_2_4")
    @JsonProperty("MVR-3-2-4")
    private String MVR_3_2_4; // 体外循环持续时间(分钟)
    public String getMVR_3_2_4() {  return this.MVR_3_2_4;}
    @JsonProperty("MVR-3-2-4")
    public void setMVR_3_2_4(final String MVR_3_2_4) { this.MVR_3_2_4=MVR_3_2_4;}
    @Column(name = "MVR_3_3_1")
    @JsonProperty("MVR-3-3-1")
    private String MVR_3_3_1; // 术中是否使用TEE超声
    public String getMVR_3_3_1() {  return this.MVR_3_3_1;}
    @JsonProperty("MVR-3-3-1")
    public void setMVR_3_3_1(final String MVR_3_3_1) { this.MVR_3_3_1=MVR_3_3_1;}
    @Column(name = "MVR_3_3_2")
    @JsonProperty("MVR-3-3-2")
    private String MVR_3_3_2; // TEE返流分级
    public String getMVR_3_3_2() {  return this.MVR_3_3_2;}
    @JsonProperty("MVR-3-3-2")
    public void setMVR_3_3_2(final String MVR_3_3_2) { this.MVR_3_3_2=MVR_3_3_2;}
    @Column(name = "MVR_3_4_1")
    @JsonProperty("MVR-3-4-1")
    private String MVR_3_4_1; // 是否围术期使用血制品
    public String getMVR_3_4_1() {  return this.MVR_3_4_1;}
    @JsonProperty("MVR-3-4-1")
    public void setMVR_3_4_1(final String MVR_3_4_1) { this.MVR_3_4_1=MVR_3_4_1;}
    @Column(name = "MVR_3_4_2")
    @JsonProperty("MVR-3-4-2")
    private String MVR_3_4_2; // 全血量(ml)
    public String getMVR_3_4_2() {  return this.MVR_3_4_2;}
    @JsonProperty("MVR-3-4-2")
    public void setMVR_3_4_2(final String MVR_3_4_2) { this.MVR_3_4_2=MVR_3_4_2;}
    @Column(name = "MVR_3_4_3")
    @JsonProperty("MVR-3-4-3")
    private String MVR_3_4_3; // 红细胞量(ml)
    public String getMVR_3_4_3() {  return this.MVR_3_4_3;}
    @JsonProperty("MVR-3-4-3")
    public void setMVR_3_4_3(final String MVR_3_4_3) { this.MVR_3_4_3=MVR_3_4_3;}
    @Column(name = "MVR_3_4_4")
    @JsonProperty("MVR-3-4-4")
    private String MVR_3_4_4; // 血浆量(ml)
    public String getMVR_3_4_4() {  return this.MVR_3_4_4;}
    @JsonProperty("MVR-3-4-4")
    public void setMVR_3_4_4(final String MVR_3_4_4) { this.MVR_3_4_4=MVR_3_4_4;}
    @Column(name = "MVR_3_4_5")
    @JsonProperty("MVR-3-4-5")
    private String MVR_3_4_5; // 血小板量(ml)
    public String getMVR_3_4_5() {  return this.MVR_3_4_5;}
    @JsonProperty("MVR-3-4-5")
    public void setMVR_3_4_5(final String MVR_3_4_5) { this.MVR_3_4_5=MVR_3_4_5;}
    @Column(name = "MVR_3_4_6")
    @JsonProperty("MVR-3-4-6")
    private String MVR_3_4_6; // 临床用血总量(ml)
    public String getMVR_3_4_6() {  return this.MVR_3_4_6;}
    @JsonProperty("MVR-3-4-6")
    public void setMVR_3_4_6(final String MVR_3_4_6) { this.MVR_3_4_6=MVR_3_4_6;}
    @Column(name = "MVR_3_5_0")
    @JsonProperty("MVR-3-5-0")
    private String MVR_3_5_0; // 是否术后入住ICU/术后复苏室
    public String getMVR_3_5_0() {  return this.MVR_3_5_0;}
    @JsonProperty("MVR-3-5-0")
    public void setMVR_3_5_0(final String MVR_3_5_0) { this.MVR_3_5_0=MVR_3_5_0;}
    @Column(name = "MVR_3_5_1")
    @JsonProperty("MVR-3-5-1")
    private String MVR_3_5_1; // 是否ICU/术后复苏室实施机械通气
    public String getMVR_3_5_1() {  return this.MVR_3_5_1;}
    @JsonProperty("MVR-3-5-1")
    public void setMVR_3_5_1(final String MVR_3_5_1) { this.MVR_3_5_1=MVR_3_5_1;}
    @Column(name = "MVR_3_5_2")
    @JsonProperty("MVR-3-5-2")
    private String MVR_3_5_2; // 起始日期时间
    public String getMVR_3_5_2() {  return this.MVR_3_5_2;}
    @JsonProperty("MVR-3-5-2")
    public void setMVR_3_5_2(final String MVR_3_5_2) { this.MVR_3_5_2=MVR_3_5_2;}
    @Column(name = "MVR_3_5_3")
    @JsonProperty("MVR-3-5-3")
    private String MVR_3_5_3; // 终止日期时间
    public String getMVR_3_5_3() {  return this.MVR_3_5_3;}
    @JsonProperty("MVR-3-5-3")
    public void setMVR_3_5_3(final String MVR_3_5_3) { this.MVR_3_5_3=MVR_3_5_3;}
    ...
    @Column(name = "MVR_5_1_1")
    @JsonProperty("MVR-5-1-1")
    private String MVR_5_1_1; // 是否术后活动性出血或血肿
    public String getMVR_5_1_1() {  return this.MVR_5_1_1;}
    @JsonProperty("MVR-5-1-1")
    public void setMVR_5_1_1(final String MVR_5_1_1) { this.MVR_5_1_1=MVR_5_1_1;}
    @Column(name = "MVR_5_1_2")
    @JsonProperty("MVR-5-1-2")
    private String MVR_5_1_2; // 术后活动性出血或血肿主要情况
    public String getMVR_5_1_2() {  return this.MVR_5_1_2;}
    @JsonProperty("MVR-5-1-2")
    public void setMVR_5_1_2(final String MVR_5_1_2) { this.MVR_5_1_2=MVR_5_1_2;}
    @Column(name = "MVR_5_2_1")
    @JsonProperty("MVR-5-2-1")
    private String MVR_5_2_1; // 是否再手术
    public String getMVR_5_2_1() {  return this.MVR_5_2_1;}
    @JsonProperty("MVR-5-2-1")
    public void setMVR_5_2_1(final String MVR_5_2_1) { this.MVR_5_2_1=MVR_5_2_1;}
    @Column(name = "MVR_5_2_2")
    @JsonProperty("MVR-5-2-2")
    private String MVR_5_2_2; // 再手术指征的选择
    public String getMVR_5_2_2() {  return this.MVR_5_2_2;}
    @JsonProperty("MVR-5-2-2")
    public void setMVR_5_2_2(final String MVR_5_2_2) { this.MVR_5_2_2=MVR_5_2_2;}
    @Column(name = "MVR_5_2_2_1")
    @JsonProperty("MVR-5-2-2-1")
    private String MVR_5_2_2_1; // 其他心脏问题再手术
    public String getMVR_5_2_2_1() {  return this.MVR_5_2_2_1;}
    @JsonProperty("MVR-5-2-2-1")
    public void setMVR_5_2_2_1(final String MVR_5_2_2_1) { this.MVR_5_2_2_1=MVR_5_2_2_1;}
    @Column(name = "MVR_5_2_2_2")
    @JsonProperty("MVR-5-2-2-2")
    private String MVR_5_2_2_2; // 其他非心脏问题再手术
    public String getMVR_5_2_2_2() {  return this.MVR_5_2_2_2;}
    @JsonProperty("MVR-5-2-2-2")
    public void setMVR_5_2_2_2(final String MVR_5_2_2_2) { this.MVR_5_2_2_2=MVR_5_2_2_2;}
    @Column(name = "MVR_5_2_3")
    @JsonProperty("MVR-5-2-3")
    private String MVR_5_2_3; // 再手术起始日期时间
    public String getMVR_5_2_3() {  return this.MVR_5_2_3;}
    @JsonProperty("MVR-5-2-3")
    public void setMVR_5_2_3(final String MVR_5_2_3) { this.MVR_5_2_3=MVR_5_2_3;}
    @Column(name = "CM_2_1")
    @JsonProperty("CM-2-1")
    ...
    @JsonProperty("CM-6-1-3")
    private String CM_6_1_3; // 心脏手术后特指并发症类别及ICD-10四位亚目的选择
    public String getCM_6_1_3() {  return this.CM_6_1_3;}
    @JsonProperty("CM-6-1-3")
    public void setCM_6_1_3(final String CM_6_1_3) { this.CM_6_1_3=CM_6_1_3;}
    @Column(name = "CM_2_4")
    @JsonProperty("CM-2-4")
    ...
    @Column(name = "MVR_7_1_1")
    @JsonProperty("MVR-7-1-1")
    private String MVR_7_1_1; // 出院时是否有继续使用华法林的带药医嘱
    public String getMVR_7_1_1() {  return this.MVR_7_1_1;}
    @JsonProperty("MVR-7-1-1")
    public void setMVR_7_1_1(final String MVR_7_1_1) { this.MVR_7_1_1=MVR_7_1_1;}
    @Column(name = "MVR_7_2_1")
    @JsonProperty("MVR-7-2-1")
    private String MVR_7_2_1; // 出院时是否有继续使用除华法林外其他抗凝药物的用药医嘱
    public String getMVR_7_2_1() {  return this.MVR_7_2_1;}
    @JsonProperty("MVR-7-2-1")
    public void setMVR_7_2_1(final String MVR_7_2_1) { this.MVR_7_2_1=MVR_7_2_1;}
    @Column(name = "MVR_7_2_2")
    @JsonProperty("MVR-7-2-2")
    private String MVR_7_2_2; // 其他抗凝药物用药
    public String getMVR_7_2_2() {  return this.MVR_7_2_2;}
    @JsonProperty("MVR-7-2-2")
    public void setMVR_7_2_2(final String MVR_7_2_2) { this.MVR_7_2_2=MVR_7_2_2;}
    @Column(name = "MVR_7_2_2_1")
    @JsonProperty("MVR-7-2-2-1")
    private String MVR_7_2_2_1; // 其他抗凝药物名称
    public String getMVR_7_2_2_1() {  return this.MVR_7_2_2_1;}
    @JsonProperty("MVR-7-2-2-1")
    public void setMVR_7_2_2_1(final String MVR_7_2_2_1) { this.MVR_7_2_2_1=MVR_7_2_2_1;}
    @Column(name = "MVR_8_1_1")
    @JsonProperty("MVR-8-1-1")
    private String MVR_8_1_1; // 是否进行术前、术后健康教育，且有记录
    public String getMVR_8_1_1() {  return this.MVR_8_1_1;}
    @JsonProperty("MVR-8-1-1")
    public void setMVR_8_1_1(final String MVR_8_1_1) { this.MVR_8_1_1=MVR_8_1_1;}
    @Column(name = "MVR_8_1_2")
    @JsonProperty("MVR-8-1-2")
    private String MVR_8_1_2; // MVR手术术前,术后的健康教育
    public String getMVR_8_1_2() {  return this.MVR_8_1_2;}
    @JsonProperty("MVR-8-1-2")
    public void setMVR_8_1_2(final String MVR_8_1_2) { this.MVR_8_1_2=MVR_8_1_2;}
    @Column(name = "MVR_8_2_1")
    @JsonProperty("MVR-8-2-1")
    private String MVR_8_2_1; // 出院时,告知患者/家属高危因素评估结果
    public String getMVR_8_2_1() {  return this.MVR_8_2_1;}
    @JsonProperty("MVR-8-2-1")
    public void setMVR_8_2_1(final String MVR_8_2_1) { this.MVR_8_2_1=MVR_8_2_1;}
    @Column(name = "MVR_8_2_2")
    @JsonProperty("MVR-8-2-2")
    private String MVR_8_2_2; // 常见高危因素的选择
    public String getMVR_8_2_2() {  return this.MVR_8_2_2;}
    @JsonProperty("MVR-8-2-2")
    public void setMVR_8_2_2(final String MVR_8_2_2) { this.MVR_8_2_2=MVR_8_2_2;}
    @Column(name = "MVR_8_2_2_1")
    @JsonProperty("MVR-8-2-2-1")
    private String MVR_8_2_2_1; // 其他常见高危因素
    public String getMVR_8_2_2_1() {  return this.MVR_8_2_2_1;}
    @JsonProperty("MVR-8-2-2-1")
    public void setMVR_8_2_2_1(final String MVR_8_2_2_1) { this.MVR_8_2_2_1=MVR_8_2_2_1;}
    @Column(name = "MVR_4_2_2_1")
    @JsonProperty("MVR-4-2-2-1")
    private String MVR_4_2_2_1; // 其它特殊使用级抗菌药物填写
    public String getMVR_4_2_2_1() {  return this.MVR_4_2_2_1;}
    @JsonProperty("MVR-4-2-2-1")
    public void setMVR_4_2_2_1(final String MVR_4_2_2_1) { this.MVR_4_2_2_1=MVR_4_2_2_1;}
    @Column(name = "MVR_8_3_1")
    @JsonProperty("MVR-8-3-1")
    private String MVR_8_3_1; // 是否履行出院教育与告知责任，且有记录
    public String getMVR_8_3_1() {  return this.MVR_8_3_1;}
    @JsonProperty("MVR-8-3-1")
    public void setMVR_8_3_1(final String MVR_8_3_1) { this.MVR_8_3_1=MVR_8_3_1;}
