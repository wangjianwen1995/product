...
public class SdInfoTKR implements Serializable {
    ...
    public String getKnee_0_1_4_1() {  return this.Knee_0_1_4_1;}
    @JsonProperty("Knee-0-1-4-1")
    public void setKnee_0_1_4_1(final String Knee_0_1_4_1) { this.Knee_0_1_4_1=Knee_0_1_4_1;}
    ...
    public String getKnee_0_1_3_1() {  return this.Knee_0_1_3_1;}
    @JsonProperty("Knee-0-1-3-1")
    public void setKnee_0_1_3_1(final String Knee_0_1_3_1) { this.Knee_0_1_3_1=Knee_0_1_3_1;}
    ...
    public String getKnee_1_1() {  return this.Knee_1_1;}
    @JsonProperty("Knee-1-1")
    public void setKnee_1_1(final String Knee_1_1) { this.Knee_1_1=Knee_1_1;}
    @Column(name = "Knee_1_1_1")
    @JsonProperty("Knee-1-1-1")
    private String Knee_1_1_1; // 其他人工膝关节置换术适应证
    public String getKnee_1_1_1() {  return this.Knee_1_1_1;}
    @JsonProperty("Knee-1-1-1")
    public void setKnee_1_1_1(final String Knee_1_1_1) { this.Knee_1_1_1=Knee_1_1_1;}
    @Column(name = "Knee_1_2_2_0")
    @JsonProperty("Knee-1-2-2-0")
    private String Knee_1_2_2_0; // 手术病变侧别
    public String getKnee_1_2_2_0() {  return this.Knee_1_2_2_0;}
    @JsonProperty("Knee-1-2-2-0")
    public void setKnee_1_2_2_0(final String Knee_1_2_2_0) { this.Knee_1_2_2_0=Knee_1_2_2_0;}
    @Column(name = "Knee_1_2_1")
    @JsonProperty("Knee-1-2-1")
    private String Knee_1_2_1; // 是否实施膝关节功能评估
    public String getKnee_1_2_1() {  return this.Knee_1_2_1;}
    @JsonProperty("Knee-1-2-1")
    public void setKnee_1_2_1(final String Knee_1_2_1) { this.Knee_1_2_1=Knee_1_2_1;}
    @Column(name = "Knee_1_2_2_2")
    @JsonProperty("Knee-1-2-2-2")
    private String Knee_1_2_2_2; // 左HSS评分值
    public String getKnee_1_2_2_2() {  return this.Knee_1_2_2_2;}
    @JsonProperty("Knee-1-2-2-2")
    public void setKnee_1_2_2_2(final String Knee_1_2_2_2) { this.Knee_1_2_2_2=Knee_1_2_2_2;}
    @Column(name = "Knee_1_2_2_4")
    @JsonProperty("Knee-1-2-2-4")
    private String Knee_1_2_2_4; // 左评估结果
    public String getKnee_1_2_2_4() {  return this.Knee_1_2_2_4;}
    @JsonProperty("Knee-1-2-2-4")
    public void setKnee_1_2_2_4(final String Knee_1_2_2_4) { this.Knee_1_2_2_4=Knee_1_2_2_4;}
    @Column(name = "Knee_1_2_2_1")
    @JsonProperty("Knee-1-2-2-1")
    private String Knee_1_2_2_1; // 右HSS评分值
    public String getKnee_1_2_2_1() {  return this.Knee_1_2_2_1;}
    @JsonProperty("Knee-1-2-2-1")
    public void setKnee_1_2_2_1(final String Knee_1_2_2_1) { this.Knee_1_2_2_1=Knee_1_2_2_1;}
    @Column(name = "Knee_1_2_2_3")
    @JsonProperty("Knee-1-2-2-3")
    private String Knee_1_2_2_3; // 右评估结果
    public String getKnee_1_2_2_3() {  return this.Knee_1_2_2_3;}
    @JsonProperty("Knee-1-2-2-3")
    public void setKnee_1_2_2_3(final String Knee_1_2_2_3) { this.Knee_1_2_2_3=Knee_1_2_2_3;}
    @Column(name = "Knee_1_3_1")
    @JsonProperty("Knee-1-3-1")
    private String Knee_1_3_1; // 麻醉方式的选择
    public String getKnee_1_3_1() {  return this.Knee_1_3_1;}
    @JsonProperty("Knee-1-3-1")
    public void setKnee_1_3_1(final String Knee_1_3_1) { this.Knee_1_3_1=Knee_1_3_1;}
    @Column(name = "Knee_1_3_2")
    @JsonProperty("Knee-1-3-2")
    private String Knee_1_3_2; // 手术部位的选择
    public String getKnee_1_3_2() {  return this.Knee_1_3_2;}
    @JsonProperty("Knee-1-3-2")
    public void setKnee_1_3_2(final String Knee_1_3_2) { this.Knee_1_3_2=Knee_1_3_2;}
    @Column(name = "Knee_1_3_3")
    @JsonProperty("Knee-1-3-3")
    private String Knee_1_3_3; // 止血带使用时间的选择
    public String getKnee_1_3_3() {  return this.Knee_1_3_3;}
    @JsonProperty("Knee-1-3-3")
    public void setKnee_1_3_3(final String Knee_1_3_3) { this.Knee_1_3_3=Knee_1_3_3;}
    @Column(name = "Knee_1_4_1")
    @JsonProperty("Knee-1-4-1")
    private String Knee_1_4_1; // 决定手术方案的医师资质
    public String getKnee_1_4_1() {  return this.Knee_1_4_1;}
    @JsonProperty("Knee-1-4-1")
    public void setKnee_1_4_1(final String Knee_1_4_1) { this.Knee_1_4_1=Knee_1_4_1;}
    ...
    public String getKnee_3_1_1() {  return this.Knee_3_1_1;}
    @JsonProperty("Knee-3-1-1")
    public void setKnee_3_1_1(final String Knee_3_1_1) { this.Knee_3_1_1=Knee_3_1_1;}
    @Column(name = "Knee_3_1_2")
    @JsonProperty("Knee-3-1-2")
    private String Knee_3_1_2; // Caprini评估分值
    public String getKnee_3_1_2() {  return this.Knee_3_1_2;}
    @JsonProperty("Knee-3-1-2")
    public void setKnee_3_1_2(final String Knee_3_1_2) { this.Knee_3_1_2=Knee_3_1_2;}
    @Column(name = "Knee_3_1_3")
    @JsonProperty("Knee-3-1-3")
    private String Knee_3_1_3; // Caprini评估风险分层
    public String getKnee_3_1_3() {  return this.Knee_3_1_3;}
    @JsonProperty("Knee-3-1-3")
    public void setKnee_3_1_3(final String Knee_3_1_3) { this.Knee_3_1_3=Knee_3_1_3;}
    @Column(name = "Knee_3_1_8")
    @JsonProperty("Knee-3-1-8")
    private String Knee_3_1_8; // 临床常用检测方法
    public String getKnee_3_1_8() {  return this.Knee_3_1_8;}
    @JsonProperty("Knee-3-1-8")
    public void setKnee_3_1_8(final String Knee_3_1_8) { this.Knee_3_1_8=Knee_3_1_8;}
    @Column(name = "Knee_3_2_1")
    @JsonProperty("Knee-3-2-1")
    private String Knee_3_2_1; // 实施预防术后深静脉血栓措施是否有禁忌
    public String getKnee_3_2_1() {  return this.Knee_3_2_1;}
    @JsonProperty("Knee-3-2-1")
    public void setKnee_3_2_1(final String Knee_3_2_1) { this.Knee_3_2_1=Knee_3_2_1;}
    @Column(name = "Knee_3_2_3")
    @JsonProperty("Knee-3-2-3")
    private String Knee_3_2_3; // 实施机械预防措施应用禁忌
    public String getKnee_3_2_3() {  return this.Knee_3_2_3;}
    @JsonProperty("Knee-3-2-3")
    public void setKnee_3_2_3(final String Knee_3_2_3) { this.Knee_3_2_3=Knee_3_2_3;}
    @Column(name = "Knee_3_2_2")
    @JsonProperty("Knee-3-2-2")
    private String Knee_3_2_2; // 实施药物应用绝对禁忌证
    public String getKnee_3_2_2() {  return this.Knee_3_2_2;}
    @JsonProperty("Knee-3-2-2")
    public void setKnee_3_2_2(final String Knee_3_2_2) { this.Knee_3_2_2=Knee_3_2_2;}
    @Column(name = "Knee_3_2_4")
    @JsonProperty("Knee-3-2-4")
    private String Knee_3_2_4; // 实施药物应用相对禁忌证
    public String getKnee_3_2_4() {  return this.Knee_3_2_4;}
    @JsonProperty("Knee-3-2-4")
    public void setKnee_3_2_4(final String Knee_3_2_4) { this.Knee_3_2_4=Knee_3_2_4;}
    @Column(name = "Knee_3_3_1")
    @JsonProperty("Knee-3-3-1")
    private String Knee_3_3_1; // 预防深静脉栓塞医嘱执行时间
    public String getKnee_3_3_1() {  return this.Knee_3_3_1;}
    @JsonProperty("Knee-3-3-1")
    public void setKnee_3_3_1(final String Knee_3_3_1) { this.Knee_3_3_1=Knee_3_3_1;}
    @Column(name = "Knee_3_4_1")
    @JsonProperty("Knee-3-4-1")
    private String Knee_3_4_1; // 基本预防措施
    public String getKnee_3_4_1() {  return this.Knee_3_4_1;}
    @JsonProperty("Knee-3-4-1")
    public void setKnee_3_4_1(final String Knee_3_4_1) { this.Knee_3_4_1=Knee_3_4_1;}
    @Column(name = "Knee_3_4_1_1")
    @JsonProperty("Knee-3-4-1-1")
    private String Knee_3_4_1_1; // 其他基本预防措施
    public String getKnee_3_4_1_1() {  return this.Knee_3_4_1_1;}
    @JsonProperty("Knee-3-4-1-1")
    public void setKnee_3_4_1_1(final String Knee_3_4_1_1) { this.Knee_3_4_1_1=Knee_3_4_1_1;}
    @Column(name = "Knee_3_4_1_2")
    @JsonProperty("Knee-3-4-1-2")
    private String Knee_3_4_1_2; // 基本预防措施医嘱执行日期
    public String getKnee_3_4_1_2() {  return this.Knee_3_4_1_2;}
    @JsonProperty("Knee-3-4-1-2")
    public void setKnee_3_4_1_2(final String Knee_3_4_1_2) { this.Knee_3_4_1_2=Knee_3_4_1_2;}
    @Column(name = "Knee_3_4_2")
    @JsonProperty("Knee-3-4-2")
    private String Knee_3_4_2; // 机械预防措施
    public String getKnee_3_4_2() {  return this.Knee_3_4_2;}
    @JsonProperty("Knee-3-4-2")
    public void setKnee_3_4_2(final String Knee_3_4_2) { this.Knee_3_4_2=Knee_3_4_2;}
    @Column(name = "Knee_3_4_2_1")
    @JsonProperty("Knee-3-4-2-1")
    private String Knee_3_4_2_1; // 其他机械预防措施
    public String getKnee_3_4_2_1() {  return this.Knee_3_4_2_1;}
    @JsonProperty("Knee-3-4-2-1")
    public void setKnee_3_4_2_1(final String Knee_3_4_2_1) { this.Knee_3_4_2_1=Knee_3_4_2_1;}
    @Column(name = "Knee_3_4_2_2")
    @JsonProperty("Knee-3-4-2-2")
    private String Knee_3_4_2_2; // 机械预防措施医嘱执行日期
    public String getKnee_3_4_2_2() {  return this.Knee_3_4_2_2;}
    @JsonProperty("Knee-3-4-2-2")
    public void setKnee_3_4_2_2(final String Knee_3_4_2_2) { this.Knee_3_4_2_2=Knee_3_4_2_2;}
    @Column(name = "Knee_3_4_3")
    @JsonProperty("Knee-3-4-3")
    private String Knee_3_4_3; // 预防性地给予药物治疗
    public String getKnee_3_4_3() {  return this.Knee_3_4_3;}
    @JsonProperty("Knee-3-4-3")
    public void setKnee_3_4_3(final String Knee_3_4_3) { this.Knee_3_4_3=Knee_3_4_3;}
    @Column(name = "Knee_3_4_3_1")
    @JsonProperty("Knee-3-4-3-1")
    private String Knee_3_4_3_1; // 预防性地给予药物治疗填写
    public String getKnee_3_4_3_1() {  return this.Knee_3_4_3_1;}
    @JsonProperty("Knee-3-4-3-1")
    public void setKnee_3_4_3_1(final String Knee_3_4_3_1) { this.Knee_3_4_3_1=Knee_3_4_3_1;}
    @Column(name = "Knee_3_4_3_2")
    @JsonProperty("Knee-3-4-3-2")
    private String Knee_3_4_3_2; // 预防性地给予药物医嘱执行日期
    public String getKnee_3_4_3_2() {  return this.Knee_3_4_3_2;}
    @JsonProperty("Knee-3-4-3-2")
    public void setKnee_3_4_3_2(final String Knee_3_4_3_2) { this.Knee_3_4_3_2=Knee_3_4_3_2;}
    @Column(name = "Knee_3_5_1")
    @JsonProperty("Knee-3-5-1")
    private String Knee_3_5_1; // 出院后继续使用抗凝药
    public String getKnee_3_5_1() {  return this.Knee_3_5_1;}
    @JsonProperty("Knee-3-5-1")
    public void setKnee_3_5_1(final String Knee_3_5_1) { this.Knee_3_5_1=Knee_3_5_1;}
    @Column(name = "Knee_3_5_1_1")
    @JsonProperty("Knee-3-5-1-1")
    private String Knee_3_5_1_1; // 其他出院后使用的抗凝药
    public String getKnee_3_5_1_1() {  return this.Knee_3_5_1_1;}
    @JsonProperty("Knee-3-5-1-1")
    public void setKnee_3_5_1_1(final String Knee_3_5_1_1) { this.Knee_3_5_1_1=Knee_3_5_1_1;}
    @Column(name = "Knee_4_1_1")
    @JsonProperty("Knee-4-1-1")
    private String Knee_4_1_1; // 是否实施输血
    public String getKnee_4_1_1() {  return this.Knee_4_1_1;}
    @JsonProperty("Knee-4-1-1")
    public void setKnee_4_1_1(final String Knee_4_1_1) { this.Knee_4_1_1=Knee_4_1_1;}
    @Column(name = "Knee_4_2_1")
    @JsonProperty("Knee-4-2-1")
    private String Knee_4_2_1; // 用血类别的选择
    public String getKnee_4_2_1() {  return this.Knee_4_2_1;}
    @JsonProperty("Knee-4-2-1")
    public void setKnee_4_2_1(final String Knee_4_2_1) { this.Knee_4_2_1=Knee_4_2_1;}
    @Column(name = "Knee_4_2_1_1")
    @JsonProperty("Knee-4-2-1-1")
    private String Knee_4_2_1_1; // 手术输血侧别
    public String getKnee_4_2_1_1() {  return this.Knee_4_2_1_1;}
    @JsonProperty("Knee-4-2-1-1")
    public void setKnee_4_2_1_1(final String Knee_4_2_1_1) { this.Knee_4_2_1_1=Knee_4_2_1_1;}
    @Column(name = "Knee_4_2_2_1")
    @JsonProperty("Knee-4-2-2-1")
    private String Knee_4_2_2_1; // 单侧手术术中输血量（ml）
    public String getKnee_4_2_2_1() {  return this.Knee_4_2_2_1;}
    @JsonProperty("Knee-4-2-2-1")
    public void setKnee_4_2_2_1(final String Knee_4_2_2_1) { this.Knee_4_2_2_1=Knee_4_2_2_1;}
    @Column(name = "Knee_4_2_2_2")
    @JsonProperty("Knee-4-2-2-2")
    private String Knee_4_2_2_2; // 单侧手术术后输血量（ml）
    public String getKnee_4_2_2_2() {  return this.Knee_4_2_2_2;}
    @JsonProperty("Knee-4-2-2-2")
    public void setKnee_4_2_2_2(final String Knee_4_2_2_2) { this.Knee_4_2_2_2=Knee_4_2_2_2;}
    @Column(name = "Knee_4_2_3_1")
    @JsonProperty("Knee-4-2-3-1")
    private String Knee_4_2_3_1; // 双侧手术术中输血量（ml）
    public String getKnee_4_2_3_1() {  return this.Knee_4_2_3_1;}
    @JsonProperty("Knee-4-2-3-1")
    public void setKnee_4_2_3_1(final String Knee_4_2_3_1) { this.Knee_4_2_3_1=Knee_4_2_3_1;}
    @Column(name = "Knee_4_2_3_2")
    @JsonProperty("Knee-4-2-3-2")
    private String Knee_4_2_3_2; // 双侧手术术后输血量（ml）
    public String getKnee_4_2_3_2() {  return this.Knee_4_2_3_2;}
    @JsonProperty("Knee-4-2-3-2")
    public void setKnee_4_2_3_2(final String Knee_4_2_3_2) { this.Knee_4_2_3_2=Knee_4_2_3_2;}
    @Column(name = "Knee_5_1_1")
    @JsonProperty("Knee-5-1-1")
    private String Knee_5_1_1; // 康复治疗前是否评估
    public String getKnee_5_1_1() {  return this.Knee_5_1_1;}
    @JsonProperty("Knee-5-1-1")
    public void setKnee_5_1_1(final String Knee_5_1_1) { this.Knee_5_1_1=Knee_5_1_1;}
    @Column(name = "Knee_5_1_2")
    @JsonProperty("Knee-5-1-2")
    private String Knee_5_1_2; // 康复治疗适宜性评估结果
    public String getKnee_5_1_2() {  return this.Knee_5_1_2;}
    @JsonProperty("Knee-5-1-2")
    public void setKnee_5_1_2(final String Knee_5_1_2) { this.Knee_5_1_2=Knee_5_1_2;}
    @Column(name = "Knee_5_1_3")
    @JsonProperty("Knee-5-1-3")
    private String Knee_5_1_3; // 康复实施人员实施康复的方式
    public String getKnee_5_1_3() {  return this.Knee_5_1_3;}
    @JsonProperty("Knee-5-1-3")
    public void setKnee_5_1_3(final String Knee_5_1_3) { this.Knee_5_1_3=Knee_5_1_3;}
    @Column(name = "Knee_5_1_4")
    @JsonProperty("Knee-5-1-4")
    private String Knee_5_1_4; // 康复实施日期(首次)
    public String getKnee_5_1_4() {  return this.Knee_5_1_4;}
    @JsonProperty("Knee-5-1-4")
    public void setKnee_5_1_4(final String Knee_5_1_4) { this.Knee_5_1_4=Knee_5_1_4;}
    @Column(name = "Knee_5_1_5")
    @JsonProperty("Knee-5-1-5")
    private String Knee_5_1_5; // 选择未能进行康复原因
    public String getKnee_5_1_5() {  return this.Knee_5_1_5;}
    @JsonProperty("Knee-5-1-5")
    public void setKnee_5_1_5(final String Knee_5_1_5) { this.Knee_5_1_5=Knee_5_1_5;}
    @Column(name = "Knee_5_2_1_1")
    @JsonProperty("Knee-5-2-1-1")
    private String Knee_5_2_1_1; // 是否进行手术后镇痛治疗
    public String getKnee_5_2_1_1() {  return this.Knee_5_2_1_1;}
    @JsonProperty("Knee-5-2-1-1")
    public void setKnee_5_2_1_1(final String Knee_5_2_1_1) { this.Knee_5_2_1_1=Knee_5_2_1_1;}
    @Column(name = "Knee_5_2_2_2")
    @JsonProperty("Knee-5-2-2-2")
    private String Knee_5_2_2_2; // 疼痛强度评估方法的选择
    public String getKnee_5_2_2_2() {  return this.Knee_5_2_2_2;}
    @JsonProperty("Knee-5-2-2-2")
    public void setKnee_5_2_2_2(final String Knee_5_2_2_2) { this.Knee_5_2_2_2=Knee_5_2_2_2;}
    @Column(name = "Knee_5_2_2_1")
    @JsonProperty("Knee-5-2-2-1")
    private String Knee_5_2_2_1; // 其他疼痛强度评估方法
    public String getKnee_5_2_2_1() {  return this.Knee_5_2_2_1;}
    @JsonProperty("Knee-5-2-2-1")
    public void setKnee_5_2_2_1(final String Knee_5_2_2_1) { this.Knee_5_2_2_1=Knee_5_2_2_1;}
    @Column(name = "Knee_5_2_3")
    @JsonProperty("Knee-5-2-3")
    private String Knee_5_2_3; // 药物选择多模式的选择
    public String getKnee_5_2_3() {  return this.Knee_5_2_3;}
    @JsonProperty("Knee-5-2-3")
    public void setKnee_5_2_3(final String Knee_5_2_3) { this.Knee_5_2_3=Knee_5_2_3;}
    @Column(name = "Knee_5_2_3_1")
    @JsonProperty("Knee-5-2-3-1")
    private String Knee_5_2_3_1; // 其他药物选择多模式
    public String getKnee_5_2_3_1() {  return this.Knee_5_2_3_1;}
    @JsonProperty("Knee-5-2-3-1")
    public void setKnee_5_2_3_1(final String Knee_5_2_3_1) { this.Knee_5_2_3_1=Knee_5_2_3_1;}
    @Column(name = "Knee_5_2_4")
    @JsonProperty("Knee-5-2-4")
    private String Knee_5_2_4; // 镇痛用药多途径的选择
    public String getKnee_5_2_4() {  return this.Knee_5_2_4;}
    @JsonProperty("Knee-5-2-4")
    public void setKnee_5_2_4(final String Knee_5_2_4) { this.Knee_5_2_4=Knee_5_2_4;}
    @Column(name = "Knee_5_5_1")
    @JsonProperty("Knee-5-5-1")
    private String Knee_5_5_1; // 药物选择多模式填写
    public String getKnee_5_5_1() {  return this.Knee_5_5_1;}
    @JsonProperty("Knee-5-5-1")
    public void setKnee_5_5_1(final String Knee_5_5_1) { this.Knee_5_5_1=Knee_5_5_1;}
    @Column(name = "CM_2_1")
    @JsonProperty("CM-2-1")
    ...
    public String getKnee_6_1() {  return this.Knee_6_1;}
    @JsonProperty("Knee-6-1")
    public void setKnee_6_1(final String Knee_6_1) { this.Knee_6_1=Knee_6_1;}
    @Column(name = "Knee_6_2_1")
    @JsonProperty("Knee-6-2-1")
    private String Knee_6_2_1; // 主要的内科疾患
    public String getKnee_6_2_1() {  return this.Knee_6_2_1;}
    @JsonProperty("Knee-6-2-1")
    public void setKnee_6_2_1(final String Knee_6_2_1) { this.Knee_6_2_1=Knee_6_2_1;}
    @Column(name = "CM_2_4")
    @JsonProperty("CM-2-4")
    ...
    public String getKnee_8_1() {  return this.Knee_8_1;}
    @JsonProperty("Knee-8-1")
    public void setKnee_8_1(final String Knee_8_1) { this.Knee_8_1=Knee_8_1;}
    @Column(name = "Knee_8_2")
    @JsonProperty("Knee-8-2")
    private String Knee_8_2; // 术前一日的健康教育选择
    public String getKnee_8_2() {  return this.Knee_8_2;}
    @JsonProperty("Knee-8-2")
    public void setKnee_8_2(final String Knee_8_2) { this.Knee_8_2=Knee_8_2;}
    @Column(name = "Knee_8_3")
    @JsonProperty("Knee-8-3")
    private String Knee_8_3; // 术后六小时内的健康教育
    public String getKnee_8_3() {  return this.Knee_8_3;}
    @JsonProperty("Knee-8-3")
    public void setKnee_8_3(final String Knee_8_3) { this.Knee_8_3=Knee_8_3;}
    @Column(name = "Knee_8_4")
    @JsonProperty("Knee-8-4")
    private String Knee_8_4; // 术后六小时至二十四小时的健康教育 
    public String getKnee_8_4() {  return this.Knee_8_4;}
    @JsonProperty("Knee-8-4")
    public void setKnee_8_4(final String Knee_8_4) { this.Knee_8_4=Knee_8_4;}
    @Column(name = "Knee_8_5")
    @JsonProperty("Knee-8-5")
    private String Knee_8_5; // 术后一周内健康教育
    public String getKnee_8_5() {  return this.Knee_8_5;}
    @JsonProperty("Knee-8-5")
    public void setKnee_8_5(final String Knee_8_5) { this.Knee_8_5=Knee_8_5;}
    @Column(name = "Knee_8_6")
    @JsonProperty("Knee-8-6")
    private String Knee_8_6; // 术后一周后健康教育
    public String getKnee_8_6() {  return this.Knee_8_6;}
    @JsonProperty("Knee-8-6")
    public void setKnee_8_6(final String Knee_8_6) { this.Knee_8_6=Knee_8_6;}
    @Column(name = "Knee_8_7")
    @JsonProperty("Knee-8-7")
    private String Knee_8_7; // 为患者提供出院前健康教育
    public String getKnee_8_7() {  return this.Knee_8_7;}
    @JsonProperty("Knee-8-7")
    public void setKnee_8_7(final String Knee_8_7) { this.Knee_8_7=Knee_8_7;}
    @Column(name = "CM_3_1")
    @JsonProperty("CM-3-1")
