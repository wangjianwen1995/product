...
@ApiModel(value = "43信息")
@Entity
@Table(name = "sd_info_PIP")
public class SdInfoPIP implements Serializable {
    private static final long serialVersionUID = 1L;
    @Id
    private Integer id; 
    public void setId(final Integer id) {this.id = id;}
    public Integer getId() {return this.id;}
    @Column(name = "PIP_0_1_1")
    @JsonProperty("PIP-0-1-1")
    private String PIP_0_1_1; // 手术类型
    public String getPIP_0_1_1() {  return this.PIP_0_1_1;}
    @JsonProperty("PIP-0-1-1")
    public void setPIP_0_1_1(final String PIP_0_1_1) { this.PIP_0_1_1=PIP_0_1_1;}
    ...
    @Column(name = "PIP_0_1_4_1")
    @JsonProperty("PIP-0-1-4-1")
    private String PIP_0_1_4_1; // 主要手术操作栏中提取ICD-9-CM-3四位亚目编码与名称(心血管病医院)
    public String getPIP_0_1_4_1() {  return this.PIP_0_1_4_1;}
    @JsonProperty("PIP-0-1-4-1")
    public void setPIP_0_1_4_1(final String PIP_0_1_4_1) { this.PIP_0_1_4_1=PIP_0_1_4_1;}
    @Column(name = "PIP_0_1_4_2")
    @JsonProperty("PIP-0-1-4-2")
    private String PIP_0_1_4_2; // 主要手术操作栏中提取ICD-9-CM-3六位临床扩展编码与名称(心血管病医院)
    public String getPIP_0_1_4_2() {  return this.PIP_0_1_4_2;}
    @JsonProperty("PIP-0-1-4-2")
    public void setPIP_0_1_4_2(final String PIP_0_1_4_2) { this.PIP_0_1_4_2=PIP_0_1_4_2;}
    ...
    @Column(name = "PIP_1_3_3")
    @JsonProperty("PIP-1-3-3")
    private String PIP_1_3_3; // 术后是否使用抗菌药物
    public String getPIP_1_3_3() {  return this.PIP_1_3_3;}
    @JsonProperty("PIP-1-3-3")
    public void setPIP_1_3_3(final String PIP_1_3_3) { this.PIP_1_3_3=PIP_1_3_3;}
    ...
    @Column(name = "PIP_2_2_1")
    @JsonProperty("PIP-2-2-1")
    private String PIP_2_2_1; // 术前伴随内科疾患
    public String getPIP_2_2_1() {  return this.PIP_2_2_1;}
    @JsonProperty("PIP-2-2-1")
    public void setPIP_2_2_1(final String PIP_2_2_1) { this.PIP_2_2_1=PIP_2_2_1;}
    @Column(name = "CM_2_4")
    @JsonProperty("CM-2-4")
