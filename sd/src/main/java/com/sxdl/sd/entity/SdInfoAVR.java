...
public class SdInfoAVR implements Serializable {
    ...
    public String getAVR_1_1_1() {  return this.AVR_1_1_1;}
    @JsonProperty("AVR-1-1-1")
    public void setAVR_1_1_1(final String AVR_1_1_1) { this.AVR_1_1_1=AVR_1_1_1;}
    @Column(name = "AVR_1_1_2")
    @JsonProperty("AVR-1-1-2")
    private String AVR_1_1_2; // 左室射血分数（LVEF）测量值(%)
    public String getAVR_1_1_2() {  return this.AVR_1_1_2;}
    @JsonProperty("AVR-1-1-2")
    public void setAVR_1_1_2(final String AVR_1_1_2) { this.AVR_1_1_2=AVR_1_1_2;}
    @Column(name = "AVR_1_1_3")
    @JsonProperty("AVR-1-1-3")
    private String AVR_1_1_3; // LVEF评估结果的选择
    public String getAVR_1_1_3() {  return this.AVR_1_1_3;}
    @JsonProperty("AVR-1-1-3")
    public void setAVR_1_1_3(final String AVR_1_1_3) { this.AVR_1_1_3=AVR_1_1_3;}
    @Column(name = "AVR_1_1_4")
    @JsonProperty("AVR-1-1-4")
    private String AVR_1_1_4; // 左心房前后径(mm)
    public String getAVR_1_1_4() {  return this.AVR_1_1_4;}
    @JsonProperty("AVR-1-1-4")
    public void setAVR_1_1_4(final String AVR_1_1_4) { this.AVR_1_1_4=AVR_1_1_4;}
    @Column(name = "AVR_1_5_1")
    @JsonProperty("AVR-1-5-1")
    private String AVR_1_5_1; // 左心房前后径评估结果的选择
    public String getAVR_1_5_1() {  return this.AVR_1_5_1;}
    @JsonProperty("AVR-1-5-1")
    public void setAVR_1_5_1(final String AVR_1_5_1) { this.AVR_1_5_1=AVR_1_5_1;}
    @Column(name = "AVR_1_1_5")
    @JsonProperty("AVR-1-1-5")
    private String AVR_1_1_5; // 反流量(ml)
    public String getAVR_1_1_5() {  return this.AVR_1_1_5;}
    @JsonProperty("AVR-1-1-5")
    public void setAVR_1_1_5(final String AVR_1_1_5) { this.AVR_1_1_5=AVR_1_1_5;}
    @Column(name = "AVR_1_1_6")
    @JsonProperty("AVR-1-1-6")
    private String AVR_1_1_6; // 反流量评估结果的选择
    public String getAVR_1_1_6() {  return this.AVR_1_1_6;}
    @JsonProperty("AVR-1-1-6")
    public void setAVR_1_1_6(final String AVR_1_1_6) { this.AVR_1_1_6=AVR_1_1_6;}
    @Column(name = "AVR_1_1_7")
    @JsonProperty("AVR-1-1-7")
    private String AVR_1_1_7; // 主动脉瓣口面积(cm²)
    public String getAVR_1_1_7() {  return this.AVR_1_1_7;}
    @JsonProperty("AVR-1-1-7")
    public void setAVR_1_1_7(final String AVR_1_1_7) { this.AVR_1_1_7=AVR_1_1_7;}
    @Column(name = "AVR_1_5_3")
    @JsonProperty("AVR-1-5-3")
    private String AVR_1_5_3; // 主动脉瓣口面积评估结果的选择
    public String getAVR_1_5_3() {  return this.AVR_1_5_3;}
    @JsonProperty("AVR-1-5-3")
    public void setAVR_1_5_3(final String AVR_1_5_3) { this.AVR_1_5_3=AVR_1_5_3;}
    @Column(name = "AVR_1_1_8")
    @JsonProperty("AVR-1-1-8")
    private String AVR_1_1_8; // 收缩期峰值流速(m/s)
    public String getAVR_1_1_8() {  return this.AVR_1_1_8;}
    @JsonProperty("AVR-1-1-8")
    public void setAVR_1_1_8(final String AVR_1_1_8) { this.AVR_1_1_8=AVR_1_1_8;}
    @Column(name = "AVR_1_5_4")
    @JsonProperty("AVR-1-5-4")
    private String AVR_1_5_4; // 收缩期峰值流速评估结果的选择
    public String getAVR_1_5_4() {  return this.AVR_1_5_4;}
    @JsonProperty("AVR-1-5-4")
    public void setAVR_1_5_4(final String AVR_1_5_4) { this.AVR_1_5_4=AVR_1_5_4;}
    @Column(name = "AVR_1_1_9")
    @JsonProperty("AVR-1-1-9")
    private String AVR_1_1_9; // 跨瓣压差( mmHg)
    public String getAVR_1_1_9() {  return this.AVR_1_1_9;}
    @JsonProperty("AVR-1-1-9")
    public void setAVR_1_1_9(final String AVR_1_1_9) { this.AVR_1_1_9=AVR_1_1_9;}
    @Column(name = "AVR_1_5_5")
    @JsonProperty("AVR-1-5-5")
    private String AVR_1_5_5; // 跨瓣压差评估结果的选择
    public String getAVR_1_5_5() {  return this.AVR_1_5_5;}
    @JsonProperty("AVR-1-5-5")
    public void setAVR_1_5_5(final String AVR_1_5_5) { this.AVR_1_5_5=AVR_1_5_5;}
    @Column(name = "AVR_1_2_1")
    @JsonProperty("AVR-1-2-1")
    private String AVR_1_2_1; // 是否有冠心病史，或冠心病危险因素
    public String getAVR_1_2_1() {  return this.AVR_1_2_1;}
    @JsonProperty("AVR-1-2-1")
    public void setAVR_1_2_1(final String AVR_1_2_1) { this.AVR_1_2_1=AVR_1_2_1;}
    @Column(name = "AVR_1_2_2")
    @JsonProperty("AVR-1-2-2")
    private String AVR_1_2_2; // 是否实施实施手术前的冠状动脉造影评估
    public String getAVR_1_2_2() {  return this.AVR_1_2_2;}
    @JsonProperty("AVR-1-2-2")
    public void setAVR_1_2_2(final String AVR_1_2_2) { this.AVR_1_2_2=AVR_1_2_2;}
    @Column(name = "AVR_1_2_3")
    @JsonProperty("AVR-1-2-3")
    private String AVR_1_2_3; // 冠状动脉病变数量
    public String getAVR_1_2_3() {  return this.AVR_1_2_3;}
    @JsonProperty("AVR-1-2-3")
    public void setAVR_1_2_3(final String AVR_1_2_3) { this.AVR_1_2_3=AVR_1_2_3;}
    @Column(name = "AVR_1_2_5")
    @JsonProperty("AVR-1-2-5")
    private String AVR_1_2_5; // 血管病变主要位置
    public String getAVR_1_2_5() {  return this.AVR_1_2_5;}
    @JsonProperty("AVR-1-2-5")
    public void setAVR_1_2_5(final String AVR_1_2_5) { this.AVR_1_2_5=AVR_1_2_5;}
    @Column(name = "AVR_1_3_1")
    @JsonProperty("AVR-1-3-1")
    private String AVR_1_3_1; // 是否使用SinoSCOREⅡ风险评估表进行手术前风险评估
    public String getAVR_1_3_1() {  return this.AVR_1_3_1;}
    @JsonProperty("AVR-1-3-1")
    public void setAVR_1_3_1(final String AVR_1_3_1) { this.AVR_1_3_1=AVR_1_3_1;}
    @Column(name = "AVR_1_3_2")
    @JsonProperty("AVR-1-3-2")
    private String AVR_1_3_2; // AVR手术风险评估（SinoSCORE-Ⅱ）评估值
    public String getAVR_1_3_2() {  return this.AVR_1_3_2;}
    @JsonProperty("AVR-1-3-2")
    public void setAVR_1_3_2(final String AVR_1_3_2) { this.AVR_1_3_2=AVR_1_3_2;}
    @Column(name = "AVR_1_3_3")
    @JsonProperty("AVR-1-3-3")
    private String AVR_1_3_3; // 评估结果分层的选择
    public String getAVR_1_3_3() {  return this.AVR_1_3_3;}
    @JsonProperty("AVR-1-3-3")
    public void setAVR_1_3_3(final String AVR_1_3_3) { this.AVR_1_3_3=AVR_1_3_3;}
    @Column(name = "AVR_1_3_5")
    @JsonProperty("AVR-1-3-5")
    private String AVR_1_3_5; // 是否使用欧州心血管手术危险因素评分 EuroSCORE进行手术前评估
    public String getAVR_1_3_5() {  return this.AVR_1_3_5;}
    @JsonProperty("AVR-1-3-5")
    public void setAVR_1_3_5(final String AVR_1_3_5) { this.AVR_1_3_5=AVR_1_3_5;}
    @Column(name = "AVR_1_3_6")
    @JsonProperty("AVR-1-3-6")
    private String AVR_1_3_6; // 欧州心血管手术危险因素评分 EuroSCORE值
    public String getAVR_1_3_6() {  return this.AVR_1_3_6;}
    @JsonProperty("AVR-1-3-6")
    public void setAVR_1_3_6(final String AVR_1_3_6) { this.AVR_1_3_6=AVR_1_3_6;}
    @Column(name = "AVR_1_3_7")
    @JsonProperty("AVR-1-3-7")
    private String AVR_1_3_7; // 评估结果分层的选择
    public String getAVR_1_3_7() {  return this.AVR_1_3_7;}
    @JsonProperty("AVR-1-3-7")
    public void setAVR_1_3_7(final String AVR_1_3_7) { this.AVR_1_3_7=AVR_1_3_7;}
    @Column(name = "AVR_1_4_1")
    @JsonProperty("AVR-1-4-1")
    private String AVR_1_4_1; // 术前最后一次实验室检查结果
    public String getAVR_1_4_1() {  return this.AVR_1_4_1;}
    @JsonProperty("AVR-1-4-1")
    public void setAVR_1_4_1(final String AVR_1_4_1) { this.AVR_1_4_1=AVR_1_4_1;}
    @Column(name = "AVR_1_4_1_1")
    @JsonProperty("AVR-1-4-1-1")
    private String AVR_1_4_1_1; // 术前最后一次血肌酐值(mg/dL)
    public String getAVR_1_4_1_1() {  return this.AVR_1_4_1_1;}
    @JsonProperty("AVR-1-4-1-1")
    public void setAVR_1_4_1_1(final String AVR_1_4_1_1) { this.AVR_1_4_1_1=AVR_1_4_1_1;}
    @Column(name = "AVR_1_4_1_2")
    @JsonProperty("AVR-1-4-1-2")
    private String AVR_1_4_1_2; // 术前最后一次总胆固醇(mg/dL)
    public String getAVR_1_4_1_2() {  return this.AVR_1_4_1_2;}
    @JsonProperty("AVR-1-4-1-2")
    public void setAVR_1_4_1_2(final String AVR_1_4_1_2) { this.AVR_1_4_1_2=AVR_1_4_1_2;}
    @Column(name = "AVR_1_4_1_3")
    @JsonProperty("AVR-1-4-1-3")
    private String AVR_1_4_1_3; // 术前最后一次低密度脂蛋白(mg/dL)
    public String getAVR_1_4_1_3() {  return this.AVR_1_4_1_3;}
    @JsonProperty("AVR-1-4-1-3")
    public void setAVR_1_4_1_3(final String AVR_1_4_1_3) { this.AVR_1_4_1_3=AVR_1_4_1_3;}
    @Column(name = "AVR_1_4_1_4")
    @JsonProperty("AVR-1-4-1-4")
    private String AVR_1_4_1_4; // 术前最后一次血糖(mg/dL)
    public String getAVR_1_4_1_4() {  return this.AVR_1_4_1_4;}
    @JsonProperty("AVR-1-4-1-4")
    public void setAVR_1_4_1_4(final String AVR_1_4_1_4) { this.AVR_1_4_1_4=AVR_1_4_1_4;}
    @Column(name = "AVR_1_4_1_5")
    @JsonProperty("AVR-1-4-1-5")
    private String AVR_1_4_1_5; // 术前最后一次血红蛋白(g/L)
    public String getAVR_1_4_1_5() {  return this.AVR_1_4_1_5;}
    @JsonProperty("AVR-1-4-1-5")
    public void setAVR_1_4_1_5(final String AVR_1_4_1_5) { this.AVR_1_4_1_5=AVR_1_4_1_5;}
    @Column(name = "AVR_1_4_2")
    @JsonProperty("AVR-1-4-2")
    private String AVR_1_4_2; // 出院前末次实验检查结果
    public String getAVR_1_4_2() {  return this.AVR_1_4_2;}
    @JsonProperty("AVR-1-4-2")
    public void setAVR_1_4_2(final String AVR_1_4_2) { this.AVR_1_4_2=AVR_1_4_2;}
    @Column(name = "AVR_1_4_2_1")
    @JsonProperty("AVR-1-4-2-1")
    private String AVR_1_4_2_1; // 出院前末次血肌酐值(mg/dL)
    public String getAVR_1_4_2_1() {  return this.AVR_1_4_2_1;}
    @JsonProperty("AVR-1-4-2-1")
    public void setAVR_1_4_2_1(final String AVR_1_4_2_1) { this.AVR_1_4_2_1=AVR_1_4_2_1;}
    @Column(name = "AVR_1_4_2_2")
    @JsonProperty("AVR-1-4-2-2")
    private String AVR_1_4_2_2; // 出院前末次总胆固醇(mg/dL)
    public String getAVR_1_4_2_2() {  return this.AVR_1_4_2_2;}
    @JsonProperty("AVR-1-4-2-2")
    public void setAVR_1_4_2_2(final String AVR_1_4_2_2) { this.AVR_1_4_2_2=AVR_1_4_2_2;}
    @Column(name = "AVR_1_4_2_3")
    @JsonProperty("AVR-1-4-2-3")
    private String AVR_1_4_2_3; // 出院前末次低密度脂蛋白(mg/dL)
    public String getAVR_1_4_2_3() {  return this.AVR_1_4_2_3;}
    @JsonProperty("AVR-1-4-2-3")
    public void setAVR_1_4_2_3(final String AVR_1_4_2_3) { this.AVR_1_4_2_3=AVR_1_4_2_3;}
    @Column(name = "AVR_1_4_2_4")
    @JsonProperty("AVR-1-4-2-4")
    private String AVR_1_4_2_4; // 出院前末次血糖(mg/dL)
    public String getAVR_1_4_2_4() {  return this.AVR_1_4_2_4;}
    @JsonProperty("AVR-1-4-2-4")
    public void setAVR_1_4_2_4(final String AVR_1_4_2_4) { this.AVR_1_4_2_4=AVR_1_4_2_4;}
    @Column(name = "AVR_1_4_2_5")
    @JsonProperty("AVR-1-4-2-5")
    private String AVR_1_4_2_5; // 出院前末次血红蛋白(g/L)
    public String getAVR_1_4_2_5() {  return this.AVR_1_4_2_5;}
    @JsonProperty("AVR-1-4-2-5")
    public void setAVR_1_4_2_5(final String AVR_1_4_2_5) { this.AVR_1_4_2_5=AVR_1_4_2_5;}
    @Column(name = "AVR_2_1_1")
    @JsonProperty("AVR-2-1-1")
    private String AVR_2_1_1; // 主动脉瓣手术适应证
    public String getAVR_2_1_1() {  return this.AVR_2_1_1;}
    @JsonProperty("AVR-2-1-1")
    public void setAVR_2_1_1(final String AVR_2_1_1) { this.AVR_2_1_1=AVR_2_1_1;}
    @Column(name = "AVR_2_1_4")
    @JsonProperty("AVR-2-1-4")
    private String AVR_2_1_4; // 是否实施急诊主动脉瓣手术
    public String getAVR_2_1_4() {  return this.AVR_2_1_4;}
    @JsonProperty("AVR-2-1-4")
    public void setAVR_2_1_4(final String AVR_2_1_4) { this.AVR_2_1_4=AVR_2_1_4;}
    @Column(name = "AVR_2_2_1")
    @JsonProperty("AVR-2-2-1")
    private String AVR_2_2_1; // 是否合并其他手术
    public String getAVR_2_2_1() {  return this.AVR_2_2_1;}
    @JsonProperty("AVR-2-2-1")
    public void setAVR_2_2_1(final String AVR_2_2_1) { this.AVR_2_2_1=AVR_2_2_1;}
    @Column(name = "AVR_2_2_2")
    @JsonProperty("AVR-2-2-2")
    private String AVR_2_2_2; // 合并手术
    public String getAVR_2_2_2() {  return this.AVR_2_2_2;}
    @JsonProperty("AVR-2-2-2")
    public void setAVR_2_2_2(final String AVR_2_2_2) { this.AVR_2_2_2=AVR_2_2_2;}
    @Column(name = "AVR_2_3_1")
    @JsonProperty("AVR-2-3-1")
    private String AVR_2_3_1; // 手术切口的选择
    public String getAVR_2_3_1() {  return this.AVR_2_3_1;}
    @JsonProperty("AVR-2-3-1")
    public void setAVR_2_3_1(final String AVR_2_3_1) { this.AVR_2_3_1=AVR_2_3_1;}
    @Column(name = "AVR_2_3_1_1")
    @JsonProperty("AVR-2-3-1-1")
    private String AVR_2_3_1_1; // 其他手术切口
    public String getAVR_2_3_1_1() {  return this.AVR_2_3_1_1;}
    @JsonProperty("AVR-2-3-1-1")
    public void setAVR_2_3_1_1(final String AVR_2_3_1_1) { this.AVR_2_3_1_1=AVR_2_3_1_1;}
    @Column(name = "AVR_3_1_1")
    @JsonProperty("AVR-3-1-1")
    private String AVR_3_1_1; // 患者体表面积(m²)
    public String getAVR_3_1_1() {  return this.AVR_3_1_1;}
    @JsonProperty("AVR-3-1-1")
    public void setAVR_3_1_1(final String AVR_3_1_1) { this.AVR_3_1_1=AVR_3_1_1;}
    @Column(name = "AVR_3_1_2")
    @JsonProperty("AVR-3-1-2")
    private String AVR_3_1_2; // 人工瓣有效瓣口面积(cm²)
    public String getAVR_3_1_2() {  return this.AVR_3_1_2;}
    @JsonProperty("AVR-3-1-2")
    public void setAVR_3_1_2(final String AVR_3_1_2) { this.AVR_3_1_2=AVR_3_1_2;}
    @Column(name = "AVR_3_2_1")
    @JsonProperty("AVR-3-2-1")
    private String AVR_3_2_1; // 是否使用体外循环
    public String getAVR_3_2_1() {  return this.AVR_3_2_1;}
    @JsonProperty("AVR-3-2-1")
    public void setAVR_3_2_1(final String AVR_3_2_1) { this.AVR_3_2_1=AVR_3_2_1;}
    @Column(name = "AVR_3_2_2")
    @JsonProperty("AVR-3-2-2")
    private String AVR_3_2_2; // 起始日期时间
    public String getAVR_3_2_2() {  return this.AVR_3_2_2;}
    @JsonProperty("AVR-3-2-2")
    public void setAVR_3_2_2(final String AVR_3_2_2) { this.AVR_3_2_2=AVR_3_2_2;}
    @Column(name = "AVR_3_2_3")
    @JsonProperty("AVR-3-2-3")
    private String AVR_3_2_3; // 终止日期时间
    public String getAVR_3_2_3() {  return this.AVR_3_2_3;}
    @JsonProperty("AVR-3-2-3")
    public void setAVR_3_2_3(final String AVR_3_2_3) { this.AVR_3_2_3=AVR_3_2_3;}
    @Column(name = "AVR_3_3_1")
    @JsonProperty("AVR-3-3-1")
    private String AVR_3_3_1; // 术中使用经食道超声
    public String getAVR_3_3_1() {  return this.AVR_3_3_1;}
    @JsonProperty("AVR-3-3-1")
    public void setAVR_3_3_1(final String AVR_3_3_1) { this.AVR_3_3_1=AVR_3_3_1;}
    @Column(name = "AVR_3_3_2")
    @JsonProperty("AVR-3-3-2")
    private String AVR_3_3_2; // TEE返流分级
    public String getAVR_3_3_2() {  return this.AVR_3_3_2;}
    @JsonProperty("AVR-3-3-2")
    public void setAVR_3_3_2(final String AVR_3_3_2) { this.AVR_3_3_2=AVR_3_3_2;}
    @Column(name = "AVR_3_3_3")
    @JsonProperty("AVR-3-3-3")
    private String AVR_3_3_3; // 跨瓣压差(mmHg)
    public String getAVR_3_3_3() {  return this.AVR_3_3_3;}
    @JsonProperty("AVR-3-3-3")
    public void setAVR_3_3_3(final String AVR_3_3_3) { this.AVR_3_3_3=AVR_3_3_3;}
    @Column(name = "AVR_3_4_1")
    @JsonProperty("AVR-3-4-1")
    private String AVR_3_4_1; // 是否围术期使用血制品
    public String getAVR_3_4_1() {  return this.AVR_3_4_1;}
    @JsonProperty("AVR-3-4-1")
    public void setAVR_3_4_1(final String AVR_3_4_1) { this.AVR_3_4_1=AVR_3_4_1;}
    @Column(name = "AVR_3_4_2")
    @JsonProperty("AVR-3-4-2")
    private String AVR_3_4_2; // 其中:全血量(ml)
    public String getAVR_3_4_2() {  return this.AVR_3_4_2;}
    @JsonProperty("AVR-3-4-2")
    public void setAVR_3_4_2(final String AVR_3_4_2) { this.AVR_3_4_2=AVR_3_4_2;}
    @Column(name = "AVR_3_4_3")
    @JsonProperty("AVR-3-4-3")
    private String AVR_3_4_3; // 其中:红细胞量(ml)
    public String getAVR_3_4_3() {  return this.AVR_3_4_3;}
    @JsonProperty("AVR-3-4-3")
    public void setAVR_3_4_3(final String AVR_3_4_3) { this.AVR_3_4_3=AVR_3_4_3;}
    @Column(name = "AVR_3_4_4")
    @JsonProperty("AVR-3-4-4")
    private String AVR_3_4_4; // 其中:血浆量(ml)
    public String getAVR_3_4_4() {  return this.AVR_3_4_4;}
    @JsonProperty("AVR-3-4-4")
    public void setAVR_3_4_4(final String AVR_3_4_4) { this.AVR_3_4_4=AVR_3_4_4;}
    @Column(name = "AVR_3_4_5")
    @JsonProperty("AVR-3-4-5")
    private String AVR_3_4_5; // 其中:血小板量(ml)
    public String getAVR_3_4_5() {  return this.AVR_3_4_5;}
    @JsonProperty("AVR-3-4-5")
    public void setAVR_3_4_5(final String AVR_3_4_5) { this.AVR_3_4_5=AVR_3_4_5;}
    @Column(name = "AVR_3_4_6")
    @JsonProperty("AVR-3-4-6")
    private String AVR_3_4_6; // 临床用血总量(ml)
    public String getAVR_3_4_6() {  return this.AVR_3_4_6;}
    @JsonProperty("AVR-3-4-6")
    public void setAVR_3_4_6(final String AVR_3_4_6) { this.AVR_3_4_6=AVR_3_4_6;}
    @Column(name = "AVR_3_5_1")
    @JsonProperty("AVR-3-5-1")
    private String AVR_3_5_1; // 是否术后入住ICU/术后复苏室
    public String getAVR_3_5_1() {  return this.AVR_3_5_1;}
    @JsonProperty("AVR-3-5-1")
    public void setAVR_3_5_1(final String AVR_3_5_1) { this.AVR_3_5_1=AVR_3_5_1;}
    @Column(name = "AVR_3_5_5")
    @JsonProperty("AVR-3-5-5")
    private String AVR_3_5_5; // 是否ICU/术后复苏室实施机械通气
    public String getAVR_3_5_5() {  return this.AVR_3_5_5;}
    @JsonProperty("AVR-3-5-5")
    public void setAVR_3_5_5(final String AVR_3_5_5) { this.AVR_3_5_5=AVR_3_5_5;}
    @Column(name = "AVR_3_5_3")
    @JsonProperty("AVR-3-5-3")
    private String AVR_3_5_3; // 起始日期时间
    public String getAVR_3_5_3() {  return this.AVR_3_5_3;}
    @JsonProperty("AVR-3-5-3")
    public void setAVR_3_5_3(final String AVR_3_5_3) { this.AVR_3_5_3=AVR_3_5_3;}
    @Column(name = "AVR_3_5_4")
    @JsonProperty("AVR-3-5-4")
    private String AVR_3_5_4; // 终止日期时间
    public String getAVR_3_5_4() {  return this.AVR_3_5_4;}
    @JsonProperty("AVR-3-5-4")
    public void setAVR_3_5_4(final String AVR_3_5_4) { this.AVR_3_5_4=AVR_3_5_4;}
    ...
    public String getAVR_5_1_1() {  return this.AVR_5_1_1;}
    @JsonProperty("AVR-5-1-1")
    public void setAVR_5_1_1(final String AVR_5_1_1) { this.AVR_5_1_1=AVR_5_1_1;}
    @Column(name = "AVR_5_1_2")
    @JsonProperty("AVR-5-1-2")
    private String AVR_5_1_2; // 术后活动性出血或血肿主要情况
    public String getAVR_5_1_2() {  return this.AVR_5_1_2;}
    @JsonProperty("AVR-5-1-2")
    public void setAVR_5_1_2(final String AVR_5_1_2) { this.AVR_5_1_2=AVR_5_1_2;}
    @Column(name = "AVR_5_1_3")
    @JsonProperty("AVR-5-1-3")
    private String AVR_5_1_3; // 是否再手术
    public String getAVR_5_1_3() {  return this.AVR_5_1_3;}
    @JsonProperty("AVR-5-1-3")
    public void setAVR_5_1_3(final String AVR_5_1_3) { this.AVR_5_1_3=AVR_5_1_3;}
    @Column(name = "AVR_5_2_2")
    @JsonProperty("AVR-5-2-2")
    private String AVR_5_2_2; // 再手术指征的选择
    public String getAVR_5_2_2() {  return this.AVR_5_2_2;}
    @JsonProperty("AVR-5-2-2")
    public void setAVR_5_2_2(final String AVR_5_2_2) { this.AVR_5_2_2=AVR_5_2_2;}
    @Column(name = "AVR_5_2_2_1")
    @JsonProperty("AVR-5-2-2-1")
    private String AVR_5_2_2_1; // 其他心脏问题再手术
    public String getAVR_5_2_2_1() {  return this.AVR_5_2_2_1;}
    @JsonProperty("AVR-5-2-2-1")
    public void setAVR_5_2_2_1(final String AVR_5_2_2_1) { this.AVR_5_2_2_1=AVR_5_2_2_1;}
    @Column(name = "AVR_5_2_2_2")
    @JsonProperty("AVR-5-2-2-2")
    private String AVR_5_2_2_2; // 其他非心脏问题再手术
    public String getAVR_5_2_2_2() {  return this.AVR_5_2_2_2;}
    @JsonProperty("AVR-5-2-2-2")
    public void setAVR_5_2_2_2(final String AVR_5_2_2_2) { this.AVR_5_2_2_2=AVR_5_2_2_2;}
    @Column(name = "AVR_5_2_3")
    @JsonProperty("AVR-5-2-3")
    private String AVR_5_2_3; // 再手术起始日期时间
    public String getAVR_5_2_3() {  return this.AVR_5_2_3;}
    @JsonProperty("AVR-5-2-3")
    public void setAVR_5_2_3(final String AVR_5_2_3) { this.AVR_5_2_3=AVR_5_2_3;}
    @Column(name = "CM_2_1")
    @JsonProperty("CM-2-1")
    ...
    public String getAVR_6_2_2_1() {  return this.AVR_6_2_2_1;}
    @JsonProperty("AVR-6-2-2-1")
    public void setAVR_6_2_2_1(final String AVR_6_2_2_1) { this.AVR_6_2_2_1=AVR_6_2_2_1;}
    @Column(name = "AVR_6_2_2_2")
    @JsonProperty("AVR-6-2-2-2")
    private String AVR_6_2_2_2; // 循环系统术后并发症
    public String getAVR_6_2_2_2() {  return this.AVR_6_2_2_2;}
    @JsonProperty("AVR-6-2-2-2")
    public void setAVR_6_2_2_2(final String AVR_6_2_2_2) { this.AVR_6_2_2_2=AVR_6_2_2_2;}
    @Column(name = "AVR_6_2_2_3")
    @JsonProperty("AVR-6-2-2-3")
    private String AVR_6_2_2_3; // 心脏和血管植入物的并发症(不包括脓毒症)
    public String getAVR_6_2_2_3() {  return this.AVR_6_2_2_3;}
    @JsonProperty("AVR-6-2-2-3")
    public void setAVR_6_2_2_3(final String AVR_6_2_2_3) { this.AVR_6_2_2_3=AVR_6_2_2_3;}
    @Column(name = "AVR_6_2_2_4")
    @JsonProperty("AVR-6-2-2-4")
    private String AVR_6_2_2_4; // 术后并发脑卒中/脑血管事件
    public String getAVR_6_2_2_4() {  return this.AVR_6_2_2_4;}
    @JsonProperty("AVR-6-2-2-4")
    public void setAVR_6_2_2_4(final String AVR_6_2_2_4) { this.AVR_6_2_2_4=AVR_6_2_2_4;}
    @Column(name = "AVR_6_1_3")
    @JsonProperty("AVR-6-1-3")
    private String AVR_6_1_3; // AVR术后特指并发症--手术后急性肾损伤
    public String getAVR_6_1_3() {  return this.AVR_6_1_3;}
    @JsonProperty("AVR-6-1-3")
    public void setAVR_6_1_3(final String AVR_6_1_3) { this.AVR_6_1_3=AVR_6_1_3;}
    @Column(name = "AVR_6_1_4")
    @JsonProperty("AVR-6-1-4")
    private String AVR_6_1_4; // AVR术后透析名称与编码
    public String getAVR_6_1_4() {  return this.AVR_6_1_4;}
    @JsonProperty("AVR-6-1-4")
    public void setAVR_6_1_4(final String AVR_6_1_4) { this.AVR_6_1_4=AVR_6_1_4;}
    @Column(name = "CM_2_4")
    @JsonProperty("CM-2-4")
    ...
    public String getAVR_6_2_1() {  return this.AVR_6_2_1;}
    @JsonProperty("AVR-6-2-1")
    public void setAVR_6_2_1(final String AVR_6_2_1) { this.AVR_6_2_1=AVR_6_2_1;}
    @Column(name = "AVR_6_2_2")
    @JsonProperty("AVR-6-2-2")
    private String AVR_6_2_2; // 头颅影像学检查结果
    public String getAVR_6_2_2() {  return this.AVR_6_2_2;}
    @JsonProperty("AVR-6-2-2")
    public void setAVR_6_2_2(final String AVR_6_2_2) { this.AVR_6_2_2=AVR_6_2_2;}
    @Column(name = "AVR_7_1_1")
    @JsonProperty("AVR-7-1-1")
    private String AVR_7_1_1; // 出院时是否有继续使用华法林的带药医嘱
    public String getAVR_7_1_1() {  return this.AVR_7_1_1;}
    @JsonProperty("AVR-7-1-1")
    public void setAVR_7_1_1(final String AVR_7_1_1) { this.AVR_7_1_1=AVR_7_1_1;}
    @Column(name = "AVR_7_2_1")
    @JsonProperty("AVR-7-2-1")
    private String AVR_7_2_1; // 出院时是否有继续使用除华法林外其他抗凝药物的用药医嘱
    public String getAVR_7_2_1() {  return this.AVR_7_2_1;}
    @JsonProperty("AVR-7-2-1")
    public void setAVR_7_2_1(final String AVR_7_2_1) { this.AVR_7_2_1=AVR_7_2_1;}
    @Column(name = "AVR_7_2_2")
    @JsonProperty("AVR-7-2-2")
    private String AVR_7_2_2; // 出院带药医嘱包括以下药物
    public String getAVR_7_2_2() {  return this.AVR_7_2_2;}
    @JsonProperty("AVR-7-2-2")
    public void setAVR_7_2_2(final String AVR_7_2_2) { this.AVR_7_2_2=AVR_7_2_2;}
    @Column(name = "AVR_7_2_2_1")
    @JsonProperty("AVR-7-2-2-1")
    private String AVR_7_2_2_1; // 其他抗凝药物
    public String getAVR_7_2_2_1() {  return this.AVR_7_2_2_1;}
    @JsonProperty("AVR-7-2-2-1")
    public void setAVR_7_2_2_1(final String AVR_7_2_2_1) { this.AVR_7_2_2_1=AVR_7_2_2_1;}
    @Column(name = "AVR_8_1_1")
    @JsonProperty("AVR-8-1-1")
    private String AVR_8_1_1; // 是否进行术前、术后健康教育，且有记录可追踪
    public String getAVR_8_1_1() {  return this.AVR_8_1_1;}
    @JsonProperty("AVR-8-1-1")
    public void setAVR_8_1_1(final String AVR_8_1_1) { this.AVR_8_1_1=AVR_8_1_1;}
    ...
    public String getAVR_8_2_1() {  return this.AVR_8_2_1;}
    @JsonProperty("AVR-8-2-1")
    public void setAVR_8_2_1(final String AVR_8_2_1) { this.AVR_8_2_1=AVR_8_2_1;}
    @Column(name = "AVR_8_2_2")
    @JsonProperty("AVR-8-2-2")
    private String AVR_8_2_2; // 常见高危因素的选择
    public String getAVR_8_2_2() {  return this.AVR_8_2_2;}
    @JsonProperty("AVR-8-2-2")
    public void setAVR_8_2_2(final String AVR_8_2_2) { this.AVR_8_2_2=AVR_8_2_2;}
    @Column(name = "AVR_8_2_2_1")
    @JsonProperty("AVR-8-2-2-1")
    private String AVR_8_2_2_1; // 其他常见高危因素
    public String getAVR_8_2_2_1() {  return this.AVR_8_2_2_1;}
    @JsonProperty("AVR-8-2-2-1")
    public void setAVR_8_2_2_1(final String AVR_8_2_2_1) { this.AVR_8_2_2_1=AVR_8_2_2_1;}
    @Column(name = "AVR_8_3_1")
    @JsonProperty("AVR-8-3-1")
    private String AVR_8_3_1; // 是否履行出院告知与术后康复教育责任，且有记录可追踪
    public String getAVR_8_3_1() {  return this.AVR_8_3_1;}
    @JsonProperty("AVR-8-3-1")
    public void setAVR_8_3_1(final String AVR_8_3_1) { this.AVR_8_3_1=AVR_8_3_1;}
