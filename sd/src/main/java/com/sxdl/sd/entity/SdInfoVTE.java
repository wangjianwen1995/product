...
public class SdInfoVTE implements Serializable {
    ...
    private String VTE_0_1_2; // 适用临床科室患者凡符合下列条件者，应首先进行VTE风险评估<br/>(注：VTE范围的手术患者不在此上报范围，请按手术名称填报"围手术期预防深靜栓塞（DVT))
    public String getVTE_0_1_2() {  return this.VTE_0_1_2;}
    @JsonProperty("VTE-0-1-2")
    public void setVTE_0_1_2(final String VTE_0_1_2) { this.VTE_0_1_2=VTE_0_1_2;}
    @Column(name = "VTE_0_1_2_1")
    @JsonProperty("VTE-0-1-2-1")
    private String VTE_0_1_2_1; // 其他临床科室的其他中高风险患者的科室名称
    public String getVTE_0_1_2_1() {  return this.VTE_0_1_2_1;}
    @JsonProperty("VTE-0-1-2-1")
    public void setVTE_0_1_2_1(final String VTE_0_1_2_1) { this.VTE_0_1_2_1=VTE_0_1_2_1;}
    ...
    public String getVTE_0_1_1() {  return this.VTE_0_1_1;}
    @JsonProperty("VTE-0-1-1")
    public void setVTE_0_1_1(final String VTE_0_1_1) { this.VTE_0_1_1=VTE_0_1_1;}
    @Column(name = "VTE_0_1_1_c")
    @JsonProperty("VTE-0-1-1-c")
    private String VTE_0_1_1_c; // 恶性肿瘤ICD-10类目编码
    public String getVTE_0_1_1_c() {  return this.VTE_0_1_1_c;}
    @JsonProperty("VTE-0-1-1-c")
    public void setVTE_0_1_1_c(final String VTE_0_1_1_c) { this.VTE_0_1_1_c=VTE_0_1_1_c;}
    @Column(name = "VTE_0_1_1_d")
    @JsonProperty("VTE-0-1-1-d")
    private String VTE_0_1_1_d; // 脓毒症ICD-10亚目编码
    public String getVTE_0_1_1_d() {  return this.VTE_0_1_1_d;}
    @JsonProperty("VTE-0-1-1-d")
    public void setVTE_0_1_1_d(final String VTE_0_1_1_d) { this.VTE_0_1_1_d=VTE_0_1_1_d;}
    @Column(name = "VTE_0_1_1_e")
    @JsonProperty("VTE-0-1-1-e")
    private String VTE_0_1_1_e; // 严重创伤 (累及身体多个部位损伤)
    public String getVTE_0_1_1_e() {  return this.VTE_0_1_1_e;}
    @JsonProperty("VTE-0-1-1-e")
    public void setVTE_0_1_1_e(final String VTE_0_1_1_e) { this.VTE_0_1_1_e=VTE_0_1_1_e;}
    @Column(name = "VTE_0_1_1_i")
    @JsonProperty("VTE-0-1-1-i")
    private String VTE_0_1_1_i; // 制动选择
    public String getVTE_0_1_1_i() {  return this.VTE_0_1_1_i;}
    @JsonProperty("VTE-0-1-1-i")
    public void setVTE_0_1_1_i(final String VTE_0_1_1_i) { this.VTE_0_1_1_i=VTE_0_1_1_i;}
    @Column(name = "VTE_0_1_1_j")
    @JsonProperty("VTE-0-1-1-j")
    private String VTE_0_1_1_j; // 机械通气ICD-9-CM-3亚目编码
    public String getVTE_0_1_1_j() {  return this.VTE_0_1_1_j;}
    @JsonProperty("VTE-0-1-1-j")
    public void setVTE_0_1_1_j(final String VTE_0_1_1_j) { this.VTE_0_1_1_j=VTE_0_1_1_j;}
    @Column(name = "VTE_0_1_1_k")
    @JsonProperty("VTE-0-1-1-k")
    private String VTE_0_1_1_k; // 留置中心静脉导管ICD-9-CM-3亚目编码
    public String getVTE_0_1_1_k() {  return this.VTE_0_1_1_k;}
    @JsonProperty("VTE-0-1-1-k")
    public void setVTE_0_1_1_k(final String VTE_0_1_1_k) { this.VTE_0_1_1_k=VTE_0_1_1_k;}
    @Column(name = "VTE_0_1_1_l")
    @JsonProperty("VTE-0-1-1-l")
    private String VTE_0_1_1_l; // 血液净化治疗ICD-9-CM-3亚目编码
    public String getVTE_0_1_1_l() {  return this.VTE_0_1_1_l;}
    @JsonProperty("VTE-0-1-1-l")
    public void setVTE_0_1_1_l(final String VTE_0_1_1_l) { this.VTE_0_1_1_l=VTE_0_1_1_l;}
    @Column(name = "VTE_0_1_1_m")
    @JsonProperty("VTE-0-1-1-m")
    private String VTE_0_1_1_m; // 使用肌肉松弛和镇静药物选择
    public String getVTE_0_1_1_m() {  return this.VTE_0_1_1_m;}
    @JsonProperty("VTE-0-1-1-m")
    public void setVTE_0_1_1_m(final String VTE_0_1_1_m) { this.VTE_0_1_1_m=VTE_0_1_1_m;}
    @Column(name = "VTE_0_1_1_n")
    @JsonProperty("VTE-0-1-1-n")
    private String VTE_0_1_1_n; // 应用收缩血管药物选择
    public String getVTE_0_1_1_n() {  return this.VTE_0_1_1_n;}
    @JsonProperty("VTE-0-1-1-n")
    public void setVTE_0_1_1_n(final String VTE_0_1_1_n) { this.VTE_0_1_1_n=VTE_0_1_1_n;}
    @Column(name = "VTE_0_1_1_q")
    @JsonProperty("VTE-0-1-1-q")
    private String VTE_0_1_1_q; // 医师认为需评估的其他中高风险患者--高危孕产妇记录
    public String getVTE_0_1_1_q() {  return this.VTE_0_1_1_q;}
    @JsonProperty("VTE-0-1-1-q")
    public void setVTE_0_1_1_q(final String VTE_0_1_1_q) { this.VTE_0_1_1_q=VTE_0_1_1_q;}
    @Column(name = "VTE_0_1_3")
    @JsonProperty("VTE-0-1-3")
    private String VTE_0_1_3; // 出院时主要诊断ICD-10编码及名称
    public String getVTE_0_1_3() {  return this.VTE_0_1_3;}
    @JsonProperty("VTE-0-1-3")
    public void setVTE_0_1_3(final String VTE_0_1_3) { this.VTE_0_1_3=VTE_0_1_3;}
    @Column(name = "VTE_0_1_4")
    @JsonProperty("VTE-0-1-4")
    private String VTE_0_1_4; // 出院时其他诊断ICD-10编码及名称
    public String getVTE_0_1_4() {  return this.VTE_0_1_4;}
    @JsonProperty("VTE-0-1-4")
    public void setVTE_0_1_4(final String VTE_0_1_4) { this.VTE_0_1_4=VTE_0_1_4;}
    @Column(name = "VTE_0_1_5")
    @JsonProperty("VTE-0-1-5")
    private String VTE_0_1_5; // 出院时主要手术及操作ICD-9-CM-3编码及名称
    public String getVTE_0_1_5() {  return this.VTE_0_1_5;}
    @JsonProperty("VTE-0-1-5")
    public void setVTE_0_1_5(final String VTE_0_1_5) { this.VTE_0_1_5=VTE_0_1_5;}
    @Column(name = "VTE_0_1_6")
    @JsonProperty("VTE-0-1-6")
    private String VTE_0_1_6; // 出院时其他手术及操作ICD-9-CM-3编码及名称
    public String getVTE_0_1_6() {  return this.VTE_0_1_6;}
    @JsonProperty("VTE-0-1-6")
    public void setVTE_0_1_6(final String VTE_0_1_6) { this.VTE_0_1_6=VTE_0_1_6;}
    ...
    public String getVTE_1_1_1() {  return this.VTE_1_1_1;}
    @JsonProperty("VTE-1-1-1")
    public void setVTE_1_1_1(final String VTE_1_1_1) { this.VTE_1_1_1=VTE_1_1_1;}
    @Column(name = "VTE_1_1_2")
    @JsonProperty("VTE-1-1-2")
    private String VTE_1_1_2; // Caprini评估分值
    public String getVTE_1_1_2() {  return this.VTE_1_1_2;}
    @JsonProperty("VTE-1-1-2")
    public void setVTE_1_1_2(final String VTE_1_1_2) { this.VTE_1_1_2=VTE_1_1_2;}
    @Column(name = "VTE_1_1_3")
    @JsonProperty("VTE-1-1-3")
    private String VTE_1_1_3; // 风险分层
    public String getVTE_1_1_3() {  return this.VTE_1_1_3;}
    @JsonProperty("VTE-1-1-3")
    public void setVTE_1_1_3(final String VTE_1_1_3) { this.VTE_1_1_3=VTE_1_1_3;}
    @Column(name = "VTE_1_1_4")
    @JsonProperty("VTE-1-1-4")
    private String VTE_1_1_4; // Padua评分分值
    public String getVTE_1_1_4() {  return this.VTE_1_1_4;}
    @JsonProperty("VTE-1-1-4")
    public void setVTE_1_1_4(final String VTE_1_1_4) { this.VTE_1_1_4=VTE_1_1_4;}
    @Column(name = "VTE_1_1_5")
    @JsonProperty("VTE-1-1-5")
    private String VTE_1_1_5; // 风险分层
    public String getVTE_1_1_5() {  return this.VTE_1_1_5;}
    @JsonProperty("VTE-1-1-5")
    public void setVTE_1_1_5(final String VTE_1_1_5) { this.VTE_1_1_5=VTE_1_1_5;}
    @Column(name = "VTE_1_2_1")
    @JsonProperty("VTE-1-2-1")
    private String VTE_1_2_1; // 呼吸(次/分)
    public String getVTE_1_2_1() {  return this.VTE_1_2_1;}
    @JsonProperty("VTE-1-2-1")
    public void setVTE_1_2_1(final String VTE_1_2_1) { this.VTE_1_2_1=VTE_1_2_1;}
    @Column(name = "VTE_1_2_2")
    @JsonProperty("VTE-1-2-2")
    private String VTE_1_2_2; // 脉搏(次/分)
    public String getVTE_1_2_2() {  return this.VTE_1_2_2;}
    @JsonProperty("VTE-1-2-2")
    public void setVTE_1_2_2(final String VTE_1_2_2) { this.VTE_1_2_2=VTE_1_2_2;}
    @Column(name = "VTE_1_2_3")
    @JsonProperty("VTE-1-2-3")
    private String VTE_1_2_3; // 收缩压(mmHg)
    public String getVTE_1_2_3() {  return this.VTE_1_2_3;}
    @JsonProperty("VTE-1-2-3")
    public void setVTE_1_2_3(final String VTE_1_2_3) { this.VTE_1_2_3=VTE_1_2_3;}
    @Column(name = "VTE_1_2_4")
    @JsonProperty("VTE-1-2-4")
    private String VTE_1_2_4; // 舒张压(mmHg)
    public String getVTE_1_2_4() {  return this.VTE_1_2_4;}
    @JsonProperty("VTE-1-2-4")
    public void setVTE_1_2_4(final String VTE_1_2_4) { this.VTE_1_2_4=VTE_1_2_4;}
    @Column(name = "VTE_2_1_1")
    @JsonProperty("VTE-2-1-1")
    private String VTE_2_1_1; // 是否实施下肢静脉血管多普勒超声检查评估
    public String getVTE_2_1_1() {  return this.VTE_2_1_1;}
    @JsonProperty("VTE-2-1-1")
    public void setVTE_2_1_1(final String VTE_2_1_1) { this.VTE_2_1_1=VTE_2_1_1;}
    @Column(name = "VTE_2_1_2")
    @JsonProperty("VTE-2-1-2")
    private String VTE_2_1_2; // 实施多普勒超声检查评估日期时间
    public String getVTE_2_1_2() {  return this.VTE_2_1_2;}
    @JsonProperty("VTE-2-1-2")
    public void setVTE_2_1_2(final String VTE_2_1_2) { this.VTE_2_1_2=VTE_2_1_2;}
    @Column(name = "VTE_2_1_3")
    @JsonProperty("VTE-2-1-3")
    private String VTE_2_1_3; // 有无多普勒超声检查阳性发现
    public String getVTE_2_1_3() {  return this.VTE_2_1_3;}
    @JsonProperty("VTE-2-1-3")
    public void setVTE_2_1_3(final String VTE_2_1_3) { this.VTE_2_1_3=VTE_2_1_3;}
    @Column(name = "VTE_2_2_1")
    @JsonProperty("VTE-2-2-1")
    private String VTE_2_2_1; // 实施D⁃二聚体检测评估
    public String getVTE_2_2_1() {  return this.VTE_2_2_1;}
    @JsonProperty("VTE-2-2-1")
    public void setVTE_2_2_1(final String VTE_2_2_1) { this.VTE_2_2_1=VTE_2_2_1;}
    @Column(name = "VTE_2_2_2")
    @JsonProperty("VTE-2-2-2")
    private String VTE_2_2_2; // D⁃二聚体检测评估日期时间
    public String getVTE_2_2_2() {  return this.VTE_2_2_2;}
    @JsonProperty("VTE-2-2-2")
    public void setVTE_2_2_2(final String VTE_2_2_2) { this.VTE_2_2_2=VTE_2_2_2;}
    @Column(name = "VTE_2_2_3")
    @JsonProperty("VTE-2-2-3")
    private String VTE_2_2_3; // D⁃二聚体检测值(μg／L)
    public String getVTE_2_2_3() {  return this.VTE_2_2_3;}
    @JsonProperty("VTE-2-2-3")
    public void setVTE_2_2_3(final String VTE_2_2_3) { this.VTE_2_2_3=VTE_2_2_3;}
    @Column(name = "VTE_2_2_4")
    @JsonProperty("VTE-2-2-4")
    private String VTE_2_2_4; // D⁃二聚体检测评估结论
    public String getVTE_2_2_4() {  return this.VTE_2_2_4;}
    @JsonProperty("VTE-2-2-4")
    public void setVTE_2_2_4(final String VTE_2_2_4) { this.VTE_2_2_4=VTE_2_2_4;}
    @Column(name = "VTE_2_2_5")
    @JsonProperty("VTE-2-2-5")
    private String VTE_2_2_5; // 是否实施氧合评估
    public String getVTE_2_2_5() {  return this.VTE_2_2_5;}
    @JsonProperty("VTE-2-2-5")
    public void setVTE_2_2_5(final String VTE_2_2_5) { this.VTE_2_2_5=VTE_2_2_5;}
    @Column(name = "VTE_2_2_6")
    @JsonProperty("VTE-2-2-6")
    private String VTE_2_2_6; // 氧合评估
    public String getVTE_2_2_6() {  return this.VTE_2_2_6;}
    @JsonProperty("VTE-2-2-6")
    public void setVTE_2_2_6(final String VTE_2_2_6) { this.VTE_2_2_6=VTE_2_2_6;}
    @Column(name = "VTE_2_2_6_1")
    @JsonProperty("VTE-2-2-6-1")
    private String VTE_2_2_6_1; // 动脉血气分析值(mmHg)
    public String getVTE_2_2_6_1() {  return this.VTE_2_2_6_1;}
    @JsonProperty("VTE-2-2-6-1")
    public void setVTE_2_2_6_1(final String VTE_2_2_6_1) { this.VTE_2_2_6_1=VTE_2_2_6_1;}
    @Column(name = "VTE_2_2_6_2")
    @JsonProperty("VTE-2-2-6-2")
    private String VTE_2_2_6_2; // 指氧仪检查值(%)
    public String getVTE_2_2_6_2() {  return this.VTE_2_2_6_2;}
    @JsonProperty("VTE-2-2-6-2")
    public void setVTE_2_2_6_2(final String VTE_2_2_6_2) { this.VTE_2_2_6_2=VTE_2_2_6_2;}
    @Column(name = "VTE_2_2_7")
    @JsonProperty("VTE-2-2-7")
    private String VTE_2_2_7; // 是否实施心脏生物学标志物检测
    public String getVTE_2_2_7() {  return this.VTE_2_2_7;}
    @JsonProperty("VTE-2-2-7")
    public void setVTE_2_2_7(final String VTE_2_2_7) { this.VTE_2_2_7=VTE_2_2_7;}
    @Column(name = "VTE_2_2_8")
    @JsonProperty("VTE-2-2-8")
    private String VTE_2_2_8; // 心脏生物学标志物检测项目
    public String getVTE_2_2_8() {  return this.VTE_2_2_8;}
    @JsonProperty("VTE-2-2-8")
    public void setVTE_2_2_8(final String VTE_2_2_8) { this.VTE_2_2_8=VTE_2_2_8;}
    @Column(name = "VTE_2_2_8_1")
    @JsonProperty("VTE-2-2-8-1")
    private String VTE_2_2_8_1; // 肌钙蛋白T（TnT）检测值(ng/mL)
    public String getVTE_2_2_8_1() {  return this.VTE_2_2_8_1;}
    @JsonProperty("VTE-2-2-8-1")
    public void setVTE_2_2_8_1(final String VTE_2_2_8_1) { this.VTE_2_2_8_1=VTE_2_2_8_1;}
    @Column(name = "VTE_2_2_8_2")
    @JsonProperty("VTE-2-2-8-2")
    private String VTE_2_2_8_2; // 肌钙蛋白I（TnI）检测值(ng/mL)
    public String getVTE_2_2_8_2() {  return this.VTE_2_2_8_2;}
    @JsonProperty("VTE-2-2-8-2")
    public void setVTE_2_2_8_2(final String VTE_2_2_8_2) { this.VTE_2_2_8_2=VTE_2_2_8_2;}
    @Column(name = "VTE_2_2_8_3")
    @JsonProperty("VTE-2-2-8-3")
    private String VTE_2_2_8_3; // 肌酸激酶同工酶（CK-MB）检测值(ng/mL)
    public String getVTE_2_2_8_3() {  return this.VTE_2_2_8_3;}
    @JsonProperty("VTE-2-2-8-3")
    public void setVTE_2_2_8_3(final String VTE_2_2_8_3) { this.VTE_2_2_8_3=VTE_2_2_8_3;}
    @Column(name = "VTE_2_2_8_4")
    @JsonProperty("VTE-2-2-8-4")
    private String VTE_2_2_8_4; // 心肌肌红蛋白（Myo）检测值(ng/mL)
    public String getVTE_2_2_8_4() {  return this.VTE_2_2_8_4;}
    @JsonProperty("VTE-2-2-8-4")
    public void setVTE_2_2_8_4(final String VTE_2_2_8_4) { this.VTE_2_2_8_4=VTE_2_2_8_4;}
    @Column(name = "VTE_2_2_8_5")
    @JsonProperty("VTE-2-2-8-5")
    private String VTE_2_2_8_5; // B型钠尿肽（BNP）检测值(ng/L)
    public String getVTE_2_2_8_5() {  return this.VTE_2_2_8_5;}
    @JsonProperty("VTE-2-2-8-5")
    public void setVTE_2_2_8_5(final String VTE_2_2_8_5) { this.VTE_2_2_8_5=VTE_2_2_8_5;}
    @Column(name = "VTE_2_2_8_6")
    @JsonProperty("VTE-2-2-8-6")
    private String VTE_2_2_8_6; // N端B型钠尿肽前体（NT-ProBNP）检测值(ng/L)
    public String getVTE_2_2_8_6() {  return this.VTE_2_2_8_6;}
    @JsonProperty("VTE-2-2-8-6")
    public void setVTE_2_2_8_6(final String VTE_2_2_8_6) { this.VTE_2_2_8_6=VTE_2_2_8_6;}
    @Column(name = "VTE_2_2_9")
    @JsonProperty("VTE-2-2-9")
    private String VTE_2_2_9; // 是否实施凝血功能检测
    public String getVTE_2_2_9() {  return this.VTE_2_2_9;}
    @JsonProperty("VTE-2-2-9")
    public void setVTE_2_2_9(final String VTE_2_2_9) { this.VTE_2_2_9=VTE_2_2_9;}
    @Column(name = "VTE_2_2_10")
    @JsonProperty("VTE-2-2-10")
    private String VTE_2_2_10; // 凝血功能检测项目
    public String getVTE_2_2_10() {  return this.VTE_2_2_10;}
    @JsonProperty("VTE-2-2-10")
    public void setVTE_2_2_10(final String VTE_2_2_10) { this.VTE_2_2_10=VTE_2_2_10;}
    @Column(name = "VTE_2_2_10_1")
    @JsonProperty("VTE-2-2-10-1")
    private String VTE_2_2_10_1; // 血浆凝血酶原时间（PT）检测值
    public String getVTE_2_2_10_1() {  return this.VTE_2_2_10_1;}
    @JsonProperty("VTE-2-2-10-1")
    public void setVTE_2_2_10_1(final String VTE_2_2_10_1) { this.VTE_2_2_10_1=VTE_2_2_10_1;}
    @Column(name = "VTE_2_2_10_2")
    @JsonProperty("VTE-2-2-10-2")
    private String VTE_2_2_10_2; // 纤维蛋白原（FIB）检测值
    public String getVTE_2_2_10_2() {  return this.VTE_2_2_10_2;}
    @JsonProperty("VTE-2-2-10-2")
    public void setVTE_2_2_10_2(final String VTE_2_2_10_2) { this.VTE_2_2_10_2=VTE_2_2_10_2;}
    @Column(name = "VTE_2_2_10_3")
    @JsonProperty("VTE-2-2-10-3")
    private String VTE_2_2_10_3; // 活化部分凝血活酶时间（APTT）检测值
    public String getVTE_2_2_10_3() {  return this.VTE_2_2_10_3;}
    @JsonProperty("VTE-2-2-10-3")
    public void setVTE_2_2_10_3(final String VTE_2_2_10_3) { this.VTE_2_2_10_3=VTE_2_2_10_3;}
    @Column(name = "VTE_2_2_10_4")
    @JsonProperty("VTE-2-2-10-4")
    private String VTE_2_2_10_4; // 血浆凝血酶时间（TT）检测值
    public String getVTE_2_2_10_4() {  return this.VTE_2_2_10_4;}
    @JsonProperty("VTE-2-2-10-4")
    public void setVTE_2_2_10_4(final String VTE_2_2_10_4) { this.VTE_2_2_10_4=VTE_2_2_10_4;}
    @Column(name = "VTE_2_3_1")
    @JsonProperty("VTE-2-3-1")
    private String VTE_2_3_1; // 是否行CT肺动脉造影（CTPA）检查评估
    public String getVTE_2_3_1() {  return this.VTE_2_3_1;}
    @JsonProperty("VTE-2-3-1")
    public void setVTE_2_3_1(final String VTE_2_3_1) { this.VTE_2_3_1=VTE_2_3_1;}
    @Column(name = "VTE_2_3_2")
    @JsonProperty("VTE-2-3-2")
    private String VTE_2_3_2; // 实施行CT肺动脉造影（CTPA）检查日期时间
    public String getVTE_2_3_2() {  return this.VTE_2_3_2;}
    @JsonProperty("VTE-2-3-2")
    public void setVTE_2_3_2(final String VTE_2_3_2) { this.VTE_2_3_2=VTE_2_3_2;}
    @Column(name = "VTE_2_3_3")
    @JsonProperty("VTE-2-3-3")
    private String VTE_2_3_3; // CT肺动脉造影（CTPA）检查阳性发现
    public String getVTE_2_3_3() {  return this.VTE_2_3_3;}
    @JsonProperty("VTE-2-3-3")
    public void setVTE_2_3_3(final String VTE_2_3_3) { this.VTE_2_3_3=VTE_2_3_3;}
    @Column(name = "VTE_3_1_1")
    @JsonProperty("VTE-3-1-1")
    private String VTE_3_1_1; // 有无履行VTE预防相关的患者/家属知情同意
    public String getVTE_3_1_1() {  return this.VTE_3_1_1;}
    @JsonProperty("VTE-3-1-1")
    public void setVTE_3_1_1(final String VTE_3_1_1) { this.VTE_3_1_1=VTE_3_1_1;}
    @Column(name = "VTE_3_1_2")
    @JsonProperty("VTE-3-1-2")
    private String VTE_3_1_2; // VTE预防相关的患者/家属知情同意
    public String getVTE_3_1_2() {  return this.VTE_3_1_2;}
    @JsonProperty("VTE-3-1-2")
    public void setVTE_3_1_2(final String VTE_3_1_2) { this.VTE_3_1_2=VTE_3_1_2;}
    @Column(name = "VTE_3_2_1")
    @JsonProperty("VTE-3-2-1")
    private String VTE_3_2_1; // 有无实施出血风险和其他可能影响预防的因素评估
    public String getVTE_3_2_1() {  return this.VTE_3_2_1;}
    @JsonProperty("VTE-3-2-1")
    public void setVTE_3_2_1(final String VTE_3_2_1) { this.VTE_3_2_1=VTE_3_2_1;}
    @Column(name = "VTE_3_2_2")
    @JsonProperty("VTE-3-2-2")
    private String VTE_3_2_2; // 实施出血风险和其他可能影响预防的因素评估
    public String getVTE_3_2_2() {  return this.VTE_3_2_2;}
    @JsonProperty("VTE-3-2-2")
    public void setVTE_3_2_2(final String VTE_3_2_2) { this.VTE_3_2_2=VTE_3_2_2;}
    @Column(name = "VTE_3_2_2_1")
    @JsonProperty("VTE-3-2-2-1")
    private String VTE_3_2_2_1; // 患者因素选择
    public String getVTE_3_2_2_1() {  return this.VTE_3_2_2_1;}
    @JsonProperty("VTE-3-2-2-1")
    public void setVTE_3_2_2_1(final String VTE_3_2_2_1) { this.VTE_3_2_2_1=VTE_3_2_2_1;}
    @Column(name = "VTE_3_2_2_2")
    @JsonProperty("VTE-3-2-2-2")
    private String VTE_3_2_2_2; // 基础疾病
    public String getVTE_3_2_2_2() {  return this.VTE_3_2_2_2;}
    @JsonProperty("VTE-3-2-2-2")
    public void setVTE_3_2_2_2(final String VTE_3_2_2_2) { this.VTE_3_2_2_2=VTE_3_2_2_2;}
    @Column(name = "VTE_3_2_2_3")
    @JsonProperty("VTE-3-2-2-3")
    private String VTE_3_2_2_3; // 合并用药
    public String getVTE_3_2_2_3() {  return this.VTE_3_2_2_3;}
    @JsonProperty("VTE-3-2-2-3")
    public void setVTE_3_2_2_3(final String VTE_3_2_2_3) { this.VTE_3_2_2_3=VTE_3_2_2_3;}
    @Column(name = "VTE_3_2_2_4")
    @JsonProperty("VTE-3-2-2-4")
    private String VTE_3_2_2_4; // 侵入性操作
    public String getVTE_3_2_2_4() {  return this.VTE_3_2_2_4;}
    @JsonProperty("VTE-3-2-2-4")
    public void setVTE_3_2_2_4(final String VTE_3_2_2_4) { this.VTE_3_2_2_4=VTE_3_2_2_4;}
    @Column(name = "VTE_3_2_2_5")
    @JsonProperty("VTE-3-2-2-5")
    private String VTE_3_2_2_5; // 其他实施出血风险和其他可能影响预防的因素评估
    public String getVTE_3_2_2_5() {  return this.VTE_3_2_2_5;}
    @JsonProperty("VTE-3-2-2-5")
    public void setVTE_3_2_2_5(final String VTE_3_2_2_5) { this.VTE_3_2_2_5=VTE_3_2_2_5;}
    @Column(name = "VTE_3_2_3_1")
    @JsonProperty("VTE-3-2-3-1")
    private String VTE_3_2_3_1; // 是否有物理性预防禁忌证
    public String getVTE_3_2_3_1() {  return this.VTE_3_2_3_1;}
    @JsonProperty("VTE-3-2-3-1")
    public void setVTE_3_2_3_1(final String VTE_3_2_3_1) { this.VTE_3_2_3_1=VTE_3_2_3_1;}
    @Column(name = "VTE_3_2_3_2")
    @JsonProperty("VTE-3-2-3-2")
    private String VTE_3_2_3_2; // 物理性预防措施应用禁忌证
    public String getVTE_3_2_3_2() {  return this.VTE_3_2_3_2;}
    @JsonProperty("VTE-3-2-3-2")
    public void setVTE_3_2_3_2(final String VTE_3_2_3_2) { this.VTE_3_2_3_2=VTE_3_2_3_2;}
    @Column(name = "VTE_3_3_0")
    @JsonProperty("VTE-3-3-0")
    private String VTE_3_3_0; // 是否需要三级预防深静脉栓塞
    public String getVTE_3_3_0() {  return this.VTE_3_3_0;}
    @JsonProperty("VTE-3-3-0")
    public void setVTE_3_3_0(final String VTE_3_3_0) { this.VTE_3_3_0=VTE_3_3_0;}
    @Column(name = "VTE_3_3_1")
    @JsonProperty("VTE-3-3-1")
    private String VTE_3_3_1; // 三级预防深静脉栓塞措施选择
    public String getVTE_3_3_1() {  return this.VTE_3_3_1;}
    @JsonProperty("VTE-3-3-1")
    public void setVTE_3_3_1(final String VTE_3_3_1) { this.VTE_3_3_1=VTE_3_3_1;}
    @Column(name = "VTE_3_3_2")
    @JsonProperty("VTE-3-3-2")
    private String VTE_3_3_2; // 基本预防措施的选择
    public String getVTE_3_3_2() {  return this.VTE_3_3_2;}
    @JsonProperty("VTE-3-3-2")
    public void setVTE_3_3_2(final String VTE_3_3_2) { this.VTE_3_3_2=VTE_3_3_2;}
    @Column(name = "VTE_3_3_2_1")
    @JsonProperty("VTE-3-3-2-1")
    private String VTE_3_3_2_1; // 其他基本预防措施
    public String getVTE_3_3_2_1() {  return this.VTE_3_3_2_1;}
    @JsonProperty("VTE-3-3-2-1")
    public void setVTE_3_3_2_1(final String VTE_3_3_2_1) { this.VTE_3_3_2_1=VTE_3_3_2_1;}
    @Column(name = "VTE_3_3_3")
    @JsonProperty("VTE-3-3-3")
    private String VTE_3_3_3; // 医嘱执行起始日期
    public String getVTE_3_3_3() {  return this.VTE_3_3_3;}
    @JsonProperty("VTE-3-3-3")
    public void setVTE_3_3_3(final String VTE_3_3_3) { this.VTE_3_3_3=VTE_3_3_3;}
    @Column(name = "VTE_3_3_4")
    @JsonProperty("VTE-3-3-4")
    private String VTE_3_3_4; // 机械预防措施的选择
    public String getVTE_3_3_4() {  return this.VTE_3_3_4;}
    @JsonProperty("VTE-3-3-4")
    public void setVTE_3_3_4(final String VTE_3_3_4) { this.VTE_3_3_4=VTE_3_3_4;}
    @Column(name = "VTE_3_3_4_1")
    @JsonProperty("VTE-3-3-4-1")
    private String VTE_3_3_4_1; // 其他机械预防措施
    public String getVTE_3_3_4_1() {  return this.VTE_3_3_4_1;}
    @JsonProperty("VTE-3-3-4-1")
    public void setVTE_3_3_4_1(final String VTE_3_3_4_1) { this.VTE_3_3_4_1=VTE_3_3_4_1;}
    @Column(name = "VTE_3_3_5")
    @JsonProperty("VTE-3-3-5")
    private String VTE_3_3_5; // 医嘱执行日期
    public String getVTE_3_3_5() {  return this.VTE_3_3_5;}
    @JsonProperty("VTE-3-3-5")
    public void setVTE_3_3_5(final String VTE_3_3_5) { this.VTE_3_3_5=VTE_3_3_5;}
    @Column(name = "VTE_3_3_6")
    @JsonProperty("VTE-3-3-6")
    private String VTE_3_3_6; // 预防性地药物的选择
    public String getVTE_3_3_6() {  return this.VTE_3_3_6;}
    @JsonProperty("VTE-3-3-6")
    public void setVTE_3_3_6(final String VTE_3_3_6) { this.VTE_3_3_6=VTE_3_3_6;}
    @Column(name = "VTE_3_3_6_1")
    @JsonProperty("VTE-3-3-6-1")
    private String VTE_3_3_6_1; // 其他预防性地药物
    public String getVTE_3_3_6_1() {  return this.VTE_3_3_6_1;}
    @JsonProperty("VTE-3-3-6-1")
    public void setVTE_3_3_6_1(final String VTE_3_3_6_1) { this.VTE_3_3_6_1=VTE_3_3_6_1;}
    @Column(name = "VTE_3_2_7")
    @JsonProperty("VTE-3-2-7")
    private String VTE_3_2_7; // 医嘱执行日期
    public String getVTE_3_2_7() {  return this.VTE_3_2_7;}
    @JsonProperty("VTE-3-2-7")
    public void setVTE_3_2_7(final String VTE_3_2_7) { this.VTE_3_2_7=VTE_3_2_7;}
    @Column(name = "VTE_3_3_8")
    @JsonProperty("VTE-3-3-8")
    private String VTE_3_3_8; // 出院后继续使用抗凝药
    public String getVTE_3_3_8() {  return this.VTE_3_3_8;}
    @JsonProperty("VTE-3-3-8")
    public void setVTE_3_3_8(final String VTE_3_3_8) { this.VTE_3_3_8=VTE_3_3_8;}
    @Column(name = "VTE_3_3_8_1")
    @JsonProperty("VTE-3-3-8-1")
    private String VTE_3_3_8_1; // 其他出院后继续使用抗凝药
    public String getVTE_3_3_8_1() {  return this.VTE_3_3_8_1;}
    @JsonProperty("VTE-3-3-8-1")
    public void setVTE_3_3_8_1(final String VTE_3_3_8_1) { this.VTE_3_3_8_1=VTE_3_3_8_1;}
    @Column(name = "VTE_3_4_1")
    @JsonProperty("VTE-3-4-1")
    private String VTE_3_4_1; // 预防依从性评估
    public String getVTE_3_4_1() {  return this.VTE_3_4_1;}
    @JsonProperty("VTE-3-4-1")
    public void setVTE_3_4_1(final String VTE_3_4_1) { this.VTE_3_4_1=VTE_3_4_1;}
    @Column(name = "VTE_3_4_2")
    @JsonProperty("VTE-3-4-2")
    private String VTE_3_4_2; // 预防安全性主要监测项目
    public String getVTE_3_4_2() {  return this.VTE_3_4_2;}
    @JsonProperty("VTE-3-4-2")
    public void setVTE_3_4_2(final String VTE_3_4_2) { this.VTE_3_4_2=VTE_3_4_2;}
    @Column(name = "VTE_3_4_2_1")
    @JsonProperty("VTE-3-4-2-1")
    private String VTE_3_4_2_1; // 其他预防安全性主要监测项目
    public String getVTE_3_4_2_1() {  return this.VTE_3_4_2_1;}
    @JsonProperty("VTE-3-4-2-1")
    public void setVTE_3_4_2_1(final String VTE_3_4_2_1) { this.VTE_3_4_2_1=VTE_3_4_2_1;}
    @Column(name = "VTE_3_4_3")
    @JsonProperty("VTE-3-4-3")
    private String VTE_3_4_3; // 是否进行预防效果评估
    public String getVTE_3_4_3() {  return this.VTE_3_4_3;}
    @JsonProperty("VTE-3-4-3")
    public void setVTE_3_4_3(final String VTE_3_4_3) { this.VTE_3_4_3=VTE_3_4_3;}
    @Column(name = "VTE_3_4_4")
    @JsonProperty("VTE-3-4-4")
    private String VTE_3_4_4; // 预防效果评估及相关不良事件
    public String getVTE_3_4_4() {  return this.VTE_3_4_4;}
    @JsonProperty("VTE-3-4-4")
    public void setVTE_3_4_4(final String VTE_3_4_4) { this.VTE_3_4_4=VTE_3_4_4;}
    @Column(name = "VTE_3_4_4_1")
    @JsonProperty("VTE-3-4-4-1")
    private String VTE_3_4_4_1; // 与预防相关的不良事件
    public String getVTE_3_4_4_1() {  return this.VTE_3_4_4_1;}
    @JsonProperty("VTE-3-4-4-1")
    public void setVTE_3_4_4_1(final String VTE_3_4_4_1) { this.VTE_3_4_4_1=VTE_3_4_4_1;}
    @Column(name = "VTE_3_4_4_2")
    @JsonProperty("VTE-3-4-4-2")
    private String VTE_3_4_4_2; // 与预防不相关的不良事件
    public String getVTE_3_4_4_2() {  return this.VTE_3_4_4_2;}
    @JsonProperty("VTE-3-4-4-2")
    public void setVTE_3_4_4_2(final String VTE_3_4_4_2) { this.VTE_3_4_4_2=VTE_3_4_4_2;}
    @Column(name = "VTE_3_4_4_3")
    @JsonProperty("VTE-3-4-4-3")
    private String VTE_3_4_4_3; // 其他预防效果评估及相关不良事件
    public String getVTE_3_4_4_3() {  return this.VTE_3_4_4_3;}
    @JsonProperty("VTE-3-4-4-3")
    public void setVTE_3_4_4_3(final String VTE_3_4_4_3) { this.VTE_3_4_4_3=VTE_3_4_4_3;}
    @Column(name = "VTE_4_1_1")
    @JsonProperty("VTE-4-1-1")
    private String VTE_4_1_1; // 是否为临床高度拟诊"VTE"的患者
    public String getVTE_4_1_1() {  return this.VTE_4_1_1;}
    @JsonProperty("VTE-4-1-1")
    public void setVTE_4_1_1(final String VTE_4_1_1) { this.VTE_4_1_1=VTE_4_1_1;}
    @Column(name = "VTE_4_1_2")
    @JsonProperty("VTE-4-1-2")
    private String VTE_4_1_2; // DVT临床高度可疑患者的识别检查项目
    public String getVTE_4_1_2() {  return this.VTE_4_1_2;}
    @JsonProperty("VTE-4-1-2")
    public void setVTE_4_1_2(final String VTE_4_1_2) { this.VTE_4_1_2=VTE_4_1_2;}
    @Column(name = "VTE_4_1_2_1")
    @JsonProperty("VTE-4-1-2-1")
    private String VTE_4_1_2_1; // 其他DVT临床高度可疑患者的识别检查项目
    public String getVTE_4_1_2_1() {  return this.VTE_4_1_2_1;}
    @JsonProperty("VTE-4-1-2-1")
    public void setVTE_4_1_2_1(final String VTE_4_1_2_1) { this.VTE_4_1_2_1=VTE_4_1_2_1;}
    @Column(name = "VTE_4_1_3")
    @JsonProperty("VTE-4-1-3")
    private String VTE_4_1_3; // 急性PTE临床高度可疑患者的识别检查项目
    public String getVTE_4_1_3() {  return this.VTE_4_1_3;}
    @JsonProperty("VTE-4-1-3")
    public void setVTE_4_1_3(final String VTE_4_1_3) { this.VTE_4_1_3=VTE_4_1_3;}
    @Column(name = "VTE_4_1_3_1")
    @JsonProperty("VTE-4-1-3-1")
    private String VTE_4_1_3_1; // 其他急性PTE临床高度可疑患者的识别检查项目
    public String getVTE_4_1_3_1() {  return this.VTE_4_1_3_1;}
    @JsonProperty("VTE-4-1-3-1")
    public void setVTE_4_1_3_1(final String VTE_4_1_3_1) { this.VTE_4_1_3_1=VTE_4_1_3_1;}
    @Column(name = "VTE_4_1_4")
    @JsonProperty("VTE-4-1-4")
    private String VTE_4_1_4; // 出现首个VTE的临床表现时间
    public String getVTE_4_1_4() {  return this.VTE_4_1_4;}
    @JsonProperty("VTE-4-1-4")
    public void setVTE_4_1_4(final String VTE_4_1_4) { this.VTE_4_1_4=VTE_4_1_4;}
    @Column(name = "VTE_4_2_1")
    @JsonProperty("VTE-4-2-1")
    private String VTE_4_2_1; // 是否经MDT制定VTE 针对性紧急处理方案
    public String getVTE_4_2_1() {  return this.VTE_4_2_1;}
    @JsonProperty("VTE-4-2-1")
    public void setVTE_4_2_1(final String VTE_4_2_1) { this.VTE_4_2_1=VTE_4_2_1;}
    @Column(name = "VTE_4_2_2")
    @JsonProperty("VTE-4-2-2")
    private String VTE_4_2_2; // 临床高度可疑为VTE后,针对性紧急处理的方法
    public String getVTE_4_2_2() {  return this.VTE_4_2_2;}
    @JsonProperty("VTE-4-2-2")
    public void setVTE_4_2_2(final String VTE_4_2_2) { this.VTE_4_2_2=VTE_4_2_2;}
    @Column(name = "VTE_4_2_2_1")
    @JsonProperty("VTE-4-2-2-1")
    private String VTE_4_2_2_1; // 其他临床高度可疑为VTE后,针对性紧急处理的方法
    public String getVTE_4_2_2_1() {  return this.VTE_4_2_2_1;}
    @JsonProperty("VTE-4-2-2-1")
    public void setVTE_4_2_2_1(final String VTE_4_2_2_1) { this.VTE_4_2_2_1=VTE_4_2_2_1;}
    @Column(name = "VTE_4_5_1")
    @JsonProperty("VTE-4-5-1")
    private String VTE_4_5_1; // 抗凝重叠治疗医嘱的执行起始的时间选择
    public String getVTE_4_5_1() {  return this.VTE_4_5_1;}
    @JsonProperty("VTE-4-5-1")
    public void setVTE_4_5_1(final String VTE_4_5_1) { this.VTE_4_5_1=VTE_4_5_1;}
    @Column(name = "VTE_4_5_1_a")
    @JsonProperty("VTE-4-5-1-a")
    private String VTE_4_5_1_a; // 溶栓剂（rt-PA+尿激酶）治疗医嘱的执行起始的时间
    public String getVTE_4_5_1_a() {  return this.VTE_4_5_1_a;}
    @JsonProperty("VTE-4-5-1-a")
    public void setVTE_4_5_1_a(final String VTE_4_5_1_a) { this.VTE_4_5_1_a=VTE_4_5_1_a;}
    ...
    public String getVTE_4_5_1_b() {  return this.VTE_4_5_1_b;}
    @JsonProperty("VTE-4-5-1-b")
    public void setVTE_4_5_1_b(final String VTE_4_5_1_b) { this.VTE_4_5_1_b=VTE_4_5_1_b;}
    @Column(name = "VTE_4_5_1_c")
    @JsonProperty("VTE-4-5-1-c")
    private String VTE_4_5_1_c; // 低分子肝素钙（LMWH）治疗医嘱的执行起始的时间
    public String getVTE_4_5_1_c() {  return this.VTE_4_5_1_c;}
    @JsonProperty("VTE-4-5-1-c")
    public void setVTE_4_5_1_c(final String VTE_4_5_1_c) { this.VTE_4_5_1_c=VTE_4_5_1_c;}
    @Column(name = "VTE_4_5_1_d")
    @JsonProperty("VTE-4-5-1-d")
    private String VTE_4_5_1_d; // 维生素K拮抗剂（VKA）治疗医嘱的执行起始的时间
    public String getVTE_4_5_1_d() {  return this.VTE_4_5_1_d;}
    @JsonProperty("VTE-4-5-1-d")
    public void setVTE_4_5_1_d(final String VTE_4_5_1_d) { this.VTE_4_5_1_d=VTE_4_5_1_d;}
    @Column(name = "VTE_4_5_1_e")
    @JsonProperty("VTE-4-5-1-e")
    private String VTE_4_5_1_e; // 华法林（Warfarin）治疗医嘱的执行起始的时间
    public String getVTE_4_5_1_e() {  return this.VTE_4_5_1_e;}
    @JsonProperty("VTE-4-5-1-e")
    public void setVTE_4_5_1_e(final String VTE_4_5_1_e) { this.VTE_4_5_1_e=VTE_4_5_1_e;}
    @Column(name = "VTE_4_5_1_f")
    @JsonProperty("VTE-4-5-1-f")
    private String VTE_4_5_1_f; // 其他抗凝剂治疗医嘱的执行起始的时间
    public String getVTE_4_5_1_f() {  return this.VTE_4_5_1_f;}
    @JsonProperty("VTE-4-5-1-f")
    public void setVTE_4_5_1_f(final String VTE_4_5_1_f) { this.VTE_4_5_1_f=VTE_4_5_1_f;}
    @Column(name = "VTE_4_6_1")
    @JsonProperty("VTE-4-6-1")
    private String VTE_4_6_1; // 放置静脉滤器（IVCF）预防PTE的执行起始的时间
    public String getVTE_4_6_1() {  return this.VTE_4_6_1;}
    @JsonProperty("VTE-4-6-1")
    public void setVTE_4_6_1(final String VTE_4_6_1) { this.VTE_4_6_1=VTE_4_6_1;}
    @Column(name = "VTE_4_6_2")
    @JsonProperty("VTE-4-6-2")
    private String VTE_4_6_2; // 放置静脉滤器（IVCF）预防PTE的术式
    public String getVTE_4_6_2() {  return this.VTE_4_6_2;}
    @JsonProperty("VTE-4-6-2")
    public void setVTE_4_6_2(final String VTE_4_6_2) { this.VTE_4_6_2=VTE_4_6_2;}
    @Column(name = "CM_4_1")
    @JsonProperty("CM-4-1")
