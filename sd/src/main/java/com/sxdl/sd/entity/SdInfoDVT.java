...
public class SdInfoDVT implements Serializable {
    ...
    public String getDVT_2_1_1() {  return this.DVT_2_1_1;}
    @JsonProperty("DVT-2-1-1")
    public void setDVT_2_1_1(final String DVT_2_1_1) { this.DVT_2_1_1=DVT_2_1_1;}
    @Column(name = "DVT_2_1_2")
    @JsonProperty("DVT-2-1-2")
    private String DVT_2_1_2; // 评估分值
    public String getDVT_2_1_2() {  return this.DVT_2_1_2;}
    @JsonProperty("DVT-2-1-2")
    public void setDVT_2_1_2(final String DVT_2_1_2) { this.DVT_2_1_2=DVT_2_1_2;}
    @Column(name = "DVT_2_1_3")
    @JsonProperty("DVT-2-1-3")
    private String DVT_2_1_3; // DVT发生风险分层
    public String getDVT_2_1_3() {  return this.DVT_2_1_3;}
    @JsonProperty("DVT-2-1-3")
    public void setDVT_2_1_3(final String DVT_2_1_3) { this.DVT_2_1_3=DVT_2_1_3;}
    @Column(name = "DVT_2_1_4")
    @JsonProperty("DVT-2-1-4")
    private String DVT_2_1_4; // 评估分值
    public String getDVT_2_1_4() {  return this.DVT_2_1_4;}
    @JsonProperty("DVT-2-1-4")
    public void setDVT_2_1_4(final String DVT_2_1_4) { this.DVT_2_1_4=DVT_2_1_4;}
    @Column(name = "DVT_2_1_5")
    @JsonProperty("DVT-2-1-5")
    private String DVT_2_1_5; // DVT发生风险分层
    public String getDVT_2_1_5() {  return this.DVT_2_1_5;}
    @JsonProperty("DVT-2-1-5")
    public void setDVT_2_1_5(final String DVT_2_1_5) { this.DVT_2_1_5=DVT_2_1_5;}
    @Column(name = "DVT_2_1_6")
    @JsonProperty("DVT-2-1-6")
    private String DVT_2_1_6; // 评估分值
    public String getDVT_2_1_6() {  return this.DVT_2_1_6;}
    @JsonProperty("DVT-2-1-6")
    public void setDVT_2_1_6(final String DVT_2_1_6) { this.DVT_2_1_6=DVT_2_1_6;}
    @Column(name = "DVT_2_1_7")
    @JsonProperty("DVT-2-1-7")
    private String DVT_2_1_7; // DVT发生风险分层
    public String getDVT_2_1_7() {  return this.DVT_2_1_7;}
    @JsonProperty("DVT-2-1-7")
    public void setDVT_2_1_7(final String DVT_2_1_7) { this.DVT_2_1_7=DVT_2_1_7;}
    @Column(name = "DVT_2_1_8")
    @JsonProperty("DVT-2-1-8")
    private String DVT_2_1_8; // 临床常用检测方法
    public String getDVT_2_1_8() {  return this.DVT_2_1_8;}
    @JsonProperty("DVT-2-1-8")
    public void setDVT_2_1_8(final String DVT_2_1_8) { this.DVT_2_1_8=DVT_2_1_8;}
    @Column(name = "DVT_2_2_4")
    @JsonProperty("DVT-2-2-4")
    private String DVT_2_2_4; // 术后可能诱发危险因素
    public String getDVT_2_2_4() {  return this.DVT_2_2_4;}
    @JsonProperty("DVT-2-2-4")
    public void setDVT_2_2_4(final String DVT_2_2_4) { this.DVT_2_2_4=DVT_2_2_4;}
    @Column(name = "DVT_2_2_4_1")
    @JsonProperty("DVT-2-2-4-1")
    private String DVT_2_2_4_1; // 其他术后可能诱发危险因素
    public String getDVT_2_2_4_1() {  return this.DVT_2_2_4_1;}
    @JsonProperty("DVT-2-2-4-1")
    public void setDVT_2_2_4_1(final String DVT_2_2_4_1) { this.DVT_2_2_4_1=DVT_2_2_4_1;}
    @Column(name = "DVT_2_2_1")
    @JsonProperty("DVT-2-2-1")
    private String DVT_2_2_1; // 是否有实施预防术后深静脉血栓措施的禁忌
    public String getDVT_2_2_1() {  return this.DVT_2_2_1;}
    @JsonProperty("DVT-2-2-1")
    public void setDVT_2_2_1(final String DVT_2_2_1) { this.DVT_2_2_1=DVT_2_2_1;}
    @Column(name = "DVT_2_2_2")
    @JsonProperty("DVT-2-2-2")
    private String DVT_2_2_2; // 实施药物预防措施应用禁忌
    public String getDVT_2_2_2() {  return this.DVT_2_2_2;}
    @JsonProperty("DVT-2-2-2")
    public void setDVT_2_2_2(final String DVT_2_2_2) { this.DVT_2_2_2=DVT_2_2_2;}
    @Column(name = "DVT_2_2_3")
    @JsonProperty("DVT-2-2-3")
    private String DVT_2_2_3; // 实施机械预防措施应用禁忌
    public String getDVT_2_2_3() {  return this.DVT_2_2_3;}
    @JsonProperty("DVT-2-2-3")
    public void setDVT_2_2_3(final String DVT_2_2_3) { this.DVT_2_2_3=DVT_2_2_3;}
    @Column(name = "DVT_2_6_1")
    @JsonProperty("DVT-2-6-1")
    private String DVT_2_6_1; // 是否实施基本预防措施
    public String getDVT_2_6_1() {  return this.DVT_2_6_1;}
    @JsonProperty("DVT-2-6-1")
    public void setDVT_2_6_1(final String DVT_2_6_1) { this.DVT_2_6_1=DVT_2_6_1;}
    @Column(name = "DVT_2_4_1")
    @JsonProperty("DVT-2-4-1")
    private String DVT_2_4_1; // 基本预防措施的选择
    public String getDVT_2_4_1() {  return this.DVT_2_4_1;}
    @JsonProperty("DVT-2-4-1")
    public void setDVT_2_4_1(final String DVT_2_4_1) { this.DVT_2_4_1=DVT_2_4_1;}
    @Column(name = "DVT_2_4_1_1")
    @JsonProperty("DVT-2-4-1-1")
    private String DVT_2_4_1_1; // 其他基本预防措施
    public String getDVT_2_4_1_1() {  return this.DVT_2_4_1_1;}
    @JsonProperty("DVT-2-4-1-1")
    public void setDVT_2_4_1_1(final String DVT_2_4_1_1) { this.DVT_2_4_1_1=DVT_2_4_1_1;}
    @Column(name = "DVT_2_4_1_2")
    @JsonProperty("DVT-2-4-1-2")
    private String DVT_2_4_1_2; // 基本预防措施医嘱执行日期
    public String getDVT_2_4_1_2() {  return this.DVT_2_4_1_2;}
    @JsonProperty("DVT-2-4-1-2")
    public void setDVT_2_4_1_2(final String DVT_2_4_1_2) { this.DVT_2_4_1_2=DVT_2_4_1_2;}
    @Column(name = "DVT_2_6_2")
    @JsonProperty("DVT-2-6-2")
    private String DVT_2_6_2; // 是否实施机械预防措施
    public String getDVT_2_6_2() {  return this.DVT_2_6_2;}
    @JsonProperty("DVT-2-6-2")
    public void setDVT_2_6_2(final String DVT_2_6_2) { this.DVT_2_6_2=DVT_2_6_2;}
    @Column(name = "DVT_2_4_2")
    @JsonProperty("DVT-2-4-2")
    private String DVT_2_4_2; // 机械预防措施的选择
    public String getDVT_2_4_2() {  return this.DVT_2_4_2;}
    @JsonProperty("DVT-2-4-2")
    public void setDVT_2_4_2(final String DVT_2_4_2) { this.DVT_2_4_2=DVT_2_4_2;}
    @Column(name = "DVT_2_4_2_1")
    @JsonProperty("DVT-2-4-2-1")
    private String DVT_2_4_2_1; // 其他机械预防措施的选择
    public String getDVT_2_4_2_1() {  return this.DVT_2_4_2_1;}
    @JsonProperty("DVT-2-4-2-1")
    public void setDVT_2_4_2_1(final String DVT_2_4_2_1) { this.DVT_2_4_2_1=DVT_2_4_2_1;}
    @Column(name = "DVT_2_4_2_2")
    @JsonProperty("DVT-2-4-2-2")
    private String DVT_2_4_2_2; // 机械预防措施医嘱执行起始日期
    public String getDVT_2_4_2_2() {  return this.DVT_2_4_2_2;}
    @JsonProperty("DVT-2-4-2-2")
    public void setDVT_2_4_2_2(final String DVT_2_4_2_2) { this.DVT_2_4_2_2=DVT_2_4_2_2;}
    @Column(name = "DVT_2_6_3")
    @JsonProperty("DVT-2-6-3")
    private String DVT_2_6_3; // 是否实施药物预防措施
    public String getDVT_2_6_3() {  return this.DVT_2_6_3;}
    @JsonProperty("DVT-2-6-3")
    public void setDVT_2_6_3(final String DVT_2_6_3) { this.DVT_2_6_3=DVT_2_6_3;}
    @Column(name = "DVT_2_4_3")
    @JsonProperty("DVT-2-4-3")
    private String DVT_2_4_3; // 预防性地药物的选择
    public String getDVT_2_4_3() {  return this.DVT_2_4_3;}
    @JsonProperty("DVT-2-4-3")
    public void setDVT_2_4_3(final String DVT_2_4_3) { this.DVT_2_4_3=DVT_2_4_3;}
    @Column(name = "DVT_2_4_3_1")
    @JsonProperty("DVT-2-4-3-1")
    private String DVT_2_4_3_1; // 其他预防性地药物
    public String getDVT_2_4_3_1() {  return this.DVT_2_4_3_1;}
    @JsonProperty("DVT-2-4-3-1")
    public void setDVT_2_4_3_1(final String DVT_2_4_3_1) { this.DVT_2_4_3_1=DVT_2_4_3_1;}
    @Column(name = "DVT_2_4_3_2")
    @JsonProperty("DVT-2-4-3-2")
    private String DVT_2_4_3_2; // 预防性地药物医嘱执行日期
    public String getDVT_2_4_3_2() {  return this.DVT_2_4_3_2;}
    @JsonProperty("DVT-2-4-3-2")
    public void setDVT_2_4_3_2(final String DVT_2_4_3_2) { this.DVT_2_4_3_2=DVT_2_4_3_2;}
    @Column(name = "DVT_2_4_4")
    @JsonProperty("DVT-2-4-4")
    private String DVT_2_4_4; // 出院后继续使用抗凝药
    public String getDVT_2_4_4() {  return this.DVT_2_4_4;}
    @JsonProperty("DVT-2-4-4")
    public void setDVT_2_4_4(final String DVT_2_4_4) { this.DVT_2_4_4=DVT_2_4_4;}
    @Column(name = "DVT_2_4_4_1")
    @JsonProperty("DVT-2-4-4-1")
    private String DVT_2_4_4_1; // 其他出院后使用的抗凝药
    public String getDVT_2_4_4_1() {  return this.DVT_2_4_4_1;}
    @JsonProperty("DVT-2-4-4-1")
    public void setDVT_2_4_4_1(final String DVT_2_4_4_1) { this.DVT_2_4_4_1=DVT_2_4_4_1;}
    @Column(name = "DVT_2_5_1")
    @JsonProperty("DVT-2-5-1")
    private String DVT_2_5_1; // 术前、术后、出院时为患者提供针对性健康教育服务
    public String getDVT_2_5_1() {  return this.DVT_2_5_1;}
    @JsonProperty("DVT-2-5-1")
    public void setDVT_2_5_1(final String DVT_2_5_1) { this.DVT_2_5_1=DVT_2_5_1;}
    @Column(name = "CM_2_1")
    @JsonProperty("CM-2-1")
    ...
    public String getDVT_3_1_1() {  return this.DVT_3_1_1;}
    @JsonProperty("DVT-3-1-1")
    public void setDVT_3_1_1(final String DVT_3_1_1) { this.DVT_3_1_1=DVT_3_1_1;}
    @Column(name = "CM_2_4")
    @JsonProperty("CM-2-4")
