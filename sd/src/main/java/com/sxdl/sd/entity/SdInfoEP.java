...
public class SdInfoEP implements Serializable {
    ...
    public String getDG_1_1() {  return this.DG_1_1;}
    @JsonProperty("DG-1-1")
    public void setDG_1_1(final String DG_1_1) { this.DG_1_1=DG_1_1;}
    @Column(name = "DG_1_2")
    @JsonProperty("DG-1-2")
    private String DG_1_2; // 高危因素的选择
    public String getDG_1_2() {  return this.DG_1_2;}
    @JsonProperty("DG-1-2")
    public void setDG_1_2(final String DG_1_2) { this.DG_1_2=DG_1_2;}
    @Column(name = "DG_1_2_1")
    @JsonProperty("DG-1-2-1")
    private String DG_1_2_1; // 其他高危因素填写
    public String getDG_1_2_1() {  return this.DG_1_2_1;}
    @JsonProperty("DG-1-2-1")
    public void setDG_1_2_1(final String DG_1_2_1) { this.DG_1_2_1=DG_1_2_1;}
    @Column(name = "DG_1_3_1")
    @JsonProperty("DG-1-3-1")
    private String DG_1_3_1; // 妊娠周数
    public String getDG_1_3_1() {  return this.DG_1_3_1;}
    @JsonProperty("DG-1-3-1")
    public void setDG_1_3_1(final String DG_1_3_1) { this.DG_1_3_1=DG_1_3_1;}
    @Column(name = "DG_1_3_2")
    @JsonProperty("DG-1-3-2")
    private String DG_1_3_2; // 腹痛程度的选择
    public String getDG_1_3_2() {  return this.DG_1_3_2;}
    @JsonProperty("DG-1-3-2")
    public void setDG_1_3_2(final String DG_1_3_2) { this.DG_1_3_2=DG_1_3_2;}
    @Column(name = "DG_1_2_4")
    @JsonProperty("DG-1-2-4")
    private String DG_1_2_4; // 生命体征是否平稳
    public String getDG_1_2_4() {  return this.DG_1_2_4;}
    @JsonProperty("DG-1-2-4")
    public void setDG_1_2_4(final String DG_1_2_4) { this.DG_1_2_4=DG_1_2_4;}
    @Column(name = "DG_1_3_4_1")
    @JsonProperty("DG-1-3-4-1")
    private String DG_1_3_4_1; // 超声检查途径的选择
    public String getDG_1_3_4_1() {  return this.DG_1_3_4_1;}
    @JsonProperty("DG-1-3-4-1")
    public void setDG_1_3_4_1(final String DG_1_3_4_1) { this.DG_1_3_4_1=DG_1_3_4_1;}
    @Column(name = "DG_1_2_2_2")
    @JsonProperty("DG-1-2-2-2")
    private String DG_1_2_2_2; // 超声检查描述
    public String getDG_1_2_2_2() {  return this.DG_1_2_2_2;}
    @JsonProperty("DG-1-2-2-2")
    public void setDG_1_2_2_2(final String DG_1_2_2_2) { this.DG_1_2_2_2=DG_1_2_2_2;}
    @Column(name = "DG_1_2_2_2_1")
    @JsonProperty("DG-1-2-2-2-1")
    private String DG_1_2_2_2_1; // 其他超声检查描述
    public String getDG_1_2_2_2_1() {  return this.DG_1_2_2_2_1;}
    @JsonProperty("DG-1-2-2-2-1")
    public void setDG_1_2_2_2_1(final String DG_1_2_2_2_1) { this.DG_1_2_2_2_1=DG_1_2_2_2_1;}
    @Column(name = "DG_1_2_2_3")
    @JsonProperty("DG-1-2-2-3")
    private String DG_1_2_2_3; // 子宫内膜厚度(mm)
    public String getDG_1_2_2_3() {  return this.DG_1_2_2_3;}
    @JsonProperty("DG-1-2-2-3")
    public void setDG_1_2_2_3(final String DG_1_2_2_3) { this.DG_1_2_2_3=DG_1_2_2_3;}
    @Column(name = "DG_1_3_4_2")
    @JsonProperty("DG-1-3-4-2")
    private String DG_1_3_4_2; // 输卵管妊娠包块最大径的选择
    public String getDG_1_3_4_2() {  return this.DG_1_3_4_2;}
    @JsonProperty("DG-1-3-4-2")
    public void setDG_1_3_4_2(final String DG_1_3_4_2) { this.DG_1_3_4_2=DG_1_3_4_2;}
    @Column(name = "DG_1_3_4_3")
    @JsonProperty("DG-1-3-4-3")
    private String DG_1_3_4_3; // 盆腔内出血量最大径的选择
    public String getDG_1_3_4_3() {  return this.DG_1_3_4_3;}
    @JsonProperty("DG-1-3-4-3")
    public void setDG_1_3_4_3(final String DG_1_3_4_3) { this.DG_1_3_4_3=DG_1_3_4_3;}
    @Column(name = "DG_1_4")
    @JsonProperty("DG-1-4")
    private String DG_1_4; // 到院首次B超检查提示异位妊娠征象报告的时间
    public String getDG_1_4() {  return this.DG_1_4;}
    @JsonProperty("DG-1-4")
    public void setDG_1_4(final String DG_1_4) { this.DG_1_4=DG_1_4;}
    @Column(name = "DG_1_3_1_1")
    @JsonProperty("DG-1-3-1-1")
    private String DG_1_3_1_1; // 是否进行β-HCG测定
    public String getDG_1_3_1_1() {  return this.DG_1_3_1_1;}
    @JsonProperty("DG-1-3-1-1")
    public void setDG_1_3_1_1(final String DG_1_3_1_1) { this.DG_1_3_1_1=DG_1_3_1_1;}
    @Column(name = "DG_1_3_0")
    @JsonProperty("DG-1-3-0")
    private String DG_1_3_0; // hCG测定方式选择
    public String getDG_1_3_0() {  return this.DG_1_3_0;}
    @JsonProperty("DG-1-3-0")
    public void setDG_1_3_0(final String DG_1_3_0) { this.DG_1_3_0=DG_1_3_0;}
    @Column(name = "DG_1_3_2_1")
    @JsonProperty("DG-1-3-2-1")
    private String DG_1_3_2_1; // 静脉血hCG测定值(U/L)
    public String getDG_1_3_2_1() {  return this.DG_1_3_2_1;}
    @JsonProperty("DG-1-3-2-1")
    public void setDG_1_3_2_1(final String DG_1_3_2_1) { this.DG_1_3_2_1=DG_1_3_2_1;}
    @Column(name = "DG_1_3_3")
    @JsonProperty("DG-1-3-3")
    private String DG_1_3_3; // 腹腔血hCG测定值(U/L)
    public String getDG_1_3_3() {  return this.DG_1_3_3;}
    @JsonProperty("DG-1-3-3")
    public void setDG_1_3_3(final String DG_1_3_3) { this.DG_1_3_3=DG_1_3_3;}
    @Column(name = "DG_1_3_4")
    @JsonProperty("DG-1-3-4")
    private String DG_1_3_4; // 阴道血hCG测定值(U/L)
    public String getDG_1_3_4() {  return this.DG_1_3_4;}
    @JsonProperty("DG-1-3-4")
    public void setDG_1_3_4(final String DG_1_3_4) { this.DG_1_3_4=DG_1_3_4;}
    @Column(name = "DG_1_3_5")
    @JsonProperty("DG-1-3-5")
    private String DG_1_3_5; // 尿hCG测定结果
    public String getDG_1_3_5() {  return this.DG_1_3_5;}
    @JsonProperty("DG-1-3-5")
    public void setDG_1_3_5(final String DG_1_3_5) { this.DG_1_3_5=DG_1_3_5;}
    @Column(name = "DG_1_3_6")
    @JsonProperty("DG-1-3-6")
    private String DG_1_3_6; // 到院首次β-HCG测定报告的时间
    public String getDG_1_3_6() {  return this.DG_1_3_6;}
    @JsonProperty("DG-1-3-6")
    public void setDG_1_3_6(final String DG_1_3_6) { this.DG_1_3_6=DG_1_3_6;}
    @Column(name = "DG_1_3_7")
    @JsonProperty("DG-1-3-7")
    private String DG_1_3_7; // 血清hCG阴道超声阈值
    public String getDG_1_3_7() {  return this.DG_1_3_7;}
    @JsonProperty("DG-1-3-7")
    public void setDG_1_3_7(final String DG_1_3_7) { this.DG_1_3_7=DG_1_3_7;}
    @Column(name = "DG_1_3_8")
    @JsonProperty("DG-1-3-8")
    private String DG_1_3_8; // 腹腔血与静脉血hCG比值（Rp/v-hCG）
    public String getDG_1_3_8() {  return this.DG_1_3_8;}
    @JsonProperty("DG-1-3-8")
    public void setDG_1_3_8(final String DG_1_3_8) { this.DG_1_3_8=DG_1_3_8;}
    @Column(name = "DG_1_3_9")
    @JsonProperty("DG-1-3-9")
    private String DG_1_3_9; // 静脉血与阴道血hCG比值（Rv/c-hCG）
    public String getDG_1_3_9() {  return this.DG_1_3_9;}
    @JsonProperty("DG-1-3-9")
    public void setDG_1_3_9(final String DG_1_3_9) { this.DG_1_3_9=DG_1_3_9;}
    @Column(name = "DG_1_4_1")
    @JsonProperty("DG-1-4-1")
    private String DG_1_4_1; // 是否进行穿刺
    public String getDG_1_4_1() {  return this.DG_1_4_1;}
    @JsonProperty("DG-1-4-1")
    public void setDG_1_4_1(final String DG_1_4_1) { this.DG_1_4_1=DG_1_4_1;}
    @Column(name = "DG_1_4_2")
    @JsonProperty("DG-1-4-2")
    private String DG_1_4_2; // 穿刺部位
    public String getDG_1_4_2() {  return this.DG_1_4_2;}
    @JsonProperty("DG-1-4-2")
    public void setDG_1_4_2(final String DG_1_4_2) { this.DG_1_4_2=DG_1_4_2;}
    @Column(name = "DG_1_4_3")
    @JsonProperty("DG-1-4-3")
    private String DG_1_4_3; // 后穹隆穿刺
    public String getDG_1_4_3() {  return this.DG_1_4_3;}
    @JsonProperty("DG-1-4-3")
    public void setDG_1_4_3(final String DG_1_4_3) { this.DG_1_4_3=DG_1_4_3;}
    @Column(name = "DG_1_4_4")
    @JsonProperty("DG-1-4-4")
    private String DG_1_4_4; // 腹腔穿刺
    public String getDG_1_4_4() {  return this.DG_1_4_4;}
    @JsonProperty("DG-1-4-4")
    public void setDG_1_4_4(final String DG_1_4_4) { this.DG_1_4_4=DG_1_4_4;}
    @Column(name = "DG_1_4_5")
    @JsonProperty("DG-1-4-5")
    private String DG_1_4_5; // 到院首次穿刺的时间
    public String getDG_1_4_5() {  return this.DG_1_4_5;}
    @JsonProperty("DG-1-4-5")
    public void setDG_1_4_5(final String DG_1_4_5) { this.DG_1_4_5=DG_1_4_5;}
    @Column(name = "DG_1_6")
    @JsonProperty("DG-1-6")
    private String DG_1_6; // 治疗方式选择
    public String getDG_1_6() {  return this.DG_1_6;}
    @JsonProperty("DG-1-6")
    public void setDG_1_6(final String DG_1_6) { this.DG_1_6=DG_1_6;}
    @Column(name = "DG_1_5_2")
    @JsonProperty("DG-1-5-2")
    private String DG_1_5_2; // 需紧急手术的病情严重程度评估
    public String getDG_1_5_2() {  return this.DG_1_5_2;}
    @JsonProperty("DG-1-5-2")
    public void setDG_1_5_2(final String DG_1_5_2) { this.DG_1_5_2=DG_1_5_2;}
    @Column(name = "DG_1_5_2_1")
    @JsonProperty("DG-1-5-2-1")
    private String DG_1_5_2_1; // 其他需紧急手术的病情严重程度评估
    public String getDG_1_5_2_1() {  return this.DG_1_5_2_1;}
    @JsonProperty("DG-1-5-2-1")
    public void setDG_1_5_2_1(final String DG_1_5_2_1) { this.DG_1_5_2_1=DG_1_5_2_1;}
    @Column(name = "DG_1_5_3")
    @JsonProperty("DG-1-5-3")
    private String DG_1_5_3; // 期待治疗纳入标准选择
    public String getDG_1_5_3() {  return this.DG_1_5_3;}
    @JsonProperty("DG-1-5-3")
    public void setDG_1_5_3(final String DG_1_5_3) { this.DG_1_5_3=DG_1_5_3;}
    @Column(name = "DG_1_5_3_1")
    @JsonProperty("DG-1-5-3-1")
    private String DG_1_5_3_1; // 其他期待治疗纳入标准
    public String getDG_1_5_3_1() {  return this.DG_1_5_3_1;}
    @JsonProperty("DG-1-5-3-1")
    public void setDG_1_5_3_1(final String DG_1_5_3_1) { this.DG_1_5_3_1=DG_1_5_3_1;}
    @Column(name = "DG_2_1_1")
    @JsonProperty("DG-2-1-1")
    private String DG_2_1_1; // 是否有药物治疗
    public String getDG_2_1_1() {  return this.DG_2_1_1;}
    @JsonProperty("DG-2-1-1")
    public void setDG_2_1_1(final String DG_2_1_1) { this.DG_2_1_1=DG_2_1_1;}
    @Column(name = "DG_2_1_2")
    @JsonProperty("DG-2-1-2")
    private String DG_2_1_2; // 是否有药物治疗禁忌症
    public String getDG_2_1_2() {  return this.DG_2_1_2;}
    @JsonProperty("DG-2-1-2")
    public void setDG_2_1_2(final String DG_2_1_2) { this.DG_2_1_2=DG_2_1_2;}
    @Column(name = "DG_2_1_3")
    @JsonProperty("DG-2-1-3")
    private String DG_2_1_3; // 药物治疗禁忌症的选择
    public String getDG_2_1_3() {  return this.DG_2_1_3;}
    @JsonProperty("DG-2-1-3")
    public void setDG_2_1_3(final String DG_2_1_3) { this.DG_2_1_3=DG_2_1_3;}
    @Column(name = "DG_2_1_3_1")
    @JsonProperty("DG-2-1-3-1")
    private String DG_2_1_3_1; // 其他药物治疗禁忌症填写
    public String getDG_2_1_3_1() {  return this.DG_2_1_3_1;}
    @JsonProperty("DG-2-1-3-1")
    public void setDG_2_1_3_1(final String DG_2_1_3_1) { this.DG_2_1_3_1=DG_2_1_3_1;}
    @Column(name = "DG_2_1_4")
    @JsonProperty("DG-2-1-4")
    private String DG_2_1_4; // 药物治疗适应症的选择
    public String getDG_2_1_4() {  return this.DG_2_1_4;}
    @JsonProperty("DG-2-1-4")
    public void setDG_2_1_4(final String DG_2_1_4) { this.DG_2_1_4=DG_2_1_4;}
    @Column(name = "DG_2_1_4_1")
    @JsonProperty("DG-2-1-4-1")
    private String DG_2_1_4_1; // 其他药物治疗适应症填写
    public String getDG_2_1_4_1() {  return this.DG_2_1_4_1;}
    @JsonProperty("DG-2-1-4-1")
    public void setDG_2_1_4_1(final String DG_2_1_4_1) { this.DG_2_1_4_1=DG_2_1_4_1;}
    @Column(name = "DG_2_2")
    @JsonProperty("DG-2-2")
    private String DG_2_2; // 治疗药物的选择
    public String getDG_2_2() {  return this.DG_2_2;}
    @JsonProperty("DG-2-2")
    public void setDG_2_2(final String DG_2_2) { this.DG_2_2=DG_2_2;}
    @Column(name = "DG_2_2_1")
    @JsonProperty("DG-2-2-1")
    private String DG_2_2_1; // 其他治疗药物填写
    public String getDG_2_2_1() {  return this.DG_2_2_1;}
    @JsonProperty("DG-2-2-1")
    public void setDG_2_2_1(final String DG_2_2_1) { this.DG_2_2_1=DG_2_2_1;}
    @Column(name = "DG_2_3")
    @JsonProperty("DG-2-3")
    private String DG_2_3; // 甲氨蝶呤（MTX）给药方案
    public String getDG_2_3() {  return this.DG_2_3;}
    @JsonProperty("DG-2-3")
    public void setDG_2_3(final String DG_2_3) { this.DG_2_3=DG_2_3;}
    @Column(name = "DG_2_4_1")
    @JsonProperty("DG-2-4-1")
    private String DG_2_4_1; // 接受甲氨蝶呤（MTX）治疗患者的用药教育
    public String getDG_2_4_1() {  return this.DG_2_4_1;}
    @JsonProperty("DG-2-4-1")
    public void setDG_2_4_1(final String DG_2_4_1) { this.DG_2_4_1=DG_2_4_1;}
    @Column(name = "DG_3_1_1")
    @JsonProperty("DG-3-1-1")
    private String DG_3_1_1; // 手术的指征的选择
    public String getDG_3_1_1() {  return this.DG_3_1_1;}
    @JsonProperty("DG-3-1-1")
    public void setDG_3_1_1(final String DG_3_1_1) { this.DG_3_1_1=DG_3_1_1;}
    @Column(name = "DG_3_1_1_1")
    @JsonProperty("DG-3-1-1-1")
    private String DG_3_1_1_1; // 其他手术的指征
    public String getDG_3_1_1_1() {  return this.DG_3_1_1_1;}
    @JsonProperty("DG-3-1-1-1")
    public void setDG_3_1_1_1(final String DG_3_1_1_1) { this.DG_3_1_1_1=DG_3_1_1_1;}
    @Column(name = "DG_3_2")
    @JsonProperty("DG-3-2")
    private String DG_3_2; // 手术方式选择
    public String getDG_3_2() {  return this.DG_3_2;}
    @JsonProperty("DG-3-2")
    public void setDG_3_2(final String DG_3_2) { this.DG_3_2=DG_3_2;}
    @Column(name = "DG_3_2_2")
    @JsonProperty("DG-3-2-2")
    private String DG_3_2_2; // 腹腔镜手术术式选择
    public String getDG_3_2_2() {  return this.DG_3_2_2;}
    @JsonProperty("DG-3-2-2")
    public void setDG_3_2_2(final String DG_3_2_2) { this.DG_3_2_2=DG_3_2_2;}
    @Column(name = "DG_3_2_2_1")
    @JsonProperty("DG-3-2-2-1")
    private String DG_3_2_2_1; // 其他腹腔镜手术术式
    public String getDG_3_2_2_1() {  return this.DG_3_2_2_1;}
    @JsonProperty("DG-3-2-2-1")
    public void setDG_3_2_2_1(final String DG_3_2_2_1) { this.DG_3_2_2_1=DG_3_2_2_1;}
    @Column(name = "DG_3_2_1")
    @JsonProperty("DG-3-2-1")
    private String DG_3_2_1; // 其他手术方式
    public String getDG_3_2_1() {  return this.DG_3_2_1;}
    @JsonProperty("DG-3-2-1")
    public void setDG_3_2_1(final String DG_3_2_1) { this.DG_3_2_1=DG_3_2_1;}
    @Column(name = "DG_3_3_3")
    @JsonProperty("DG-3-3-3")
    private String DG_3_3_3; // 手术持续时间(分钟)
    public String getDG_3_3_3() {  return this.DG_3_3_3;}
    @JsonProperty("DG-3-3-3")
    public void setDG_3_3_3(final String DG_3_3_3) { this.DG_3_3_3=DG_3_3_3;}
    @Column(name = "DG_4_1_1")
    @JsonProperty("DG-4-1-1")
    private String DG_4_1_1; // 手术治疗的患者
    public String getDG_4_1_1() {  return this.DG_4_1_1;}
    @JsonProperty("DG-4-1-1")
    public void setDG_4_1_1(final String DG_4_1_1) { this.DG_4_1_1=DG_4_1_1;}
    @Column(name = "DG_4_1_2")
    @JsonProperty("DG-4-1-2")
    private String DG_4_1_2; // 药物治疗的患者
    public String getDG_4_1_2() {  return this.DG_4_1_2;}
    @JsonProperty("DG-4-1-2")
    public void setDG_4_1_2(final String DG_4_1_2) { this.DG_4_1_2=DG_4_1_2;}
    ...
    public String getCM_2_3_16_1() {  return this.CM_2_3_16_1;}
    @JsonProperty("CM-2-3-16-1")
    public void setCM_2_3_16_1(final String CM_2_3_16_1) { this.CM_2_3_16_1=CM_2_3_16_1;}
    ...
    public String getCM_2_3_18() {  return this.CM_2_3_18;}
    @JsonProperty("CM-2-3-18")
    public void setCM_2_3_18(final String CM_2_3_18) { this.CM_2_3_18=CM_2_3_18;}
    @Column(name = "CM_2_3_19")
    @JsonProperty("CM-2-3-19")
    private String CM_2_3_19; // 产科手术伤口的感染
    public String getCM_2_3_19() {  return this.CM_2_3_19;}
    @JsonProperty("CM-2-3-19")
    public void setCM_2_3_19(final String CM_2_3_19) { this.CM_2_3_19=CM_2_3_19;}
    @Column(name = "CM_2_3_20")
    @JsonProperty("CM-2-3-20")
    private String CM_2_3_20; // 产科伤口裂开
    public String getCM_2_3_20() {  return this.CM_2_3_20;}
    @JsonProperty("CM-2-3-20")
    public void setCM_2_3_20(final String CM_2_3_20) { this.CM_2_3_20=CM_2_3_20;}
    @Column(name = "CM_2_3_21")
    @JsonProperty("CM-2-3-21")
    private String CM_2_3_21; // 其他并发症
    public String getCM_2_3_21() {  return this.CM_2_3_21;}
    @JsonProperty("CM-2-3-21")
    public void setCM_2_3_21(final String CM_2_3_21) { this.CM_2_3_21=CM_2_3_21;}
    @Column(name = "CM_2_3_21_1")
    @JsonProperty("CM-2-3-21-1")
    private String CM_2_3_21_1; // 其他的其他并发症
    public String getCM_2_3_21_1() {  return this.CM_2_3_21_1;}
    @JsonProperty("CM-2-3-21-1")
    public void setCM_2_3_21_1(final String CM_2_3_21_1) { this.CM_2_3_21_1=CM_2_3_21_1;}
    @Column(name = "CM_2_4")
    @JsonProperty("CM-2-4")
    ...
    public String getDG_6_1() {  return this.DG_6_1;}
    @JsonProperty("DG-6-1")
    public void setDG_6_1(final String DG_6_1) { this.DG_6_1=DG_6_1;}
    @Column(name = "DG_6_2_1")
    @JsonProperty("DG-6-2-1")
    private String DG_6_2_1; // 是否实施输血
    public String getDG_6_2_1() {  return this.DG_6_2_1;}
    @JsonProperty("DG-6-2-1")
    public void setDG_6_2_1(final String DG_6_2_1) { this.DG_6_2_1=DG_6_2_1;}
    @Column(name = "DG_6_2_2")
    @JsonProperty("DG-6-2-2")
    private String DG_6_2_2; // 是否实施回收式自体输血
    public String getDG_6_2_2() {  return this.DG_6_2_2;}
    @JsonProperty("DG-6-2-2")
    public void setDG_6_2_2(final String DG_6_2_2) { this.DG_6_2_2=DG_6_2_2;}
    @Column(name = "DG_6_5_1")
    @JsonProperty("DG-6-5-1")
    private String DG_6_5_1; // 用血类别的选择
    public String getDG_6_5_1() {  return this.DG_6_5_1;}
    @JsonProperty("DG-6-5-1")
    public void setDG_6_5_1(final String DG_6_5_1) { this.DG_6_5_1=DG_6_5_1;}
    @Column(name = "DG_6_5_1_1")
    @JsonProperty("DG-6-5-1-1")
    private String DG_6_5_1_1; // 全血输血量（ml）
    public String getDG_6_5_1_1() {  return this.DG_6_5_1_1;}
    @JsonProperty("DG-6-5-1-1")
    public void setDG_6_5_1_1(final String DG_6_5_1_1) { this.DG_6_5_1_1=DG_6_5_1_1;}
    @Column(name = "DG_6_5_1_2")
    @JsonProperty("DG-6-5-1-2")
    private String DG_6_5_1_2; // 成份血输血量（ml）
    public String getDG_6_5_1_2() {  return this.DG_6_5_1_2;}
    @JsonProperty("DG-6-5-1-2")
    public void setDG_6_5_1_2(final String DG_6_5_1_2) { this.DG_6_5_1_2=DG_6_5_1_2;}
    @Column(name = "DG_6_5_1_3")
    @JsonProperty("DG-6-5-1-3")
    private String DG_6_5_1_3; // 血浆输血量（ml）
    public String getDG_6_5_1_3() {  return this.DG_6_5_1_3;}
    @JsonProperty("DG-6-5-1-3")
    public void setDG_6_5_1_3(final String DG_6_5_1_3) { this.DG_6_5_1_3=DG_6_5_1_3;}
    @Column(name = "DG_6_2_3")
    @JsonProperty("DG-6-2-3")
    private String DG_6_2_3; // 其中：回收式自体输血量（ml）
    public String getDG_6_2_3() {  return this.DG_6_2_3;}
    @JsonProperty("DG-6-2-3")
    public void setDG_6_2_3(final String DG_6_2_3) { this.DG_6_2_3=DG_6_2_3;}
    @Column(name = "DG_6_4_1")
    @JsonProperty("DG-6-4-1")
    private String DG_6_4_1; // 是否实施储存式自体输血
    public String getDG_6_4_1() {  return this.DG_6_4_1;}
    @JsonProperty("DG-6-4-1")
    public void setDG_6_4_1(final String DG_6_4_1) { this.DG_6_4_1=DG_6_4_1;}
    @Column(name = "DG_6_4_1_1")
    @JsonProperty("DG-6-4-1-1")
    private String DG_6_4_1_1; // 其中：储存式自体输血量（ml）
    public String getDG_6_4_1_1() {  return this.DG_6_4_1_1;}
    @JsonProperty("DG-6-4-1-1")
    public void setDG_6_4_1_1(final String DG_6_4_1_1) { this.DG_6_4_1_1=DG_6_4_1_1;}
    @Column(name = "DG_7_1_1")
    @JsonProperty("DG-7-1-1")
    private String DG_7_1_1; // 术前：健康辅导
    public String getDG_7_1_1() {  return this.DG_7_1_1;}
    @JsonProperty("DG-7-1-1")
    public void setDG_7_1_1(final String DG_7_1_1) { this.DG_7_1_1=DG_7_1_1;}
    @Column(name = "DG_7_1_2")
    @JsonProperty("DG-7-1-2")
    private String DG_7_1_2; // 术后：健康辅导
    public String getDG_7_1_2() {  return this.DG_7_1_2;}
    @JsonProperty("DG-7-1-2")
    public void setDG_7_1_2(final String DG_7_1_2) { this.DG_7_1_2=DG_7_1_2;}
    @Column(name = "DG_7_2_1")
    @JsonProperty("DG-7-2-1")
    private String DG_7_2_1; // 交与患者“出院小结”的副本告知患者出院时风险因素
    public String getDG_7_2_1() {  return this.DG_7_2_1;}
    @JsonProperty("DG-7-2-1")
    public void setDG_7_2_1(final String DG_7_2_1) { this.DG_7_2_1=DG_7_2_1;}
    @Column(name = "DG_7_2_2")
    @JsonProperty("DG-7-2-2")
    private String DG_7_2_2; // 出院带药
    public String getDG_7_2_2() {  return this.DG_7_2_2;}
    @JsonProperty("DG-7-2-2")
    public void setDG_7_2_2(final String DG_7_2_2) { this.DG_7_2_2=DG_7_2_2;}
    @Column(name = "DG_7_2_3")
    @JsonProperty("DG-7-2-3")
    private String DG_7_2_3; // 告知发生紧急情况时求援救治途径
    public String getDG_7_2_3() {  return this.DG_7_2_3;}
    @JsonProperty("DG-7-2-3")
    public void setDG_7_2_3(final String DG_7_2_3) { this.DG_7_2_3=DG_7_2_3;}
    @Column(name = "DG_7_2_4")
    @JsonProperty("DG-7-2-4")
    private String DG_7_2_4; // 出院时教育与随访
    public String getDG_7_2_4() {  return this.DG_7_2_4;}
    @JsonProperty("DG-7-2-4")
    public void setDG_7_2_4(final String DG_7_2_4) { this.DG_7_2_4=DG_7_2_4;}
    @Column(name = "DG_7_2_5")
    @JsonProperty("DG-7-2-5")
    private String DG_7_2_5; // 告知何为风险因素与紧急情况
    public String getDG_7_2_5() {  return this.DG_7_2_5;}
    @JsonProperty("DG-7-2-5")
    public void setDG_7_2_5(final String DG_7_2_5) { this.DG_7_2_5=DG_7_2_5;}
    @Column(name = "CM_3_1")
    @JsonProperty("CM-3-1")
