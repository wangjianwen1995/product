package com.sxdl.base.util.license.xml;
...
public class PersistenceService implements XMLConstants {
	...
	private static final ExceptionListener createExceptionListener() {
		return new ExceptionListener() {
			public void exceptionThrown(Exception paramAnonymousException) {
				throw ((paramAnonymousException instanceof UndeclaredThrowableException)
						? (UndeclaredThrowableException) paramAnonymousException
						: new UndeclaredThrowableException(paramAnonymousException));
			}
		};
	}
	...
	public static void store(Object paramObject, File paramFile)
		...
		try {
			...
			throw ((localObject instanceof PersistenceServiceException) ? (PersistenceServiceException) localObject
					: new PersistenceServiceException(localObject));
		}
	}
