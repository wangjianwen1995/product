...
public final class ObfuscatedString {
	...
	public static String encrypt_Base64(String str) {
		try {
			...
			System.out.println("出错了!字符串转换失败!");
		}
		return str;
	}
	...
	public static String obfuscate(String paramString) {
		if (paramString.indexOf(0) != -1) {
			throw new IllegalArgumentException(
					new ObfuscatedString(new long[] { 2598583114197433456L, -2532951909540716745L, 1850312903926917213L,
							-7324743161950196342L, 3319654553699491298L }).toString());
		}
		byte[] arrayOfByte;
		try {
		...
		StringBuffer localStringBuffer = new StringBuffer(
				new ObfuscatedString(new long[] { -6733388613909857970L, -557652741307719956L, 563088487624542180L,
						5623833171491374716L, -2309350771052518321L, 2627844803624578169L }).toString());
		...
		localStringBuffer.append(new ObfuscatedString(
				new long[] { 4756003162039514438L, -7241174029104351587L, 2576762727660584163L, 2432800632635846553L })
						.toString());
		localStringBuffer.append(paramString
				.replaceAll("\\\\",
						new ObfuscatedString(new long[] { 7866777055383403009L, -5101749501440392498L }).toString())
				.replaceAll("\"",
						new ObfuscatedString(new long[] { -8797265930671803829L, -5738757606858957305L }).toString()));
		localStringBuffer
				.append(new ObfuscatedString(new long[] { -4228881123273879289L, 1823585417647083411L }).toString());
