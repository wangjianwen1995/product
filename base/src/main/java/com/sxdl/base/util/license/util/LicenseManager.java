...
import com.sxdl.base.util.license.exception.LicenseContentException;
import com.sxdl.base.util.license.exception.NoLicenseInstalledException;
...
public class LicenseManager implements LicenseVerifier{
	...
	protected synchronized void validate(LicenseContent paramLicenseContent)
		...
		String macAddress = licenseCheckModel.getMacAddress();
