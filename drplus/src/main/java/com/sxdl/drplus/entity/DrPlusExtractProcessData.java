...
@ApiModel(value = "drplus_extract_process_data", description = "抽取数据时保存病历号(用来数据下钻)")
@Entity
@Data
@Table(name="drplus_extract_process_data")
@Deprecated
public class DrPlusExtractProcessData implements Serializable {
