...
public class HpIcdcm3Service extends BaseUUIDServiceImpl<HpIcdcm3> {
     ...
     * @param p    分页信息
     */
    public PageInfo findIccm(String name, String ssdj, String lb, String wc, String rj, PageInfo p) throws Exception {
        ...
        String col = "[id],[lc1_2dm],[lc1_2mc],[lc2_0dm],[lc2_0mc],[yb1_0dm],[yb1_0mc],[lc3_0dm],[lc3_0mc],[lb],[ssdj],[iswc],[isrj],[isss],(case when iszlxcz=1 or iszlxcz=2 then 1 else 0 end) as [iszlxcz],[isjr],[iszdxcz],[bz],[bz_name],[flag],[create_time],[modify_time]";
     ...
     * 查询执行标准字典表
     */
    public List<SysDictVal> findBZDicts() throws Exception {
     ...
     * @throws Exception
     */
    public boolean checkHasData(String bz, String bzname) throws Exception {
     ...
     * @throws Exception
     */
    public void initData(String bz, String bzname) throws Exception {
