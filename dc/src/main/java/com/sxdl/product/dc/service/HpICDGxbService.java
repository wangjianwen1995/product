...
import com.sxdl.product.dc.dao.dao1.HpICDGxbDao;
...
public class HpICDGxbService extends BaseUUIDServiceImpl<HpICDGxb> {
    ...
    public List selectnNewVersionSome(String leftVersion, String rightVersion, String flag, String type) throws Exception {
    ...
    public HpICDGxb getVersion(String leftVersion, String rightVersion) throws Exception {
    ...
    public void saveGxb(String leftVersion, String rightVersion, String type, String tableName, String gxbName) throws Exception {
        //获取查询的列
