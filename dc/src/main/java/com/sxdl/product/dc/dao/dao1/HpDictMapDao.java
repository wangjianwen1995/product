...
public interface HpDictMapDao extends BaseDao<HpDictMap> {
    ...
    @Select("select * from hp_dict_map where his_code = '${his_code}' and his_name = '${his_name}' and hp_column_id = '${col_id}' order by hp_val_id")
    List<HpDictMap> findDataByHisCodeAndColId(String his_code,String his_name, String col_id);
