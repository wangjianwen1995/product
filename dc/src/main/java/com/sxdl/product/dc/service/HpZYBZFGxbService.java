...
import com.sxdl.product.dc.dao.dao1.HpZYBZFGxbDao;
import com.sxdl.product.dc.entity.HpZYBZFGxb;
...
public class HpZYBZFGxbService extends BaseServiceImpl<HpZYBZFGxb> {
    ...
    public HpZYBZFGxb getVersion(String leftVersion, String rightVersion) throws Exception {
