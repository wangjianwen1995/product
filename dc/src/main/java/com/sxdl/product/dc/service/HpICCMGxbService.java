...
public class HpICCMGxbService extends BaseServiceImpl<HpICCMGxb> {
    ...
    public static HpICCMGxb getVersion(String leftVersion, String rightVersion) throws Exception {
    ...
    public List<HpICCMGxb> selectSome(String leftVersion, String rightVersion, String table_name, String name) throws Exception {
    ...
    public Map<String, List<HpICCMGxb>> selectLeftAndBzVersion(String leftVersion, String rightVersion, String type, String table_name) throws Exception {
        HpICCMGxb version = getVersion(leftVersion, rightVersion);
    ...
    public List<HpICCMGxb> findWzdData(String rightVersion, String type, String leftMc) throws Exception {
        String left_mc = "";
    ...
    public String getLikeName(String name) throws Exception {
    ...
    public String saveDz(String leftVersion, String rightVersion, String type, String tableName, String gxbName) throws Exception {
    ...
    //获取未对照的版本号，版本名称
    public List getWdzVersion(String type, String tableName) throws Exception {
        String sql = "select distinct version,version_name  from hp_bzdmk  where type=" + type + " and version not in (select distinct c.val from sys.columns a \n" +
                ...
                "inner join dc_sys_dict_val c on SUBSTRING(a.name,0,LEN(a.name)-1)=c.remark \n" +
    ...
    //获取已对照的版本号，版本名称
    public List getIcdYdzVersion(String tableName) throws Exception {
    ...
    public List getIcdYdz2Version(String type) throws Exception {
        String sql = "select val,name from dc_sys_dict_val where remark='" + type + "' ";
        List<Map<String, Object>> list = hpICCMGxbDao.selectSqlWithSQL(sql);
        return list;
    }

    // 获取表的字段
    public List getTableColum(String tableName) throws Exception {
    ...
    public void resetDz(String leftVersion, String rightVersion, String gxbName, String tableName) throws Exception {
        String gxType = leftVersion + "_" + rightVersion;
        HpICCMGxb version = getVersion(leftVersion, rightVersion);
        String right_mc = version.getRight_mc();
        String right_dm = version.getRight_dm();
    ...
    //修改手术等级
    public void updateSSdj(String leftVersion, String rightVersion) throws Exception {
        HpICCMGxb version = getVersion(leftVersion, rightVersion);
        ...
        String updateDictSql = "update dc_sys_dict_val set val=" + rightVersion + ", name='" + name + "' where dict_id=103";
    ...
    public String selectSSVersion(String table) throws Exception {
