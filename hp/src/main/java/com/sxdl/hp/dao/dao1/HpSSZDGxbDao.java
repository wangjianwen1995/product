...
import com.sxdl.hp.entity.HpSSZDGxb;
import org.apache.ibatis.annotations.Param;
import org.apache.ibatis.annotations.Select;

import java.util.List;

public interface HpSSZDGxbDao extends BaseDao<HpSSZDGxb> {
    @Select("select ${left_dm} as left_bm,${left_mc} as left_mc,${right_dm} as right_dm,${right_mc} as right_mc from ${table_name}")
    List<HpSSZDGxb> selectByVersion(@Param("left_dm") String left_dm,
    ...
    */
    ...
    List<HpSSZDGxb> selectLeftByVersion(@Param("left_dm") String left_dm,
                                        @Param("left_mc") String left_mc);

    @Select("select code as right_dm,name as right_mc from hp_bzdmk where type=${type} and version=${rightVersion} ")
    List<HpSSZDGxb> selectByTypeAndVersion(@Param("type") String type, @Param("rightVersion") String rightVersion);
 /*   @Select("select code as as right_dm,name as right_mc from hp_bzdmk a left join hp_iccm_gxb b on  \n" +
    ...
    List<HpSSZDGxb> selectWdz(@Param("type") String type,
