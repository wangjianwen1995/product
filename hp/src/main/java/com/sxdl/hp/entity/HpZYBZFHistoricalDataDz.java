...
@ApiModel(value = "hp_history_zybzf_dz", description = "中医病症法历史数据编码对照")
@Entity
@Data
@Table(name="hp_history_zybzf_dz")
public class HpZYBZFHistoricalDataDz implements Serializable {
