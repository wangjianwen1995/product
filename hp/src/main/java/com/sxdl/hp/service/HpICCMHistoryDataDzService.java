...
import com.sxdl.hp.dao.dao1.HpICCMHistoryDataDzDao;
...
public class HpICCMHistoryDataDzService extends BaseServiceImpl<HpICCMHistoricalDataDz> {
    ...
    public Boolean saveDz(String version, String stime, String etime, String version_name, String type)  {
    ...
    public List<Map<String, Object>> selectBySome(String version, String status, String type, String stime, String etime)  {
    ...
    public void saveOrUpdate(HpICCMHistoricalDataDz hpDataDz)  {
