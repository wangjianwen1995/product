...
public class HpRzJzService extends BaseUUIDServiceImpl<HpRzJz> {
     ...
     * @return 字典列表
     */
    public List<SysDictVal> getWZQJYYDict(Integer ison)  {
     ...
     * @return
     */
    public List<SysDictVal> sortAndFilterDicts(Integer ison, List<SysDictVal> dicts)  {
     ...
     * @return 字典列表
     */
    public List<Map<String, Object>> getJZKSDict()  {
        return hpKsService.findKsByType(3, "val");
    }
     ...
     * @param end
     */
    public Map<String, Object> selectJZRZ(String ksid, String start, String end)  {
...
//        System.out.println(allsql);
    ...
    public ResultUtil insertorupdate(HpRzJz hpRzJz)  {
